...
explain analyze select * from valid_detection
where rxr_project_name = 'AATAMS Heron Island'
limit 100;
...
explain analyze select * from valid_detection
where rxr_project_name = 'AATAMS Coffs Harbour line'
limit 100;
