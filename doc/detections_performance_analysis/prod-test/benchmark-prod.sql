...
-- 2716283 rows limited to first 100

explain analyze select * from detection_extract_view_mv
where project = 'AATAMS Heron Island'
limit 100;

-- 3913743 rows limited to first 100

explain analyze select * from detection_extract_view_mv
where spcode = '37018030'
limit 100;

-- 17098775 rows limited to first 100

explain analyze select * from detection_extract_view_mv
where timestamp between '2012-03-01' and '2013-09-01'
limit 100;

-- 2716283 ^ 3913743 -> 1420919 rows limited to first 100
...
-- 2716283 ^ 17098775 -> 902906 rows limited to first 100
...
-- 3913743 ^ 17098775 -> 2233756 rows limited to first 100
...
-- 2716283 ^ 3913743 ^ 17098775 -> 690003 rows limited to first 100
