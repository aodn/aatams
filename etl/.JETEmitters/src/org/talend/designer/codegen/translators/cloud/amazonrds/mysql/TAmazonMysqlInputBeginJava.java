...
public class TAmazonMysqlInputBeginJava
{
  ...
  protected final String TEXT_173 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_174 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_175 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_176 = ".setLength(rsmd_";
  protected final String TEXT_177 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_178 = ".setLength(rsmd_";
  protected final String TEXT_179 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_180 = NL + "\t\t\tdcm_";
  protected final String TEXT_181 = ".setLength(rsmd_";
  protected final String TEXT_182 = ".getPrecision(i));";
  protected final String TEXT_183 = NL + "                \tdcm_";
  protected final String TEXT_184 = ".setPrecision(rsmd_";
  protected final String TEXT_185 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_186 = ".setNullable(rsmd_";
  protected final String TEXT_187 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_188 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_189 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_190 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_191 = ".metadatas.add(dcm_";
  protected final String TEXT_192 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_193 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_194 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_195 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_196 = "++;" + NL + "\t\t        ";
  protected final String TEXT_197 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_208 = " = (List)rs_";
  protected final String TEXT_209 = ".getObject(";
  protected final String TEXT_210 = ");";
  protected final String TEXT_211 = NL + "\t\t                         ";
  protected final String TEXT_212 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_213 = ".getObject(";
  protected final String TEXT_214 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_215 = NL + "                                    ";
  protected final String TEXT_216 = ".";
  protected final String TEXT_217 = " = new Geometry(wktValue);";
  protected final String TEXT_218 = NL + "                                        ";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = ".setEPSG(";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_223 = NL + "                                  ";
  protected final String TEXT_224 = ".";
  protected final String TEXT_225 = "=dcg_";
  protected final String TEXT_226 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_227 = ".";
  protected final String TEXT_228 = ", rs_";
  protected final String TEXT_229 = ", fixedColumnCount_";
  protected final String TEXT_230 = ");";
  protected final String TEXT_231 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_232 = ".getObject(";
  protected final String TEXT_233 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_234 = ".";
  protected final String TEXT_235 = " = new Geometry(sb.toString());";
