...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_46 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t} else {" + NL + "\t\tString proprtties_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "\t\tif (!proprtties_";
  protected final String TEXT_49 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproprtties_";
  ...
  protected final String TEXT_54 = " + \"?\" + proprtties_";
  ...
  protected final String TEXT_80 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_81 = ".execute(\"";
  protected final String TEXT_82 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_83 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_88 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_104 = ".close();";
  ...
  protected final String TEXT_110 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_128 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_129 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_130 = "+\"][\"+";
  protected final String TEXT_131 = "+\"][\"+";
  protected final String TEXT_132 = "+\"][\"+";
  protected final String TEXT_133 = "+\"][\"+";
  protected final String TEXT_134 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_135 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_136 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_137 = " = conn_";
  protected final String TEXT_138 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_139 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_140 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_141 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_142 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_143 = ")== null){";
  protected final String TEXT_144 = "              ";
  protected final String TEXT_145 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_148 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_149 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_150 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_151 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_152 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_159 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_160 = ", tableNameForSearch_";
  protected final String TEXT_161 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_162 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_163 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_164 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_165 = ".close();" + NL + "\t            ";
  protected final String TEXT_166 = "  \t            " + NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_167 = " = conn_";
  protected final String TEXT_168 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_169 = " = dbMetaData_";
  protected final String TEXT_170 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_171 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_172 = ".next()) {" + NL + "\t                String table_";
  ...
  protected final String TEXT_176 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_177 = ".equalsIgnoreCase(";
  protected final String TEXT_178 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_179 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_180 = ") || dbschema_";
  protected final String TEXT_181 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_182 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_188 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_189 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_190 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_191 = " = rsTable_";
  protected final String TEXT_192 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_193 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_198 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_203 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_210 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_223 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_224 = ".execute(\"";
  protected final String TEXT_225 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_226 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_248 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_249 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_250 = "            ";
  protected final String TEXT_251 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_252 = " = conn_";
  protected final String TEXT_253 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_254 = ".executeUpdate(\"";
  protected final String TEXT_255 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_256 = ".close();";
  protected final String TEXT_257 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_260 = " = stmtTruncCount_";
  protected final String TEXT_261 = ".executeQuery(\"";
  protected final String TEXT_262 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_263 = " = conn_";
  protected final String TEXT_264 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_265 = ".executeUpdate(\"";
  protected final String TEXT_266 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_267 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_268 = " += rsTruncCount_";
  protected final String TEXT_269 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_270 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_271 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_289 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_290 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_292 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_293 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_294 = ".append (\"`\" +  ";
  protected final String TEXT_295 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_296 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_297 = ".append (";
  protected final String TEXT_298 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t       ";
  protected final String TEXT_300 = NL + "\t\t        String insert_";
  protected final String TEXT_301 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_302 = " + \"` (";
  protected final String TEXT_303 = ") VALUES (";
  protected final String TEXT_304 = ")\";";
  protected final String TEXT_305 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_306 = " += \tduplidateClause_";
  protected final String TEXT_307 = ".toString();";
  protected final String TEXT_308 = NL + "\t\t\t\t";
  protected final String TEXT_309 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_310 = " = new StringBuffer(insert_";
  protected final String TEXT_311 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_312 = ".insert(insert_";
  protected final String TEXT_313 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_314 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_315 = " =insertStringBuffer_";
  protected final String TEXT_316 = ".toString(); ";
  protected final String TEXT_317 = "    " + NL;
  protected final String TEXT_318 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_319 = " = conn_";
  protected final String TEXT_320 = ".prepareStatement(insert_";
  protected final String TEXT_321 = ");";
  protected final String TEXT_322 = NL + "                        ";
  protected final String TEXT_323 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_324 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_327 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_328 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_329 = ",insert_";
  protected final String TEXT_330 = ",keyPsmt_";
  protected final String TEXT_331 = ");";
  protected final String TEXT_332 = NL + "\t        \t        ";
  protected final String TEXT_333 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_334 = " {" + NL + "    \t            ";
  protected final String TEXT_335 = NL + "                            ";
  protected final String TEXT_336 = " ";
  protected final String TEXT_337 = ";                ";
  protected final String TEXT_338 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_339 = "(";
  protected final String TEXT_340 = NL + "                                ,";
  protected final String TEXT_341 = NL + "                            ";
  protected final String TEXT_342 = " ";
  protected final String TEXT_343 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_344 = NL + "                                this.";
  protected final String TEXT_345 = " = ";
  protected final String TEXT_346 = ";              ";
  protected final String TEXT_347 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_348 = "> exInsertColValueList";
  protected final String TEXT_349 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_350 = " exInsertColValue";
  protected final String TEXT_351 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_352 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_353 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_354 = ".append(\"(";
  protected final String TEXT_355 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_356 = "-1) extendInsertValueStmt_";
  protected final String TEXT_357 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_358 = " = \"INSERT INTO `\"+";
  protected final String TEXT_359 = "+\"` (";
  protected final String TEXT_360 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_361 = ".toString();";
  protected final String TEXT_362 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_363 = " += \tduplidateClause_";
  protected final String TEXT_364 = ".toString();";
  protected final String TEXT_365 = NL + "\t\t\t\t";
  protected final String TEXT_366 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_367 = " = new StringBuffer(insert_";
  protected final String TEXT_368 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_369 = ".insert(insert_";
  protected final String TEXT_370 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_371 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_372 = " =insertStringBuffer_";
  protected final String TEXT_373 = ".toString(); ";
  protected final String TEXT_374 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_375 = " =  conn_";
  protected final String TEXT_376 = ".prepareStatement(insert_";
  protected final String TEXT_377 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_378 = " = \"";
  protected final String TEXT_379 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_380 = " =  \"";
  protected final String TEXT_381 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_382 = " = 0;\t ";
  protected final String TEXT_383 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_384 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_385 = " + \"` (";
  protected final String TEXT_386 = ") VALUES (";
  protected final String TEXT_387 = ")\";";
  protected final String TEXT_388 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_389 = " += \tduplidateClause_";
  protected final String TEXT_390 = ".toString();";
  protected final String TEXT_391 = NL + "\t\t        int batchSize_";
  protected final String TEXT_392 = " = ";
  protected final String TEXT_393 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_394 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_395 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_396 = " = new StringBuffer(insert_";
  protected final String TEXT_397 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_398 = ".insert(insert_";
  protected final String TEXT_399 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_400 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_401 = " =insertStringBuffer_";
  protected final String TEXT_402 = ".toString(); ";
  protected final String TEXT_403 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_404 = " = conn_";
  protected final String TEXT_405 = ".prepareStatement(insert_";
  protected final String TEXT_406 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_407 = NL + "\t    String update_";
  protected final String TEXT_408 = " = \"UPDATE `\" + ";
  protected final String TEXT_409 = " + \"` SET ";
  protected final String TEXT_410 = " WHERE ";
  protected final String TEXT_411 = "\";" + NL + "\t    ";
  protected final String TEXT_412 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_413 = " = new StringBuffer(update_";
  protected final String TEXT_414 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_415 = ".insert(update_";
  protected final String TEXT_416 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_417 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_418 = " =updateStringBuffer_";
  protected final String TEXT_419 = ".toString(); ";
  protected final String TEXT_420 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_421 = " = conn_";
  protected final String TEXT_422 = ".prepareStatement(update_";
  protected final String TEXT_423 = ");" + NL + "\t    ";
  protected final String TEXT_424 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_425 = " = conn_";
  protected final String TEXT_426 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_427 = " + \"` WHERE ";
  protected final String TEXT_428 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_429 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_430 = " + \"` (";
  protected final String TEXT_431 = ") VALUES (";
  protected final String TEXT_432 = ")\";" + NL + "\t    ";
  protected final String TEXT_433 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_434 = " = new StringBuffer(insert_";
  protected final String TEXT_435 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_436 = ".insert(insert_";
  protected final String TEXT_437 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_438 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_439 = " =insertStringBuffer_";
  protected final String TEXT_440 = ".toString(); ";
  protected final String TEXT_441 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_442 = " = conn_";
  protected final String TEXT_443 = ".prepareStatement(insert_";
  protected final String TEXT_444 = ");" + NL + "\t    String update_";
  protected final String TEXT_445 = " = \"UPDATE `\" + ";
  protected final String TEXT_446 = " + \"` SET ";
  protected final String TEXT_447 = " WHERE ";
  protected final String TEXT_448 = "\";" + NL + "\t    ";
  protected final String TEXT_449 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_450 = " = new StringBuffer(update_";
  protected final String TEXT_451 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_452 = ".insert(update_";
  protected final String TEXT_453 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_454 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_455 = " =updateStringBuffer_";
  protected final String TEXT_456 = ".toString(); ";
  protected final String TEXT_457 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".prepareStatement(update_";
  protected final String TEXT_460 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_461 = NL + "\t    String update_";
  protected final String TEXT_462 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_474 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_475 = " = conn_";
  protected final String TEXT_476 = ".prepareStatement(update_";
  protected final String TEXT_477 = ");" + NL + "\t    String insert_";
  protected final String TEXT_478 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_495 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_496 = " + \"` WHERE ";
  protected final String TEXT_497 = "\";" + NL + "\t    ";
  protected final String TEXT_498 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_499 = " = new StringBuffer(delete_";
  protected final String TEXT_500 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_501 = ".insert(delete_";
  protected final String TEXT_502 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_503 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_504 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_508 = ".prepareStatement(delete_";
  protected final String TEXT_509 = ");" + NL + "\t    ";
  protected final String TEXT_510 = NL + "\t    String replace_";
  protected final String TEXT_511 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_512 = " + \"` (";
  protected final String TEXT_513 = ") VALUES (";
  protected final String TEXT_514 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_515 = " = conn_";
  protected final String TEXT_516 = ".prepareStatement(replace_";
  protected final String TEXT_517 = ");" + NL + "\t    ";
  protected final String TEXT_518 = NL + "\t    String insertIgnore_";
  protected final String TEXT_519 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_520 = " + \"` (";
  protected final String TEXT_521 = ") VALUES (";
  protected final String TEXT_522 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_523 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_524 = " = conn_";
  protected final String TEXT_525 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_526 = ");" + NL + "\t    ";
  protected final String TEXT_527 = NL + "\t    String insert_";
  protected final String TEXT_528 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_544 = NL + "        StringBuffer query_";
  protected final String TEXT_545 = " = null;" + NL + "       \t";
  protected final String TEXT_546 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_547 = " = insert_";
  protected final String TEXT_548 = ".split(\"\\\\?\");";
  protected final String TEXT_549 = NL + "\t\t\tupdate_";
  protected final String TEXT_550 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_551 = " = update_";
  protected final String TEXT_552 = ".split(\"\\\\?\");";
  protected final String TEXT_553 = NL + "\t\t\tupdate_";
  protected final String TEXT_554 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_555 = " = update_";
  protected final String TEXT_556 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_557 = " = insert_";
  protected final String TEXT_558 = ".split(\"\\\\?\");";
  protected final String TEXT_559 = NL + "\t\t\tdelete_";
  protected final String TEXT_560 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_561 = " = delete_";
  protected final String TEXT_562 = ".split(\"\\\\?\");";
  protected final String TEXT_563 = NL + "\t\t\treplace_";
  protected final String TEXT_564 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_565 = " = replace_";
  protected final String TEXT_566 = ".split(\"\\\\?\");";
  protected final String TEXT_567 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_568 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_569 = " = insertIgnore_";
  protected final String TEXT_570 = ".split(\"\\\\?\");";
  protected final String TEXT_571 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_572 = " = insert_";
  protected final String TEXT_573 = ".split(\"\\\\?\");";
  protected final String TEXT_574 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_575 = " {" + NL + "    \t            ";
  protected final String TEXT_576 = NL + "                            ";
  protected final String TEXT_577 = " ";
  protected final String TEXT_578 = ";                ";
  protected final String TEXT_579 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_580 = ";" + NL + "\t\t\t";
  protected final String TEXT_581 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_582 = "(";
  protected final String TEXT_583 = NL + "                                ,";
  protected final String TEXT_584 = NL + "                            ";
  protected final String TEXT_585 = " ";
  protected final String TEXT_586 = NL + "\t\t\t\t, Dynamic ";
  protected final String TEXT_587 = NL + "\t\t\t";
  protected final String TEXT_588 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_589 = NL + "                                this.";
  protected final String TEXT_590 = " = ";
  protected final String TEXT_591 = ";              ";
  protected final String TEXT_592 = NL + "\t\t\t\tthis.";
  protected final String TEXT_593 = "=";
  protected final String TEXT_594 = ";" + NL + "\t\t\t";
  protected final String TEXT_595 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_596 = "> exInsertColValueList";
  protected final String TEXT_597 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_598 = " exInsertColValue";
  protected final String TEXT_599 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_600 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_601 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_602 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_603 = "=1;";
  protected final String TEXT_604 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_605 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_606 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_607 = " =null;" + NL + "\tint batchSizeCounter_";
  protected final String TEXT_608 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_609 = "=0;" + NL + "\tint rowCount";
