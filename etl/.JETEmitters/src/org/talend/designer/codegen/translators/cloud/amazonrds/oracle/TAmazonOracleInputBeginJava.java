...
public class TAmazonOracleInputBeginJava
{
  ...
  protected final String TEXT_266 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_267 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_268 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_269 = ".setLength(rsmd_";
  protected final String TEXT_270 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_271 = ".setLength(rsmd_";
  protected final String TEXT_272 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_273 = NL + "\t\t\tdcm_";
  protected final String TEXT_274 = ".setLength(rsmd_";
  protected final String TEXT_275 = ".getPrecision(i));";
  protected final String TEXT_276 = NL + "                \tdcm_";
  protected final String TEXT_277 = ".setPrecision(rsmd_";
  protected final String TEXT_278 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_279 = ".setNullable(rsmd_";
  protected final String TEXT_280 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_282 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_284 = ".metadatas.add(dcm_";
  protected final String TEXT_285 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_286 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_287 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_288 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_289 = "++;" + NL + "\t\t        ";
  protected final String TEXT_290 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_301 = " = (List)rs_";
  protected final String TEXT_302 = ".getObject(";
  protected final String TEXT_303 = ");";
  protected final String TEXT_304 = NL + "\t\t                         ";
  protected final String TEXT_305 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_306 = ".getObject(";
  protected final String TEXT_307 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_308 = NL + "                                    ";
  protected final String TEXT_309 = ".";
  protected final String TEXT_310 = " = new Geometry(wktValue);";
  protected final String TEXT_311 = NL + "                                        ";
  protected final String TEXT_312 = ".";
  protected final String TEXT_313 = ".setEPSG(";
  protected final String TEXT_314 = ");";
  protected final String TEXT_315 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "                                  ";
  protected final String TEXT_317 = ".";
  protected final String TEXT_318 = "=dcg_";
  ...
  protected final String TEXT_322 = ", fixedColumnCount_";
  protected final String TEXT_323 = ");";
  protected final String TEXT_324 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_325 = ".getObject(";
  protected final String TEXT_326 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_327 = ".";
  protected final String TEXT_328 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_337 = NL + NL + "\t" + NL + "\t" + NL;
