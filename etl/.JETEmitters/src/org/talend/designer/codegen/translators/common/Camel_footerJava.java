...
public class Camel_footerJava
{
  ...
  protected final String TEXT_5 = NL + "\t\t\t\tjavax.jms.ConnectionFactory jmsConnectionFactory = null;";
  protected final String TEXT_6 = NL + "\t\t\t\tjmsConnectionFactory = new org.apache.activemq.ActiveMQConnectionFactory(";
  protected final String TEXT_7 = ");";
  protected final String TEXT_8 = NL + "\t\t\t\torg.apache.activemq.pool.PooledConnectionFactory pooledConnectionFactory_";
  protected final String TEXT_9 = " " + NL + "\t\t\t\t\t= new org.apache.activemq.pool.PooledConnectionFactory();" + NL + "\t\t\t\tpooledConnectionFactory_";
  protected final String TEXT_10 = ".setConnectionFactory(jmsConnectionFactory);" + NL + "\t\t\t\tpooledConnectionFactory_";
  protected final String TEXT_11 = ".setExpiryTimeout(";
  protected final String TEXT_12 = ");" + NL + "\t\t\t\tpooledConnectionFactory_";
  protected final String TEXT_13 = ".setIdleTimeout(";
  protected final String TEXT_14 = ");" + NL + "\t\t\t\tpooledConnectionFactory_";
  protected final String TEXT_15 = ".setMaxConnections(";
  protected final String TEXT_16 = ");" + NL + "\t\t\t\tpooledConnectionFactory_";
  protected final String TEXT_17 = ".setMaximumActive(";
  protected final String TEXT_18 = ");" + NL + "\t\t\t\tcamelContext.addComponent(";
  protected final String TEXT_19 = "," + NL + "\t\t\t\t\torg.apache.camel.component.jms.JmsComponent.jmsComponent";
  protected final String TEXT_20 = "(pooledConnectionFactory_";
  protected final String TEXT_21 = "));\t";
  protected final String TEXT_22 = "\t\t\t\t" + NL + "\t\t\t\tcamelContext.addComponent(";
  protected final String TEXT_23 = "," + NL + "\t\t\t\t\torg.apache.camel.component.jms.JmsComponent.jmsComponent";
  protected final String TEXT_24 = "(jmsConnectionFactory));";
  protected final String TEXT_25 = NL + "\t\t\t\t\tjmsConnectionFactory = new com.ibm.mq.jms.MQQueueConnectionFactory();" + NL + "\t       \t\t\t((com.ibm.mq.jms.MQConnectionFactory) jmsConnectionFactory).setHostName(";
  protected final String TEXT_26 = ");" + NL + "\t       \t\t\ttry {" + NL + "\t       \t\t\t\t((com.ibm.mq.jms.MQConnectionFactory) jmsConnectionFactory).setPort(";
  protected final String TEXT_27 = ");" + NL + "\t       \t\t\t\t((com.ibm.mq.jms.MQConnectionFactory) jmsConnectionFactory).setTransportType(";
  protected final String TEXT_28 = ");" + NL + "\t       \t\t\t\t((com.ibm.mq.jms.MQConnectionFactory) jmsConnectionFactory).setQueueManager(";
  protected final String TEXT_29 = ");\t" + NL + "\t       \t\t\t} catch (javax.jms.JMSException e) {" + NL + "\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t}";
  ...
  protected final String TEXT_33 = NL + "\t\t\t\t\torg.springframework.jms.connection.UserCredentialsConnectionFactoryAdapter connectionFactoryAdapter";
  protected final String TEXT_34 = " " + NL + "\t\t\t\t\t\t\t= new org.springframework.jms.connection.UserCredentialsConnectionFactoryAdapter();" + NL + "       \t\t\t\tconnectionFactoryAdapter";
  protected final String TEXT_35 = ".setUsername(";
  protected final String TEXT_36 = ");" + NL + "      \t\t\t\tconnectionFactoryAdapter";
  protected final String TEXT_37 = ".setPassword(";
  protected final String TEXT_38 = ");" + NL + "       \t\t\t\tconnectionFactoryAdapter";
  protected final String TEXT_39 = ".setTargetConnectionFactory(jmsConnectionFactory);" + NL + "       " + NL + "\t\t\t\t\tcamelContext.addComponent(";
  protected final String TEXT_40 = "," + NL + "\t\t\t\t\t\torg.apache.camel.component.jms.JmsComponent.jmsComponent";
  protected final String TEXT_41 = "(connectionFactoryAdapter";
  protected final String TEXT_42 = "));";
  protected final String TEXT_43 = NL + "\t\t\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t\tcamelContext.addComponent(";
  protected final String TEXT_45 = "," + NL + "\t\t\t\t\t\torg.apache.camel.component.jms.JmsComponent.jmsComponent";
  protected final String TEXT_46 = "(jmsConnectionFactory));";
  protected final String TEXT_47 = NL + "\t\t\t    ";
  protected final String TEXT_48 = NL + "\t\t\t//using Route name as CamelContext ID" + NL + "\t\t\tanswer.put(\"";
  protected final String TEXT_49 = "\", camelContext);" + NL + "\t\t\tcamelContext.setName(\"";
  protected final String TEXT_50 = "\");" + NL + "\t\t\treturn answer;" + NL + "\t\t}" + NL + "" + NL + "\t\tprotected org.apache.camel.view.ModelFileGenerator createModelFileGenerator()" + NL + "\t\t\t\tthrows javax.xml.bind.JAXBException {" + NL + "\t\t\treturn null;" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\tfinal CamelImpl camelImplementation = new CamelImpl();" + NL + "\tif(start){" + NL + "\t\tstopDelegate = new TalendESBRoute() {" + NL + "\t\t\t" + NL + "\t\t\tpublic int runJobInTOS(String[] args) {" + NL + "\t\t\t\treturn 0;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic String[][] runJob(String[] args) {" + NL + "\t\t\t\treturn null;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic void stop() throws Exception {" + NL + "\t\t\t\tcamelImplementation.stop();" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic void shutdown() throws Exception {" + NL + "\t\t\t\tcamelImplementation.shutdown();" + NL + "\t\t\t}" + NL + "\t\t};\t" + NL + "\t\tcamelImplementation.enableHangupSupport();" + NL + "\t\tcamelImplementation.run();" + NL + "\t}" + NL + "\treturn routeBuilder;" + NL + "\t" + NL + "}";
