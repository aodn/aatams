...
public class HeaderJava
{
  ...
  protected final String TEXT_23 = NL + "\tpublic TalendESBJob newTalendESBJob() {" + NL + "\t\treturn new ";
  protected final String TEXT_24 = "();" + NL + "\t}";
  protected final String TEXT_25 = NL + NL + "\tpublic final Object obj = new Object();" + NL + "" + NL + "\t// for transmiting parameters purpose" + NL + "\tprivate Object valueObject = null;" + NL + "" + NL + "\tpublic Object getValueObject() {" + NL + "\t\treturn this.valueObject;" + NL + "\t}" + NL + "" + NL + "\tpublic void setValueObject(Object valueObject) {" + NL + "\t\tthis.valueObject = valueObject;" + NL + "\t}";
  protected final String TEXT_26 = NL + "\tprivate Object[] multiThreadLockWrite = new Object[0];";
  protected final String TEXT_27 = NL + "\t";
  protected final String TEXT_28 = NL + "\tprivate final static String defaultCharset = java.nio.charset.Charset.defaultCharset().name();" + NL + "" + NL + "\t";
  protected final String TEXT_29 = NL + "\tprivate final static String utf8Charset = \"UTF-8\";" + NL + "" + NL + "\t// create and load default properties" + NL + "\tprivate java.util.Properties defaultProps = new java.util.Properties();" + NL + "\t// create application properties with default" + NL + "\tpublic class ContextProperties extends java.util.Properties {" + NL + "" + NL + "\t\tprivate static final long serialVersionUID = 1L;" + NL + "\t" + NL + "\t\tpublic ContextProperties(java.util.Properties properties){" + NL + "\t\t\tsuper(properties);" + NL + "\t\t}" + NL + "\t\tpublic ContextProperties(){" + NL + "\t\t\tsuper();" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void synchronizeContext(){" + NL + "\t\t\t";
  protected final String TEXT_30 = NL + "\t\t\tif(";
  protected final String TEXT_31 = " != null){" + NL + "\t\t\t\t";
  protected final String TEXT_32 = NL + "\t\t\t\t\tString pattern_";
  protected final String TEXT_33 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "\t\t\t\t\tString value_";
  protected final String TEXT_34 = " = \"";
  protected final String TEXT_35 = "\";" + NL + "\t\t\t\t\tString[] parts_";
  protected final String TEXT_36 = " = value_";
  protected final String TEXT_37 = ".split(\";\");" + NL + "\t\t\t\t\tif(parts_";
  protected final String TEXT_38 = ".length > 1){" + NL + "\t\t\t\t\t\tpattern_";
  protected final String TEXT_39 = " = parts_";
  protected final String TEXT_40 = "[0];" + NL + "\t\t\t\t\t\tthis.setProperty(\"";
  ...
  protected final String TEXT_61 = "(){" + NL + "\treturn this.";
  protected final String TEXT_62 = ";" + NL + "}";
  protected final String TEXT_63 = NL + "\t}" + NL + "\tprivate ContextProperties context = new ContextProperties();" + NL + "\tpublic ContextProperties getContext() {" + NL + "\t\treturn this.context;" + NL + "\t}" + NL + "\tprivate final String jobVersion = \"";
  protected final String TEXT_64 = "\";" + NL + "\tprivate final String jobName = \"";
  protected final String TEXT_65 = "\";" + NL + "\tprivate final String projectName = \"";
  protected final String TEXT_66 = "\";" + NL + "\tpublic Integer errorCode = null;" + NL + "\tprivate String currentComponent = \"\";";
  protected final String TEXT_67 = NL + "\tprivate final java.util.Map<String, Long> start_Hash = new java.util.HashMap<String, Long>();" + NL + "\tprivate final java.util.Map<String, Long> end_Hash = new java.util.HashMap<String, Long>();" + NL + "\tprivate final java.util.Map<String, Boolean> ok_Hash = new java.util.HashMap<String, Boolean>();" + NL + "\tprivate final java.util.Map<String, Object> globalMap = new java.util.HashMap<String, Object>();" + NL + "\tpublic  final java.util.List<String[]> globalBuffer = new java.util.ArrayList<String[]>();";
  protected final String TEXT_68 = NL + "\tprivate final java.util.Map<String, Long> start_Hash = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Long>());" + NL + "\tprivate final java.util.Map<String, Long> end_Hash = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Long>());" + NL + "\tprivate final java.util.Map<String, Boolean> ok_Hash = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Boolean>());" + NL + "\tprivate final java.util.Map<String, Object> globalMap = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Object>());" + NL + "\tpublic  final java.util.List<String[]> globalBuffer = java.util.Collections.synchronizedList(new java.util.ArrayList<String[]>());";
  protected final String TEXT_69 = NL;
  protected final String TEXT_70 = NL + "private RunStat runStat = new RunStat();";
  protected final String TEXT_71 = NL + "private RunTrace runTrace = new RunTrace();";
  protected final String TEXT_72 = NL + NL + "public boolean isExportedAsOSGI = ";
  protected final String TEXT_73 = ";" + NL;
  protected final String TEXT_74 = NL + "\tLogCatcherUtils ";
  protected final String TEXT_75 = " = new LogCatcherUtils();";
  protected final String TEXT_76 = NL + "\tStatCatcherUtils ";
  protected final String TEXT_77 = " = new StatCatcherUtils(\"";
  protected final String TEXT_78 = "\", \"";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = NL + "\tMetterCatcherUtils ";
  protected final String TEXT_81 = " = new MetterCatcherUtils(\"";
  protected final String TEXT_82 = "\", \"";
  protected final String TEXT_83 = "\");";
  protected final String TEXT_84 = NL + "\tAssertCatcherUtils ";
  protected final String TEXT_85 = " = new AssertCatcherUtils();";
  protected final String TEXT_86 = NL + NL + "private final java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();" + NL + "private final java.io.PrintStream errorMessagePS = new java.io.PrintStream(new java.io.BufferedOutputStream(baos));" + NL + "" + NL + "public String getExceptionStackTrace() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\terrorMessagePS.flush();" + NL + "\t\treturn baos.toString();" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private Exception exception = null;" + NL + "" + NL + "public Exception getException() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\treturn this.exception;" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private class TalendException extends Exception {" + NL + "" + NL + "\tprivate static final long serialVersionUID = 1L;" + NL + "" + NL + "\tprivate java.util.Map<String, Object> globalMap = null;" + NL + "\tprivate Exception e = null;" + NL + "\tprivate String currentComponent = null;" + NL + "" + NL + "\tprivate TalendException(Exception e, String errorComponent, final java.util.Map<String, Object> globalMap) {" + NL + "\t\tthis.currentComponent= errorComponent;" + NL + "\t\tthis.globalMap = globalMap;" + NL + "\t\tthis.e = e;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void printStackTrace() {" + NL + "\t\tif (!(e instanceof TalendException || e instanceof TDieException)) {" + NL + "\t\t\t globalMap.put(currentComponent+\"_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\t\tSystem.err.println(\"Exception in component \" + currentComponent);" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TDieException)) {" + NL + "\t\t\tif(e instanceof TalendException){" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t} else {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\te.printStackTrace(errorMessagePS);" + NL + "\t\t\t\t";
  protected final String TEXT_87 = ".this.exception = e;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TalendException)) {" + NL + "\t\ttry {" + NL + "\t\t\tfor (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {" + NL + "\t\t\t\tif (m.getName().compareTo(currentComponent + \"_error\") == 0) {" + NL + "\t\t\t\t\tm.invoke(";
  protected final String TEXT_88 = ".this, new Object[] { e , currentComponent, globalMap});" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tif(!(e instanceof TDieException)){";
  protected final String TEXT_89 = NL + "\t\t\t\t";
  protected final String TEXT_90 = ".addMessage(\"Java Exception\", currentComponent, 6, e.getClass().getName() + \":\" + e.getMessage(), 1);";
  protected final String TEXT_91 = NL + "\t\t\ttry{";
  protected final String TEXT_92 = NL + "\t\t\t\t";
  protected final String TEXT_93 = "Process(globalMap);";
  protected final String TEXT_94 = NL + "\t\t\t}finally{";
  protected final String TEXT_95 = NL + "\t\t\t\t";
  protected final String TEXT_96 = "Process(globalMap);";
  protected final String TEXT_97 = NL + "\t\t\t}";
  protected final String TEXT_98 = NL + "\t\t\t}" + NL + "\t\t} catch (java.lang.SecurityException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.IllegalArgumentException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.IllegalAccessException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.reflect.InvocationTargetException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t}";
  protected final String TEXT_99 = NL + "\t\t\t\tcatch (TalendException e) {" + NL + "\t\t\t\t\t// do nothing" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_100 = NL + "\t\t}" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_101 = NL + "\t\t\tpublic void ";
  protected final String TEXT_102 = "_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {" + NL + "\t\t\t\tend_Hash.put(\"";
  protected final String TEXT_103 = "\", System.currentTimeMillis());" + NL + "\t\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\t\t\t\t\t\tif(!(exception instanceof TDieException)){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_105 = ".addMessage(pid, projectName, jobName, \"java\", null, \"Failed\", \"Job execution error\", exception.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_106 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_108 = ".addMessage(\"failure\",\"";
  protected final String TEXT_109 = "\", end_Hash.get(\"";
  protected final String TEXT_110 = "\")-start_Hash.get(\"";
  protected final String TEXT_111 = "\"));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_112 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\t\t\t\t\tif(this.execStat){" + NL + "\t\t\t\t\t\t    \t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_115 = "\", 0, \"error\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"failure\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_118 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t\t\t\tstatus = \"failure\";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_120 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_121 = NL + NL + "\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t";
  protected final String TEXT_123 = "_onSubJobError(exception, errorComponent, globalMap);" + NL + "" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\tpublic void ";
  protected final String TEXT_125 = "_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {";
  protected final String TEXT_126 = NL + NL + "resumeUtil.addLog(\"SYSTEM_LOG\", \"NODE:\"+ errorComponent, \"\", Thread.currentThread().getId()+ \"\", \"";
  protected final String TEXT_127 = "\", \"\", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),\"\");" + NL;
  ...
  protected final String TEXT_131 = NL + "\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"failure\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_132 = "Process(globalMap);";
  protected final String TEXT_133 = NL + "\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\tstatus = \"failure\";" + NL + "\t\t\t\t\t";
  protected final String TEXT_134 = "Process(globalMap);";
  protected final String TEXT_135 = NL + "\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t}";
