...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_1 = "\tString file_";
  protected final String TEXT_2 = " = ";
  protected final String TEXT_3 = ";" + NL + "\tfile_";
  protected final String TEXT_4 = " = file_";
  protected final String TEXT_5 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\tString fileName_";
  protected final String TEXT_6 = " = file_";
  protected final String TEXT_7 = ".substring(file_";
  protected final String TEXT_8 = ".lastIndexOf(\"/\")+1);" + NL + "\tString fileDirectory_";
  protected final String TEXT_9 = " = file_";
  protected final String TEXT_10 = ".substring(0,file_";
  protected final String TEXT_11 = ".lastIndexOf(\"/\"));" + NL + "\t" + NL + "\tString tableName_";
  ...
  protected final String TEXT_18 = "\t" + NL + "\t\tjava.lang.Class.forName(\"sun.jdbc.odbc.JdbcOdbcDriver\");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_19 = NL + "\t\t\tString url_";
  protected final String TEXT_20 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_21 = ";" + NL + "\t\t";
  protected final String TEXT_22 = NL + "\t\t\tString url_";
  protected final String TEXT_23 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  protected final String TEXT_24 = ";" + NL + "\t\t";
  protected final String TEXT_25 = NL + "\t\tString userName_";
  ...
  protected final String TEXT_32 = ", userName_";
  protected final String TEXT_33 = ", password_";
  protected final String TEXT_34 = ");" + NL + "\t";
  protected final String TEXT_35 = NL + "\t\tString atnParams_";
  protected final String TEXT_36 = " = ";
  protected final String TEXT_37 = ";" + NL + "\t\tatnParams_";
  protected final String TEXT_38 = " = atnParams_";
  protected final String TEXT_39 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_40 = " = new java.util.Properties();" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_41 = ".put(\"user\",userName_";
  protected final String TEXT_42 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_43 = ".put(\"password\",password_";
  protected final String TEXT_44 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_45 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_46 = ".getBytes()));" + NL + "\t  " + NL + "\t\tconn_";
  protected final String TEXT_47 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_48 = ", atnParamsPrope_";
  protected final String TEXT_49 = ");" + NL + "\t";
  protected final String TEXT_50 = NL + "\t\t";
  protected final String TEXT_51 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_52 = " = conn_";
  protected final String TEXT_53 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_62 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_63 = " = conn_";
  protected final String TEXT_64 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_65 = ".execute(\"";
  protected final String TEXT_66 = ")\");" + NL + "            stmtCreate_";
  protected final String TEXT_67 = ".close();";
  protected final String TEXT_68 = NL + "\t         ";
  protected final String TEXT_69 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_71 = " = conn_";
  protected final String TEXT_72 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_73 = " = dbMetaData_";
  protected final String TEXT_74 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_75 = ", tableNameForSearch_";
  protected final String TEXT_76 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_77 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_78 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_79 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_80 = ".close();";
  protected final String TEXT_81 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_82 = " = conn_";
  protected final String TEXT_83 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_84 = " = dbMetaData_";
  protected final String TEXT_85 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_86 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_87 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_88 = " = rsTable_";
  protected final String TEXT_89 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_90 = " = rsTable_";
  protected final String TEXT_91 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_92 = ".equalsIgnoreCase(";
  protected final String TEXT_93 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_94 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_95 = ") || dbschema_";
  protected final String TEXT_96 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_97 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_98 = ".close();";
  protected final String TEXT_99 = "      " + NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_100 = " = conn_";
  protected final String TEXT_101 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_102 = " = dbMetaData_";
  protected final String TEXT_103 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_104 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_105 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_106 = " = rsTable_";
  protected final String TEXT_107 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_108 = ".equalsIgnoreCase(";
  protected final String TEXT_109 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_110 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_116 = ".createStatement();" + NL + "                    stmtCreate_";
  protected final String TEXT_117 = ".execute(\"";
  protected final String TEXT_118 = ")\");" + NL + "                    stmtCreate_";
  protected final String TEXT_119 = ".close();            " + NL + "                }                ";
  protected final String TEXT_120 = NL + "                if(whetherExist_";
  protected final String TEXT_121 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_124 = ".execute(\"";
  protected final String TEXT_125 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_126 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_132 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_135 = ".executeUpdate(\"";
  protected final String TEXT_136 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_137 = ".close();";
  protected final String TEXT_138 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_141 = " = stmtTruncCount_";
  protected final String TEXT_142 = ".executeQuery(\"";
  ...
  protected final String TEXT_147 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_148 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_149 = " += rsTruncCount_";
  protected final String TEXT_150 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_151 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_152 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_153 = ".close();            ";
  protected final String TEXT_154 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_155 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_156 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_157 = " " + NL;
  protected final String TEXT_158 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_159 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_160 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_161 = " + \";HDR=";
  protected final String TEXT_162 = "].[\" + fileName_";
  protected final String TEXT_163 = " + \"]\";";
  protected final String TEXT_164 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_167 = ".execute(bulkInsert_";
  protected final String TEXT_168 = ");" + NL + "" + NL + "\tstmt_";
