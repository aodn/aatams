...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_86 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_87 = ";";
  protected final String TEXT_88 = NL + "\t            String url_";
  protected final String TEXT_89 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  ...
  protected final String TEXT_103 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_106 = " = atnParams_";
  protected final String TEXT_107 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_108 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_109 = ".put(\"user\",dbUser_";
  protected final String TEXT_110 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_111 = ".put(\"password\",dbPwd_";
  protected final String TEXT_112 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_113 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_114 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_115 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_116 = ", atnParamsPrope_";
  protected final String TEXT_117 = ");";
  protected final String TEXT_118 = NL + "            java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_130 = NL + "\t        Object value = rs_";
  protected final String TEXT_131 = ".getObject(";
  protected final String TEXT_132 = ");" + NL + "\t        if(value != null) {";
  protected final String TEXT_133 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_134 = "(";
  protected final String TEXT_135 = ".parse";
  protected final String TEXT_136 = "(value.toString()));";
  protected final String TEXT_137 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_138 = "(";
  protected final String TEXT_139 = ".parse";
  protected final String TEXT_140 = "(value.toString()));";
  protected final String TEXT_141 = NL + "\t \t   \t\t \t\t";
  protected final String TEXT_142 = ".";
  protected final String TEXT_143 = " = (";
  protected final String TEXT_144 = ")value;" + NL + "\t                } else {";
  protected final String TEXT_145 = NL + "\t                ";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = " = null;";
  protected final String TEXT_148 = "    " + NL + "\t                throw new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_149 = NL + "\t        }";
  protected final String TEXT_150 = NL + "    " + NL + "\t";
  protected final String TEXT_151 = NL + "\t\t    int nb_line_";
  protected final String TEXT_152 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_158 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_159 = " = ";
  protected final String TEXT_160 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_161 = "_QUERY\",dbquery_";
  protected final String TEXT_162 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_163 = " = stmt_";
  protected final String TEXT_164 = ".executeQuery(dbquery_";
  protected final String TEXT_165 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_166 = " = rs_";
  protected final String TEXT_167 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_168 = " = rsmd_";
  protected final String TEXT_169 = ".getColumnCount();" + NL;
  protected final String TEXT_170 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_171 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_172 = ".setDbmsId(\"";
  protected final String TEXT_173 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_174 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_175 = "=1; i_";
  protected final String TEXT_176 = "<";
  protected final String TEXT_177 = "; i_";
  protected final String TEXT_178 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_179 = ".add(rsmd_";
  protected final String TEXT_180 = ".getColumnName(i_";
  protected final String TEXT_181 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_182 = " = ";
  protected final String TEXT_183 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_184 = "; i <= rsmd_";
  protected final String TEXT_185 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_186 = ".contains(rsmd_";
  protected final String TEXT_187 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_188 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_189 = ".setName(rsmd_";
  protected final String TEXT_190 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_191 = ".setDbName(rsmd_";
  protected final String TEXT_192 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_193 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_194 = "\", rsmd_";
  protected final String TEXT_195 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_196 = ".getPrecision(i), rsmd_";
  protected final String TEXT_197 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_198 = ".setDbType(rsmd_";
  protected final String TEXT_199 = ".getColumnTypeName(i));";
  protected final String TEXT_200 = NL + "                \tdcm_";
  protected final String TEXT_201 = ".setFormat(";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_204 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_205 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_206 = ".setLength(rsmd_";
  protected final String TEXT_207 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_208 = ".setLength(rsmd_";
  protected final String TEXT_209 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_210 = NL + "\t\t\tdcm_";
  protected final String TEXT_211 = ".setLength(rsmd_";
  protected final String TEXT_212 = ".getPrecision(i));";
  protected final String TEXT_213 = NL + "                \tdcm_";
  ...
  protected final String TEXT_224 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_225 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_226 = "++;" + NL + "\t\t        ";
  protected final String TEXT_227 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_238 = " = (List)rs_";
  protected final String TEXT_239 = ".getObject(";
  protected final String TEXT_240 = ");";
  protected final String TEXT_241 = NL + "\t\t                         ";
  protected final String TEXT_242 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_243 = ".getObject(";
  protected final String TEXT_244 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_245 = NL + "                                    ";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = " = new Geometry(wktValue);";
  protected final String TEXT_248 = NL + "                                        ";
  protected final String TEXT_249 = ".";
  protected final String TEXT_250 = ".setEPSG(";
  protected final String TEXT_251 = ");";
  protected final String TEXT_252 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_253 = NL + "                                  ";
  protected final String TEXT_254 = ".";
  protected final String TEXT_255 = "=dcg_";
  protected final String TEXT_256 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_257 = ".";
  protected final String TEXT_258 = ", rs_";
  protected final String TEXT_259 = ", fixedColumnCount_";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_262 = ".getObject(";
  protected final String TEXT_263 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_264 = ".";
  protected final String TEXT_265 = " = new Geometry(sb.toString());";
