...
public class TAccessOutputMainJava {
  ...
  protected final String TEXT_7 = " = new StringBuffer(\"\");";
  protected final String TEXT_8 = NL + "\t\t\t\t\tcommitEvery_";
  protected final String TEXT_9 = " = buffersSize_";
  protected final String TEXT_10 = ";";
  protected final String TEXT_11 = NL + "    \twhetherReject_";
  ...
  protected final String TEXT_19 = ".toString().trim());";
  protected final String TEXT_20 = NL + "            try {" + NL + "            \tinsertedCount_";
  protected final String TEXT_21 = " = insertedCount_";
  protected final String TEXT_22 = " + pstmt_";
  protected final String TEXT_23 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_24 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_25 = " = true;";
  protected final String TEXT_26 = NL + "                    throw(e);";
  ...
  protected final String TEXT_36 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_55 = "_QUERY\", query_";
  protected final String TEXT_56 = ".toString().trim());";
  protected final String TEXT_57 = NL + "            try {" + NL + "            \tupdatedCount_";
  protected final String TEXT_58 = " = updatedCount_";
  protected final String TEXT_59 = " + pstmt_";
  protected final String TEXT_60 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_61 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_62 = " = true;";
  protected final String TEXT_63 = NL + "                    throw(e);";
  ...
  protected final String TEXT_75 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_76 = NL + "            }";
  protected final String TEXT_77 = NL + "\t\t\t\t\t";
  protected final String TEXT_78 = NL + "                    \t";
  protected final String TEXT_79 = NL + "                    ";
  protected final String TEXT_80 = NL + "                    ";
  protected final String TEXT_81 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_82 = " = pstmt_";
  protected final String TEXT_83 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_84 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_85 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_86 = " = rs_";
  protected final String TEXT_87 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_107 = " + pstmtUpdate_";
  protected final String TEXT_108 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_109 = " = true;";
  protected final String TEXT_110 = NL + "                        throw(e);";
  ...
  protected final String TEXT_129 = "_QUERY\", query_";
  protected final String TEXT_130 = ".toString().trim());";
  protected final String TEXT_131 = NL + "                try{" + NL + "        \t\t\tinsertedCount_";
  protected final String TEXT_132 = " = insertedCount_";
  protected final String TEXT_133 = " + pstmtInsert_";
  protected final String TEXT_134 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_135 = " = true;";
  protected final String TEXT_136 = NL + "                        throw(e);";
  ...
  protected final String TEXT_146 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_151 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_169 = NL + "    " + NL + "             try {" + NL + "                 updateFlag_";
  protected final String TEXT_170 = "=pstmtUpdate_";
  protected final String TEXT_171 = ".executeUpdate();" + NL + "                 updatedCount_";
  protected final String TEXT_172 = " = updatedCount_";
  protected final String TEXT_173 = "+updateFlag_";
  protected final String TEXT_174 = ";" + NL + "             } catch(Exception e) {" + NL + "                 whetherReject_";
  ...
  protected final String TEXT_189 = NL + "             }" + NL + "             if(updateFlag_";
  protected final String TEXT_190 = " == 0) {" + NL + "\t\t\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\tquery_";
  protected final String TEXT_192 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_203 = ".executeUpdate();" + NL + "                 } catch(Exception e) {" + NL + "                     whetherReject_";
  protected final String TEXT_204 = " = true;";
  protected final String TEXT_205 = NL + "                         throw(e);";
  protected final String TEXT_206 = NL + "                             ";
  protected final String TEXT_207 = " = new ";
  protected final String TEXT_208 = "Struct();";
  ...
  protected final String TEXT_218 = NL + "                 }" + NL + "             } " + NL + "             nb_line_";
  ...
  protected final String TEXT_231 = "_QUERY\", query_";
  protected final String TEXT_232 = ".toString().trim());";
  protected final String TEXT_233 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_234 = " = deletedCount_";
  protected final String TEXT_235 = " + pstmt_";
  protected final String TEXT_236 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_237 = " = true;";
  protected final String TEXT_238 = NL + "                    throw(e);";
  protected final String TEXT_239 = NL + "                        ";
  protected final String TEXT_240 = " = new ";
  protected final String TEXT_241 = "Struct();";
  ...
  protected final String TEXT_251 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_252 = "++;";
  protected final String TEXT_253 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_264 = NL + "\t            commitCounter_";
  protected final String TEXT_265 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_266 = "<=commitCounter_";
  protected final String TEXT_267 = ") {" + NL + "\t            " + NL + "\t            \tconn_";
  protected final String TEXT_268 = ".commit();" + NL + "\t            \t" + NL + "\t            \tcommitCounter_";
  protected final String TEXT_269 = "=0;\t" + NL + "\t            }\t" + NL + "\t            ";
