...
public class TAS400InputBeginJava
{
  ...
  protected final String TEXT_147 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_148 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_149 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_150 = ".setLength(rsmd_";
  protected final String TEXT_151 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_152 = ".setLength(rsmd_";
  protected final String TEXT_153 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_154 = NL + "\t\t\tdcm_";
  protected final String TEXT_155 = ".setLength(rsmd_";
  protected final String TEXT_156 = ".getPrecision(i));";
  protected final String TEXT_157 = NL + "                \tdcm_";
  protected final String TEXT_158 = ".setPrecision(rsmd_";
  protected final String TEXT_159 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_160 = ".setNullable(rsmd_";
  protected final String TEXT_161 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_162 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_163 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_164 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_165 = ".metadatas.add(dcm_";
  protected final String TEXT_166 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_167 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_168 = " = null;" + NL + "\t\t    while (rs_";
  ...
  protected final String TEXT_182 = " = (List)rs_";
  protected final String TEXT_183 = ".getObject(";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\t\t                         ";
  protected final String TEXT_186 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_187 = ".getObject(";
  protected final String TEXT_188 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_189 = NL + "                                    ";
  protected final String TEXT_190 = ".";
  protected final String TEXT_191 = " = new Geometry(wktValue);";
  protected final String TEXT_192 = NL + "                                        ";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = ".setEPSG(";
  protected final String TEXT_195 = ");";
  protected final String TEXT_196 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_197 = NL + "                                  ";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = "=dcg_";
  protected final String TEXT_200 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = ", rs_";
  protected final String TEXT_203 = ", fixedColumnCount_";
  protected final String TEXT_204 = ");";
  protected final String TEXT_205 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_206 = ".getObject(";
  protected final String TEXT_207 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = " = new Geometry(sb.toString());";
