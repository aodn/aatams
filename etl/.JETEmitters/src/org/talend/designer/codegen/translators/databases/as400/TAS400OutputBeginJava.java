...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_16 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_17 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_18 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_19 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_20 = " = ";
  protected final String TEXT_21 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_22 = " = false;" + NL + NL;
  ...
  protected final String TEXT_26 = NL + "    String dbProperties_";
  protected final String TEXT_27 = " = ";
  protected final String TEXT_28 = ";" + NL + "    String url_";
  protected final String TEXT_29 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_30 = " == null || dbProperties_";
  protected final String TEXT_31 = ".trim().length() == 0) {" + NL + "        url_";
  protected final String TEXT_32 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_33 = " + \"/\" + ";
  protected final String TEXT_34 = ";" + NL + "    } else {" + NL + "        url_";
  protected final String TEXT_35 = " = \"jdbc:as400://\" + ";
  ...
  protected final String TEXT_42 = ";    " + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");" + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_48 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";                " + NL + "            int commitCounter_";
  protected final String TEXT_51 = " = 0;                ";
  protected final String TEXT_52 = NL + "int count_";
  ...
  protected final String TEXT_64 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_71 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_83 = ".createStatement();";
  ...
  protected final String TEXT_93 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_127 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_153 = ".equalsIgnoreCase(";
  protected final String TEXT_154 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_155 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_168 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_172 = ".close();";
  protected final String TEXT_173 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_179 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_186 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_195 = ".close();            " + NL + "                }                ";
  protected final String TEXT_196 = NL + "                if(whetherExist_";
  protected final String TEXT_197 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_200 = ".execute(\"";
  protected final String TEXT_201 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_202 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_207 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_214 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_224 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_225 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_226 = "            ";
  protected final String TEXT_227 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_230 = ".executeUpdate(\"";
  protected final String TEXT_231 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_232 = ".close();";
  protected final String TEXT_233 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_236 = " = stmtTruncCount_";
  protected final String TEXT_237 = ".executeQuery(\"";
  protected final String TEXT_238 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_241 = ".executeUpdate(\"";
  ...
  protected final String TEXT_245 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_246 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_247 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_265 = NL + "\t    String insert_";
  protected final String TEXT_266 = " = \"INSERT INTO \" + ";
  protected final String TEXT_267 = " + \" (";
  protected final String TEXT_268 = ") VALUES (";
  protected final String TEXT_269 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_270 = " = conn_";
  protected final String TEXT_271 = ".prepareStatement(insert_";
  protected final String TEXT_272 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_273 = NL + "\t    String update_";
  protected final String TEXT_274 = " = \"UPDATE \" + ";
  protected final String TEXT_275 = " + \" SET ";
  protected final String TEXT_276 = " WHERE ";
  protected final String TEXT_277 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_278 = " = conn_";
  protected final String TEXT_279 = ".prepareStatement(update_";
  protected final String TEXT_280 = ");" + NL + "\t    ";
  protected final String TEXT_281 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_284 = " + \" WHERE ";
  protected final String TEXT_285 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_286 = " = \"INSERT INTO \" + ";
  protected final String TEXT_287 = " + \" (";
  protected final String TEXT_288 = ") VALUES (";
  protected final String TEXT_289 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_290 = " = conn_";
  protected final String TEXT_291 = ".prepareStatement(insert_";
  protected final String TEXT_292 = ");" + NL + "\t    String update_";
  protected final String TEXT_293 = " = \"UPDATE \" + ";
  protected final String TEXT_294 = " + \" SET ";
  protected final String TEXT_295 = " WHERE ";
  protected final String TEXT_296 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_297 = " = conn_";
  protected final String TEXT_298 = ".prepareStatement(update_";
  protected final String TEXT_299 = ");" + NL + "\t    ";
  protected final String TEXT_300 = NL + "\t    String update_";
  protected final String TEXT_301 = " = \"UPDATE \" + ";
  protected final String TEXT_302 = " + \" SET ";
  protected final String TEXT_303 = " WHERE ";
  protected final String TEXT_304 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".prepareStatement(update_";
  protected final String TEXT_307 = ");" + NL + "\t    String insert_";
  protected final String TEXT_308 = " = \"INSERT INTO \" + ";
  protected final String TEXT_309 = " + \" (";
  protected final String TEXT_310 = ") VALUES (";
  protected final String TEXT_311 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_312 = " = conn_";
  protected final String TEXT_313 = ".prepareStatement(insert_";
  protected final String TEXT_314 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_315 = NL + "\t    String delete_";
  protected final String TEXT_316 = " = \"DELETE FROM \" + ";
  protected final String TEXT_317 = " + \" WHERE ";
  protected final String TEXT_318 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_319 = " = conn_";
  protected final String TEXT_320 = ".prepareStatement(delete_";
  protected final String TEXT_321 = ");" + NL + "\t    ";
  protected final String TEXT_322 = NL + "        StringBuffer query_";
  protected final String TEXT_323 = " = null;" + NL + "       \t";
  protected final String TEXT_324 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_325 = " = insert_";
  protected final String TEXT_326 = ".split(\"\\\\?\");";
  protected final String TEXT_327 = NL + "\t\t\tupdate_";
  protected final String TEXT_328 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_329 = " = update_";
  protected final String TEXT_330 = ".split(\"\\\\?\");";
  protected final String TEXT_331 = NL + "\t\t\tupdate_";
  protected final String TEXT_332 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_333 = " = update_";
  protected final String TEXT_334 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_335 = " = insert_";
  protected final String TEXT_336 = ".split(\"\\\\?\");";
  protected final String TEXT_337 = NL + "\t\t\tdelete_";
  protected final String TEXT_338 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_339 = " = delete_";
  protected final String TEXT_340 = ".split(\"\\\\?\");";
  protected final String TEXT_341 = NL + "\t\t\treplace_";
  protected final String TEXT_342 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_343 = " = replace_";
  protected final String TEXT_344 = ".split(\"\\\\?\");";
  protected final String TEXT_345 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_346 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_347 = " = insertIgnore_";
  protected final String TEXT_348 = ".split(\"\\\\?\");";
  protected final String TEXT_349 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_350 = " = insert_";
  protected final String TEXT_351 = ".split(\"\\\\?\");";
  protected final String TEXT_352 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_353 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_354 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
