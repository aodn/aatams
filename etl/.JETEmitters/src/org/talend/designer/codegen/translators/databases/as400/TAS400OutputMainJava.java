...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_241 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_296 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_346 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_386 = NL + "        whetherReject_";
  protected final String TEXT_387 = " = false;";
  protected final String TEXT_388 = NL + "                    ";
  protected final String TEXT_389 = NL + "                        query_";
  protected final String TEXT_390 = " = ";
  protected final String TEXT_391 = ";";
  protected final String TEXT_392 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = ", pstmt_";
  protected final String TEXT_395 = ", ";
  protected final String TEXT_396 = ", \"";
  protected final String TEXT_397 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_398 = NL + "                globalMap.put(\"";
  protected final String TEXT_399 = "_QUERY\", query_";
  protected final String TEXT_400 = ".toString().trim());";
  protected final String TEXT_401 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_402 = " = insertedCount_";
  protected final String TEXT_403 = " + pstmt_";
  protected final String TEXT_404 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_405 = "++;" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_406 = " = true;";
  protected final String TEXT_407 = NL + "                    throw(e);";
  protected final String TEXT_408 = NL + "                        ";
  protected final String TEXT_409 = " = new ";
  protected final String TEXT_410 = "Struct();";
  ...
  protected final String TEXT_419 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_420 = NL + "            }";
  protected final String TEXT_421 = NL + "                    ";
  protected final String TEXT_422 = NL + "                        query_";
  protected final String TEXT_423 = " = ";
  protected final String TEXT_424 = ";";
  protected final String TEXT_425 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_426 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_427 = ".";
  protected final String TEXT_428 = ", pstmt_";
  protected final String TEXT_429 = ", ";
  protected final String TEXT_430 = ", \"";
  protected final String TEXT_431 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_432 = NL + "                    " + NL + "\t\t\t\t\t";
  protected final String TEXT_433 = NL + "                    \t";
  protected final String TEXT_434 = NL + "                        query_";
  ...
  protected final String TEXT_442 = NL + "                globalMap.put(\"";
  protected final String TEXT_443 = "_QUERY\", query_";
  protected final String TEXT_444 = ".toString().trim());";
  protected final String TEXT_445 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_446 = " = updatedCount_";
  protected final String TEXT_447 = " + pstmt_";
  protected final String TEXT_448 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_449 = "++;" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_450 = " = true;";
  protected final String TEXT_451 = NL + "                    throw(e);";
  protected final String TEXT_452 = NL + "                        ";
  protected final String TEXT_453 = " = new ";
  protected final String TEXT_454 = "Struct();";
  ...
  protected final String TEXT_461 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_462 = ";";
  protected final String TEXT_463 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_464 = NL + "            }";
  protected final String TEXT_465 = NL + "\t\t\t\t\t";
  protected final String TEXT_466 = NL + "                    \t";
  protected final String TEXT_467 = NL + "                    ";
  protected final String TEXT_468 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_469 = " = pstmt_";
  protected final String TEXT_470 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_471 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_472 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_473 = " = rs_";
  protected final String TEXT_474 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_475 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_476 = NL + "                        ";
  protected final String TEXT_477 = NL + "                            query_";
  protected final String TEXT_478 = " = ";
  protected final String TEXT_479 = ";";
  protected final String TEXT_480 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_481 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_482 = ".";
  protected final String TEXT_483 = ", pstmtUpdate_";
  ...
  protected final String TEXT_494 = NL + "                            query_";
  ...
  protected final String TEXT_500 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_501 = " = updatedCount_";
  ...
  protected final String TEXT_518 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_525 = ", pstmtInsert_";
  ...
  protected final String TEXT_532 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_533 = " = insertedCount_";
  protected final String TEXT_534 = " + pstmtInsert_";
  protected final String TEXT_535 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_536 = " = true;";
  protected final String TEXT_537 = NL + "                        throw(e);";
  protected final String TEXT_538 = NL + "                            ";
  protected final String TEXT_539 = " = new ";
  protected final String TEXT_540 = "Struct();";
  ...
  protected final String TEXT_547 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_548 = ";";
  protected final String TEXT_549 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_550 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_551 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_552 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_561 = ", pstmtUpdate_";
  ...
  protected final String TEXT_572 = NL + "                        query_";
  ...
  protected final String TEXT_578 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_579 = "=pstmtUpdate_";
  protected final String TEXT_580 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_581 = " = updatedCount_";
  protected final String TEXT_582 = "+updateFlag_";
  ...
  protected final String TEXT_595 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_596 = ";";
  protected final String TEXT_597 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_598 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_599 = " == 0) {" + NL + "\t\t\t\t";
  protected final String TEXT_600 = NL + "\t\t\t\tquery_";
  protected final String TEXT_601 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_602 = NL + "                        ";
  protected final String TEXT_603 = NL + "                            query_";
  protected final String TEXT_604 = " = ";
  protected final String TEXT_605 = ";";
  protected final String TEXT_606 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_607 = ".";
  protected final String TEXT_608 = ", pstmtInsert_";
  protected final String TEXT_609 = ", ";
  protected final String TEXT_610 = ", \"";
  protected final String TEXT_611 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_612 = NL + "                    globalMap.put(\"";
  protected final String TEXT_613 = "_QUERY\", query_";
  protected final String TEXT_614 = ".toString().trim());";
  protected final String TEXT_615 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_616 = " = insertedCount_";
  protected final String TEXT_617 = " + pstmtInsert_";
  ...
  protected final String TEXT_632 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_633 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_648 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_649 = " = deletedCount_";
  protected final String TEXT_650 = " + pstmt_";
  protected final String TEXT_651 = ".executeUpdate();" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_666 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_667 = "++;" + NL + "    \t";
  protected final String TEXT_668 = NL + "            if(!whetherReject_";
  protected final String TEXT_669 = ") {";
  protected final String TEXT_670 = NL + "                            ";
  protected final String TEXT_671 = " = new ";
  protected final String TEXT_672 = "Struct();";
  ...
  protected final String TEXT_679 = NL + "                    commitCounter_";
  protected final String TEXT_680 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_681 = " <= commitCounter_";
  protected final String TEXT_682 = ") {                " + NL + "                        conn_";
  protected final String TEXT_683 = ".commit();                \t" + NL + "                        commitCounter_";
  protected final String TEXT_684 = "=0;                " + NL + "                    }\t";
