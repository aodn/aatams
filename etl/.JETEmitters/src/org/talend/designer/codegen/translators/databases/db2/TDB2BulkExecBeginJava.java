...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_7 = NL + "\t    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");    " + NL + "    \tString url_";
  protected final String TEXT_8 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_15 = ";" + NL + "    \tString schema_";
  ...
  protected final String TEXT_22 = NL + "\t\tString tableName_";
  protected final String TEXT_23 = " = null;" + NL + "\t\tif(schema_";
  protected final String TEXT_24 = " == null || schema_";
  protected final String TEXT_25 = ".trim().length() == 0) {" + NL + "    \t\ttableName_";
  protected final String TEXT_26 = " = ";
  protected final String TEXT_27 = ";" + NL + "\t\t} else {" + NL + "    \t\ttableName_";
  protected final String TEXT_28 = " = schema_";
  protected final String TEXT_29 = " +  \"\\\".\\\"\" + ";
  protected final String TEXT_30 = ";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString fileName_";
  protected final String TEXT_31 = " = ";
  protected final String TEXT_32 = ";" + NL + "\t\t";
  protected final String TEXT_33 = NL;
  protected final String TEXT_34 = NL + "\t\tString sqlLoadPending_";
  protected final String TEXT_35 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tjava.sql.CallableStatement callStmtLoadPending_";
  protected final String TEXT_36 = " = conn_";
  protected final String TEXT_37 = ".prepareCall(sqlLoadPending_";
  protected final String TEXT_38 = ");" + NL + "        callStmtLoadPending_";
  protected final String TEXT_39 = ".setString(1, \"load from  /dev/null  of del terminate into \\\"\" + tableName_";
  protected final String TEXT_40 = " + \"\\\"\");" + NL + "        try {" + NL + "        \tcallStmtLoadPending_";
  protected final String TEXT_41 = ".execute();   " + NL + "        } catch (java.sql.SQLException e) { " + NL + "        \t//when table not in load pending mode will throw exception." + NL + "        \t//and do nothing." + NL + "        }" + NL + "        callStmtLoadPending_";
  protected final String TEXT_42 = ".close();";
  protected final String TEXT_43 = NL;
  protected final String TEXT_44 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_45 = " = conn_";
  protected final String TEXT_46 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_47 = ".execute(\"";
  protected final String TEXT_48 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_49 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_50 = " = conn_";
  protected final String TEXT_51 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_63 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_64 = " = conn_";
  protected final String TEXT_65 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_66 = " = dbMetaData_";
  protected final String TEXT_67 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_68 = ", tableNameForSearch_";
  ...
  protected final String TEXT_73 = ".close();";
  ...
  protected final String TEXT_78 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_79 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_80 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_81 = " = rsTable_";
  protected final String TEXT_82 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_83 = " = rsTable_";
  protected final String TEXT_84 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_85 = ".equalsIgnoreCase(";
  protected final String TEXT_86 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_87 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_88 = ") || dbschema_";
  protected final String TEXT_89 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_94 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_95 = " = dbMetaData_";
  protected final String TEXT_96 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_97 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_98 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_99 = " = rsTable_";
  protected final String TEXT_100 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_101 = ".equalsIgnoreCase(";
  protected final String TEXT_102 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_103 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_104 = ".close();";
  protected final String TEXT_105 = NL;
  protected final String TEXT_106 = NL + "                if(!whetherExist_";
  protected final String TEXT_107 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_113 = NL + "                if(whetherExist_";
  protected final String TEXT_114 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_117 = ".execute(\"";
  protected final String TEXT_118 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_119 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_125 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_128 = ".executeUpdate(\"";
  protected final String TEXT_129 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_130 = ".close();";
  protected final String TEXT_131 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_134 = " = stmtTruncCount_";
  protected final String TEXT_135 = ".executeQuery(\"";
  protected final String TEXT_136 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_137 = " = conn_";
  protected final String TEXT_138 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_139 = ".executeUpdate(\"";
  protected final String TEXT_140 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_141 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_142 = " += rsTruncCount_";
  protected final String TEXT_143 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_144 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_145 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_146 = ".close();            ";
  protected final String TEXT_147 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_148 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_149 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_150 = NL;
  protected final String TEXT_151 = NL;
  protected final String TEXT_152 = NL + "        String action_";
  protected final String TEXT_153 = " = \"";
  protected final String TEXT_154 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_155 = " = null;" + NL + "        String sql_";
  protected final String TEXT_156 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        String param_";
  protected final String TEXT_157 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_158 = " + \"\\\" OF ";
  protected final String TEXT_159 = " DEL MODIFIED BY COLDEL\"+ ";
  protected final String TEXT_160 = " + " + NL + "        \t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_161 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_162 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_163 = " +\"\\\" ";
  protected final String TEXT_164 = " \" +" + NL + "        \t\t\t\t action_";
  protected final String TEXT_165 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_166 = " + \"\\\" ";
  protected final String TEXT_167 = "\";     \t\t\t" + NL + "        callStmt_";
  protected final String TEXT_168 = " = conn_";
  protected final String TEXT_169 = ".prepareCall(sql_";
  protected final String TEXT_170 = ");" + NL + "        callStmt_";
  protected final String TEXT_171 = ".setString(1, param_";
  protected final String TEXT_172 = ");" + NL + "        callStmt_";
  protected final String TEXT_173 = ".execute();        " + NL + "        callStmt_";
  protected final String TEXT_174 = ".close();";
  protected final String TEXT_175 = NL + "            int keyCount_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_178 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_179 = " = tableName_";
  protected final String TEXT_180 = ";" + NL + "            tableName_";
  protected final String TEXT_181 = " = \"tmp_";
  protected final String TEXT_182 = "\" + \"_\" + pid; " + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "            " + NL + "" + NL + "            " + NL + "            stmtCreateTmp_";
  protected final String TEXT_185 = ".execute(\"";
  protected final String TEXT_186 = "\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_187 = ".close();" + NL + "                        " + NL + "        \tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_188 = " = null;" + NL + "        \tString sql_";
  protected final String TEXT_189 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        \tString param_";
  protected final String TEXT_190 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_191 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_192 = " DEL MODIFIED BY COLDEL\" + ";
  protected final String TEXT_193 = " + " + NL + "        \t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_194 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_195 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_196 = "+\"\\\"\" + " + NL + "        \t\t\t\t\t\t\t\" ";
  protected final String TEXT_197 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_198 = " + \"\\\" ";
  protected final String TEXT_199 = "\"; \t        \t\t\t" + NL + "        \t" + NL + "        \tcallStmt_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".prepareCall(sql_";
  protected final String TEXT_202 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_203 = ".setString(1, param_";
  protected final String TEXT_204 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_205 = ".execute();        " + NL + "        \tcallStmt_";
  protected final String TEXT_206 = ".close();            " + NL + "                    \t\t\t" + NL + "            tableName_";
  protected final String TEXT_207 = " = tmpTableName_";
  protected final String TEXT_208 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_209 = " = \"tmp_";
  protected final String TEXT_210 = "\"+ \"_\" + pid;             " + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement();" + NL + "                        " + NL + "            stmtUpdateBulk_";
  protected final String TEXT_213 = ".executeUpdate(\"";
  protected final String TEXT_214 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_215 = ".close();           " + NL + "            " + NL + "            tableName_";
  protected final String TEXT_216 = " = \"tmp_";
  protected final String TEXT_217 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_220 = ".execute(\"";
  protected final String TEXT_221 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_222 = ".close();";
  protected final String TEXT_223 = NL + NL + NL + NL + NL + NL;
