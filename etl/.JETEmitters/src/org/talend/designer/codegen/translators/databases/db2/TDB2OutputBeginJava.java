...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_17 = " = 0;" + NL + "int deletedCount_";
  protected final String TEXT_18 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_19 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_20 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_21 = " = 0;" + NL + "boolean whetherReject_";
  protected final String TEXT_22 = " = false;";
  protected final String TEXT_23 = NL + "    String dbschema_";
  protected final String TEXT_24 = " = (String)globalMap.get(\"";
  protected final String TEXT_25 = "\");    " + NL + "    java.sql.Connection conn_";
  protected final String TEXT_26 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_27 = "\");";
  protected final String TEXT_28 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");    " + NL + "    String url_";
  protected final String TEXT_29 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_49 = NL + "   int batchSize_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_62 = NL + "int count_";
  ...
  protected final String TEXT_66 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_67 = ".execute(\"";
  protected final String TEXT_68 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_69 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_74 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_81 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_96 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_103 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_114 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_115 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_116 = "+\"][\"+";
  protected final String TEXT_117 = "+\"][\"+";
  protected final String TEXT_118 = "+\"][\"+";
  protected final String TEXT_119 = "+\"][\"+";
  protected final String TEXT_120 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_121 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_122 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_125 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_126 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_127 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_128 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_129 = ")== null){";
  protected final String TEXT_130 = "              ";
  protected final String TEXT_131 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_134 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_135 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_136 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_137 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_138 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_145 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_146 = ", tableNameForSearch_";
  protected final String TEXT_147 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_148 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_149 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_150 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_156 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_157 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_158 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_159 = " = rsTable_";
  protected final String TEXT_160 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_161 = " = rsTable_";
  protected final String TEXT_162 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_163 = ".equalsIgnoreCase(";
  protected final String TEXT_164 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_165 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_166 = ") || dbschema_";
  protected final String TEXT_167 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_175 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_176 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_177 = " = rsTable_";
  protected final String TEXT_178 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_179 = ".equalsIgnoreCase(";
  protected final String TEXT_180 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_181 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_182 = ".close();";
  protected final String TEXT_183 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_196 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_209 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_210 = ".execute(\"";
  protected final String TEXT_211 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_212 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();";
  protected final String TEXT_215 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_216 = ".execute(\"";
  protected final String TEXT_217 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_234 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_235 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_236 = "            ";
  protected final String TEXT_237 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_238 = " = conn_";
  protected final String TEXT_239 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_240 = ".executeUpdate(\"";
  protected final String TEXT_241 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_242 = ".close();";
  protected final String TEXT_243 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_246 = " = stmtTruncCount_";
  protected final String TEXT_247 = ".executeQuery(\"";
  protected final String TEXT_248 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_249 = " = conn_";
  protected final String TEXT_250 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_251 = ".executeUpdate(\"";
  protected final String TEXT_252 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_253 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_254 = " += rsTruncCount_";
  protected final String TEXT_255 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_256 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_257 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_258 = ".close();            ";
  protected final String TEXT_259 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_262 = " = stmtTruncCount_";
  protected final String TEXT_263 = ".executeQuery(\"";
  protected final String TEXT_264 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_265 = " = conn_";
  protected final String TEXT_266 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_267 = ".executeUpdate(\"";
  protected final String TEXT_268 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_269 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_270 = " += rsTruncCount_";
  protected final String TEXT_271 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_272 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_273 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_279 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".prepareStatement(insert_";
  protected final String TEXT_282 = ");" + NL + "\t    ";
  protected final String TEXT_283 = NL + "\t    String update_";
  protected final String TEXT_284 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_285 = " + \"\\\" SET ";
  protected final String TEXT_286 = " WHERE ";
  protected final String TEXT_287 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".prepareStatement(update_";
  protected final String TEXT_290 = ");" + NL + "\t    ";
  protected final String TEXT_291 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_292 = " = conn_";
  protected final String TEXT_293 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_294 = " + \"\\\" WHERE ";
  protected final String TEXT_295 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_296 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_297 = " + \"\\\" (";
  protected final String TEXT_298 = ") VALUES (";
  protected final String TEXT_299 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_300 = " = conn_";
  protected final String TEXT_301 = ".prepareStatement(insert_";
  protected final String TEXT_302 = ");" + NL + "\t    String update_";
  protected final String TEXT_303 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_304 = " + \"\\\" SET ";
  protected final String TEXT_305 = " WHERE ";
  protected final String TEXT_306 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".prepareStatement(update_";
  protected final String TEXT_309 = ");" + NL + "\t    ";
  protected final String TEXT_310 = NL + "\t    String update_";
  protected final String TEXT_311 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_312 = " + \"\\\" SET ";
  protected final String TEXT_313 = " WHERE ";
  protected final String TEXT_314 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".prepareStatement(update_";
  ...
  protected final String TEXT_321 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_322 = " = conn_";
  protected final String TEXT_323 = ".prepareStatement(insert_";
  protected final String TEXT_324 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_325 = NL + "\t    String delete_";
  protected final String TEXT_326 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_330 = ".prepareStatement(delete_";
  protected final String TEXT_331 = ");" + NL + "\t    ";
  protected final String TEXT_332 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_333 = " = null;" + NL + "       \t";
  protected final String TEXT_334 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_335 = " = insert_";
  protected final String TEXT_336 = ".split(\"\\\\?\");";
  protected final String TEXT_337 = NL + "\t\t\tupdate_";
  protected final String TEXT_338 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_339 = " = update_";
  protected final String TEXT_340 = ".split(\"\\\\?\");";
  protected final String TEXT_341 = NL + "\t\t\tupdate_";
  protected final String TEXT_342 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_343 = " = update_";
  protected final String TEXT_344 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_345 = " = insert_";
  protected final String TEXT_346 = ".split(\"\\\\?\");";
  protected final String TEXT_347 = NL + "\t\t\tdelete_";
  protected final String TEXT_348 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_349 = " = delete_";
  protected final String TEXT_350 = ".split(\"\\\\?\");";
  protected final String TEXT_351 = NL + "\t\t\treplace_";
  protected final String TEXT_352 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_353 = " = replace_";
  protected final String TEXT_354 = ".split(\"\\\\?\");";
  protected final String TEXT_355 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_356 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_357 = " = insertIgnore_";
  protected final String TEXT_358 = ".split(\"\\\\?\");";
  protected final String TEXT_359 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_360 = " = insert_";
  protected final String TEXT_361 = ".split(\"\\\\?\");";
  protected final String TEXT_362 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_363 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_364 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
