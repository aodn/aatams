...
public class TDB2SCDBeginJava {
  ...
  protected final String TEXT_10 = NL + "        java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "        String connectionString_";
  protected final String TEXT_11 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_12 = " + \":\" + ";
  protected final String TEXT_13 = " + \"/\" + ";
  protected final String TEXT_14 = ";" + NL + "        java.sql.Connection connection_";
  protected final String TEXT_15 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_16 = ", ";
  protected final String TEXT_17 = ", ";
  protected final String TEXT_18 = ");" + NL + "\t    ";
  protected final String TEXT_19 = "    " + NL + "\tString tableName_";
  protected final String TEXT_20 = " = null;" + NL + "    String schema_";
  protected final String TEXT_21 = " = ";
  protected final String TEXT_22 = ";" + NL + "    if(schema_";
  protected final String TEXT_23 = " == null || schema_";
  ...
  protected final String TEXT_29 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_30 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_31 = " = null;    ";
  protected final String TEXT_32 = NL + "        String searching_";
  protected final String TEXT_33 = " = \"";
  protected final String TEXT_34 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_35 = " = connection_";
  protected final String TEXT_36 = ".prepareStatement(searching_";
  protected final String TEXT_37 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_38 = " = null;";
  protected final String TEXT_39 = NL + "        String search_";
  protected final String TEXT_40 = " = \"";
  protected final String TEXT_41 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_42 = " = connection_";
  protected final String TEXT_43 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_44 = " = statement_";
  protected final String TEXT_45 = ".executeQuery(search_";
  protected final String TEXT_46 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_47 = ", SCDStruct_";
  protected final String TEXT_48 = "> cache_";
  protected final String TEXT_49 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_50 = ", SCDStruct_";
  protected final String TEXT_51 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_52 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_53 = " sk_";
  protected final String TEXT_54 = " = new SCDSK_";
  protected final String TEXT_55 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_56 = " row_";
  protected final String TEXT_57 = " = new SCDStruct_";
  protected final String TEXT_58 = "();";
  protected final String TEXT_59 = NL + "                    tmpValue_";
  protected final String TEXT_60 = " = resultSet_";
  protected final String TEXT_61 = ".getString(";
  protected final String TEXT_62 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_63 = " != null && tmpValue_";
  protected final String TEXT_64 = ".length() > 0) {";
  protected final String TEXT_65 = NL + "                        ";
  protected final String TEXT_66 = ".";
  protected final String TEXT_67 = " = tmpValue_";
  protected final String TEXT_68 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_69 = NL + "                            if(tmpValue_";
  protected final String TEXT_70 = " == null) {";
  protected final String TEXT_71 = NL + "                                ";
  protected final String TEXT_72 = ".";
  protected final String TEXT_73 = " = null;" + NL + "                            } else {";
  protected final String TEXT_74 = NL + "                                ";
  protected final String TEXT_75 = ".";
  protected final String TEXT_76 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_77 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_78 = ")) {";
  protected final String TEXT_79 = NL + "                                ";
  protected final String TEXT_80 = ".";
  protected final String TEXT_81 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_82 = "' in '";
  protected final String TEXT_83 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_84 = NL + "                    }";
  protected final String TEXT_85 = NL + "                    timestamp_";
  protected final String TEXT_86 = " = resultSet_";
  protected final String TEXT_87 = ".getTimestamp(";
  protected final String TEXT_88 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_89 = " != null) {";
  protected final String TEXT_90 = NL + "                        ";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = " = new java.util.Date(timestamp_";
  protected final String TEXT_93 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_94 = NL + "                        ";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = " = null;" + NL + "                    }";
  protected final String TEXT_97 = NL + "                    if(resultSet_";
  ...
  protected final String TEXT_106 = NL + "            cache_";
  protected final String TEXT_107 = ".put(sk_";
  protected final String TEXT_108 = ", row_";
  protected final String TEXT_109 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_110 = ".close();" + NL + "        statement_";
  protected final String TEXT_111 = ".close();";
  protected final String TEXT_112 = NL + "            System.out.println(\"[";
  protected final String TEXT_113 = "] comparison cache loaded\");";
  ...
  protected final String TEXT_118 = ".size() > 0) {";
  protected final String TEXT_119 = NL + "        String tmpQuery_";
  protected final String TEXT_120 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_121 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_122 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_123 = " = connection_";
  protected final String TEXT_124 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_125 = " = tmpStmt_";
  protected final String TEXT_126 = ".executeQuery(tmpQuery_";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "        if(tmpRS_";
  protected final String TEXT_129 = ".next() && tmpRS_";
  protected final String TEXT_130 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_131 = " = tmpRS_";
  protected final String TEXT_132 = ".get";
  protected final String TEXT_133 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_134 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_135 = ".close();";
  protected final String TEXT_136 = NL + "            }            ";
  protected final String TEXT_137 = NL + "    String insertionSQL_";
  protected final String TEXT_138 = " = \"";
  protected final String TEXT_139 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_140 = " = connection_";
  protected final String TEXT_141 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_142 = ");";
  protected final String TEXT_143 = NL + "            insertionStatement_";
  protected final String TEXT_144 = ".setTimestamp(";
  protected final String TEXT_145 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_146 = "\")));";
  protected final String TEXT_147 = NL + "            insertionStatement_";
  protected final String TEXT_148 = ".setNull(";
  protected final String TEXT_149 = ", java.sql.Types.DATE);";
  protected final String TEXT_150 = NL + "            insertionStatement_";
  protected final String TEXT_151 = ".setTimestamp(";
  protected final String TEXT_152 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_153 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_154 = NL + "        String updateSQLForType1_";
  protected final String TEXT_155 = " = \"";
  protected final String TEXT_156 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_157 = " = connection_";
  protected final String TEXT_158 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_159 = ");        ";
  protected final String TEXT_160 = NL + "        String updateSQLForType2_";
  protected final String TEXT_161 = " = \"";
  protected final String TEXT_162 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_163 = " = connection_";
  protected final String TEXT_164 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_165 = ");";
  protected final String TEXT_166 = NL + "            updateForType2_";
  protected final String TEXT_167 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_168 = "\")));";
  protected final String TEXT_169 = NL + "        String updateSQLForType3_";
  protected final String TEXT_170 = " = \"";
  protected final String TEXT_171 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_172 = " = connection_";
  protected final String TEXT_173 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_174 = ");";
  protected final String TEXT_175 = NL + "        SCDSK_";
  protected final String TEXT_176 = " lookUpKey_";
  protected final String TEXT_177 = " = null;        ";
  protected final String TEXT_178 = NL + "    SCDStruct_";
  protected final String TEXT_179 = " lookUpValue_";
