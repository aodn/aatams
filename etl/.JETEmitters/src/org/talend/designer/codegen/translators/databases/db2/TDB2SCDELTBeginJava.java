...
public class TDB2SCDELTBeginJava {
  ...
  protected final String TEXT_19 = ");" + NL + "        String schema_";
  protected final String TEXT_20 = " = ";
  protected final String TEXT_21 = ";";
  protected final String TEXT_22 = NL + "    String tableName_";
  protected final String TEXT_23 = " = null;" + NL + "    String sourceTable_";
  protected final String TEXT_24 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_25 = " != null && schema_";
  protected final String TEXT_26 = ".trim().length() != 0) {" + NL + "        tableName_";
  protected final String TEXT_27 = " = schema_";
  protected final String TEXT_28 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_29 = ";" + NL + "        sourceTable_";
  protected final String TEXT_30 = " = schema_";
  protected final String TEXT_31 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_32 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_33 = " = ";
  protected final String TEXT_34 = ";" + NL + "        sourceTable_";
  protected final String TEXT_35 = " = ";
  protected final String TEXT_36 = ";" + NL + "    }";
  protected final String TEXT_37 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_38 = " = conn_";
  protected final String TEXT_39 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_40 = ".execute(\"";
  protected final String TEXT_41 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_42 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_54 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_57 = " = dbMetaData_";
  protected final String TEXT_58 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_59 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_60 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_61 = " = rsTable_";
  protected final String TEXT_62 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_63 = ".equalsIgnoreCase(";
  protected final String TEXT_64 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_65 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_74 = NL + "                if(whetherExist_";
  protected final String TEXT_75 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_76 = " = conn_";
  protected final String TEXT_77 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_78 = ".execute(\"";
  protected final String TEXT_79 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_80 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_86 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_87 = " = conn_";
  protected final String TEXT_88 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_89 = ".executeUpdate(\"";
  protected final String TEXT_90 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_91 = ".close();";
  protected final String TEXT_92 = NL + "        System.out.println(\"[";
  protected final String TEXT_93 = "] table action ";
  protected final String TEXT_94 = " done\\n\");";
  protected final String TEXT_95 = NL + "        String updateForType1_";
  protected final String TEXT_96 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_97 = " + \"\\\" d SET (";
  protected final String TEXT_98 = ") = (SELECT ";
  protected final String TEXT_99 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_100 = " + \"\\\" t WHERE ";
  protected final String TEXT_101 = " AND (";
  protected final String TEXT_102 = ")) WHERE EXISTS (SELECT 1 FROM \\\"\" + sourceTable_";
  protected final String TEXT_103 = " + \"\\\" t WHERE ";
  protected final String TEXT_104 = " AND (";
  protected final String TEXT_105 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_106 = " = conn_";
  protected final String TEXT_107 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_108 = ".executeUpdate(updateForType1_";
  protected final String TEXT_109 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_110 = ".close();";
  protected final String TEXT_111 = NL + "            System.out.println(\"[";
  protected final String TEXT_112 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_113 = " + \"\\ndone\");";
  protected final String TEXT_114 = NL + "        String updateForType2_";
  protected final String TEXT_115 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_116 = " + \"\\\" d SET \\\"";
  protected final String TEXT_117 = "\\\" = '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_118 = "\"))) + \"'";
  protected final String TEXT_119 = ", \\\"";
  protected final String TEXT_120 = "\\\" = 0";
  protected final String TEXT_121 = " WHERE EXISTS (SELECT 1 FROM \\\"\" + sourceTable_";
  protected final String TEXT_122 = " + " + NL + "        \"\\\" t WHERE ";
  protected final String TEXT_123 = " AND (";
  protected final String TEXT_124 = ")) AND d.\\\"";
  protected final String TEXT_125 = "\\\" IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_128 = ".executeUpdate(updateForType2_";
  protected final String TEXT_129 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_130 = ".close();";
  protected final String TEXT_131 = NL + "            System.out.println(\"[";
  protected final String TEXT_132 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_133 = " + \"\\ndone\");";
  protected final String TEXT_134 = NL + "        String insertForType2_";
  protected final String TEXT_135 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_136 = " + \"\\\"(";
  protected final String TEXT_137 = "\\\"";
  protected final String TEXT_138 = "\\\", ";
  protected final String TEXT_139 = ") SELECT ";
  protected final String TEXT_140 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_141 = " + \", ";
  protected final String TEXT_142 = "t.";
  protected final String TEXT_143 = ", '\" + " + NL + "        (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_144 = "\"))) + \"', CAST(NULL AS DATE)";
  protected final String TEXT_145 = ", 1";
  protected final String TEXT_146 = ", d.\\\"";
  protected final String TEXT_147 = "\\\" + 1";
  protected final String TEXT_148 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_149 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_150 = " + \"\\\" d WHERE ";
  protected final String TEXT_151 = " AND (";
  protected final String TEXT_152 = ") AND d.\\\"";
  protected final String TEXT_153 = "\\\" = '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_154 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_157 = ".executeUpdate(insertForType2_";
  protected final String TEXT_158 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_159 = ".close();";
  protected final String TEXT_160 = NL + "            System.out.println(\"[";
  protected final String TEXT_161 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_162 = " + \"\\ndone\");";
  protected final String TEXT_163 = NL + "    String insert_";
  protected final String TEXT_164 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_165 = " + \"\\\"(";
  protected final String TEXT_166 = "\\\"";
  protected final String TEXT_167 = "\\\", ";
  protected final String TEXT_168 = ") SELECT ";
  protected final String TEXT_169 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_170 = " + \", ";
  protected final String TEXT_171 = "t.";
  protected final String TEXT_172 = "\"";
  protected final String TEXT_173 = " + \", '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_174 = "\"))) + \"', CAST(NULL AS DATE)\"";
  protected final String TEXT_175 = NL + "    + \"";
  protected final String TEXT_176 = ", 1";
  protected final String TEXT_177 = ", 1";
  protected final String TEXT_178 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_179 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_180 = " + \"\\\" d ON ";
  protected final String TEXT_181 = " WHERE (";
  protected final String TEXT_182 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_185 = ".executeUpdate(insert_";
  protected final String TEXT_186 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_187 = ".close();";
  protected final String TEXT_188 = NL + "        System.out.println(\"[";
  protected final String TEXT_189 = "] new rows sql\\n\" + insert_";
