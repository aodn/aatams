...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_199 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_200 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_201 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_202 = ".setLength(rsmd_";
  protected final String TEXT_203 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_204 = ".setLength(rsmd_";
  protected final String TEXT_205 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_206 = NL + "\t\t\tdcm_";
  protected final String TEXT_207 = ".setLength(rsmd_";
  protected final String TEXT_208 = ".getPrecision(i));";
  protected final String TEXT_209 = NL + "                \tdcm_";
  protected final String TEXT_210 = ".setPrecision(rsmd_";
  protected final String TEXT_211 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_212 = ".setNullable(rsmd_";
  protected final String TEXT_213 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_214 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_215 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_216 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_217 = ".metadatas.add(dcm_";
  protected final String TEXT_218 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_219 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_220 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_221 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_222 = "++;" + NL + "\t\t        ";
  protected final String TEXT_223 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_234 = " = (List)rs_";
  protected final String TEXT_235 = ".getObject(";
  protected final String TEXT_236 = ");";
  protected final String TEXT_237 = NL + "\t\t                         ";
  protected final String TEXT_238 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_239 = ".getObject(";
  protected final String TEXT_240 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_241 = NL + "                                    ";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = " = new Geometry(wktValue);";
  protected final String TEXT_244 = NL + "                                        ";
  protected final String TEXT_245 = ".";
  protected final String TEXT_246 = ".setEPSG(";
  protected final String TEXT_247 = ");";
  protected final String TEXT_248 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_249 = NL + "                                  ";
  protected final String TEXT_250 = ".";
  protected final String TEXT_251 = "=dcg_";
  protected final String TEXT_252 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_253 = ".";
  protected final String TEXT_254 = ", rs_";
  protected final String TEXT_255 = ", fixedColumnCount_";
  protected final String TEXT_256 = ");";
  protected final String TEXT_257 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_258 = ".getObject(";
  protected final String TEXT_259 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_260 = ".";
  protected final String TEXT_261 = " = new Geometry(sb.toString());";
