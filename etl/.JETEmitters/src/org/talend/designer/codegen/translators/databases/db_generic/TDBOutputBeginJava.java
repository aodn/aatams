...
public class TDBOutputBeginJava {
  ...
  protected final String TEXT_14 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_15 = ";";
  protected final String TEXT_16 = NL + "    String url_";
  protected final String TEXT_17 = " = \"jdbc:odbc:\" + ";
  ...
  protected final String TEXT_25 = " = \"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_38 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_39 = NL + "        int deleteKeyCount_";
  protected final String TEXT_40 = " = ";
  protected final String TEXT_41 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_42 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_43 = " " + NL + "java.lang.Class.forName(\"";
  protected final String TEXT_44 = "\");" + NL + "String dbUser_";
  protected final String TEXT_45 = " = ";
  protected final String TEXT_46 = ";" + NL + "String dbPwd_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "java.sql.Connection conn_";
  protected final String TEXT_49 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_50 = ",dbUser_";
  protected final String TEXT_51 = ",dbPwd_";
  protected final String TEXT_52 = ");" + NL + "conn_";
  protected final String TEXT_53 = ".setAutoCommit(false);";
  protected final String TEXT_54 = NL + "    java.sql.Statement stmtClear_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".createStatement();" + NL + "    deletedCount_";
  protected final String TEXT_57 = " = deletedCount_";
  protected final String TEXT_58 = " + stmtClear_";
  protected final String TEXT_59 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = NL + "\t    String insert_";
  protected final String TEXT_62 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_67 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_73 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_74 = " = conn_";
  protected final String TEXT_75 = ".prepareStatement(update_";
  protected final String TEXT_76 = ");" + NL + "\t    ";
  protected final String TEXT_77 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_78 = " = conn_";
  protected final String TEXT_79 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_80 = " + \" WHERE ";
  protected final String TEXT_81 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_82 = " = \"INSERT INTO \" + ";
  protected final String TEXT_83 = " + \" (";
  protected final String TEXT_84 = ") VALUES (";
  protected final String TEXT_85 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_86 = " = conn_";
  protected final String TEXT_87 = ".prepareStatement(insert_";
  protected final String TEXT_88 = ");" + NL + "\t    String update_";
  protected final String TEXT_89 = " = \"UPDATE \" + ";
  protected final String TEXT_90 = " + \" SET ";
  protected final String TEXT_91 = " WHERE ";
  protected final String TEXT_92 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_93 = " = conn_";
  protected final String TEXT_94 = ".prepareStatement(update_";
  protected final String TEXT_95 = ");\t" + NL + "\t    ";
  protected final String TEXT_96 = NL + "\t    String update_";
  protected final String TEXT_97 = " = \"UPDATE \" + ";
  protected final String TEXT_98 = " + \" SET ";
  protected final String TEXT_99 = " WHERE ";
  protected final String TEXT_100 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_101 = " = conn_";
  protected final String TEXT_102 = ".prepareStatement(update_";
  ...
  protected final String TEXT_107 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".prepareStatement(insert_";
  protected final String TEXT_110 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_111 = NL + "\t    String delete_";
  protected final String TEXT_112 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_113 = " + \" WHERE ";
  protected final String TEXT_114 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = ".prepareStatement(delete_";
  protected final String TEXT_117 = ");" + NL + "\t    ";
  protected final String TEXT_118 = NL + "        StringBuffer query_";
  protected final String TEXT_119 = " = null;" + NL + "       \t";
  protected final String TEXT_120 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_121 = " = insert_";
  protected final String TEXT_122 = ".split(\"\\\\?\");";
  protected final String TEXT_123 = NL + "\t\t\tupdate_";
  protected final String TEXT_124 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_125 = " = update_";
  protected final String TEXT_126 = ".split(\"\\\\?\");";
  protected final String TEXT_127 = NL + "\t\t\tupdate_";
  protected final String TEXT_128 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_129 = " = update_";
  protected final String TEXT_130 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_131 = " = insert_";
  protected final String TEXT_132 = ".split(\"\\\\?\");";
  protected final String TEXT_133 = NL + "\t\t\tdelete_";
  protected final String TEXT_134 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_135 = " = delete_";
  protected final String TEXT_136 = ".split(\"\\\\?\");";
  protected final String TEXT_137 = NL + "\t\t\treplace_";
  protected final String TEXT_138 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_139 = " = replace_";
  protected final String TEXT_140 = ".split(\"\\\\?\");";
  protected final String TEXT_141 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_142 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_143 = " = insertIgnore_";
  protected final String TEXT_144 = ".split(\"\\\\?\");";
  protected final String TEXT_145 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_146 = " = insert_";
  protected final String TEXT_147 = ".split(\"\\\\?\");";
  protected final String TEXT_148 = NL + "\t    int commitEvery_";
  protected final String TEXT_149 = " = ";
  protected final String TEXT_150 = ";" + NL + "\t    int commitCounter_";
