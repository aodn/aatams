...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_126 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_127 = " = ";
  protected final String TEXT_128 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_129 = "_QUERY\",dbquery_";
  protected final String TEXT_130 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_131 = " = stmt_";
  protected final String TEXT_132 = ".executeQuery(dbquery_";
  protected final String TEXT_133 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_134 = " = rs_";
  protected final String TEXT_135 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_136 = " = rsmd_";
  protected final String TEXT_137 = ".getColumnCount();" + NL;
  protected final String TEXT_138 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_139 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_140 = ".setDbmsId(\"";
  protected final String TEXT_141 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_142 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_143 = "=1; i_";
  protected final String TEXT_144 = "<";
  protected final String TEXT_145 = "; i_";
  protected final String TEXT_146 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_147 = ".add(rsmd_";
  protected final String TEXT_148 = ".getColumnName(i_";
  protected final String TEXT_149 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_152 = "; i <= rsmd_";
  protected final String TEXT_153 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_154 = ".contains(rsmd_";
  protected final String TEXT_155 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_156 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_157 = ".setName(rsmd_";
  protected final String TEXT_158 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_159 = ".setDbName(rsmd_";
  protected final String TEXT_160 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_161 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_162 = "\", rsmd_";
  protected final String TEXT_163 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_164 = ".getPrecision(i), rsmd_";
  protected final String TEXT_165 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_166 = ".setDbType(rsmd_";
  protected final String TEXT_167 = ".getColumnTypeName(i));";
  protected final String TEXT_168 = NL + "                \tdcm_";
  protected final String TEXT_169 = ".setFormat(";
  protected final String TEXT_170 = ");";
  protected final String TEXT_171 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_172 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_173 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_174 = ".setLength(rsmd_";
  protected final String TEXT_175 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_176 = ".setLength(rsmd_";
  protected final String TEXT_177 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_178 = NL + "\t\t\tdcm_";
  protected final String TEXT_179 = ".setLength(rsmd_";
  protected final String TEXT_180 = ".getPrecision(i));";
  protected final String TEXT_181 = NL + "                \tdcm_";
  protected final String TEXT_182 = ".setPrecision(rsmd_";
  protected final String TEXT_183 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_184 = ".setNullable(rsmd_";
  protected final String TEXT_185 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_186 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_187 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_188 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_189 = ".metadatas.add(dcm_";
  protected final String TEXT_190 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_191 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_192 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_193 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_194 = "++;" + NL + "\t\t        ";
  protected final String TEXT_195 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_206 = " = (List)rs_";
  protected final String TEXT_207 = ".getObject(";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "\t\t                         ";
  protected final String TEXT_210 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_211 = ".getObject(";
  protected final String TEXT_212 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_213 = NL + "                                    ";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = " = new Geometry(wktValue);";
  protected final String TEXT_216 = NL + "                                        ";
  protected final String TEXT_217 = ".";
  protected final String TEXT_218 = ".setEPSG(";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_221 = NL + "                                  ";
  protected final String TEXT_222 = ".";
  protected final String TEXT_223 = "=dcg_";
  protected final String TEXT_224 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_225 = ".";
  protected final String TEXT_226 = ", rs_";
  protected final String TEXT_227 = ", fixedColumnCount_";
  protected final String TEXT_228 = ");";
  protected final String TEXT_229 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_230 = ".getObject(";
  protected final String TEXT_231 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = " = new Geometry(sb.toString());";
