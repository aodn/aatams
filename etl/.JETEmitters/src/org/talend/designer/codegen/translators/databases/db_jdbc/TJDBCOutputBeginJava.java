...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_2 = NL + "        int updateKeyCount_";
  protected final String TEXT_3 = " = ";
  protected final String TEXT_4 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_5 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_6 = NL + "        int deleteKeyCount_";
  protected final String TEXT_7 = " = ";
  protected final String TEXT_8 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_9 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_10 = NL + NL + "int nb_line_";
  protected final String TEXT_11 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_12 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_13 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_14 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_15 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_16 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_17 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_18 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_19 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_20 = " = false;" + NL;
  protected final String TEXT_21 = NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_33 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_34 = " = ";
  protected final String TEXT_35 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_36 = " = 0;         ";
  protected final String TEXT_37 = NL + "   int batchSize_";
  protected final String TEXT_38 = " = ";
  protected final String TEXT_39 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_40 = "=0;";
  protected final String TEXT_41 = " " + NL;
  protected final String TEXT_42 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_43 = " = connection_";
  protected final String TEXT_44 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_45 = " = deletedCount_";
  protected final String TEXT_46 = " + statementClear_";
  protected final String TEXT_47 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_48 = ");" + NL + "\t";
  protected final String TEXT_49 = NL + "\t\tString insert_";
  protected final String TEXT_50 = " = \"INSERT INTO \" + ";
  protected final String TEXT_51 = " + \" (";
  protected final String TEXT_52 = ") VALUES (";
  protected final String TEXT_53 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_54 = " = connection_";
  protected final String TEXT_55 = ".prepareStatement(insert_";
  protected final String TEXT_56 = ");" + NL + "\t\t";
  protected final String TEXT_57 = NL + "\t\tString update_";
  protected final String TEXT_58 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_63 = ".prepareStatement(update_";
  protected final String TEXT_64 = ");" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_66 = " = connection_";
  protected final String TEXT_67 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_68 = " + \" WHERE ";
  protected final String TEXT_69 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_70 = " = \"INSERT INTO \" + ";
  protected final String TEXT_71 = " + \" (";
  protected final String TEXT_72 = ") VALUES (";
  protected final String TEXT_73 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_74 = " = connection_";
  protected final String TEXT_75 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_80 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_81 = " = connection_";
  protected final String TEXT_82 = ".prepareStatement(update_";
  protected final String TEXT_83 = ");" + NL + "\t\t";
  protected final String TEXT_84 = NL + "\t\tString update_";
  protected final String TEXT_85 = " = \"UPDATE \" + ";
  protected final String TEXT_86 = " + \" SET ";
  protected final String TEXT_87 = " WHERE ";
  protected final String TEXT_88 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_89 = " = connection_";
  protected final String TEXT_90 = ".prepareStatement(update_";
  protected final String TEXT_91 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_92 = " = \"INSERT INTO \" + ";
  protected final String TEXT_93 = " + \" (";
  protected final String TEXT_94 = ") VALUES (";
  protected final String TEXT_95 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_96 = " = connection_";
  protected final String TEXT_97 = ".prepareStatement(insert_";
  protected final String TEXT_98 = ");" + NL + "\t\t";
  protected final String TEXT_99 = NL + "\t\tString delete_";
  protected final String TEXT_100 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_104 = ".prepareStatement(delete_";
  protected final String TEXT_105 = ");" + NL + "\t\t";
  protected final String TEXT_106 = NL + "        StringBuffer query_";
  protected final String TEXT_107 = " = null;" + NL + "       \t";
  protected final String TEXT_108 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_109 = " = insert_";
  protected final String TEXT_110 = ".split(\"\\\\?\");";
  protected final String TEXT_111 = NL + "\t\t\tupdate_";
  protected final String TEXT_112 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_113 = " = update_";
  protected final String TEXT_114 = ".split(\"\\\\?\");";
  protected final String TEXT_115 = NL + "\t\t\tupdate_";
  protected final String TEXT_116 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_117 = " = update_";
  protected final String TEXT_118 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_119 = " = insert_";
  protected final String TEXT_120 = ".split(\"\\\\?\");";
  protected final String TEXT_121 = NL + "\t\t\tdelete_";
  protected final String TEXT_122 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_123 = " = delete_";
  protected final String TEXT_124 = ".split(\"\\\\?\");";
  protected final String TEXT_125 = NL + "\t\t\treplace_";
  protected final String TEXT_126 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_127 = " = replace_";
  protected final String TEXT_128 = ".split(\"\\\\?\");";
  protected final String TEXT_129 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_130 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_131 = " = insertIgnore_";
  protected final String TEXT_132 = ".split(\"\\\\?\");";
  protected final String TEXT_133 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_134 = " = insert_";
  protected final String TEXT_135 = ".split(\"\\\\?\");";
