...
public class TJDBCOutputMainJava {
  ...
  protected final String TEXT_7 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_8 = " = buffersSize_";
  protected final String TEXT_9 = ";";
  protected final String TEXT_10 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_11 = " = buffersSize_";
  protected final String TEXT_12 = ";";
  protected final String TEXT_13 = NL + "        whetherReject_";
  protected final String TEXT_14 = " = false;";
  protected final String TEXT_15 = NL + "                    ";
  protected final String TEXT_16 = NL + "                        query_";
  protected final String TEXT_17 = " = ";
  protected final String TEXT_18 = ";";
  protected final String TEXT_19 = NL + "                globalMap.put(\"";
  protected final String TEXT_20 = "_QUERY\", query_";
  protected final String TEXT_21 = ".toString().trim());";
  protected final String TEXT_22 = NL + "    \t\tpstmt_";
  protected final String TEXT_23 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_24 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_25 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_62 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_63 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_64 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_65 = "++;";
  protected final String TEXT_66 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_67 = " = updatedCount_";
  protected final String TEXT_68 = " + pstmt_";
  protected final String TEXT_69 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_70 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_71 = " = true;";
  protected final String TEXT_72 = NL + "                    throw(e);";
  protected final String TEXT_73 = NL + "                        ";
  protected final String TEXT_74 = " = new ";
  protected final String TEXT_75 = "Struct();";
  protected final String TEXT_76 = NL + "                            ";
  protected final String TEXT_77 = ".";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ".";
  protected final String TEXT_80 = ";";
  protected final String TEXT_81 = NL + "                        rejectedCount_";
  protected final String TEXT_82 = " = rejectedCount_";
  protected final String TEXT_83 = " + 1;";
  protected final String TEXT_84 = NL + "                        ";
  protected final String TEXT_85 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_86 = ";";
  protected final String TEXT_87 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_88 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_89 = NL + "                    ";
  protected final String TEXT_90 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_91 = " = pstmt_";
  protected final String TEXT_92 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_93 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_94 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_95 = " = rs_";
  protected final String TEXT_96 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_112 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_130 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_131 = NL + "                        ";
  protected final String TEXT_132 = NL + "                            query_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ";";
  protected final String TEXT_135 = NL + "                    globalMap.put(\"";
  protected final String TEXT_136 = "_QUERY\", query_";
  protected final String TEXT_137 = ".toString().trim());";
  protected final String TEXT_138 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_139 = " = insertedCount_";
  protected final String TEXT_140 = " + pstmtInsert_";
  protected final String TEXT_141 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_152 = NL + "                            rejectedCount_";
  protected final String TEXT_153 = " = rejectedCount_";
  protected final String TEXT_154 = " + 1;";
  protected final String TEXT_155 = NL + "                            ";
  protected final String TEXT_156 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_157 = ";";
  protected final String TEXT_158 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_159 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_160 = "++;";
  protected final String TEXT_161 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_172 = "_QUERY\", query_";
  protected final String TEXT_173 = ".toString().trim());";
  protected final String TEXT_174 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_175 = " = pstmtUpdate_";
  protected final String TEXT_176 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_177 = " = updatedCount_";
  protected final String TEXT_178 = " + updateFlag_";
  protected final String TEXT_179 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_180 = " = true;";
  protected final String TEXT_181 = NL + "                    throw(e);";
  protected final String TEXT_182 = NL + "                        ";
  protected final String TEXT_183 = " = new ";
  protected final String TEXT_184 = "Struct();";
  protected final String TEXT_185 = NL + "                            ";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ".";
  protected final String TEXT_189 = ";";
  protected final String TEXT_190 = NL + "                        rejectedCount_";
  protected final String TEXT_191 = " = rejectedCount_";
  protected final String TEXT_192 = " + 1;";
  ...
  protected final String TEXT_197 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_198 = " == 0) {" + NL + "            \t";
  protected final String TEXT_199 = NL + "\t\t\t\tquery_";
  protected final String TEXT_200 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_201 = NL + "                        ";
  protected final String TEXT_202 = NL + "                            query_";
  protected final String TEXT_203 = " = ";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL + "                    globalMap.put(\"";
  protected final String TEXT_206 = "_QUERY\", query_";
  protected final String TEXT_207 = ".toString().trim());";
  protected final String TEXT_208 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_209 = " = insertedCount_";
  protected final String TEXT_210 = " + pstmtInsert_";
  protected final String TEXT_211 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_212 = " = true;";
  protected final String TEXT_213 = NL + "                        throw(e);";
  ...
  protected final String TEXT_229 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_236 = "_QUERY\", query_";
  protected final String TEXT_237 = ".toString().trim());";
  protected final String TEXT_238 = NL + "    \t\tpstmt_";
  protected final String TEXT_239 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_240 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_241 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_242 = "++;";
  protected final String TEXT_243 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_244 = " = deletedCount_";
  protected final String TEXT_245 = " + pstmt_";
  protected final String TEXT_246 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_247 = " = true;";
  protected final String TEXT_248 = NL + "                    throw(e);";
  ...
  protected final String TEXT_257 = NL + "                        rejectedCount_";
  protected final String TEXT_258 = " = rejectedCount_";
  ...
  protected final String TEXT_267 = NL + "            if(!whetherReject_";
  protected final String TEXT_268 = ") {";
  protected final String TEXT_269 = NL + "                            ";
  protected final String TEXT_270 = " = new ";
  protected final String TEXT_271 = "Struct();";
  ...
  protected final String TEXT_278 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_279 = " <= batchSizeCounter_";
  protected final String TEXT_280 = ") {                ";
  protected final String TEXT_281 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_282 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_283 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_284 = " += pstmt_";
  protected final String TEXT_285 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_286 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_287 = " += pstmt_";
  protected final String TEXT_288 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_289 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_290 = " += pstmt_";
  protected final String TEXT_291 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_292 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_293 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_294 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_295 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_296 = NL + "                }";
  protected final String TEXT_297 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_298 = NL + "                commitCounter_";
  protected final String TEXT_299 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_300 = " <= commitCounter_";
  protected final String TEXT_301 = ") {" + NL + "                    connection_";
  protected final String TEXT_302 = ".commit();" + NL + "                    commitCounter_";
  protected final String TEXT_303 = "=0;" + NL + "                }    ";
