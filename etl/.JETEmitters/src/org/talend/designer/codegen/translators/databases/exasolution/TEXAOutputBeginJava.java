...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_32 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_33 = " + \":\" + ";
  protected final String TEXT_34 = "+ \":schema=\" + ";
  protected final String TEXT_35 = "; " + NL + "    } else {" + NL + "       url_";
  protected final String TEXT_36 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_37 = " + \":\" + ";
  protected final String TEXT_38 = " + \":schema=\" + ";
  protected final String TEXT_39 = " + \":\" + ";
  protected final String TEXT_40 = ";" + NL + "    }" + NL + "    String dbUser_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = ";" + NL + "    String dbPwd_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";    " + NL + "     java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_50 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  ...
  protected final String TEXT_60 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_96 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_99 = " = deletedCount_";
  protected final String TEXT_100 = " + stmtClear_";
  protected final String TEXT_101 = ".executeUpdate(\"";
  protected final String TEXT_102 = "\");";
  protected final String TEXT_103 = NL + "\t    String insert_";
  ...
  protected final String TEXT_109 = ".prepareStatement(insert_";
  protected final String TEXT_110 = ");" + NL + "\t    ";
  protected final String TEXT_111 = NL + "\t    String update_";
  protected final String TEXT_112 = " = \"UPDATE \" + ";
  protected final String TEXT_113 = " + \" SET ";
  protected final String TEXT_114 = " WHERE ";
  protected final String TEXT_115 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_116 = " = conn_";
  protected final String TEXT_117 = ".prepareStatement(update_";
  protected final String TEXT_118 = ");" + NL + "\t    ";
  protected final String TEXT_119 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_130 = ");" + NL + "\t    String update_";
  protected final String TEXT_131 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_136 = ".prepareStatement(update_";
  protected final String TEXT_137 = ");" + NL + "\t    ";
  protected final String TEXT_138 = NL + "\t    String update_";
  protected final String TEXT_139 = " = \"UPDATE \" + ";
  protected final String TEXT_140 = " + \" SET ";
  protected final String TEXT_141 = " WHERE ";
  protected final String TEXT_142 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".prepareStatement(update_";
  protected final String TEXT_145 = ");" + NL + "\t    String insert_";
  protected final String TEXT_146 = " = \"INSERT INTO \" + ";
  protected final String TEXT_147 = " + \" (";
  protected final String TEXT_148 = ") VALUES (";
  protected final String TEXT_149 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".prepareStatement(insert_";
  protected final String TEXT_152 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_153 = NL + "\t    String delete_";
  protected final String TEXT_154 = " = \"DELETE FROM \" + ";
  protected final String TEXT_155 = " + \" WHERE ";
  protected final String TEXT_156 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = ".prepareStatement(delete_";
  protected final String TEXT_159 = ");" + NL + "\t    ";
  protected final String TEXT_160 = NL + "        String query_";
