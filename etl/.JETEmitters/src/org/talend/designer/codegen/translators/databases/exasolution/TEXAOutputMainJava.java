...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_5 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_6 = " = buffersSize_";
  protected final String TEXT_7 = ";";
  protected final String TEXT_8 = NL + "        whetherReject_";
  protected final String TEXT_9 = " = false;";
  protected final String TEXT_10 = NL + "                query_";
  protected final String TEXT_11 = " = new String(insert_";
  protected final String TEXT_12 = ");";
  protected final String TEXT_13 = NL + "                    ";
  protected final String TEXT_14 = NL + "                        query_";
  protected final String TEXT_15 = " = ";
  protected final String TEXT_16 = ";";
  protected final String TEXT_17 = NL + "                globalMap.put(\"";
  protected final String TEXT_18 = "_QUERY\", query_";
  protected final String TEXT_19 = ");";
  protected final String TEXT_20 = NL + "pstmt_";
  protected final String TEXT_21 = ".addBatch();" + NL + "            try {" + NL + "                //insertedCount_";
  protected final String TEXT_22 = " = insertedCount_";
  protected final String TEXT_23 = " + pstmt_";
  protected final String TEXT_24 = ".executeUpdate();" + NL + "\t\t\tinsertedCount_";
  protected final String TEXT_25 = " = insertedCount_";
  protected final String TEXT_26 = " + 1;" + NL + "" + NL + "                nb_line_";
  protected final String TEXT_27 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_28 = " = true;";
  protected final String TEXT_29 = NL + "                    throw(e);";
  ...
  protected final String TEXT_40 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_41 = NL + "            }";
  protected final String TEXT_42 = NL + "                query_";
  protected final String TEXT_43 = " = new String(update_";
  ...
  protected final String TEXT_54 = "_QUERY\", query_";
  protected final String TEXT_55 = ");";
  protected final String TEXT_56 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_57 = " = updatedCount_";
  protected final String TEXT_58 = " + pstmt_";
  protected final String TEXT_59 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_60 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_72 = ".errorMessage = e.getMessage();";
  protected final String TEXT_73 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_74 = NL + "            }";
  protected final String TEXT_75 = NL + "    " + NL + "    \t    ";
  protected final String TEXT_76 = NL + "                    ";
  protected final String TEXT_77 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_78 = " = pstmt_";
  protected final String TEXT_79 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_80 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_81 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_82 = " = rs_";
  protected final String TEXT_83 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_101 = " + pstmtUpdate_";
  protected final String TEXT_102 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_115 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_116 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_117 = NL + "                    query_";
  protected final String TEXT_118 = " = new String(insert_";
  protected final String TEXT_119 = ");";
  protected final String TEXT_120 = NL + "                        ";
  protected final String TEXT_121 = NL + "                            query_";
  protected final String TEXT_122 = " = ";
  protected final String TEXT_123 = ";";
  protected final String TEXT_124 = NL + "                    globalMap.put(\"";
  protected final String TEXT_125 = "_QUERY\", query_";
  protected final String TEXT_126 = ");";
  protected final String TEXT_127 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_128 = " = insertedCount_";
  protected final String TEXT_129 = " + pstmtInsert_";
  protected final String TEXT_130 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_142 = ".errorMessage = e.getMessage();";
  protected final String TEXT_143 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_144 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_145 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_146 = NL + "                query_";
  protected final String TEXT_147 = " = new String(update_";
  protected final String TEXT_148 = ");";
  protected final String TEXT_149 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_160 = "_QUERY\", query_";
  protected final String TEXT_161 = ");";
  protected final String TEXT_162 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_163 = "=pstmtUpdate_";
  protected final String TEXT_164 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_165 = " = updatedCount_";
  protected final String TEXT_166 = "+updateFlag_";
  protected final String TEXT_167 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_179 = ".errorMessage = e.getMessage();";
  protected final String TEXT_180 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_181 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_182 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_183 = NL + "                    query_";
  protected final String TEXT_184 = " = new String(insert_";
  ...
  protected final String TEXT_193 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_194 = " = insertedCount_";
  protected final String TEXT_195 = " + pstmtInsert_";
  protected final String TEXT_196 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_197 = " = true;";
  protected final String TEXT_198 = NL + "                        throw(e);";
  protected final String TEXT_199 = NL + "                            ";
  protected final String TEXT_200 = " = new ";
  protected final String TEXT_201 = "Struct();";
  ...
  protected final String TEXT_208 = ".errorMessage = e.getMessage();";
  protected final String TEXT_209 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_210 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  protected final String TEXT_211 = "++;";
  protected final String TEXT_212 = NL + "                query_";
  protected final String TEXT_213 = " = new String(delete_";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "                    ";
  protected final String TEXT_216 = NL + "                        query_";
  protected final String TEXT_217 = " = ";
  protected final String TEXT_218 = ";";
  protected final String TEXT_219 = NL + "                globalMap.put(\"";
  protected final String TEXT_220 = "_QUERY\", query_";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_223 = " = deletedCount_";
  protected final String TEXT_224 = " + pstmt_";
  protected final String TEXT_225 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_237 = ".errorMessage = e.getMessage();";
  protected final String TEXT_238 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_239 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_240 = "++;" + NL + "    \t";
  protected final String TEXT_241 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_252 = NL + "                    commitCounter_";
  protected final String TEXT_253 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_254 = " <= commitCounter_";
  protected final String TEXT_255 = ") {   " + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_256 = ".execute();" + NL + "                        conn_";
  protected final String TEXT_257 = ".commit();                \t" + NL + "                        commitCounter_";
