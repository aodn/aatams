...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_141 = ".getColumnTypeName(i));";
  protected final String TEXT_142 = NL + "                \tdcm_";
  protected final String TEXT_143 = ".setFormat(";
  protected final String TEXT_144 = ");";
  protected final String TEXT_145 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_146 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_147 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_148 = ".setLength(rsmd_";
  protected final String TEXT_149 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_150 = ".setLength(rsmd_";
  protected final String TEXT_151 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_152 = NL + "\t\t\tdcm_";
  protected final String TEXT_153 = ".setLength(rsmd_";
  protected final String TEXT_154 = ".getPrecision(i));";
  protected final String TEXT_155 = NL + "                \tdcm_";
  protected final String TEXT_156 = ".setPrecision(rsmd_";
  protected final String TEXT_157 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_158 = ".setNullable(rsmd_";
  protected final String TEXT_159 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_160 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_161 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_162 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_163 = ".metadatas.add(dcm_";
  protected final String TEXT_164 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_165 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_166 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_167 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_168 = "++;" + NL + "\t\t        ";
  protected final String TEXT_169 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_180 = " = (List)rs_";
  protected final String TEXT_181 = ".getObject(";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "\t\t                         ";
  protected final String TEXT_184 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_185 = ".getObject(";
  protected final String TEXT_186 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_187 = NL + "                                    ";
  protected final String TEXT_188 = ".";
  protected final String TEXT_189 = " = new Geometry(wktValue);";
  protected final String TEXT_190 = NL + "                                        ";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = ".setEPSG(";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_195 = NL + "                                  ";
  protected final String TEXT_196 = ".";
  protected final String TEXT_197 = "=dcg_";
  protected final String TEXT_198 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = ", rs_";
  protected final String TEXT_201 = ", fixedColumnCount_";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_204 = ".getObject(";
  protected final String TEXT_205 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_206 = ".";
  protected final String TEXT_207 = " = new Geometry(sb.toString());";
