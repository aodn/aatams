...
public class TFirebirdOutputBeginJava {
  ...
  protected final String TEXT_29 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_45 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";            " + NL + "        int commitCounter_";
  protected final String TEXT_48 = " = 0;            ";
  protected final String TEXT_49 = NL;
  protected final String TEXT_50 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_51 = " = conn_";
  protected final String TEXT_52 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_60 = ".commit();";
  protected final String TEXT_61 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_67 = ".commit();";
  ...
  protected final String TEXT_72 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_73 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_74 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_75 = " = rsTable_";
  protected final String TEXT_76 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_77 = ".equalsIgnoreCase(";
  protected final String TEXT_78 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_79 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_80 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_86 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_91 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_92 = " = conn_";
  protected final String TEXT_93 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_94 = ".execute(\"";
  protected final String TEXT_95 = ")\");                ";
  protected final String TEXT_96 = NL + "                conn_";
  protected final String TEXT_97 = ".commit();";
  protected final String TEXT_98 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_99 = " = conn_";
  protected final String TEXT_100 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_101 = " = deletedCount_";
  protected final String TEXT_102 = " + stmtClear_";
  protected final String TEXT_103 = ".executeUpdate(\"";
  protected final String TEXT_104 = "\");";
  protected final String TEXT_105 = NL + "\t    String insert_";
  protected final String TEXT_106 = " = \"INSERT INTO \" + ";
  protected final String TEXT_107 = " + \" (";
  protected final String TEXT_108 = ") VALUES (";
  protected final String TEXT_109 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_110 = " = conn_";
  protected final String TEXT_111 = ".prepareStatement(insert_";
  protected final String TEXT_112 = ");" + NL + "\t    ";
  protected final String TEXT_113 = NL + "\t    String update_";
  protected final String TEXT_114 = " = \"UPDATE \" + ";
  protected final String TEXT_115 = " + \" SET ";
  protected final String TEXT_116 = " WHERE ";
  protected final String TEXT_117 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_118 = " = conn_";
  protected final String TEXT_119 = ".prepareStatement(update_";
  protected final String TEXT_120 = ");" + NL + "\t    ";
  protected final String TEXT_121 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_124 = " + \" WHERE ";
  protected final String TEXT_125 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_126 = " = \"INSERT INTO \" + ";
  protected final String TEXT_127 = " + \" (";
  protected final String TEXT_128 = ") VALUES (";
  protected final String TEXT_129 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".prepareStatement(insert_";
  protected final String TEXT_132 = ");" + NL + "\t    String update_";
  protected final String TEXT_133 = " = \"UPDATE \" + ";
  protected final String TEXT_134 = " + \" SET ";
  protected final String TEXT_135 = " WHERE ";
  protected final String TEXT_136 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_137 = " = conn_";
  protected final String TEXT_138 = ".prepareStatement(update_";
  protected final String TEXT_139 = ");" + NL + "\t    ";
  protected final String TEXT_140 = NL + "\t    String update_";
  protected final String TEXT_141 = " = \"UPDATE \" + ";
  protected final String TEXT_142 = " + \" SET ";
  protected final String TEXT_143 = " WHERE ";
  protected final String TEXT_144 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_145 = " = conn_";
  protected final String TEXT_146 = ".prepareStatement(update_";
  protected final String TEXT_147 = ");" + NL + "\t    String insert_";
  protected final String TEXT_148 = " = \"INSERT INTO \" + ";
  protected final String TEXT_149 = " + \" (";
  protected final String TEXT_150 = ") VALUES (";
  protected final String TEXT_151 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".prepareStatement(insert_";
  protected final String TEXT_154 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_155 = NL + "\t    String delete_";
  protected final String TEXT_156 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_157 = " + \" WHERE ";
  protected final String TEXT_158 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".prepareStatement(delete_";
  protected final String TEXT_161 = ");" + NL + "\t    ";
  protected final String TEXT_162 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_163 = " = null;" + NL + "       \t";
  protected final String TEXT_164 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_165 = " = insert_";
  protected final String TEXT_166 = ".split(\"\\\\?\");";
  protected final String TEXT_167 = NL + "\t\t\tupdate_";
  protected final String TEXT_168 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_169 = " = update_";
  ...
  protected final String TEXT_174 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_175 = " = insert_";
  protected final String TEXT_176 = ".split(\"\\\\?\");";
  protected final String TEXT_177 = NL + "\t\t\tdelete_";
  protected final String TEXT_178 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_179 = " = delete_";
  protected final String TEXT_180 = ".split(\"\\\\?\");";
  protected final String TEXT_181 = NL + "\t\t\treplace_";
  protected final String TEXT_182 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_183 = " = replace_";
  protected final String TEXT_184 = ".split(\"\\\\?\");";
  protected final String TEXT_185 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_186 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_187 = " = insertIgnore_";
  protected final String TEXT_188 = ".split(\"\\\\?\");";
  protected final String TEXT_189 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_190 = " = insert_";
