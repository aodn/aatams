...
public class TFirebirdOutputMainJava {
  ...
  protected final String TEXT_34 = NL + "                        rejectedCount_";
  protected final String TEXT_35 = " = rejectedCount_";
  protected final String TEXT_36 = " + 1;";
  protected final String TEXT_37 = NL + "                        ";
  protected final String TEXT_38 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_39 = ";";
  protected final String TEXT_40 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_41 = NL + "            }";
  protected final String TEXT_42 = NL + "                    ";
  protected final String TEXT_43 = NL + "                        query_";
  ...
  protected final String TEXT_53 = NL + "                        query_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "                globalMap.put(\"";
  protected final String TEXT_57 = "_QUERY\", query_";
  protected final String TEXT_58 = ".toString().trim());";
  protected final String TEXT_59 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_63 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_85 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_86 = " = pstmt_";
  protected final String TEXT_87 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_88 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_89 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_90 = " = rs_";
  protected final String TEXT_91 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_92 = " > 0) {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_110 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_111 = " = updatedCount_";
  protected final String TEXT_112 = " + pstmtUpdate_";
  protected final String TEXT_113 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_124 = NL + "                            rejectedCount_";
  protected final String TEXT_125 = " = rejectedCount_";
  protected final String TEXT_126 = " + 1;";
  protected final String TEXT_127 = NL + "                            ";
  protected final String TEXT_128 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_129 = ";";
  protected final String TEXT_130 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_131 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_132 = NL + "                        ";
  protected final String TEXT_133 = NL + "                            query_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = ";";
  protected final String TEXT_136 = NL + "                    globalMap.put(\"";
  protected final String TEXT_137 = "_QUERY\", query_";
  protected final String TEXT_138 = ".toString().trim());";
  protected final String TEXT_139 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_140 = " = insertedCount_";
  protected final String TEXT_141 = " + pstmtInsert_";
  protected final String TEXT_142 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_153 = NL + "                            rejectedCount_";
  protected final String TEXT_154 = " = rejectedCount_";
  protected final String TEXT_155 = " + 1;";
  protected final String TEXT_156 = NL + "                            ";
  protected final String TEXT_157 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_158 = ";";
  protected final String TEXT_159 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_160 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_161 = "++;" + NL + "    \t\t";
  protected final String TEXT_162 = NL + "    \t    int updateFlag_";
  protected final String TEXT_163 = "=0;" + NL + "    \t    ";
  protected final String TEXT_164 = NL + "                    ";
  protected final String TEXT_165 = NL + "                        query_";
  ...
  protected final String TEXT_175 = NL + "                        query_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";";
  protected final String TEXT_178 = NL + "                globalMap.put(\"";
  protected final String TEXT_179 = "_QUERY\", query_";
  protected final String TEXT_180 = ".toString().trim());";
  protected final String TEXT_181 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_182 = "=pstmtUpdate_";
  protected final String TEXT_183 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_184 = " = updatedCount_";
  protected final String TEXT_185 = " + updateFlag_";
  protected final String TEXT_186 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_201 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_202 = ";";
  protected final String TEXT_203 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_204 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_205 = " == 0) {" + NL + "            \t";
  protected final String TEXT_206 = NL + "\t\t\t\tquery_";
  protected final String TEXT_207 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_215 = NL + "                try {" + NL + "                \tinsertedCount_";
  protected final String TEXT_216 = " = insertedCount_";
  protected final String TEXT_217 = " + pstmtInsert_";
  protected final String TEXT_218 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_219 = " = true;";
  protected final String TEXT_220 = NL + "                        throw(e);";
  protected final String TEXT_221 = NL + "                            ";
  protected final String TEXT_222 = " = new ";
  protected final String TEXT_223 = "Struct();";
  protected final String TEXT_224 = NL + "                                ";
  protected final String TEXT_225 = ".";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = ".";
  protected final String TEXT_228 = ";";
  protected final String TEXT_229 = NL + "                            rejectedCount_";
  protected final String TEXT_230 = " = rejectedCount_";
  protected final String TEXT_231 = " + 1;";
  ...
  protected final String TEXT_236 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_251 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_252 = " = deletedCount_";
  protected final String TEXT_253 = " + pstmt_";
  protected final String TEXT_254 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_271 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_272 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_273 = "++;" + NL + "    \t";
  protected final String TEXT_274 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_285 = NL + "                commitCounter_";
  protected final String TEXT_286 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_287 = " <= commitCounter_";
  protected final String TEXT_288 = ") {" + NL + "                " + NL + "                \tconn_";
  protected final String TEXT_289 = ".commit();" + NL + "                \t" + NL + "                \tcommitCounter_";
  protected final String TEXT_290 = "=0;" + NL + "                " + NL + "                }" + NL + "        \t";
