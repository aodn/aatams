...
public class TGreenplumGPLoadEndJava {
  ...
  protected final String TEXT_6 = NL + "\t\t\tgploadThread_";
  protected final String TEXT_7 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_8 = NL + "\t\t\tgploadThread_";
  protected final String TEXT_9 = ".start();" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_10 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_11 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_12 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_13 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_14 = "_NB_LINE\", insertedCount_";
