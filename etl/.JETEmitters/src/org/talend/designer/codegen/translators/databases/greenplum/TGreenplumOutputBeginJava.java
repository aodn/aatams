...
public class TGreenplumOutputBeginJava {
  ...
  protected final String TEXT_56 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_57 = NL;
  protected final String TEXT_58 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_59 = " = conn_";
  protected final String TEXT_60 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_72 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_73 = " = conn_";
  protected final String TEXT_74 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_90 = NL + "                if(whetherExist_";
  protected final String TEXT_91 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_92 = " = conn_";
  protected final String TEXT_93 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_94 = ".execute(\"";
  protected final String TEXT_95 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_100 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_101 = " = conn_";
  protected final String TEXT_102 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_103 = " = stmtClearCount_";
  protected final String TEXT_104 = ".executeQuery(\"";
  protected final String TEXT_105 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_106 = " = conn_";
  protected final String TEXT_107 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_108 = ".executeUpdate(\"";
  protected final String TEXT_109 = "\");" + NL + "            while(rsClearCount_";
  protected final String TEXT_110 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_111 = " += rsClearCount_";
  protected final String TEXT_112 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_113 = "\t\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_121 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_127 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_131 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_132 = " + \"\\\" (";
  protected final String TEXT_133 = ") VALUES (";
  protected final String TEXT_134 = ")\");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_137 = " + \"\\\" SET ";
  protected final String TEXT_138 = " WHERE ";
  protected final String TEXT_139 = "\");\t" + NL + "\t    ";
  protected final String TEXT_140 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_143 = " + \"\\\" SET ";
  protected final String TEXT_144 = " WHERE ";
  protected final String TEXT_145 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_148 = " + \"\\\" (";
  protected final String TEXT_149 = ") VALUES (";
  protected final String TEXT_150 = ")\");\t\t" + NL + "\t    ";
  protected final String TEXT_151 = "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_154 = " + \"\\\" WHERE ";
  protected final String TEXT_155 = "\");" + NL + "\t    ";
  protected final String TEXT_156 = "    " + NL + "            int commitEvery_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";            " + NL + "            int commitCounter_";
