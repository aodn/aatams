...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_11 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_12 = " = insertedCount_";
  protected final String TEXT_13 = " + pstmt_";
  protected final String TEXT_14 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_15 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_16 = " = true;";
  protected final String TEXT_17 = NL + "                    throw(e);";
  ...
  protected final String TEXT_26 = NL + "                        rejectedCount_";
  protected final String TEXT_27 = " =  rejectedCount_";
  protected final String TEXT_28 = " + 1;";
  protected final String TEXT_29 = NL + "                        ";
  protected final String TEXT_30 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_31 = ";";
  protected final String TEXT_32 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_42 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_43 = " = updatedCount_";
  protected final String TEXT_44 = " + pstmt_";
  protected final String TEXT_45 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_46 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_57 = NL + "                        rejectedCount_";
  protected final String TEXT_58 = " =  rejectedCount_";
  protected final String TEXT_59 = " + 1;";
  protected final String TEXT_60 = NL + "                        ";
  protected final String TEXT_61 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_62 = ";";
  protected final String TEXT_63 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_70 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_71 = " = pstmt_";
  protected final String TEXT_72 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_73 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_74 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_75 = " = rs_";
  protected final String TEXT_76 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_85 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_86 = " = updatedCount_";
  protected final String TEXT_87 = " + pstmtUpdate_";
  protected final String TEXT_88 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_99 = NL + "                            rejectedCount_";
  ...
  protected final String TEXT_106 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_107 = NL + "                        ";
  protected final String TEXT_108 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_109 = " = insertedCount_";
  protected final String TEXT_110 = " + pstmtInsert_";
  protected final String TEXT_111 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_122 = NL + "                            rejectedCount_";
  protected final String TEXT_123 = " =  rejectedCount_";
  ...
  protected final String TEXT_129 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_130 = "++;";
  protected final String TEXT_131 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_141 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_142 = "=pstmtUpdate_";
  protected final String TEXT_143 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_144 = " = updatedCount_";
  protected final String TEXT_145 = "+updateFlag_";
  protected final String TEXT_146 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_164 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_165 = " == 0) {";
  protected final String TEXT_166 = NL + "                        ";
  protected final String TEXT_167 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_168 = " = insertedCount_";
  protected final String TEXT_169 = " + pstmtInsert_";
  protected final String TEXT_170 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_181 = NL + "                            rejectedCount_";
  protected final String TEXT_182 = " =  rejectedCount_";
  protected final String TEXT_183 = " + 1;";
  protected final String TEXT_184 = NL + "                            ";
  protected final String TEXT_185 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_186 = ";";
  protected final String TEXT_187 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_188 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_189 = "++;";
  protected final String TEXT_190 = NL + "\t\t\t\t\t";
  protected final String TEXT_191 = NL + "                    \t";
  protected final String TEXT_192 = NL + "\t                        query_";
  protected final String TEXT_193 = " = ";
  protected final String TEXT_194 = ";" + NL + "\t                        ";
  protected final String TEXT_195 = NL + "                    ";
  protected final String TEXT_196 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_197 = " = deletedCount_";
  protected final String TEXT_198 = " + pstmt_";
  protected final String TEXT_199 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_200 = " = true;";
  protected final String TEXT_201 = NL + "                    throw(e);";
  ...
  protected final String TEXT_210 = NL + "                        rejectedCount_";
  protected final String TEXT_211 = " =  rejectedCount_";
  protected final String TEXT_212 = " + 1;";
  ...
  protected final String TEXT_219 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_230 = NL + "                commitCounter_";
  protected final String TEXT_231 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_232 = "<=commitCounter_";
  protected final String TEXT_233 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_234 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_235 = "=0;" + NL + "        " + NL + "                }";
