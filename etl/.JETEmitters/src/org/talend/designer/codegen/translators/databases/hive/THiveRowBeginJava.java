...
public class THiveRowBeginJava
{
  ...
  protected final String TEXT_7 = NL + "\t\t\tif(true) {" + NL + "\t\t\t\tthrow new Exception(\"The Hive version and the connection mode are not compatible together. Please check your component configuration.\");" + NL + "\t\t\t}";
  protected final String TEXT_8 = NL + "\t\t\tSystem.setProperty(\"hive.metastore.local\", \"false\");" + NL + "\t\t\tSystem.setProperty(\"hive.metastore.uris\", \"thrift://\" + ";
  protected final String TEXT_9 = " + \":\" + ";
  protected final String TEXT_10 = ");" + NL + "\t\t\tString url_";
  protected final String TEXT_11 = " = \"jdbc:hive://\";";
  protected final String TEXT_12 = NL + "\t\t\tString url_";
  protected final String TEXT_13 = " = \"jdbc:hive://\" + ";
  ...
  protected final String TEXT_21 = ";    " + NL + "\t\tjava.lang.Class.forName(\"";
  ...
  protected final String TEXT_28 = NL + "        if(conn_";
  protected final String TEXT_29 = ".getAutoCommit()) {" + NL + "            conn_";
  protected final String TEXT_30 = ".setAutoCommit(false);" + NL + "        }        " + NL + "        int commitEvery_";
  ...
  protected final String TEXT_43 = " = \"\";" + NL + "boolean whetherReject_";
