...
public class THSQLDbOutputMainJava {
  ...
  protected final String TEXT_51 = "_QUERY\", query_";
  protected final String TEXT_52 = ".toString().trim());";
  protected final String TEXT_53 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_54 = " = updatedCount_";
  protected final String TEXT_55 = " + pstmt_";
  protected final String TEXT_56 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_57 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_68 = NL + "                        rejectedCount_";
  protected final String TEXT_69 = " = rejectedCount_";
  protected final String TEXT_70 = " + 1;";
  protected final String TEXT_71 = NL + "                        ";
  protected final String TEXT_72 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_73 = ";";
  protected final String TEXT_74 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_75 = NL + "            }";
  protected final String TEXT_76 = NL + "                    ";
  protected final String TEXT_77 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  ...
  protected final String TEXT_98 = " + pstmtUpdate_";
  protected final String TEXT_99 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_100 = " = true;";
  protected final String TEXT_101 = NL + "                        throw(e);";
  ...
  protected final String TEXT_110 = NL + "                            rejectedCount_";
  ...
  protected final String TEXT_119 = NL + "                            query_";
  protected final String TEXT_120 = " = ";
  protected final String TEXT_121 = ";";
  protected final String TEXT_122 = NL + "                    globalMap.put(\"";
  protected final String TEXT_123 = "_QUERY\", query_";
  protected final String TEXT_124 = ".toString().trim());";
  protected final String TEXT_125 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_126 = " = insertedCount_";
  protected final String TEXT_127 = " + pstmtInsert_";
  protected final String TEXT_128 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_139 = NL + "                            rejectedCount_";
  protected final String TEXT_140 = " = rejectedCount_";
  protected final String TEXT_141 = " + 1;";
  protected final String TEXT_142 = NL + "                            ";
  protected final String TEXT_143 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_144 = ";";
  protected final String TEXT_145 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_146 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_147 = "++;";
  protected final String TEXT_148 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_161 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_162 = "=pstmtUpdate_";
  protected final String TEXT_163 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_164 = " = updatedCount_";
  protected final String TEXT_165 = " + updateFlag_";
  protected final String TEXT_166 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_177 = NL + "                        rejectedCount_";
  ...
  protected final String TEXT_184 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_185 = " == 0) {" + NL + "            \t";
  protected final String TEXT_186 = NL + "\t\t\t\tquery_";
  protected final String TEXT_187 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_198 = ".executeUpdate();  " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_216 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_224 = ".toString().trim());";
  protected final String TEXT_225 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_226 = " = deletedCount_";
  protected final String TEXT_227 = " + pstmt_";
  protected final String TEXT_228 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_239 = NL + "                        rejectedCount_";
  protected final String TEXT_240 = " = rejectedCount_";
  protected final String TEXT_241 = " + 1;";
  protected final String TEXT_242 = NL + "                        ";
  protected final String TEXT_243 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_244 = ";";
  protected final String TEXT_245 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_246 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_247 = "++;";
  protected final String TEXT_248 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_259 = NL + "            commitCounter_";
  protected final String TEXT_260 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_261 = " <= commitCounter_";
  protected final String TEXT_262 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_263 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_264 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
