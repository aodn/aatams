...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_296 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_341 = " WHERE ";
  protected final String TEXT_342 = "\";" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_343 = " = conn_";
  protected final String TEXT_344 = ".prepareStatement(update_";
  protected final String TEXT_345 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".prepareStatement(insert_";
  protected final String TEXT_348 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_349 = NL + "\t    String delete_";
  protected final String TEXT_350 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_351 = " + \" WHERE ";
  protected final String TEXT_352 = "\";" + NL + "\t    ";
  protected final String TEXT_353 = NL + "\t    pstmt_";
  protected final String TEXT_354 = " = conn_";
  protected final String TEXT_355 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_399 = NL + "        whetherReject_";
  protected final String TEXT_400 = " = false;";
  protected final String TEXT_401 = NL + "                    ";
  protected final String TEXT_402 = NL + "                        query_";
  protected final String TEXT_403 = " = ";
  protected final String TEXT_404 = ";";
  protected final String TEXT_405 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = ", pstmt_";
  protected final String TEXT_408 = ", ";
  protected final String TEXT_409 = ", \"";
  protected final String TEXT_410 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_411 = NL + "                globalMap.put(\"";
  protected final String TEXT_412 = "_QUERY\", query_";
  protected final String TEXT_413 = ".toString().trim());";
  protected final String TEXT_414 = NL + "            ";
  protected final String TEXT_415 = NL + "    \t\tpstmt_";
  protected final String TEXT_416 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_417 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_418 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_424 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_441 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_461 = NL + "                        query_";
  protected final String TEXT_462 = " = ";
  protected final String TEXT_463 = ";";
  protected final String TEXT_464 = NL + "                globalMap.put(\"";
  protected final String TEXT_465 = "_QUERY\", query_";
  protected final String TEXT_466 = ".toString().trim());";
  protected final String TEXT_467 = NL + "            ";
  protected final String TEXT_468 = NL + "    \t\tpstmt_";
  protected final String TEXT_469 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_470 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_471 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_477 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_494 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_499 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_500 = " = pstmt_";
  protected final String TEXT_501 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_502 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_503 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_504 = " = rs_";
  protected final String TEXT_505 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_506 = " > 0) {";
  protected final String TEXT_507 = NL + "                        ";
  protected final String TEXT_508 = NL + "                            query_";
  protected final String TEXT_509 = " = ";
  protected final String TEXT_510 = ";";
  protected final String TEXT_511 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_512 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_513 = ".";
  protected final String TEXT_514 = ", pstmtUpdate_";
  ...
  protected final String TEXT_530 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_531 = " = updatedCount_";
  protected final String TEXT_532 = " + pstmtUpdate_";
  protected final String TEXT_533 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_550 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_551 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_565 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_566 = " = insertedCount_";
  protected final String TEXT_567 = " + pstmtInsert_";
  protected final String TEXT_568 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_614 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_615 = "=pstmtUpdate_";
  protected final String TEXT_616 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_617 = " = updatedCount_";
  protected final String TEXT_618 = " + updateFlag_";
  protected final String TEXT_619 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_634 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_635 = ";";
  protected final String TEXT_636 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_637 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_638 = " == 0) {" + NL + "            \t";
  protected final String TEXT_639 = NL + "\t\t\t\tquery_";
  protected final String TEXT_640 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_641 = NL + "                        ";
  protected final String TEXT_642 = NL + "                            query_";
  protected final String TEXT_643 = " = ";
  protected final String TEXT_644 = ";";
  protected final String TEXT_645 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_646 = ".";
  protected final String TEXT_647 = ", pstmtInsert_";
  protected final String TEXT_648 = ", ";
  protected final String TEXT_649 = ", \"";
  protected final String TEXT_650 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_651 = NL + "                    globalMap.put(\"";
  protected final String TEXT_652 = "_QUERY\", query_";
  protected final String TEXT_653 = ".toString().trim());";
  protected final String TEXT_654 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_655 = " = insertedCount_";
  protected final String TEXT_656 = " + pstmtInsert_";
  protected final String TEXT_657 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_672 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_673 = ";";
  protected final String TEXT_674 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_675 = NL + "                }" + NL + "                " + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_698 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_715 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_716 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_717 = NL + "            nb_line_";
  protected final String TEXT_718 = "++;";
  protected final String TEXT_719 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_730 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_731 = " <= batchSizeCounter_";
  protected final String TEXT_732 = ") {                ";
  protected final String TEXT_733 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_734 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_735 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_736 = " += pstmt_";
  protected final String TEXT_737 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_738 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_739 = " += pstmt_";
  protected final String TEXT_740 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_741 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_742 = " += pstmt_";
  protected final String TEXT_743 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_744 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_745 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_746 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_747 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_748 = NL + "                }";
  protected final String TEXT_749 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_750 = NL + "            commitCounter_";
  protected final String TEXT_751 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_752 = "<=commitCounter_";
  protected final String TEXT_753 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_754 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_755 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
