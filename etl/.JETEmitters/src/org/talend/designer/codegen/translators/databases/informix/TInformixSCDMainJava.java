...
public class TInformixSCDMainJava {
  ...
  protected final String TEXT_162 = NL + "    }" + NL + "    " + NL + "\t} catch (Exception e) {//catch" + NL + "\t";
  ...
  protected final String TEXT_176 = NL + "\t}//end catch" + NL + "    ";
  protected final String TEXT_177 = NL + "                lookUpValue_";
  ...
  protected final String TEXT_192 = NL + "        cache_";
  protected final String TEXT_193 = ".put(lookUpKey_";
