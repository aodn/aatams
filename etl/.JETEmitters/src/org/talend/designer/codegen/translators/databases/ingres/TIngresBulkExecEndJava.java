...
public class TIngresBulkExecEndJava {
  protected static String nl;
  public static synchronized TIngresBulkExecEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresBulkExecEndJava result = new TIngresBulkExecEndJava();
    nl = null;
    return result;
  }
