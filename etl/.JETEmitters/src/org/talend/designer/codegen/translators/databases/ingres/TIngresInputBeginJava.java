...
public class TIngresInputBeginJava
{
  ...
  protected final String TEXT_86 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_143 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_144 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_145 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_146 = ".setLength(rsmd_";
  protected final String TEXT_147 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_148 = ".setLength(rsmd_";
  protected final String TEXT_149 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_150 = NL + "\t\t\tdcm_";
  protected final String TEXT_151 = ".setLength(rsmd_";
  protected final String TEXT_152 = ".getPrecision(i));";
  protected final String TEXT_153 = NL + "                \tdcm_";
  protected final String TEXT_154 = ".setPrecision(rsmd_";
  protected final String TEXT_155 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_156 = ".setNullable(rsmd_";
  protected final String TEXT_157 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_158 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_159 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_160 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_161 = ".metadatas.add(dcm_";
  protected final String TEXT_162 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_163 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_164 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_165 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_166 = "++;" + NL + "\t\t        ";
  protected final String TEXT_167 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_178 = " = (List)rs_";
  protected final String TEXT_179 = ".getObject(";
  protected final String TEXT_180 = ");";
  protected final String TEXT_181 = NL + "\t\t                         ";
  protected final String TEXT_182 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_183 = ".getObject(";
  protected final String TEXT_184 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_185 = NL + "                                    ";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = " = new Geometry(wktValue);";
  protected final String TEXT_188 = NL + "                                        ";
  protected final String TEXT_189 = ".";
  protected final String TEXT_190 = ".setEPSG(";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_193 = NL + "                                  ";
  protected final String TEXT_194 = ".";
  protected final String TEXT_195 = "=dcg_";
  protected final String TEXT_196 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_197 = ".";
  protected final String TEXT_198 = ", rs_";
  protected final String TEXT_199 = ", fixedColumnCount_";
  protected final String TEXT_200 = ");";
  protected final String TEXT_201 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_202 = ".getObject(";
  protected final String TEXT_203 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = " = new Geometry(sb.toString());";
