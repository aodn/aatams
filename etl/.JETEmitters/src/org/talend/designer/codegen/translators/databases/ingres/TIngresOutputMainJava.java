...
public class TIngresOutputMainJava {
  ...
  protected final String TEXT_12 = NL + "                        query_";
  protected final String TEXT_13 = " = ";
  protected final String TEXT_14 = ";";
  protected final String TEXT_15 = NL + "                globalMap.put(\"";
  protected final String TEXT_16 = "_QUERY\", query_";
  protected final String TEXT_17 = ".toString().trim());";
  protected final String TEXT_18 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_19 = " = insertedCount_";
  protected final String TEXT_20 = " + pstmt_";
  protected final String TEXT_21 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_22 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_23 = " = true;";
  protected final String TEXT_24 = NL + "                    throw(e);";
  ...
  protected final String TEXT_33 = NL + "                        rejectedCount_";
  protected final String TEXT_34 = " = rejectedCount_";
  protected final String TEXT_35 = " + 1;";
  protected final String TEXT_36 = NL + "                        ";
  protected final String TEXT_37 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_38 = ";";
  protected final String TEXT_39 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_58 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_59 = " = updatedCount_";
  protected final String TEXT_60 = " + pstmt_";
  protected final String TEXT_61 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_62 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_63 = " = true;";
  ...
  protected final String TEXT_73 = NL + "                        rejectedCount_";
  protected final String TEXT_74 = " = rejectedCount_";
  protected final String TEXT_75 = " + 1;";
  protected final String TEXT_76 = NL + "                        ";
  protected final String TEXT_77 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_78 = ";";
  protected final String TEXT_79 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_180 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_181 = "=pstmtUpdate_";
  protected final String TEXT_182 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_183 = " = updatedCount_";
  protected final String TEXT_184 = " + updateFlag_";
  protected final String TEXT_185 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_203 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_204 = " == 0) {" + NL + "            \t";
  protected final String TEXT_205 = NL + "\t\t\t\tquery_";
  protected final String TEXT_206 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_207 = NL + "                        ";
  protected final String TEXT_208 = NL + "                            query_";
  protected final String TEXT_209 = " = ";
  protected final String TEXT_210 = ";";
  protected final String TEXT_211 = NL + "                    globalMap.put(\"";
  protected final String TEXT_212 = "_QUERY\", query_";
  protected final String TEXT_213 = ".toString().trim());";
  protected final String TEXT_214 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_215 = " = insertedCount_";
  protected final String TEXT_216 = " + pstmtInsert_";
  protected final String TEXT_217 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_228 = NL + "                            rejectedCount_";
  protected final String TEXT_229 = " = rejectedCount_";
  protected final String TEXT_230 = " + 1;";
  protected final String TEXT_231 = NL + "                            ";
  protected final String TEXT_232 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_233 = ";";
  protected final String TEXT_234 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_235 = NL + "                }" + NL + "            }" + NL + "           " + NL + "            nb_line_";
  ...
  protected final String TEXT_249 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_250 = " = deletedCount_";
  protected final String TEXT_251 = " + pstmt_";
  protected final String TEXT_252 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_263 = NL + "                        rejectedCount_";
  protected final String TEXT_264 = " = rejectedCount_";
  protected final String TEXT_265 = " + 1;";
  protected final String TEXT_266 = NL + "                        ";
  protected final String TEXT_267 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_268 = ";";
  protected final String TEXT_269 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_270 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_271 = "++;";
  protected final String TEXT_272 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_283 = NL + "\t            commitCounter_";
  protected final String TEXT_284 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_285 = " <= commitCounter_";
  protected final String TEXT_286 = ") {" + NL + "\t            " + NL + "\t                conn_";
  protected final String TEXT_287 = ".commit();" + NL + "\t                " + NL + "\t                commitCounter_";
  protected final String TEXT_288 = "=0;" + NL + "\t            " + NL + "\t            }" + NL + "\t        " + NL + "\t        ";
