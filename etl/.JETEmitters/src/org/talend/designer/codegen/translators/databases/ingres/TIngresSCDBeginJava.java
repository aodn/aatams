...
public class TIngresSCDBeginJava {
  ...
  protected final String TEXT_12 = NL + "    \tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "    \tString connectionString_";
  protected final String TEXT_13 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_21 = NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_22 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_23 = " = null;    ";
  protected final String TEXT_24 = NL + "        String searching_";
  protected final String TEXT_25 = " = \"";
  protected final String TEXT_26 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_27 = " = connection_";
  protected final String TEXT_28 = ".prepareStatement(searching_";
  protected final String TEXT_29 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_30 = " = null;";
  protected final String TEXT_31 = NL + "        String search_";
  protected final String TEXT_32 = " = \"";
  protected final String TEXT_33 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_34 = " = connection_";
  protected final String TEXT_35 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_36 = " = statement_";
  protected final String TEXT_37 = ".executeQuery(search_";
  protected final String TEXT_38 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_39 = ", SCDStruct_";
  protected final String TEXT_40 = "> cache_";
  protected final String TEXT_41 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_42 = ", SCDStruct_";
  protected final String TEXT_43 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_44 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_45 = " sk_";
  protected final String TEXT_46 = " = new SCDSK_";
  protected final String TEXT_47 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_48 = " row_";
  protected final String TEXT_49 = " = new SCDStruct_";
  protected final String TEXT_50 = "();";
  protected final String TEXT_51 = NL + "                    tmpValue_";
  protected final String TEXT_52 = " = resultSet_";
  protected final String TEXT_53 = ".getString(";
  protected final String TEXT_54 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_55 = " != null && tmpValue_";
  protected final String TEXT_56 = ".length() > 0) {";
  protected final String TEXT_57 = NL + "                        ";
  protected final String TEXT_58 = ".";
  protected final String TEXT_59 = " = tmpValue_";
  protected final String TEXT_60 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_61 = NL + "                            if(tmpValue_";
  protected final String TEXT_62 = " == null) {";
  protected final String TEXT_63 = NL + "                                ";
  protected final String TEXT_64 = ".";
  protected final String TEXT_65 = " = null;" + NL + "                            } else {";
  protected final String TEXT_66 = NL + "                                ";
  protected final String TEXT_67 = ".";
  protected final String TEXT_68 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_69 = NL + "                            if(tmpValue_";
  protected final String TEXT_70 = "(\"\").equals()) {";
  protected final String TEXT_71 = NL + "                                ";
  protected final String TEXT_72 = ".";
  protected final String TEXT_73 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_74 = "' in '";
  protected final String TEXT_75 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_76 = NL + "                    }";
  protected final String TEXT_77 = NL + "                    timestamp_";
  protected final String TEXT_78 = " = resultSet_";
  protected final String TEXT_79 = ".getTimestamp(";
  protected final String TEXT_80 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_81 = " != null) {";
  protected final String TEXT_82 = NL + "                        ";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = " = new java.util.Date(timestamp_";
  protected final String TEXT_85 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_86 = NL + "                        ";
  protected final String TEXT_87 = ".";
  protected final String TEXT_88 = " = null;" + NL + "                    }";
  protected final String TEXT_89 = NL + "                    if(resultSet_";
  protected final String TEXT_90 = ".getObject(";
  protected final String TEXT_91 = ") != null) {";
  protected final String TEXT_92 = NL + "                        ";
  protected final String TEXT_93 = ".";
  protected final String TEXT_94 = " = resultSet_";
  protected final String TEXT_95 = ".get";
  protected final String TEXT_96 = "(";
  protected final String TEXT_97 = ");" + NL + "                    }";
  protected final String TEXT_98 = NL + "            cache_";
  protected final String TEXT_99 = ".put(sk_";
  protected final String TEXT_100 = ", row_";
  protected final String TEXT_101 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_102 = ".close();" + NL + "        statement_";
  protected final String TEXT_103 = ".close();";
  protected final String TEXT_104 = NL + "            System.out.println(\"[";
  protected final String TEXT_105 = "] comparison cache loaded\");";
  protected final String TEXT_106 = NL + "        ";
  protected final String TEXT_107 = " nextSurrogateKey_";
  protected final String TEXT_108 = " = 1;";
  protected final String TEXT_109 = NL + "            if(cache_";
  protected final String TEXT_110 = ".size() > 0) {";
  protected final String TEXT_111 = NL + "        String tmpQuery_";
  protected final String TEXT_112 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_113 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_114 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_115 = " = connection_";
  protected final String TEXT_116 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_117 = " = tmpStmt_";
  protected final String TEXT_118 = ".executeQuery(tmpQuery_";
  protected final String TEXT_119 = ");";
  protected final String TEXT_120 = NL + "        if(tmpRS_";
  protected final String TEXT_121 = ".next() && tmpRS_";
  protected final String TEXT_122 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_123 = " = tmpRS_";
  protected final String TEXT_124 = ".get";
  protected final String TEXT_125 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_126 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_127 = ".close();";
  protected final String TEXT_128 = NL + "            }            ";
  protected final String TEXT_129 = NL + "    String insertionSQL_";
  protected final String TEXT_130 = " = \"";
  protected final String TEXT_131 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_132 = " = connection_";
  protected final String TEXT_133 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_134 = ");";
  protected final String TEXT_135 = NL + "            insertionStatement_";
  protected final String TEXT_136 = ".setTimestamp(";
  protected final String TEXT_137 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_138 = "\")));";
  protected final String TEXT_139 = NL + "            insertionStatement_";
  protected final String TEXT_140 = ".setNull(";
  protected final String TEXT_141 = ", java.sql.Types.DATE);";
  protected final String TEXT_142 = NL + "            insertionStatement_";
  protected final String TEXT_143 = ".setTimestamp(";
  protected final String TEXT_144 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_145 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_146 = NL + "        String updateSQLForType1_";
  protected final String TEXT_147 = " = \"";
  protected final String TEXT_148 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_149 = " = connection_";
  protected final String TEXT_150 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_151 = ");        ";
  protected final String TEXT_152 = NL + "        String updateSQLForType2_";
  protected final String TEXT_153 = " = \"";
  protected final String TEXT_154 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_155 = " = connection_";
  protected final String TEXT_156 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_157 = ");";
  protected final String TEXT_158 = NL + "            updateForType2_";
  protected final String TEXT_159 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_160 = "\")));";
  protected final String TEXT_161 = NL + "        String updateSQLForType3_";
  protected final String TEXT_162 = " = \"";
  protected final String TEXT_163 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_164 = " = connection_";
  protected final String TEXT_165 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_166 = ");";
  protected final String TEXT_167 = NL + "    ";
  protected final String TEXT_168 = NL + "        SCDSK_";
  protected final String TEXT_169 = " lookUpKey_";
  protected final String TEXT_170 = " = null;        ";
  protected final String TEXT_171 = NL + "    SCDStruct_";
