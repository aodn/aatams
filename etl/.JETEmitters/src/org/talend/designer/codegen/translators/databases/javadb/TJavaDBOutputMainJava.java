...
public class TJavaDBOutputMainJava {
  ...
  protected final String TEXT_35 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_36 = ";";
  protected final String TEXT_37 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_38 = NL + "            }";
  protected final String TEXT_39 = NL + "                    ";
  protected final String TEXT_40 = NL + "                        query_";
  ...
  protected final String TEXT_48 = "_QUERY\", query_";
  protected final String TEXT_49 = ".toString().trim());";
  protected final String TEXT_50 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_51 = " = updatedCount_";
  protected final String TEXT_52 = " + pstmt_";
  protected final String TEXT_53 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_54 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_55 = " = true;";
  protected final String TEXT_56 = NL + "                    throw(e);";
  ...
  protected final String TEXT_66 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_67 = ";";
  protected final String TEXT_68 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_69 = NL + "            }";
  protected final String TEXT_70 = NL + "                    ";
  protected final String TEXT_71 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_72 = " = pstmt_";
  protected final String TEXT_73 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_74 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_75 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_76 = " = rs_";
  protected final String TEXT_77 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_78 = " > 0) {";
  protected final String TEXT_79 = NL + "                        ";
  protected final String TEXT_80 = NL + "                            query_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";";
  protected final String TEXT_83 = NL + "                        ";
  protected final String TEXT_84 = NL + "                            query_";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = ";";
  protected final String TEXT_87 = NL + "                    globalMap.put(\"";
  protected final String TEXT_88 = "_QUERY\", query_";
  protected final String TEXT_89 = ".toString().trim());";
  protected final String TEXT_90 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_91 = " = updatedCount_";
  protected final String TEXT_92 = " + pstmtUpdate_";
  protected final String TEXT_93 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_105 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_106 = ";";
  protected final String TEXT_107 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_108 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_109 = NL + "                        ";
  protected final String TEXT_110 = NL + "                            query_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = ";";
  protected final String TEXT_113 = NL + "                    globalMap.put(\"";
  protected final String TEXT_114 = "_QUERY\", query_";
  protected final String TEXT_115 = ".toString().trim());";
  protected final String TEXT_116 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_117 = " = insertedCount_";
  protected final String TEXT_118 = " + pstmtInsert_";
  protected final String TEXT_119 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_131 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_132 = ";";
  protected final String TEXT_133 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_134 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_135 = "++;";
  protected final String TEXT_136 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_147 = "_QUERY\", query_";
  protected final String TEXT_148 = ".toString().trim());";
  protected final String TEXT_149 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_150 = "=pstmtUpdate_";
  protected final String TEXT_151 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_152 = " = updatedCount_";
  protected final String TEXT_153 = "+updateFlag_";
  protected final String TEXT_154 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_169 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_170 = " == 0) {" + NL + "            \t";
  protected final String TEXT_171 = NL + "\t\t\t\tquery_";
  protected final String TEXT_172 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_173 = NL + "                        ";
  protected final String TEXT_174 = NL + "                            query_";
  protected final String TEXT_175 = " = ";
  protected final String TEXT_176 = ";";
  protected final String TEXT_177 = NL + "                    globalMap.put(\"";
  protected final String TEXT_178 = "_QUERY\", query_";
  protected final String TEXT_179 = ".toString().trim());";
  protected final String TEXT_180 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_181 = " = insertedCount_";
  protected final String TEXT_182 = " + pstmtInsert_";
  protected final String TEXT_183 = ".executeUpdate();   " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_184 = " = true;";
  protected final String TEXT_185 = NL + "                        throw(e);";
  protected final String TEXT_186 = NL + "                            ";
  protected final String TEXT_187 = " = new ";
  protected final String TEXT_188 = "Struct();";
  ...
  protected final String TEXT_207 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_208 = " = deletedCount_";
  protected final String TEXT_209 = " + pstmt_";
  protected final String TEXT_210 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_222 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_223 = ";";
  protected final String TEXT_224 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_225 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_226 = "++;";
  protected final String TEXT_227 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_238 = NL + "            commitCounter_";
  protected final String TEXT_239 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_240 = " <= commitCounter_";
  protected final String TEXT_241 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_242 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_243 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
