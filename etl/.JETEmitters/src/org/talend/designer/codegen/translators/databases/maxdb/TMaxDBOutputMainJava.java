...
public class TMaxDBOutputMainJava {
  ...
  protected final String TEXT_10 = NL + "        whetherReject_";
  protected final String TEXT_11 = " = false;";
  protected final String TEXT_12 = NL + "                    ";
  protected final String TEXT_13 = NL + "                        query_";
  protected final String TEXT_14 = " = ";
  protected final String TEXT_15 = ";";
  protected final String TEXT_16 = NL + "                globalMap.put(\"";
  protected final String TEXT_17 = "_QUERY\", query_";
  protected final String TEXT_18 = ".toString().trim());";
  protected final String TEXT_19 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_20 = " = insertedCount_";
  protected final String TEXT_21 = " + pstmt_";
  protected final String TEXT_22 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_23 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_24 = " = true;";
  protected final String TEXT_25 = NL + "                    throw(e);";
  ...
  protected final String TEXT_32 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_33 = ";";
  protected final String TEXT_34 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_42 = NL + "                        query_";
  ...
  protected final String TEXT_51 = ".toString().trim());";
  protected final String TEXT_52 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_53 = " = updatedCount_";
  protected final String TEXT_54 = " + pstmt_";
  protected final String TEXT_55 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_56 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_65 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_66 = ";";
  protected final String TEXT_67 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_68 = NL + "            }";
  protected final String TEXT_69 = NL + "\t\t\t\t\t";
  protected final String TEXT_70 = NL + "                    \t";
  protected final String TEXT_71 = NL + "                    ";
  protected final String TEXT_72 = NL + "                    ";
  protected final String TEXT_73 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_74 = " = pstmt_";
  protected final String TEXT_75 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_76 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_77 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_78 = " = rs_";
  protected final String TEXT_79 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_80 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_81 = NL + "                        ";
  protected final String TEXT_82 = NL + "                            query_";
  ...
  protected final String TEXT_91 = NL + "                            query_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + "                    globalMap.put(\"";
  protected final String TEXT_95 = "_QUERY\", query_";
  protected final String TEXT_96 = ".toString().trim());";
  protected final String TEXT_97 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_98 = " = updatedCount_";
  protected final String TEXT_99 = " + pstmtUpdate_";
  protected final String TEXT_100 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_101 = " = true;";
  protected final String TEXT_102 = NL + "                        throw(e);";
  ...
  protected final String TEXT_109 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_110 = ";";
  protected final String TEXT_111 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_118 = "_QUERY\", query_";
  protected final String TEXT_119 = ".toString().trim());";
  protected final String TEXT_120 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_121 = " = insertedCount_";
  protected final String TEXT_122 = " + pstmtInsert_";
  protected final String TEXT_123 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_124 = " = true;";
  ...
  protected final String TEXT_134 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_135 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_136 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_137 = NL + "    \t    int updateFlag_";
  protected final String TEXT_138 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_139 = NL + "                    ";
  protected final String TEXT_140 = NL + "                        query_";
  protected final String TEXT_141 = " = ";
  protected final String TEXT_142 = ";";
  protected final String TEXT_143 = NL + "\t\t\t\t\t";
  protected final String TEXT_144 = NL + "                    \t";
  protected final String TEXT_145 = NL + "\t                        query_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\t                        ";
  protected final String TEXT_148 = NL + "                    ";
  protected final String TEXT_149 = NL + "                        query_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";";
  protected final String TEXT_152 = NL + "                globalMap.put(\"";
  protected final String TEXT_153 = "_QUERY\", query_";
  protected final String TEXT_154 = ".toString().trim());";
  protected final String TEXT_155 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_156 = " = pstmtUpdate_";
  protected final String TEXT_157 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_158 = " = updatedCount_";
  protected final String TEXT_159 = " + updateFlag_";
  protected final String TEXT_160 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_171 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_172 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_173 = " == 0) {" + NL + "            \t";
  protected final String TEXT_174 = NL + "\t\t\t\tquery_";
  protected final String TEXT_175 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_182 = ".toString().trim());";
  ...
  protected final String TEXT_186 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_187 = " = true;";
  protected final String TEXT_188 = NL + "                        throw(e);";
  ...
  protected final String TEXT_197 = NL + "                            throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_198 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_210 = "_QUERY\", query_";
  protected final String TEXT_211 = ".toString().trim());";
  protected final String TEXT_212 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_213 = " = deletedCount_";
  protected final String TEXT_214 = " + pstmt_";
  protected final String TEXT_215 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_216 = " = true;";
  protected final String TEXT_217 = NL + "                    throw(e);";
  ...
  protected final String TEXT_224 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_225 = ";";
  protected final String TEXT_226 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_227 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_228 = "++;" + NL + "    \t";
  protected final String TEXT_229 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_237 = NL + "            commitCounter_";
  protected final String TEXT_238 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_239 = " <= commitCounter_";
  protected final String TEXT_240 = ") {" + NL + "            " + NL + "            \tconn_";
  protected final String TEXT_241 = ".commit();" + NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_242 = "=0;" + NL + "            " + NL + "            }\t" + NL + "    \t";
