...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_108 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_112 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_113 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_114 = ") || dbschema_";
  protected final String TEXT_115 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_116 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_117 = ".close();";
  protected final String TEXT_118 = "      " + NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_121 = " = dbMetaData_";
  protected final String TEXT_122 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_123 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_124 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_125 = " = rsTable_";
  protected final String TEXT_126 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_127 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_135 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_147 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_148 = ".execute(\"";
  protected final String TEXT_149 = ")\");" + NL + "                stmtCreate_";
  protected final String TEXT_150 = ".close();";
  protected final String TEXT_151 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_154 = ".executeUpdate(\"";
  protected final String TEXT_155 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_156 = ".close();";
  protected final String TEXT_157 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_160 = " = stmtTruncCount_";
  protected final String TEXT_161 = ".executeQuery(\"";
  protected final String TEXT_162 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_165 = ".executeUpdate(\"";
  protected final String TEXT_166 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_167 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_168 = " += rsTruncCount_";
  protected final String TEXT_169 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_170 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_171 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_172 = ".close();            ";
  protected final String TEXT_173 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_174 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_175 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_176 = NL + "        java.sql.Statement stmtBulkInsert_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".createStatement();" + NL + "        stmtBulkInsert_";
  protected final String TEXT_179 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_180 = " + \"] FROM '\" + ";
  protected final String TEXT_181 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_182 = " + \"',DATAFILETYPE='";
  protected final String TEXT_183 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_184 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_185 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_186 = "+\"')\");" + NL + "        stmtBulkInsert_";
  protected final String TEXT_187 = ".close();        ";
  protected final String TEXT_188 = NL + "            int keyCount_";
  protected final String TEXT_189 = " = ";
  protected final String TEXT_190 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_191 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_192 = " = tableName_";
  protected final String TEXT_193 = ";" + NL + "            tableName_";
  protected final String TEXT_194 = " = \"tmp_";
  protected final String TEXT_195 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".createStatement();" + NL + "            stmtCreateTmp_";
  protected final String TEXT_198 = ".execute(\"";
  protected final String TEXT_199 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_200 = ".close();" + NL + "            java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".createStatement();" + NL + "            stmtTmpBulk_";
  protected final String TEXT_203 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_204 = " + \"] FROM '\" + ";
  protected final String TEXT_205 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_206 = " + \"',DATAFILETYPE='";
  protected final String TEXT_207 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_208 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_209 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_210 = "+\"')\");" + NL + "            stmtTmpBulk_";
  protected final String TEXT_211 = ".close();" + NL + "            tableName_";
  protected final String TEXT_212 = " = tmpTableName_";
  protected final String TEXT_213 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_214 = " = \"tmp_";
  protected final String TEXT_215 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".createStatement();" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_218 = ".executeUpdate(\"";
  protected final String TEXT_219 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_220 = ".close();" + NL + "            tableName_";
  protected final String TEXT_221 = " = \"tmp_";
  protected final String TEXT_222 = "\" + \"_\" +pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_225 = ".execute(\"";
  protected final String TEXT_226 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_227 = ".close();";
  protected final String TEXT_228 = NL + "        if(conn_";
  protected final String TEXT_229 = " != null && !conn_";
  protected final String TEXT_230 = ".isClosed()) {" + NL + "            conn_";
