...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_85 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_86 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_87 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_88 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_89 = ", talendToDBArray_";
  protected final String TEXT_90 = "); ";
  protected final String TEXT_91 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_92 = " = (String)globalMap.get(\"";
  protected final String TEXT_93 = "\");";
  protected final String TEXT_94 = NL + "\t\t    String port_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_99 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_100 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_101 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_102 = " += \":\" + ";
  protected final String TEXT_103 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_104 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_105 = " += \"//\" + ";
  protected final String TEXT_106 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_107 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_108 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";";
  protected final String TEXT_111 = NL + "\t\t\t";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = " = mssqlGTU_";
  protected final String TEXT_114 = ".getDate(rsmd_";
  protected final String TEXT_115 = ", rs_";
  protected final String TEXT_116 = ", ";
  protected final String TEXT_117 = ");" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "            tmpContent_";
  protected final String TEXT_119 = " = rs_";
  protected final String TEXT_120 = ".getString(";
  protected final String TEXT_121 = ");" + NL + "            if(tmpContent_";
  protected final String TEXT_122 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_123 = " .contains(rsmd_";
  protected final String TEXT_124 = ".getColumnTypeName(";
  protected final String TEXT_125 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = " = FormatterUtils.formatUnwithE(Double.valueOf(tmpContent_";
  protected final String TEXT_128 = "));" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " = tmpContent_";
  protected final String TEXT_131 = ";" + NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_137 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_138 = " = null;";
  protected final String TEXT_139 = NL + "\t\t        conn_";
  protected final String TEXT_140 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_159 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_160 = "=1; i_";
  protected final String TEXT_161 = "<";
  protected final String TEXT_162 = "; i_";
  protected final String TEXT_163 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_164 = ".add(rsmd_";
  protected final String TEXT_165 = ".getColumnName(i_";
  protected final String TEXT_166 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_169 = "; i <= rsmd_";
  protected final String TEXT_170 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_171 = ".contains(rsmd_";
  protected final String TEXT_172 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_173 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_174 = ".setName(rsmd_";
  protected final String TEXT_175 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_176 = ".setDbName(rsmd_";
  protected final String TEXT_177 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_178 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_179 = "\", rsmd_";
  protected final String TEXT_180 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_181 = ".getPrecision(i), rsmd_";
  protected final String TEXT_182 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_183 = ".setDbType(rsmd_";
  protected final String TEXT_184 = ".getColumnTypeName(i));";
  protected final String TEXT_185 = NL + "                \tdcm_";
  protected final String TEXT_186 = ".setFormat(";
  protected final String TEXT_187 = ");";
  protected final String TEXT_188 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_189 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_190 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_191 = ".setLength(rsmd_";
  protected final String TEXT_192 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_193 = ".setLength(rsmd_";
  protected final String TEXT_194 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_195 = NL + "\t\t\tdcm_";
  protected final String TEXT_196 = ".setLength(rsmd_";
  protected final String TEXT_197 = ".getPrecision(i));";
  protected final String TEXT_198 = NL + "                \tdcm_";
  protected final String TEXT_199 = ".setPrecision(rsmd_";
  protected final String TEXT_200 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_201 = ".setNullable(rsmd_";
  protected final String TEXT_202 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_203 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_204 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_205 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_206 = ".metadatas.add(dcm_";
  protected final String TEXT_207 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_208 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_209 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_210 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_211 = "++;" + NL + "\t\t        ";
  protected final String TEXT_212 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_241 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = ", rs_";
  protected final String TEXT_244 = ", fixedColumnCount_";
  protected final String TEXT_245 = ");";
  protected final String TEXT_246 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_247 = ".getObject(";
  protected final String TEXT_248 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_249 = ".";
  protected final String TEXT_250 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_259 = NL + NL + NL + NL + NL;
