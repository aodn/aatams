...
public class TMSSqlSCDBeginJava {
  ...
  protected final String TEXT_12 = "\");" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_13 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_14 = "\");" + NL + "\t";
  protected final String TEXT_15 = NL + "    dbschema_";
  protected final String TEXT_16 = " = ";
  protected final String TEXT_17 = ";" + NL + "    java.lang.Class.forName(\"net.sourceforge.jtds.jdbc.Driver\");" + NL + "    String port_";
  protected final String TEXT_18 = " = ";
  protected final String TEXT_19 = ";" + NL + "    String dbname_";
  protected final String TEXT_20 = " = ";
  protected final String TEXT_21 = " ;" + NL + "    String url_";
  protected final String TEXT_22 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_23 = " ; " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_24 = ")) {" + NL + "    \turl_";
  protected final String TEXT_25 = " += \":\" + ";
  protected final String TEXT_26 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_27 = ")) {" + NL + "    \turl_";
  protected final String TEXT_28 = " += \"//\" + ";
  protected final String TEXT_29 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_30 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_40 = NL + NL + "    if(dbschema_";
  ...
  protected final String TEXT_47 = ";" + NL + "    }" + NL + "\t" + NL + "    java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_168 = NL + "            insertionStatement_";
  protected final String TEXT_169 = ".setTimestamp(";
  protected final String TEXT_170 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_171 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_172 = NL + "        String updateSQLForType1_";
  protected final String TEXT_173 = " = \"";
  protected final String TEXT_174 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_177 = ");        ";
  protected final String TEXT_178 = NL + "        String updateSQLForType2_";
  protected final String TEXT_179 = " = \"";
  protected final String TEXT_180 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_181 = " = conn_";
  protected final String TEXT_182 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "            updateForType2_";
  protected final String TEXT_185 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_186 = "\")));";
  protected final String TEXT_187 = NL + "        String updateSQLForType3_";
  protected final String TEXT_188 = " = \"";
  protected final String TEXT_189 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_192 = ");";
  protected final String TEXT_193 = NL + "    ";
  protected final String TEXT_194 = NL + "        SCDSK_";
  protected final String TEXT_195 = " lookUpKey_";
