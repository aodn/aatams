...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_604 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_605 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_606 = "=0;";
  protected final String TEXT_607 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_608 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_609 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_610 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_611 = "=0;";
...
if (useBatchSize && "mysql-connector-java-5.1.0-bin.jar".equals(dbVersion) && (("UPDATE").equals(dataAction)||("DELETE").equals(dataAction))) {
...
if(isDynamic) {
	...
	}else if ("mysql-connector-java-5.1.0-bin.jar".equals(dbVersion) && extendedInsert){			       
