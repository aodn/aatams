...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_159 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_160 = NL + "                \tint countSum_";
  protected final String TEXT_161 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_162 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_163 = " += (countEach_";
  protected final String TEXT_164 = " < 0 ? 0 : countEach_";
  protected final String TEXT_165 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_166 = NL + "            \t    insertedCount_";
  protected final String TEXT_167 = " += countSum_";
  protected final String TEXT_168 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_169 = " " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_170 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_171 = " = 0;    ";
  protected final String TEXT_172 = "    \t\t\t" + NL + "    \t\t";
  protected final String TEXT_173 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_174 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_175 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_176 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_177 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_178 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_179 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_180 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_181 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_182 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_183 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_184 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_185 = NL + "\t";
  protected final String TEXT_186 = "                " + NL + "    try {" + NL + "\t\t\tint countSum_";
  ...
  protected final String TEXT_191 = " < 0 ? 0 : countEach_";
  protected final String TEXT_192 = ");" + NL + "\t\t\t}       \t" + NL + "\t    \t";
  protected final String TEXT_193 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_194 = " += countSum_";
  protected final String TEXT_195 = "; " + NL + "\t    \t";
  protected final String TEXT_196 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_197 = " += countSum_";
  protected final String TEXT_198 = ";" + NL + "\t    \t";
  protected final String TEXT_199 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_200 = " += countSum_";
  protected final String TEXT_201 = ";" + NL + "\t    \t";
  protected final String TEXT_202 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_203 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_204 = NL + "    \tint countSum_";
  protected final String TEXT_205 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_206 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_207 = " += (countEach_";
  protected final String TEXT_208 = " < 0 ? 0 : countEach_";
  protected final String TEXT_209 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_210 = NL + "    \tinsertedCount_";
  protected final String TEXT_211 = " += countSum_";
  protected final String TEXT_212 = ";" + NL + "    \t";
  protected final String TEXT_213 = "            \t    \t\t" + NL + "    \tupdatedCount_";
  protected final String TEXT_214 = " += countSum_";
  protected final String TEXT_215 = ";" + NL + "    \t";
  protected final String TEXT_216 = NL + "    \tdeletedCount_";
  protected final String TEXT_217 = " += countSum_";
  protected final String TEXT_218 = ";" + NL + "    \t";
  protected final String TEXT_219 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_220 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_221 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_222 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_224 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_226 = ");   " + NL + "\t\t\t";
  protected final String TEXT_227 = "              " + NL + "        }        ";
  protected final String TEXT_228 = NL;
  protected final String TEXT_229 = NL + "    \t\tconn_";
  protected final String TEXT_230 = ".commit();" + NL + "    \t\t";
  protected final String TEXT_231 = "\t" + NL + "    \tconn_";
  protected final String TEXT_232 = " .close();" + NL + "    \t";
  protected final String TEXT_233 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_234 = "=nb_line_deleted_";
  protected final String TEXT_235 = "+ deletedCount_";
  protected final String TEXT_236 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_237 = "=nb_line_update_";
  protected final String TEXT_238 = " + updatedCount_";
  protected final String TEXT_239 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_240 = "=nb_line_inserted_";
  protected final String TEXT_241 = " + insertedCount_";
  protected final String TEXT_242 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_243 = "=nb_line_rejected_";
  protected final String TEXT_244 = " + rejectedCount_";
  ...
  protected final String TEXT_248 = "_NB_LINE_UPDATED\",nb_line_update_";
  ...
  protected final String TEXT_254 = "_NB_LINE_REJECTED\", nb_line_rejected_";
