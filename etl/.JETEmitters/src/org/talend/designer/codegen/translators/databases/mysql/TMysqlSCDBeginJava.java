...
public class TMysqlSCDBeginJava {
  ...
  protected final String TEXT_12 = NL + "        java.lang.Class.forName(\"org.gjt.mm.mysql.Driver\");";
  protected final String TEXT_13 = NL + "            String connectionString_";
  protected final String TEXT_14 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_15 = " + \":\" + ";
  protected final String TEXT_16 = " + \"/\" + ";
  protected final String TEXT_17 = ";";
  protected final String TEXT_18 = NL + "            String connectionString_";
  protected final String TEXT_19 = " = \"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_38 = ".getMetaData();";
  protected final String TEXT_39 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_40 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_41 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_42 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_43 = " = ((String)";
  protected final String TEXT_44 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_45 = " = schema_";
  protected final String TEXT_46 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_47 = " = dbMetaData_";
  protected final String TEXT_48 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_49 = ", (";
  protected final String TEXT_50 = ").toUpperCase(), new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_51 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_52 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_53 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_54 = ".close();" + NL + "\t            ";
  protected final String TEXT_55 = NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_56 = " = dbMetaData_";
  protected final String TEXT_57 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_58 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_59 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_60 = " = rsTable_";
  protected final String TEXT_61 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_62 = ".equalsIgnoreCase(";
  protected final String TEXT_63 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_64 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  protected final String TEXT_65 = "            " + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_72 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_73 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_74 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_75 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_76 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_77 = " = calendarYear0_";
  protected final String TEXT_78 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_79 = " = calendar_";
  protected final String TEXT_80 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_81 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_82 = " = calendar_";
  protected final String TEXT_83 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_84 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_85 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_86 = " = null;    ";
  protected final String TEXT_87 = NL + "        String searching_";
  protected final String TEXT_88 = " = \"";
  protected final String TEXT_89 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_90 = " = connection_";
  protected final String TEXT_91 = ".prepareStatement(searching_";
  protected final String TEXT_92 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_93 = " = null;";
  protected final String TEXT_94 = NL + "        String search_";
  protected final String TEXT_95 = " = \"";
  protected final String TEXT_96 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_97 = " = connection_";
  protected final String TEXT_98 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_99 = " = statement_";
  protected final String TEXT_100 = ".executeQuery(search_";
  protected final String TEXT_101 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_102 = ", SCDStruct_";
  protected final String TEXT_103 = "> cache_";
  protected final String TEXT_104 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_105 = ", SCDStruct_";
  protected final String TEXT_106 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_107 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_108 = " sk_";
  protected final String TEXT_109 = " = new SCDSK_";
  protected final String TEXT_110 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_111 = " row_";
  protected final String TEXT_112 = " = new SCDStruct_";
  ...
  protected final String TEXT_140 = NL + "                    dateStr_";
  protected final String TEXT_141 = " = resultSet_";
  protected final String TEXT_142 = ".getString(";
  protected final String TEXT_143 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_144 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_145 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_146 = ")) {";
  protected final String TEXT_147 = NL + "                            ";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = " = new java.util.Date(resultSet_";
  protected final String TEXT_150 = ".getTimestamp(";
  protected final String TEXT_151 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_152 = NL + "                            ";
  protected final String TEXT_153 = ".";
  protected final String TEXT_154 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_155 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_156 = NL + "                        ";
  protected final String TEXT_157 = ".";
  protected final String TEXT_158 = " = null;" + NL + "                    }";
  protected final String TEXT_159 = NL + "                    if(resultSet_";
  protected final String TEXT_160 = ".getObject(";
  protected final String TEXT_161 = ") != null) {";
  protected final String TEXT_162 = NL + "                        ";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = " = resultSet_";
  protected final String TEXT_165 = ".get";
  protected final String TEXT_166 = "(";
  protected final String TEXT_167 = ");" + NL + "                    }";
  protected final String TEXT_168 = NL + "            cache_";
  protected final String TEXT_169 = ".put(sk_";
  protected final String TEXT_170 = ", row_";
  protected final String TEXT_171 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_172 = ".close();" + NL + "        statement_";
  protected final String TEXT_173 = ".close();";
  protected final String TEXT_174 = NL + "            System.out.println(\"[";
  protected final String TEXT_175 = "] comparison cache loaded\");";
  protected final String TEXT_176 = NL + "        ";
  protected final String TEXT_177 = " nextSurrogateKey_";
  protected final String TEXT_178 = " = 1;";
  protected final String TEXT_179 = NL + "            if(cache_";
  protected final String TEXT_180 = ".size() > 0) {";
  protected final String TEXT_181 = NL + "        String tmpQuery_";
  protected final String TEXT_182 = " = \"SELECT MAX(`";
  protected final String TEXT_183 = "`) FROM `\" + tableName_";
  protected final String TEXT_184 = " + \"`\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_185 = " = connection_";
  protected final String TEXT_186 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_187 = " = tmpStmt_";
  protected final String TEXT_188 = ".executeQuery(tmpQuery_";
  protected final String TEXT_189 = ");";
  protected final String TEXT_190 = NL + "        if(tmpRS_";
  protected final String TEXT_191 = ".next() && tmpRS_";
  protected final String TEXT_192 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_193 = " = tmpRS_";
  protected final String TEXT_194 = ".get";
  protected final String TEXT_195 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_196 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_197 = ".close();";
  protected final String TEXT_198 = NL + "            }            ";
  protected final String TEXT_199 = NL + "    String insertionSQL_";
  protected final String TEXT_200 = " = \"";
  protected final String TEXT_201 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_202 = " = connection_";
  protected final String TEXT_203 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_204 = ");";
  protected final String TEXT_205 = NL + "            insertionStatement_";
  protected final String TEXT_206 = ".setTimestamp(";
  protected final String TEXT_207 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_208 = "\")));";
  protected final String TEXT_209 = NL + "            insertionStatement_";
  protected final String TEXT_210 = ".setNull(";
  protected final String TEXT_211 = ", java.sql.Types.DATE);";
  protected final String TEXT_212 = NL + "            insertionStatement_";
  protected final String TEXT_213 = ".setTimestamp(";
  protected final String TEXT_214 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_215 = " + \"-01-01 12:00:00\").getTime()));";
