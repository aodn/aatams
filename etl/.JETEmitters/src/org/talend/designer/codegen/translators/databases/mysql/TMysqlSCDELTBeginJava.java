...
public class TMysqlSCDELTBeginJava {
  ...
  protected final String TEXT_5 = NL + "        java.lang.Class.forName(\"org.gjt.mm.mysql.Driver\");" + NL + "        String dbProperties_";
  ...
  protected final String TEXT_11 = ".trim().length() == 0) {" + NL + "            url_";
  protected final String TEXT_12 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_13 = " + \":\" + ";
  protected final String TEXT_14 = " + \"/\" + ";
  protected final String TEXT_15 = ";" + NL + "        } else {" + NL + "            url_";
  ...
  protected final String TEXT_29 = NL + "    String tableName_";
  protected final String TEXT_30 = " = ";
  protected final String TEXT_31 = ";" + NL + "    String sourceTable_";
  protected final String TEXT_32 = " = ";
  protected final String TEXT_33 = ";";
  protected final String TEXT_34 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_35 = " = conn_";
  protected final String TEXT_36 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_37 = ".execute(\"";
  protected final String TEXT_38 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_39 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_51 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_52 = " = conn_";
  protected final String TEXT_53 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_54 = " = dbMetaData_";
  protected final String TEXT_55 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_56 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_57 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_58 = " = rsTable_";
  protected final String TEXT_59 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_60 = ".equalsIgnoreCase(";
  protected final String TEXT_61 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_62 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_63 = ".close();";
  protected final String TEXT_64 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_71 = NL + "                if(whetherExist_";
  protected final String TEXT_72 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_73 = " = conn_";
  protected final String TEXT_74 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_75 = ".execute(\"";
  protected final String TEXT_76 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_77 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_85 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_86 = ".executeUpdate(\"";
  protected final String TEXT_87 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_88 = ".close();";
  protected final String TEXT_89 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_90 = " = conn_";
  protected final String TEXT_91 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_92 = ".executeUpdate(\"";
  protected final String TEXT_93 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_94 = ".close();";
  protected final String TEXT_95 = NL + "        System.out.println(\"[";
  protected final String TEXT_96 = "] table action ";
  protected final String TEXT_97 = " done\\n\");";
  protected final String TEXT_98 = NL + "    ";
  protected final String TEXT_99 = NL + "        String updateForType1_";
  protected final String TEXT_100 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_101 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_102 = " + \"` t SET ";
  protected final String TEXT_103 = " WHERE ";
  ...
  protected final String TEXT_114 = "        " + NL + "        String changeDateTime_";
  protected final String TEXT_115 = " = (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_116 = "\"))).toString();" + NL + "        String updateForType2_";
  protected final String TEXT_117 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_118 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_119 = " + \"` t SET `";
  protected final String TEXT_120 = "` = '\" + (changeDateTime_";
  protected final String TEXT_121 = ") + \"'";
  protected final String TEXT_122 = ", `";
  protected final String TEXT_123 = "` = 0";
  protected final String TEXT_124 = " WHERE ";
  protected final String TEXT_125 = " AND (";
  protected final String TEXT_126 = ") AND d.`";
  protected final String TEXT_127 = "` IS NULL\"; " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_130 = ".executeUpdate(updateForType2_";
  protected final String TEXT_131 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_132 = ".close();";
  protected final String TEXT_133 = NL + "            System.out.println(\"[";
  protected final String TEXT_134 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_135 = " + \"\\ndone\");";
  protected final String TEXT_136 = NL + "        String insertForType2_";
  protected final String TEXT_137 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_138 = " + \"`(";
  protected final String TEXT_139 = ") SELECT t.";
  protected final String TEXT_140 = ", '\" + " + NL + "        (changeDateTime_";
  protected final String TEXT_141 = ") + \"', NULL";
  protected final String TEXT_142 = ", 1";
  protected final String TEXT_143 = ", d.`";
  protected final String TEXT_144 = "` + 1";
  protected final String TEXT_145 = " FROM `\" + " + NL + "        sourceTable_";
  protected final String TEXT_146 = " + \"` t, `\" + tableName_";
  protected final String TEXT_147 = " + \"` d WHERE ";
  protected final String TEXT_148 = " AND (";
  protected final String TEXT_149 = ") AND d.`";
  protected final String TEXT_150 = "` = '\" + (changeDateTime_";
  protected final String TEXT_151 = ") + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_154 = ".executeUpdate(insertForType2_";
  protected final String TEXT_155 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_156 = ".close();";
  protected final String TEXT_157 = NL + "            System.out.println(\"[";
  protected final String TEXT_158 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_159 = " + \"\\ndone\");";
  protected final String TEXT_160 = NL + "    String insert_";
  protected final String TEXT_161 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_162 = " + \"`(";
  protected final String TEXT_163 = ") SELECT t.";
  protected final String TEXT_164 = "\"";
  protected final String TEXT_165 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_166 = ") + \"', NULL\"";
  protected final String TEXT_167 = NL + "    + \"";
  protected final String TEXT_168 = ", 1";
  protected final String TEXT_169 = ", 1";
  protected final String TEXT_170 = " FROM `\" + " + NL + "    sourceTable_";
  protected final String TEXT_171 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_172 = " + \"` d ON ";
  protected final String TEXT_173 = " WHERE (";
  protected final String TEXT_174 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_177 = ".executeUpdate(insert_";
  protected final String TEXT_178 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_179 = ".close();";
  protected final String TEXT_180 = NL + "        System.out.println(\"[";
  protected final String TEXT_181 = "] new rows sql\\n\" + insert_";
...
if(columnList != null && columnList.size() > 0) {
    ...
    if(isEnableType1) {
        ...
        for(Map<String, String> type1Attribute : type1Attributes) {
            ...
            setColumns.add(" d." + StringUtils.getMysqlProtectedColumnName(type1Attribute.get("NAME")) + " = t." + StringUtils.getMysqlProtectedColumnName(type1Attribute.get("NAME")));
            whereClause.add(" d." + StringUtils.getMysqlProtectedColumnName(type1Attribute.get("NAME")) + " <> t." + StringUtils.getMysqlProtectedColumnName(type1Attribute.get("NAME")));            
        }
    ...
    if(isEnableType2) {
        ...
        for (Map<String, String> type2Attribute : type2Attributes) {
            whereClause.add(" d." + StringUtils.getMysqlProtectedColumnName(type2Attribute.get("NAME")) + " <> t." + StringUtils.getMysqlProtectedColumnName(type2Attribute.get("NAME")));
        }
        String whereClauseString = StringUtils.join(whereClause.toArray(), " OR ");
