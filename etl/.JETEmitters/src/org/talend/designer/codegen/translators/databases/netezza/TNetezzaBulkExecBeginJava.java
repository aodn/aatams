...
public class TNetezzaBulkExecBeginJava {
  ...
  protected final String TEXT_1 = "\tString bulkSQL_";
  protected final String TEXT_2 = "=\"\";";
  protected final String TEXT_3 = " " + NL + "\tbulkSQL_";
  protected final String TEXT_4 = " += \"INSERT INTO \" + ";
  protected final String TEXT_5 = " + \" \"  " + NL + "            + \" SELECT * FROM EXTERNAL '\"+ ";
  protected final String TEXT_6 = " + \"'\"" + NL + "            + \" USING (DELIM '\"+";
  protected final String TEXT_7 = "+\"' REMOTESOURCE 'JDBC' \"" + NL + "\t\t\t+ \" DATESTYLE '\"+";
  protected final String TEXT_8 = "+\"' DATEDELIM '\"+";
  protected final String TEXT_9 = "+\"' \"" + NL + "\t\t\t+ \" TIMESTYLE '";
  protected final String TEXT_10 = "' TIMEDELIM '\"+";
  protected final String TEXT_11 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_12 = NL + "\t\t\t+ \" ESCAPECHAR '\"+";
  protected final String TEXT_13 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_14 = NL + "\t\t\t+ \"\tMAXERRORS ";
  protected final String TEXT_15 = " SKIPROWS ";
  protected final String TEXT_16 = " LOGDIR '' ";
  protected final String TEXT_17 = ")\";" + NL + "" + NL + "java.lang.Class.forName(\"org.netezza.Driver\").newInstance();" + NL + "java.sql.Connection con_";
  protected final String TEXT_18 = " = java.sql.DriverManager.getConnection(\"jdbc:netezza://\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = " + \"/\" + ";
  protected final String TEXT_21 = ", ";
  protected final String TEXT_22 = ", ";
  protected final String TEXT_23 = ");" + NL + "" + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_24 = " = con_";
  protected final String TEXT_25 = ".createStatement();" + NL + "    stmtBulk_";
  protected final String TEXT_26 = ".execute(bulkSQL_";
  protected final String TEXT_27 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_28 = ".close();       " + NL + "\tcon_";
