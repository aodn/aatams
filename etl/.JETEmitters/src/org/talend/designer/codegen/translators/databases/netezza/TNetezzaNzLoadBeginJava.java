...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_12 = NL + "\t\tjava.lang.Class.forName(\"org.netezza.Driver\");" + NL + "\t\tString url_";
  ...
  protected final String TEXT_108 = NL + "\tfinal StringBuilder nzloadOutput_";
  protected final String TEXT_109 = " = new StringBuilder(200);" + NL + "\t//final " + NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_110 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_111 = " ";
  protected final String TEXT_112 = ",";
  protected final String TEXT_113 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tif((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_116 = ".append(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\t\t\t\t\tSystem.out.println(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_119 = ".append(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_122 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\t";
  protected final String TEXT_123 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_124 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_125 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_126 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_128 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_129 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_130 = NL + "\tnzloadThread_";
  protected final String TEXT_131 = ".start();" + NL + "\tnzloadThread_";
  protected final String TEXT_132 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_133 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_134 = ".toString());";
