...
public class TNetezzaNzLoadEndJava {
  ...
  protected final String TEXT_6 = NL + "\t\t\tnzloadThread_";
  protected final String TEXT_7 = ".join(0);" + NL + "\t\t\t//TODO: clean up named pipe" + NL + "\t\t\t";
  protected final String TEXT_8 = NL + "\t\t\tnzloadThread_";
  protected final String TEXT_9 = ".start();" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_10 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_11 = NL + "\t\t\t\t// added \"show log output\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_12 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t// System.out.println(\"reading log file :\" + ";
  protected final String TEXT_13 = " );" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t// Open the file and print contents " + NL + "\t\t\t\t\t\t\t java.io.FileInputStream fstream = new java.io.FileInputStream(";
  protected final String TEXT_14 = ");" + NL + "\t\t\t\t\t\t\t java.io.DataInputStream in = new java.io.DataInputStream(fstream);" + NL + "\t\t\t\t\t\t\t java.io.BufferedReader br = new java.io.BufferedReader(new java.io.InputStreamReader(in));" + NL + "\t\t\t\t\t\t\t String strLine;" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\twhile ((strLine = br.readLine()) != null)   {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println (strLine);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tin.close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcatch (Exception e) {" + NL + "\t\t\t\t\t\t\t// System.err.println(\"Error Reading Log File \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_15 = NL + "\t\t\t\t// end \"show log output\"" + NL + "\t\t\t\t";
