...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_40 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_41 = " + \":\" + ";
  protected final String TEXT_42 = " + \"/\" + ";
  protected final String TEXT_43 = ";" + NL + "\t    ";
  protected final String TEXT_44 = NL + "\t    String url_";
  protected final String TEXT_45 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_61 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_77 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_78 = " = false;" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_83 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_84 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_85 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_92 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_93 = " = conn_";
  protected final String TEXT_94 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_95 = ".execute(\"";
  protected final String TEXT_96 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_101 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_104 = " = stmtClearCount_";
  protected final String TEXT_105 = ".executeQuery(\"";
  protected final String TEXT_106 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_107 = " = conn_";
  protected final String TEXT_108 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_109 = ".executeUpdate(\"";
  protected final String TEXT_110 = "\");" + NL + "            while(rsClearCount_";
  protected final String TEXT_111 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_112 = " += rsClearCount_";
  protected final String TEXT_113 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_114 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_117 = " = deletedCount_";
  protected final String TEXT_118 = " + stmtClear_";
  protected final String TEXT_119 = ".executeUpdate(\"";
  protected final String TEXT_120 = "\");" + NL + "            stmtClear_";
  ...
  protected final String TEXT_124 = "      \t    " + NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_125 = " = conn_";
  protected final String TEXT_126 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_127 = "+\" (";
  protected final String TEXT_128 = ") VALUES (";
  protected final String TEXT_129 = ")\");\t        " + NL + "\t        ";
  protected final String TEXT_130 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_131 = " {" + NL + "    \t            ";
  protected final String TEXT_132 = NL + "                            ";
  protected final String TEXT_133 = " ";
  protected final String TEXT_134 = ";                ";
  protected final String TEXT_135 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_144 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_145 = "> exInsertColValueList";
  protected final String TEXT_146 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_147 = " exInsertColValue";
  protected final String TEXT_148 = " = null; " + NL + "\t            " + NL + "\t            ";
  protected final String TEXT_149 = NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_150 = " = " + NL + "\t                conn_";
  protected final String TEXT_151 = ".prepareStatement(\"INSERT INTO `\"+";
  protected final String TEXT_152 = "+\"` (";
  protected final String TEXT_153 = ") VALUES ";
  protected final String TEXT_154 = "\");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_155 = " = \"";
  protected final String TEXT_156 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_157 = " =  \"";
  protected final String TEXT_158 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_159 = " = 0;\t            " + NL + "\t    ";
  protected final String TEXT_160 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_163 = " + \" SET ";
  protected final String TEXT_164 = " WHERE ";
  protected final String TEXT_165 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_166 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_167 = " = conn_";
  protected final String TEXT_168 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_169 = " + \" WHERE ";
  protected final String TEXT_170 = "\");\t" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_173 = " + \" (";
  protected final String TEXT_174 = ") VALUES (";
  protected final String TEXT_175 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_178 = " + \" SET ";
  protected final String TEXT_179 = " WHERE ";
  protected final String TEXT_180 = "\");" + NL + "\t\t" + NL + "\t    ";
  protected final String TEXT_181 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_184 = " + \" SET ";
  protected final String TEXT_185 = " WHERE ";
  protected final String TEXT_186 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_189 = " + \" (";
  protected final String TEXT_190 = ") VALUES (";
  protected final String TEXT_191 = ")\");" + NL + "\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_192 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_195 = " + \" WHERE ";
  protected final String TEXT_196 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_197 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_198 = " = ";
  protected final String TEXT_199 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_200 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_201 = NL + "\t   int batchSize_";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = ";" + NL + "\t   int batchSizeCounter_";
...
if(columnList != null && columnList.size() > 0) {
    ...
    stringBuffer.append(extendInsertValueStmt.toString());
	...
	if (useBatchSize  && !extendedInsert) {
