...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_107 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_108 = " = buffersSize_";
  protected final String TEXT_109 = ";";
  protected final String TEXT_110 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_111 = " = buffersSize_";
  protected final String TEXT_112 = ";";
  protected final String TEXT_113 = NL + "\t\t";
  protected final String TEXT_114 = NL + "        whetherReject_";
  protected final String TEXT_115 = " = false;";
  protected final String TEXT_116 = "                " + NL + "                int counter";
  protected final String TEXT_117 = " = rowCount";
  protected final String TEXT_118 = " * ";
  protected final String TEXT_119 = " + 1;";
  protected final String TEXT_120 = NL + "                        counter";
  protected final String TEXT_121 = "++;";
  protected final String TEXT_122 = NL + "             " + NL + "                exInsertColValue";
  protected final String TEXT_123 = " = new BufferLine_";
  protected final String TEXT_124 = "(";
  protected final String TEXT_125 = NL + "                            ,";
  protected final String TEXT_126 = NL + "                        ";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = "              ";
  protected final String TEXT_129 = "  " + NL + "                ); " + NL + "               " + NL + "                exInsertColValueList";
  protected final String TEXT_130 = ".add(exInsertColValue";
  protected final String TEXT_131 = ");" + NL + "    " + NL + "                rowCount";
  protected final String TEXT_132 = "++;" + NL + "         " + NL + "                if(rowCount";
  protected final String TEXT_133 = " == ";
  protected final String TEXT_134 = "){ " + NL + "                    insertedCount_";
  protected final String TEXT_135 = " = insertedCount_";
  protected final String TEXT_136 = " + pstmt_";
  protected final String TEXT_137 = ".executeUpdate();" + NL + "                    exInsertColValueList";
  protected final String TEXT_138 = ".clear();" + NL + "                    rowCount";
  ...
  protected final String TEXT_144 = ".executeUpdate();" + NL + "                    pstmt_";
  protected final String TEXT_145 = ".addBatch();" + NL + "                    " + NL + "                    nb_line_";
  protected final String TEXT_146 = "++;" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_157 = NL + "                            rejectedCount_";
  protected final String TEXT_158 = " = rejectedCount_";
  protected final String TEXT_159 = " + 1;";
  protected final String TEXT_160 = NL + "                            ";
  protected final String TEXT_161 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_162 = ";";
  protected final String TEXT_163 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_176 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_177 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_178 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_179 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_180 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_181 = NL + "            try{" + NL + "                updatedCount_";
  protected final String TEXT_182 = " = updatedCount_";
  protected final String TEXT_183 = " + pstmt_";
  protected final String TEXT_184 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_185 = "++;" + NL + "            }catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  protected final String TEXT_186 = " = true;";
  protected final String TEXT_187 = NL + "                    throw(e);";
  ...
  protected final String TEXT_196 = NL + "                        rejectedCount_";
  protected final String TEXT_197 = " = rejectedCount_";
  protected final String TEXT_198 = " + 1;";
  ...
  protected final String TEXT_209 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_210 = " = pstmt_";
  protected final String TEXT_211 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_212 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_213 = ".next())" + NL + "    \t\t{" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_214 = " = rs_";
  protected final String TEXT_215 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_216 = " > 0)" + NL + "    \t\t{" + NL + "    \t\t\t";
  ...
  protected final String TEXT_226 = NL + "                try{" + NL + "                    updatedCount_";
  protected final String TEXT_227 = " = updatedCount_";
  protected final String TEXT_228 = " + pstmtUpdate_";
  protected final String TEXT_229 = ".executeUpdate();" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_240 = NL + "                            rejectedCount_";
  protected final String TEXT_241 = " = rejectedCount_";
  protected final String TEXT_242 = " + 1;";
  protected final String TEXT_243 = NL + "                            ";
  protected final String TEXT_244 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_245 = ";";
  protected final String TEXT_246 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_247 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\telse" + NL + "    \t\t{" + NL + "    \t\t\t";
  protected final String TEXT_248 = NL + "    \t\t\t\t    ";
  protected final String TEXT_249 = NL + "    \t\t\t\t    ";
  protected final String TEXT_250 = NL + "                try{" + NL + "                    insertedCount_";
  protected final String TEXT_251 = " = insertedCount_";
  protected final String TEXT_252 = " + pstmtInsert_";
  protected final String TEXT_253 = ".executeUpdate();" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_254 = " = true;";
  protected final String TEXT_255 = NL + "                        throw(e);";
  ...
  protected final String TEXT_264 = NL + "                            rejectedCount_";
  protected final String TEXT_265 = " = rejectedCount_";
  ...
  protected final String TEXT_271 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_272 = "++;" + NL + "    \t\t";
  protected final String TEXT_273 = NL + "    \t    int updateFlag_";
  protected final String TEXT_274 = "=0;" + NL + "    \t    ";
  protected final String TEXT_275 = NL + "    \t\t\t    ";
  protected final String TEXT_276 = NL + "    \t\t\t    ";
  protected final String TEXT_277 = NL + "\t\t\t\t\t";
  protected final String TEXT_278 = NL + "                    \t";
  protected final String TEXT_279 = NL + "\t                        query_";
  protected final String TEXT_280 = " = ";
  protected final String TEXT_281 = ";" + NL + "\t                        ";
  protected final String TEXT_282 = NL + "    \t\t\t    ";
  protected final String TEXT_283 = NL + "    \t\t\t    ";
  protected final String TEXT_284 = NL + "    \t" + NL + "            try{" + NL + "                updateFlag_";
  protected final String TEXT_285 = "=pstmtUpdate_";
  protected final String TEXT_286 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_287 = " = updatedCount_";
  protected final String TEXT_288 = "+updateFlag_";
  protected final String TEXT_289 = ";" + NL + "                " + NL + "            }catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  protected final String TEXT_290 = " = true;";
  protected final String TEXT_291 = NL + "                    throw(e);";
  protected final String TEXT_292 = NL + "                        ";
  protected final String TEXT_293 = " = new ";
  protected final String TEXT_294 = "Struct();";
  protected final String TEXT_295 = NL + "                            ";
  protected final String TEXT_296 = ".";
  protected final String TEXT_297 = " = ";
  protected final String TEXT_298 = ".";
  protected final String TEXT_299 = ";";
  protected final String TEXT_300 = NL + "                        rejectedCount_";
  protected final String TEXT_301 = " = rejectedCount_";
  protected final String TEXT_302 = " + 1;";
  protected final String TEXT_303 = NL + "                        ";
  protected final String TEXT_304 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_305 = ";";
  protected final String TEXT_306 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_307 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_308 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_309 = NL + "        \t\t\t    ";
  protected final String TEXT_310 = NL + "        \t\t\t    ";
  protected final String TEXT_311 = NL + "                try{" + NL + "                    insertedCount_";
  protected final String TEXT_312 = " = insertedCount_";
  protected final String TEXT_313 = " + pstmtInsert_";
  protected final String TEXT_314 = ".executeUpdate();" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_322 = NL + "                            rejectedCount_";
  protected final String TEXT_323 = " = rejectedCount_";
  protected final String TEXT_324 = " + 1;";
  protected final String TEXT_325 = NL + "                            ";
  protected final String TEXT_326 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_327 = ";";
  protected final String TEXT_328 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_329 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_330 = "++;";
  protected final String TEXT_331 = NL + "\t\t\t\t\t";
  protected final String TEXT_332 = NL + "                    \t";
  protected final String TEXT_333 = NL + "\t                        query_";
  protected final String TEXT_334 = " = ";
  protected final String TEXT_335 = ";" + NL + "\t                        ";
  protected final String TEXT_336 = NL + "    \t\t\t    ";
  protected final String TEXT_337 = NL + "    \t\t\t    ";
  protected final String TEXT_338 = NL + "    \t";
  protected final String TEXT_339 = NL + "    \t\tpstmt_";
  protected final String TEXT_340 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_341 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_342 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_343 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_344 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_345 = NL + "        try{" + NL + "    \t    deletedCount_";
  protected final String TEXT_346 = " = deletedCount_";
  protected final String TEXT_347 = " + pstmt_";
  protected final String TEXT_348 = ".executeUpdate();" + NL + "        }catch(Exception e)" + NL + "        {" + NL + "            whetherReject_";
  protected final String TEXT_349 = " = true;";
  protected final String TEXT_350 = NL + "                throw(e);";
  ...
  protected final String TEXT_359 = NL + "                    rejectedCount_";
  protected final String TEXT_360 = " = rejectedCount_";
  protected final String TEXT_361 = " + 1;";
  protected final String TEXT_362 = NL + "                    ";
  protected final String TEXT_363 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_364 = ";";
  protected final String TEXT_365 = NL + "                    System.err.print(e.getMessage());";
  protected final String TEXT_366 = NL + "        }" + NL + "        nb_line_";
  protected final String TEXT_367 = "++;" + NL + "\t\t\t";
  protected final String TEXT_368 = NL + "    \t";
  protected final String TEXT_369 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_380 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_381 = " <= batchSizeCounter_";
  protected final String TEXT_382 = ") {                ";
  protected final String TEXT_383 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_384 = ".executeBatch();                \t" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_385 = ".clearBatch();" + NL + "            \t    \t";
  protected final String TEXT_386 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_387 = " += pstmt_";
  protected final String TEXT_388 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_389 = NL + "            \t    \t\tupdatedCount_";
  ...
  protected final String TEXT_394 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_395 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_396 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_397 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_398 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_399 = NL + "                }";
  protected final String TEXT_400 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_401 = NL + "        \t    commitCounter_";
  protected final String TEXT_402 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_403 = " <= commitCounter_";
  protected final String TEXT_404 = "){" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_405 = NL + "                try {" + NL + "                \t\tpstmt_";
  protected final String TEXT_406 = ".executeBatch();" + NL + "                \t\tpstmt_";
  protected final String TEXT_407 = ".clearBatch();" + NL + "            \t    \t";
  protected final String TEXT_408 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_409 = " += pstmt_";
  protected final String TEXT_410 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_411 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_412 = " += pstmt_";
  protected final String TEXT_413 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_414 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_415 = " += pstmt_";
  protected final String TEXT_416 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_417 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_418 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_419 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_420 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_421 = NL + "                \tconn_";
  protected final String TEXT_422 = ".commit();" + NL + "                \tcommitCounter_";
  protected final String TEXT_423 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    " + NL + "    \t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_379);
		...
		if (useBatchSize &&(rejectConnName==null) && !extendedInsert) {
    		if(!("").equals(batchSize) && !("0").equals(batchSize)) {
