...
public class TNetezzaSCDBeginJava {
  ...
  protected final String TEXT_12 = NL + "        java.lang.Class.forName(\"org.netezza.Driver\");";
  protected final String TEXT_13 = NL + "            String connectionString_";
  protected final String TEXT_14 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_15 = " + \":\" + ";
  protected final String TEXT_16 = " + \"/\" + ";
  protected final String TEXT_17 = ";";
  protected final String TEXT_18 = NL + "            String connectionString_";
  protected final String TEXT_19 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_20 = " + \":\" + ";
  protected final String TEXT_21 = " + \"/\" + ";
  protected final String TEXT_22 = " + \"?\" + ";
  protected final String TEXT_23 = ";";
  protected final String TEXT_24 = NL + "        java.sql.Connection connection_";
  protected final String TEXT_25 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_26 = ", ";
  protected final String TEXT_27 = ", ";
  protected final String TEXT_28 = ");";
  protected final String TEXT_29 = NL + "    ";
  protected final String TEXT_30 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_31 = " = connection_";
  protected final String TEXT_32 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_33 = ".execute(\"";
  protected final String TEXT_34 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_35 = ".close();";
  protected final String TEXT_36 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_37 = " = connection_";
  protected final String TEXT_38 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_39 = " = dbMetaData_";
  protected final String TEXT_40 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_41 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_42 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_43 = " = rsTable_";
  protected final String TEXT_44 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_45 = ".equalsIgnoreCase(";
  protected final String TEXT_46 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_47 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            if(!whetherExist_";
  protected final String TEXT_48 = ") {" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_49 = " = connection_";
  protected final String TEXT_50 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_54 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_55 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_56 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_57 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_58 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_59 = " = calendarYear0_";
  protected final String TEXT_60 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_61 = " = calendar_";
  protected final String TEXT_62 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_63 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_64 = " = calendar_";
  protected final String TEXT_65 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_66 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_67 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_68 = " = null;    ";
  protected final String TEXT_69 = NL + "        String searching_";
  protected final String TEXT_70 = " = \"";
  protected final String TEXT_71 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_72 = " = connection_";
  protected final String TEXT_73 = ".prepareStatement(searching_";
  protected final String TEXT_74 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_75 = " = null;";
  protected final String TEXT_76 = NL + "        String search_";
  protected final String TEXT_77 = " = \"";
  protected final String TEXT_78 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_79 = " = connection_";
  protected final String TEXT_80 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_81 = " = statement_";
  protected final String TEXT_82 = ".executeQuery(search_";
  protected final String TEXT_83 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_84 = ", SCDStruct_";
  protected final String TEXT_85 = "> cache_";
  protected final String TEXT_86 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_87 = ", SCDStruct_";
  protected final String TEXT_88 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_89 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_90 = " sk_";
  protected final String TEXT_91 = " = new SCDSK_";
  protected final String TEXT_92 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_93 = " row_";
  protected final String TEXT_94 = " = new SCDStruct_";
  protected final String TEXT_95 = "();";
  protected final String TEXT_96 = NL + "                    tmpValue_";
  protected final String TEXT_97 = " = resultSet_";
  protected final String TEXT_98 = ".getString(";
  protected final String TEXT_99 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_100 = " != null && tmpValue_";
  protected final String TEXT_101 = ".length() > 0) {";
  protected final String TEXT_102 = NL + "                        ";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = " = tmpValue_";
  protected final String TEXT_105 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_106 = NL + "                            if(tmpValue_";
  protected final String TEXT_107 = " == null) {";
  protected final String TEXT_108 = NL + "                                ";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = " = null;" + NL + "                            } else {";
  protected final String TEXT_111 = NL + "                                ";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_114 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_115 = ")) {";
  protected final String TEXT_116 = NL + "                                ";
  protected final String TEXT_117 = ".";
  protected final String TEXT_118 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_119 = "' in '";
  protected final String TEXT_120 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_121 = NL + "                    }";
  protected final String TEXT_122 = NL + "                    dateStr_";
  protected final String TEXT_123 = " = resultSet_";
  protected final String TEXT_124 = ".getString(";
  protected final String TEXT_125 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_126 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_127 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_128 = ")) {";
  protected final String TEXT_129 = NL + "                            ";
  protected final String TEXT_130 = ".";
  protected final String TEXT_131 = " = new java.util.Date(resultSet_";
  protected final String TEXT_132 = ".getTimestamp(";
  protected final String TEXT_133 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_134 = NL + "                            ";
  protected final String TEXT_135 = ".";
  protected final String TEXT_136 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_137 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_138 = NL + "                        ";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " = null;" + NL + "                    }";
  protected final String TEXT_141 = NL + "                    if(resultSet_";
  protected final String TEXT_142 = ".getObject(";
  protected final String TEXT_143 = ") != null) {";
  protected final String TEXT_144 = NL + "                        ";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = " = resultSet_";
  protected final String TEXT_147 = ".get";
  protected final String TEXT_148 = "(";
  protected final String TEXT_149 = ");" + NL + "                    }";
  protected final String TEXT_150 = NL + "            cache_";
  protected final String TEXT_151 = ".put(sk_";
  protected final String TEXT_152 = ", row_";
  protected final String TEXT_153 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_154 = ".close();" + NL + "        statement_";
  protected final String TEXT_155 = ".close();";
  protected final String TEXT_156 = NL + "            System.out.println(\"[";
  protected final String TEXT_157 = "] comparison cache loaded\");";
  protected final String TEXT_158 = NL + "        ";
  protected final String TEXT_159 = " nextSurrogateKey_";
  protected final String TEXT_160 = " = 1;";
  protected final String TEXT_161 = NL + "            if(cache_";
  protected final String TEXT_162 = ".size() > 0) {";
  protected final String TEXT_163 = NL + "        String tmpQuery_";
  protected final String TEXT_164 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_165 = "\\\") FROM \" + tableName_";
  protected final String TEXT_166 = " + \"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_167 = " = connection_";
  protected final String TEXT_168 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_169 = " = tmpStmt_";
  protected final String TEXT_170 = ".executeQuery(tmpQuery_";
  protected final String TEXT_171 = ");";
  protected final String TEXT_172 = NL + "        if(tmpRS_";
  protected final String TEXT_173 = ".next() && tmpRS_";
  protected final String TEXT_174 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_175 = " = tmpRS_";
  protected final String TEXT_176 = ".get";
  protected final String TEXT_177 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_178 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_179 = ".close();";
  protected final String TEXT_180 = NL + "            }            ";
  protected final String TEXT_181 = NL + "    String insertionSQL_";
  protected final String TEXT_182 = " = \"";
  protected final String TEXT_183 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_184 = " = connection_";
  protected final String TEXT_185 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_186 = ");";
  protected final String TEXT_187 = NL + "            insertionStatement_";
  protected final String TEXT_188 = ".setTimestamp(";
  protected final String TEXT_189 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_190 = "\")));";
  protected final String TEXT_191 = NL + "            insertionStatement_";
  protected final String TEXT_192 = ".setNull(";
  protected final String TEXT_193 = ", java.sql.Types.DATE);";
  protected final String TEXT_194 = NL + "            insertionStatement_";
  protected final String TEXT_195 = ".setTimestamp(";
  protected final String TEXT_196 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_197 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_198 = NL + "        String updateSQLForType1_";
  protected final String TEXT_199 = " = \"";
  protected final String TEXT_200 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_201 = " = connection_";
  protected final String TEXT_202 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_203 = ");        ";
  protected final String TEXT_204 = NL + "        String updateSQLForType2_";
  protected final String TEXT_205 = " = \"";
  protected final String TEXT_206 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_207 = " = connection_";
  protected final String TEXT_208 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_209 = ");";
  protected final String TEXT_210 = NL + "            updateForType2_";
  protected final String TEXT_211 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_212 = "\")));";
  protected final String TEXT_213 = NL + "        String updateSQLForType3_";
  protected final String TEXT_214 = " = \"";
  protected final String TEXT_215 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_216 = " = connection_";
  protected final String TEXT_217 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL + "    ";
  protected final String TEXT_220 = NL + "        SCDSK_";
  protected final String TEXT_221 = " lookUpKey_";
  protected final String TEXT_222 = " = null;        ";
  protected final String TEXT_223 = NL + "    SCDStruct_";
  protected final String TEXT_224 = " lookUpValue_";
