...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_109 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_110 = "\",conn_";
  protected final String TEXT_111 = ".getMetaData().getUserName());";
  protected final String TEXT_112 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_113 = "\", ";
  protected final String TEXT_114 = ");";
  protected final String TEXT_115 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_116 = "\",";
  protected final String TEXT_117 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
