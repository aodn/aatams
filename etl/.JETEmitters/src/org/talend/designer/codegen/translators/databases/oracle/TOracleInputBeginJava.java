...
public class TOracleInputBeginJava
{
  ...
  protected final String TEXT_322 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_323 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_324 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_325 = ".setLength(rsmd_";
  protected final String TEXT_326 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_327 = ".setLength(rsmd_";
  protected final String TEXT_328 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_329 = NL + "\t\t\tdcm_";
  protected final String TEXT_330 = ".setLength(rsmd_";
  protected final String TEXT_331 = ".getPrecision(i));";
  protected final String TEXT_332 = NL + "                \tdcm_";
  protected final String TEXT_333 = ".setPrecision(rsmd_";
  protected final String TEXT_334 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_335 = ".setNullable(rsmd_";
  protected final String TEXT_336 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_337 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_338 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_339 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_340 = ".metadatas.add(dcm_";
  protected final String TEXT_341 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_342 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_343 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_344 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_345 = "++;" + NL + "\t\t        ";
  protected final String TEXT_346 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  protected final String TEXT_347 = " < ";
  protected final String TEXT_348 = ") { \t\t" + NL + "\t\t                        ";
  protected final String TEXT_349 = ".";
  protected final String TEXT_350 = " = ";
  protected final String TEXT_351 = "; \t\t\t" + NL + "\t\t                    } else {";
  protected final String TEXT_352 = NL + "\t\t                 \t\t\t";
  protected final String TEXT_353 = "\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t                            ";
  protected final String TEXT_356 = ".";
  protected final String TEXT_357 = " = (List)rs_";
  protected final String TEXT_358 = ".getObject(";
  protected final String TEXT_359 = ");";
  protected final String TEXT_360 = NL + "\t\t                         ";
  protected final String TEXT_361 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_362 = ".getObject(";
  protected final String TEXT_363 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_364 = NL + "                                    ";
  protected final String TEXT_365 = ".";
  protected final String TEXT_366 = " = new Geometry(wktValue);";
  protected final String TEXT_367 = NL + "                                        ";
  protected final String TEXT_368 = ".";
  protected final String TEXT_369 = ".setEPSG(";
  protected final String TEXT_370 = ");";
  protected final String TEXT_371 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_372 = NL + "                                  ";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = "=dcg_";
  ...
  protected final String TEXT_380 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_381 = ".getObject(";
  protected final String TEXT_382 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_393 = NL + NL + "\t" + NL + "\t" + NL;
