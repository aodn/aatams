...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_46 = NL + "\t\turl_";
  protected final String TEXT_47 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_48 = " + \":\" + ";
  protected final String TEXT_49 = " + \":\" + ";
  protected final String TEXT_50 = ";" + NL + "\t\t";
  protected final String TEXT_51 = NL + "\t\turl_";
  protected final String TEXT_52 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_53 = " + \")(port=\" + ";
  protected final String TEXT_54 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_55 = " + \")))\";" + NL + "\t\t";
  protected final String TEXT_56 = NL + "\t    url_";
  protected final String TEXT_57 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_58 = ";;" + NL + "\t    ";
  protected final String TEXT_59 = NL + "\t    url_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = ";" + NL + "\t    ";
  protected final String TEXT_62 = NL + "\tString dbUser_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "\tString dbPwd_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "    dbschema_";
  ...
  protected final String TEXT_71 = ");" + NL + "\t\tif(dbschema_";
  protected final String TEXT_72 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_73 = ")) //get schema from connection" + NL + "\t\t\t{" + NL + "\t\t\tdbschema_";
  protected final String TEXT_74 = "=conn_";
  protected final String TEXT_75 = ".getMetaData().getUserName();" + NL + "\t\t\t}" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_81 = NL + "\tString atnParams_";
  protected final String TEXT_82 = " = ";
  protected final String TEXT_83 = ";" + NL + "\tatnParams_";
  protected final String TEXT_84 = " = atnParams_";
  protected final String TEXT_85 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_86 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_87 = ".put(\"user\",dbUser_";
  protected final String TEXT_88 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_89 = ".put(\"password\",dbPwd_";
  protected final String TEXT_90 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_91 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_92 = ".getBytes()));" + NL + "\tconn_";
  ...
  protected final String TEXT_98 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";        " + NL + "        int commitCounter_";
  protected final String TEXT_101 = " = 0;        ";
  protected final String TEXT_102 = NL + "   int batchSize_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_105 = "=0;";
  protected final String TEXT_106 = " " + NL;
  protected final String TEXT_107 = NL + "int count_";
  protected final String TEXT_108 = "=0;";
  protected final String TEXT_109 = NL + NL + "if(dbschema_";
  protected final String TEXT_110 = " == null || dbschema_";
  protected final String TEXT_111 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_112 = " = ";
  protected final String TEXT_113 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_114 = " = dbschema_";
  protected final String TEXT_115 = " + \".\" + ";
  protected final String TEXT_116 = ";    " + NL + "}";
  protected final String TEXT_117 = NL + "  \ttableName_";
  protected final String TEXT_118 = " += \" \" +";
  protected final String TEXT_119 = ";";
  protected final String TEXT_120 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_121 = " = conn_";
  protected final String TEXT_122 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_130 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_170 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_171 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_178 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_181 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_182 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_183 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_184 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_185 = ")== null){";
  protected final String TEXT_186 = "              ";
  protected final String TEXT_187 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_190 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_191 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_192 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_193 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_194 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_219 = ".equalsIgnoreCase(";
  protected final String TEXT_220 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_221 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_242 = ".createStatement();";
  protected final String TEXT_243 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_244 = ".execute(\"";
  protected final String TEXT_245 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_260 = NL + "                    stmtCreate_";
  protected final String TEXT_261 = ".close();            " + NL + "                }                ";
  protected final String TEXT_262 = NL + "                if(whetherExist_";
  protected final String TEXT_263 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_270 = ".createStatement();";
  ...
  protected final String TEXT_290 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_291 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_292 = "            ";
  protected final String TEXT_293 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_294 = " = conn_";
  protected final String TEXT_295 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_304 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_307 = ".executeUpdate(\"";
  protected final String TEXT_308 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_309 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_310 = " += rsTruncCount_";
  protected final String TEXT_311 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_312 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_313 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_336 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_337 = " = new StringBuffer(insert_";
  protected final String TEXT_338 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_339 = ".insert(insert_";
  protected final String TEXT_340 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_341 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_342 = " =insertStringBuffer_";
  protected final String TEXT_343 = ".toString(); ";
  protected final String TEXT_344 = "    \t    " + NL + "\t    ";
  protected final String TEXT_345 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".prepareStatement(insert_";
  protected final String TEXT_348 = ");";
  protected final String TEXT_349 = NL + "                        ";
  protected final String TEXT_350 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_354 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_355 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_356 = ",insert_";
  protected final String TEXT_357 = ",keyPsmt_";
  ...
  protected final String TEXT_363 = " WHERE ";
  protected final String TEXT_364 = "\";" + NL + "    \t";
  protected final String TEXT_365 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_366 = " = new StringBuffer(update_";
  protected final String TEXT_367 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_368 = ".insert(update_";
  protected final String TEXT_369 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_370 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_371 = " =updateStringBuffer_";
  ...
  protected final String TEXT_375 = ".prepareStatement(update_";
  protected final String TEXT_376 = ");" + NL + "\t    ";
  protected final String TEXT_377 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_378 = " = conn_";
  protected final String TEXT_379 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_380 = " + \" WHERE ";
  protected final String TEXT_381 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_382 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_383 = " + \" (";
  protected final String TEXT_384 = ") VALUES (";
  ...
  protected final String TEXT_394 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_402 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_403 = " = new StringBuffer(update_";
  protected final String TEXT_404 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_405 = ".insert(update_";
  protected final String TEXT_406 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_407 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_408 = " =updateStringBuffer_";
  protected final String TEXT_409 = ".toString(); ";
  protected final String TEXT_410 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_411 = " = conn_";
  protected final String TEXT_412 = ".prepareStatement(update_";
  protected final String TEXT_413 = ");" + NL + "\t    ";
  protected final String TEXT_414 = NL + "\t    String update_";
  protected final String TEXT_415 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_416 = " + \" SET ";
  protected final String TEXT_417 = " WHERE ";
  protected final String TEXT_418 = "\";" + NL + "\t   \t";
  protected final String TEXT_419 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_420 = " = new StringBuffer(update_";
  protected final String TEXT_421 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_422 = ".insert(update_";
  protected final String TEXT_423 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_424 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_425 = " =updateStringBuffer_";
  protected final String TEXT_426 = ".toString(); ";
  protected final String TEXT_427 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_428 = " = conn_";
  protected final String TEXT_429 = ".prepareStatement(update_";
  ...
  protected final String TEXT_435 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_436 = " = new StringBuffer(insert_";
  protected final String TEXT_437 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_438 = ".insert(insert_";
  protected final String TEXT_439 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_440 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_441 = " =insertStringBuffer_";
  protected final String TEXT_442 = ".toString(); ";
  protected final String TEXT_443 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_444 = " = conn_";
  protected final String TEXT_445 = ".prepareStatement(insert_";
  protected final String TEXT_446 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_447 = NL + "\t    String delete_";
  protected final String TEXT_448 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_449 = " + \" WHERE ";
  protected final String TEXT_450 = "\";" + NL + "\t    ";
  protected final String TEXT_451 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_452 = " = new StringBuffer(delete_";
  protected final String TEXT_453 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_454 = ".insert(delete_";
  protected final String TEXT_455 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_456 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_457 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_461 = ".prepareStatement(delete_";
  protected final String TEXT_462 = ");" + NL + "\t    ";
  protected final String TEXT_463 = NL + "        StringBuffer query_";
  protected final String TEXT_464 = " = null;" + NL + "\t   ";
  protected final String TEXT_465 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_470 = " = update_";
  ...
  protected final String TEXT_475 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_476 = " = insert_";
  protected final String TEXT_477 = ".split(\"\\\\?\");";
  protected final String TEXT_478 = NL + "\t\t\tdelete_";
  protected final String TEXT_479 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_480 = " = delete_";
  protected final String TEXT_481 = ".split(\"\\\\?\");";
  protected final String TEXT_482 = NL + "\t\t\treplace_";
  protected final String TEXT_483 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_484 = " = replace_";
  protected final String TEXT_485 = ".split(\"\\\\?\");";
  protected final String TEXT_486 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_487 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_488 = " = insertIgnore_";
  protected final String TEXT_489 = ".split(\"\\\\?\");";
  protected final String TEXT_490 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_491 = " = insert_";
  protected final String TEXT_492 = ".split(\"\\\\?\");";
  protected final String TEXT_493 = NL + "\t   ";
  protected final String TEXT_494 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_495 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_496 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_497 = " = true;" + NL + "    \t";
  protected final String TEXT_498 = NL + "\tclass XMLTypeUtil_";
  protected final String TEXT_499 = " {" + NL + "\t\tpublic oracle.sql.CLOB getCLOB(String xmlData, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t  oracle.sql.CLOB tempClob = null;" + NL + "\t\t  try{" + NL + "\t\t    // If the temporary CLOB has not yet been created, create one" + NL + "\t\t    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION); " + NL + "\t\t " + NL + "\t\t    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t    tempClob.open(oracle.sql.CLOB.MODE_READWRITE); " + NL + "\t\t    // Get the output stream to write" + NL + "\t\t    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream(); " + NL + "\t\t    // Write the data into the temporary CLOB" + NL + "\t\t    tempClobWriter.write(xmlData); " + NL + "\t\t " + NL + "\t\t    // Flush and close the stream" + NL + "\t\t    tempClobWriter.flush();" + NL + "\t\t    tempClobWriter.close(); " + NL + "\t\t " + NL + "\t\t    // Close the temporary CLOB " + NL + "\t\t    tempClob.close();    " + NL + "\t\t  } catch( java.sql.SQLException sqlexp){" + NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    sqlexp.printStackTrace();" + NL + "\t\t  } catch(Exception exp){" + NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    exp.printStackTrace();" + NL + "\t\t  }" + NL + "\t\t  return tempClob; " + NL + "\t\t}" + NL + "\t}" + NL + "\tXMLTypeUtil_";
  protected final String TEXT_500 = " xmlTypeUtil_";
  protected final String TEXT_501 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_502 = " = new XMLTypeUtil_";
  protected final String TEXT_503 = "();";
  protected final String TEXT_504 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_505 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_506 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_507 = " =null;";
  protected final String TEXT_508 = NL + NL + NL + NL;
