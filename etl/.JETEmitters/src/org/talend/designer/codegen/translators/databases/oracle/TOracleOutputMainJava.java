...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_541 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_542 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_543 = " = true;";
  protected final String TEXT_544 = NL + "                    throw(e_";
  protected final String TEXT_545 = ");";
  protected final String TEXT_546 = NL + "                        ";
  protected final String TEXT_547 = " = new ";
  protected final String TEXT_548 = "Struct();";
  protected final String TEXT_549 = NL + "                            ";
  protected final String TEXT_550 = ".";
  protected final String TEXT_551 = " = ";
  protected final String TEXT_552 = ".";
  protected final String TEXT_553 = ";";
  protected final String TEXT_554 = NL + "                        rejectedCount_";
  protected final String TEXT_555 = " = rejectedCount_";
  protected final String TEXT_556 = " + 1;";
  protected final String TEXT_557 = NL + "                        ";
  protected final String TEXT_558 = ".errorMessage = e_";
  protected final String TEXT_559 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_560 = ";";
  protected final String TEXT_561 = NL + "                        System.err.print(e_";
  protected final String TEXT_562 = ".getMessage());";
  protected final String TEXT_563 = NL + "            }    \t\t" + NL + "    \t\t";
  protected final String TEXT_564 = NL + "                    ";
  protected final String TEXT_565 = NL + "                        query_";
  protected final String TEXT_566 = " = ";
  protected final String TEXT_567 = ";";
  protected final String TEXT_568 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_569 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_595 = NL + "             try {" + NL + "                updatedCount_";
  protected final String TEXT_596 = " = updatedCount_";
  protected final String TEXT_597 = " + pstmt_";
  protected final String TEXT_598 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_599 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_600 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_601 = " = true;";
  protected final String TEXT_602 = NL + "                    throw(e_";
  protected final String TEXT_603 = ");";
  protected final String TEXT_604 = NL + "                        ";
  protected final String TEXT_605 = " = new ";
  protected final String TEXT_606 = "Struct();";
  protected final String TEXT_607 = NL + "                            ";
  protected final String TEXT_608 = ".";
  protected final String TEXT_609 = " = ";
  protected final String TEXT_610 = ".";
  protected final String TEXT_611 = ";";
  protected final String TEXT_612 = NL + "                        rejectedCount_";
  protected final String TEXT_613 = " = rejectedCount_";
  protected final String TEXT_614 = " + 1;";
  protected final String TEXT_615 = NL + "                        ";
  protected final String TEXT_616 = ".errorMessage = e_";
  protected final String TEXT_617 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_618 = ";";
  protected final String TEXT_619 = NL + "                        System.err.print(e_";
  protected final String TEXT_620 = ".getMessage());";
  ...
  protected final String TEXT_627 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_628 = " = pstmt_";
  protected final String TEXT_629 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_630 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_631 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_632 = " = rs_";
  protected final String TEXT_633 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_634 = " > 0) {";
  ...
  protected final String TEXT_642 = ", pstmtUpdate_";
  ...
  protected final String TEXT_658 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_659 = " = updatedCount_";
  protected final String TEXT_660 = " + pstmtUpdate_";
  protected final String TEXT_661 = ".executeUpdate();" + NL + "                } catch(Exception e_";
  protected final String TEXT_662 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_663 = " = true;";
  protected final String TEXT_664 = NL + "                        throw(e_";
  protected final String TEXT_665 = ");";
  protected final String TEXT_666 = NL + "                            ";
  protected final String TEXT_667 = " = new ";
  protected final String TEXT_668 = "Struct();";
  protected final String TEXT_669 = NL + "                                ";
  protected final String TEXT_670 = ".";
  protected final String TEXT_671 = " = ";
  protected final String TEXT_672 = ".";
  protected final String TEXT_673 = ";";
  protected final String TEXT_674 = NL + "                            rejectedCount_";
  protected final String TEXT_675 = " = rejectedCount_";
  protected final String TEXT_676 = " + 1;";
  protected final String TEXT_677 = NL + "                            ";
  protected final String TEXT_678 = ".errorMessage = e_";
  protected final String TEXT_679 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_680 = ";";
  protected final String TEXT_681 = NL + "                            System.err.print(e_";
  protected final String TEXT_682 = ".getMessage());";
  protected final String TEXT_683 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_684 = NL + "                        ";
  protected final String TEXT_685 = NL + "                            query_";
  protected final String TEXT_686 = " = ";
  protected final String TEXT_687 = ";";
  protected final String TEXT_688 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_689 = ".";
  protected final String TEXT_690 = ", pstmtInsert_";
  protected final String TEXT_691 = ", ";
  protected final String TEXT_692 = ", \"";
  protected final String TEXT_693 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_694 = NL + "                    globalMap.put(\"";
  protected final String TEXT_695 = "_QUERY\", query_";
  protected final String TEXT_696 = ".toString().trim());";
  protected final String TEXT_697 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_698 = " = insertedCount_";
  protected final String TEXT_699 = " + pstmtInsert_";
  protected final String TEXT_700 = ".executeUpdate();" + NL + "                } catch(Exception e_";
  protected final String TEXT_701 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_702 = " = true;";
  protected final String TEXT_703 = NL + "                        throw(e_";
  protected final String TEXT_704 = ");";
  protected final String TEXT_705 = NL + "                            ";
  protected final String TEXT_706 = " = new ";
  protected final String TEXT_707 = "Struct();";
  protected final String TEXT_708 = NL + "                                ";
  protected final String TEXT_709 = ".";
  protected final String TEXT_710 = " = ";
  protected final String TEXT_711 = ".";
  protected final String TEXT_712 = ";";
  protected final String TEXT_713 = NL + "                            rejectedCount_";
  protected final String TEXT_714 = " = rejectedCount_";
  protected final String TEXT_715 = " + 1;";
  protected final String TEXT_716 = NL + "                            ";
  protected final String TEXT_717 = ".errorMessage = e_";
  protected final String TEXT_718 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_719 = ";";
  protected final String TEXT_720 = NL + "                            System.err.print(e_";
  protected final String TEXT_721 = ".getMessage());";
  protected final String TEXT_722 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_723 = "++;" + NL + "    \t\t";
  protected final String TEXT_724 = NL + "    \t    int updateFlag_";
  protected final String TEXT_725 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_726 = NL + "                    ";
  protected final String TEXT_727 = NL + "                        query_";
  protected final String TEXT_728 = " = ";
  protected final String TEXT_729 = ";";
  protected final String TEXT_730 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_731 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_732 = ".";
  protected final String TEXT_733 = ", pstmtUpdate_";
  ...
  protected final String TEXT_750 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_755 = ";" + NL + "            } catch(Exception e_";
  protected final String TEXT_756 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_757 = " = true;";
  ...
  protected final String TEXT_768 = NL + "                        rejectedCount_";
  protected final String TEXT_769 = " = rejectedCount_";
  protected final String TEXT_770 = " + 1;";
  protected final String TEXT_771 = NL + "                        ";
  protected final String TEXT_772 = ".errorMessage = e_";
  protected final String TEXT_773 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_774 = ";";
  protected final String TEXT_775 = NL + "                        System.err.print(e_";
  protected final String TEXT_776 = ".getMessage());";
  protected final String TEXT_777 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_778 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_779 = NL + "\t\t\t\tquery_";
  protected final String TEXT_780 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_781 = NL + "                        ";
  protected final String TEXT_782 = NL + "                            query_";
  protected final String TEXT_783 = " = ";
  protected final String TEXT_784 = ";";
  protected final String TEXT_785 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_791 = NL + "                    globalMap.put(\"";
  protected final String TEXT_792 = "_QUERY\", query_";
  protected final String TEXT_793 = ".toString().trim());";
  protected final String TEXT_794 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_795 = " = insertedCount_";
  protected final String TEXT_796 = " + pstmtInsert_";
  protected final String TEXT_797 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(Exception e_";
  protected final String TEXT_798 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_799 = " = true;";
  protected final String TEXT_800 = NL + "                        throw(e_";
  ...
  protected final String TEXT_814 = ".errorMessage = e_";
  protected final String TEXT_815 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_816 = ";";
  protected final String TEXT_817 = NL + "                            System.err.print(e_";
  protected final String TEXT_818 = ".getMessage());";
  protected final String TEXT_819 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_830 = NL + "                globalMap.put(\"";
  protected final String TEXT_831 = "_QUERY\", query_";
  protected final String TEXT_832 = ".toString().trim());";
  protected final String TEXT_833 = NL + "    \t\t";
  protected final String TEXT_834 = NL + "    \t\tpstmt_";
  protected final String TEXT_835 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_836 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_837 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_838 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_839 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_840 = " = deletedCount_";
  protected final String TEXT_841 = " + pstmt_";
  protected final String TEXT_842 = ".executeUpdate();" + NL + "            } catch(Exception e_";
  protected final String TEXT_843 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_844 = " = true;";
  protected final String TEXT_845 = NL + "                    throw(e_";
  ...
  protected final String TEXT_867 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_878 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_879 = " <= batchSizeCounter_";
  protected final String TEXT_880 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_881 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_882 = "){" + NL + "                \t";
  protected final String TEXT_883 = NL + "                \t\tthrow(e_";
  protected final String TEXT_884 = ");" + NL + "                \t";
  protected final String TEXT_885 = NL + "                \t\tSystem.err.println(e_";
  protected final String TEXT_886 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_887 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_888 = " = pstmt_";
  protected final String TEXT_889 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  protected final String TEXT_890 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_891 = NL + "        \t    \t";
  protected final String TEXT_892 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_893 = NL + "        \t    \t";
  protected final String TEXT_894 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_895 = NL + "        \t    \t";
  protected final String TEXT_896 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_897 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_898 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_899 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_900 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_901 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_902 = " <= commitCounter_";
  protected final String TEXT_903 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_904 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_905 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_906 = "){" + NL + "\t\t                \t";
  protected final String TEXT_907 = NL + "\t\t\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_908 = ");" + NL + "\t\t                \t";
  protected final String TEXT_909 = NL + "\t\t                        System.out.println(e_";
  protected final String TEXT_910 = ".getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_911 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_912 = " = pstmt_";
  protected final String TEXT_913 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_914 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_915 = NL + "\t\t    \t    \t";
  protected final String TEXT_916 = "            \t    \t\t" + NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_917 = NL + "\t\t    \t    \t";
  protected final String TEXT_918 = NL + "\t\t    \t    \t    deletedCount_";
  protected final String TEXT_919 = NL + "\t\t    \t    \t";
  protected final String TEXT_920 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_921 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_922 = ":0);" + NL + "\t                ";
  protected final String TEXT_923 = NL + "                \tconn_";
  protected final String TEXT_924 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_925 = "=0;" + NL + "                }\t";
