...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_7 = NL + "        String schema_";
  protected final String TEXT_8 = " = (String) globalMap.get(\"dbschema_";
  ...
  protected final String TEXT_13 = NL + "        \tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");\t";
  protected final String TEXT_14 = NL + "    \t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");\t" + NL + "    \t";
  ...
  protected final String TEXT_31 = NL + "        String schema_";
  protected final String TEXT_32 = " = ";
  protected final String TEXT_33 = ";";
  protected final String TEXT_34 = NL + "\t\tjava.sql.Connection connection_";
  protected final String TEXT_35 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_36 = ", ";
  protected final String TEXT_37 = ", ";
  protected final String TEXT_38 = ");";
  protected final String TEXT_39 = NL + "\t\tString atnParams_";
  protected final String TEXT_40 = " = ";
  protected final String TEXT_41 = ";" + NL + "\t\tatnParams_";
  protected final String TEXT_42 = " = atnParams_";
  protected final String TEXT_43 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_44 = " = new java.util.Properties();" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_45 = ".put(\"user\",";
  protected final String TEXT_46 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_47 = ".put(\"password\",";
  protected final String TEXT_48 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_49 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_50 = ".getBytes()));" + NL + "\t\tjava.sql.Connection connection_";
  protected final String TEXT_51 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_52 = ", atnParamsPrope_";
  protected final String TEXT_53 = ");";
  protected final String TEXT_54 = NL + "        ";
  protected final String TEXT_55 = NL + "    String tableName_";
  protected final String TEXT_56 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_57 = " == null || schema_";
  protected final String TEXT_58 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_61 = " = schema_";
  protected final String TEXT_62 = " + \".\" + ";
  protected final String TEXT_63 = ";" + NL + "    }" + NL + "    ";
  protected final String TEXT_64 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_65 = " = connection_";
  protected final String TEXT_66 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_67 = ".execute(\"";
  protected final String TEXT_68 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_69 = ".close();";
  protected final String TEXT_70 = NL + "\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_71 = " = connection_";
  protected final String TEXT_72 = ".getMetaData();";
  protected final String TEXT_73 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_74 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_75 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_76 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_77 = " = ((String)";
  protected final String TEXT_78 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_79 = " = schema_";
  protected final String TEXT_80 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_81 = " = dbMetaData_";
  protected final String TEXT_82 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_83 = ", (";
  protected final String TEXT_84 = ").toUpperCase(), new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_85 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_86 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_87 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_88 = ".close();" + NL + "\t            ";
  protected final String TEXT_89 = NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_90 = " = dbMetaData_";
  protected final String TEXT_91 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_92 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_93 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_94 = " = rsTable_";
  protected final String TEXT_95 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_96 = ".equalsIgnoreCase(";
  protected final String TEXT_97 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_98 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  protected final String TEXT_99 = "            " + NL + "            if(!whetherExist_";
  protected final String TEXT_100 = ") {" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_101 = " = connection_";
  protected final String TEXT_102 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_106 = NL + "    " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_107 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_108 = " = null;    ";
  protected final String TEXT_109 = NL + "        String searching_";
  protected final String TEXT_110 = " = \"";
  protected final String TEXT_111 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_112 = " = connection_";
  protected final String TEXT_113 = ".prepareStatement(searching_";
  protected final String TEXT_114 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_115 = " = null;";
  protected final String TEXT_116 = NL + "        String search_";
  protected final String TEXT_117 = " = \"";
  protected final String TEXT_118 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_119 = " = connection_";
  protected final String TEXT_120 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_121 = " = statement_";
  protected final String TEXT_122 = ".executeQuery(search_";
  protected final String TEXT_123 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_124 = ", SCDStruct_";
  protected final String TEXT_125 = "> cache_";
  protected final String TEXT_126 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_127 = ", SCDStruct_";
  protected final String TEXT_128 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_129 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_130 = " sk_";
  protected final String TEXT_131 = " = new SCDSK_";
  protected final String TEXT_132 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_133 = " row_";
  protected final String TEXT_134 = " = new SCDStruct_";
  protected final String TEXT_135 = "();";
  protected final String TEXT_136 = NL + "                    tmpValue_";
  protected final String TEXT_137 = " = resultSet_";
  protected final String TEXT_138 = ".getString(";
  protected final String TEXT_139 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_140 = " != null && tmpValue_";
  protected final String TEXT_141 = ".length() > 0) {";
  protected final String TEXT_142 = NL + "                        ";
  protected final String TEXT_143 = ".";
  protected final String TEXT_144 = " = tmpValue_";
  protected final String TEXT_145 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_146 = NL + "                            if(tmpValue_";
  protected final String TEXT_147 = " == null) {";
  protected final String TEXT_148 = NL + "                                ";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = " = null;" + NL + "                            } else {";
  protected final String TEXT_151 = NL + "                                ";
  protected final String TEXT_152 = ".";
  protected final String TEXT_153 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_154 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_155 = ")) {";
  protected final String TEXT_156 = NL + "                                ";
  protected final String TEXT_157 = ".";
  protected final String TEXT_158 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_159 = "' in '";
  protected final String TEXT_160 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_161 = NL + "                    }";
  protected final String TEXT_162 = NL + "                    timestamp_";
  protected final String TEXT_163 = " = resultSet_";
  protected final String TEXT_164 = ".getTimestamp(";
  protected final String TEXT_165 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_166 = " != null) {";
  protected final String TEXT_167 = NL + "                        ";
  protected final String TEXT_168 = ".";
  protected final String TEXT_169 = " = new java.util.Date(timestamp_";
  protected final String TEXT_170 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_171 = NL + "                        ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = " = null;" + NL + "                    }";
  protected final String TEXT_174 = NL + "                    if(resultSet_";
  protected final String TEXT_175 = ".getObject(";
  protected final String TEXT_176 = ") != null) {";
  protected final String TEXT_177 = NL + "                        ";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = " = resultSet_";
  protected final String TEXT_180 = ".get";
  protected final String TEXT_181 = "(";
  protected final String TEXT_182 = ");" + NL + "                    }";
  protected final String TEXT_183 = NL + "            cache_";
  protected final String TEXT_184 = ".put(sk_";
  protected final String TEXT_185 = ", row_";
  protected final String TEXT_186 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_187 = ".close();" + NL + "        statement_";
  protected final String TEXT_188 = ".close();";
  protected final String TEXT_189 = NL + "            System.out.println(\"[";
  protected final String TEXT_190 = "] comparison cache loaded\");";
  protected final String TEXT_191 = NL + "        ";
  protected final String TEXT_192 = " nextSurrogateKey_";
  protected final String TEXT_193 = " = 1;";
  protected final String TEXT_194 = NL + "            if(cache_";
  protected final String TEXT_195 = ".size() > 0) {";
  protected final String TEXT_196 = NL + "        String tmpQuery_";
  protected final String TEXT_197 = " = \"SELECT MAX(";
  protected final String TEXT_198 = ") FROM \" + tableName_";
  protected final String TEXT_199 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_200 = " = connection_";
  protected final String TEXT_201 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_202 = " = tmpStmt_";
  protected final String TEXT_203 = ".executeQuery(tmpQuery_";
  protected final String TEXT_204 = ");";
  protected final String TEXT_205 = NL + "        if(tmpRS_";
  protected final String TEXT_206 = ".next() && tmpRS_";
  protected final String TEXT_207 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_208 = " = tmpRS_";
  protected final String TEXT_209 = ".get";
  protected final String TEXT_210 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_211 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_212 = ".close();";
  protected final String TEXT_213 = NL + "            }            ";
  protected final String TEXT_214 = NL + "    String insertionSQL_";
  protected final String TEXT_215 = " = \"";
  protected final String TEXT_216 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_217 = " = connection_";
  protected final String TEXT_218 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "            insertionStatement_";
  protected final String TEXT_221 = ".setTimestamp(";
  protected final String TEXT_222 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_223 = "\")));";
  protected final String TEXT_224 = NL + "            insertionStatement_";
  protected final String TEXT_225 = ".setNull(";
  protected final String TEXT_226 = ", java.sql.Types.DATE);";
  protected final String TEXT_227 = NL + "            insertionStatement_";
  protected final String TEXT_228 = ".setTimestamp(";
  protected final String TEXT_229 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_230 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_231 = NL + "        String updateSQLForType1_";
  protected final String TEXT_232 = " = \"";
  protected final String TEXT_233 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_234 = " = connection_";
  protected final String TEXT_235 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_236 = ");        ";
  protected final String TEXT_237 = NL + "        String updateSQLForType2_";
  protected final String TEXT_238 = " = \"";
  protected final String TEXT_239 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_240 = " = connection_";
  protected final String TEXT_241 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "            updateForType2_";
  protected final String TEXT_244 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_245 = "\")));";
  protected final String TEXT_246 = NL + "        String updateSQLForType3_";
  protected final String TEXT_247 = " = \"";
  protected final String TEXT_248 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_249 = " = connection_";
  protected final String TEXT_250 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_251 = ");";
  protected final String TEXT_252 = NL + "    ";
  protected final String TEXT_253 = NL + "        SCDSK_";
  protected final String TEXT_254 = " lookUpKey_";
  protected final String TEXT_255 = " = null;        ";
  protected final String TEXT_256 = NL + "    SCDStruct_";
  protected final String TEXT_257 = " lookUpValue_";
