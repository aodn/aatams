...
public class TOracleSCDELTBeginJava {
  ...
  protected final String TEXT_14 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_15 = " + \":\" + ";
  protected final String TEXT_16 = " + \":\" + ";
  protected final String TEXT_17 = ";";
  protected final String TEXT_18 = NL + "            String url_";
  protected final String TEXT_19 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_20 = " + \")(port=\" + ";
  protected final String TEXT_21 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_22 = " + \")))\";";
  protected final String TEXT_23 = NL + "            String url_";
  protected final String TEXT_24 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_36 = NL + "\tString atnParams_";
  protected final String TEXT_37 = " = ";
  protected final String TEXT_38 = ";" + NL + "\tatnParams_";
  protected final String TEXT_39 = " = atnParams_";
  protected final String TEXT_40 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_41 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_42 = ".put(\"user\",dbUser_";
  protected final String TEXT_43 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_44 = ".put(\"password\",dbPwd_";
  protected final String TEXT_45 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_46 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_47 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_48 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_49 = ", atnParamsPrope_";
  protected final String TEXT_50 = ");";
  protected final String TEXT_51 = NL + "        " + NL + "        String schema_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";";
  protected final String TEXT_54 = NL + "    String tableName_";
  protected final String TEXT_55 = " = null;" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_59 = " = schema_";
  protected final String TEXT_60 = " + \".\" + ";
  protected final String TEXT_61 = ";" + NL + "        sourceTable_";
  protected final String TEXT_62 = " = schema_";
  protected final String TEXT_63 = " + \".\" + ";
  protected final String TEXT_64 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "        sourceTable_";
  ...
  protected final String TEXT_76 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_82 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_90 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_91 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_92 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_93 = " = rsTable_";
  protected final String TEXT_94 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_95 = ".equalsIgnoreCase(";
  protected final String TEXT_96 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_97 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_109 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_110 = ".execute(\"";
  protected final String TEXT_111 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_112 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_118 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_121 = ".executeUpdate(\"";
  protected final String TEXT_122 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_123 = ".close();";
  protected final String TEXT_124 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_125 = " = conn_";
  protected final String TEXT_126 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_127 = ".executeUpdate(\"";
  protected final String TEXT_128 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_129 = ".close();";
  protected final String TEXT_130 = NL + "        System.out.println(\"[";
  protected final String TEXT_131 = "] table action ";
  protected final String TEXT_132 = " done\\n\");";
  protected final String TEXT_133 = NL + "    java.util.Date currentDate_";
  protected final String TEXT_134 = " = new java.util.Date((Long)start_Hash.get(\"";
  protected final String TEXT_135 = "\"));" + NL + "    String dateString_";
  protected final String TEXT_136 = " = routines.system.FormatterUtils.format_Date(currentDate_";
  protected final String TEXT_137 = ", \"yyyy-MM-dd HH:mm:ss\");" + NL + "    String dateValue_";
  protected final String TEXT_138 = " = \"to_date('\" + dateString_";
  protected final String TEXT_139 = " + \"', 'yyyy-mm-dd HH24:MI:SS')\";    ";
  protected final String TEXT_140 = NL + "        String updateForType1_";
  protected final String TEXT_141 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_142 = " + \" d SET (";
  protected final String TEXT_143 = ") = (SELECT ";
  protected final String TEXT_144 = " FROM \" + sourceTable_";
  protected final String TEXT_145 = " + \" t WHERE ";
  protected final String TEXT_146 = " AND (";
  protected final String TEXT_147 = ")) WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_148 = " + \" t WHERE ";
  protected final String TEXT_149 = " AND (";
  protected final String TEXT_150 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_153 = ".executeUpdate(updateForType1_";
  protected final String TEXT_154 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_155 = ".close();";
  protected final String TEXT_156 = NL + "            System.out.println(\"[";
  protected final String TEXT_157 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_158 = " + \"\\ndone\");";
  protected final String TEXT_159 = NL + "        String updateForType2_";
  protected final String TEXT_160 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_161 = " + \" d SET ";
  protected final String TEXT_162 = " = \" + ";
  protected final String TEXT_163 = NL + "\t        \"(SELECT t.";
  protected final String TEXT_164 = " FROM \" + sourceTable_";
  protected final String TEXT_165 = " + " + NL + "\t        \" t WHERE ";
  protected final String TEXT_166 = ")\"";
  protected final String TEXT_167 = NL + "        \tdateValue_";
  protected final String TEXT_168 = " " + NL + "        + \"";
  protected final String TEXT_169 = ", ";
  protected final String TEXT_170 = " = 0";
  protected final String TEXT_171 = " WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_172 = " + " + NL + "        \" t WHERE ";
  protected final String TEXT_173 = " AND (";
  protected final String TEXT_174 = ")) AND d.";
  protected final String TEXT_175 = " \"" + NL + "        +";
  protected final String TEXT_176 = NL + "         \" IS NULL\";";
  protected final String TEXT_177 = NL + "         \"= to_date ('\" + ";
  protected final String TEXT_178 = " +\"-01-01', 'yyyy-mm-dd')\";";
  protected final String TEXT_179 = "        " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_182 = ".executeUpdate(updateForType2_";
  protected final String TEXT_183 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_184 = ".close();";
  protected final String TEXT_185 = NL + "            System.out.println(\"[";
  protected final String TEXT_186 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_187 = " + \"\\ndone\");";
  protected final String TEXT_188 = NL + "        String insertForType2_";
  protected final String TEXT_189 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_190 = " + \"(";
  protected final String TEXT_191 = ", ";
  protected final String TEXT_192 = ") SELECT ";
  protected final String TEXT_193 = "\" + ";
  protected final String TEXT_194 = " + \".NEXTVAL, ";
  protected final String TEXT_195 = "t.";
  protected final String TEXT_196 = ", \" " + NL + "        + ";
  protected final String TEXT_197 = NL + "        dateValue_";
  protected final String TEXT_198 = NL + "        \"t.";
  protected final String TEXT_199 = "\"  ";
  protected final String TEXT_200 = "                " + NL + "         + ";
  protected final String TEXT_201 = NL + "         \", NULL\"";
  protected final String TEXT_202 = NL + "         \", to_date('\"+";
  protected final String TEXT_203 = "+\"-01-01', 'yyyy-mm-dd')\" ";
  ...
  protected final String TEXT_214 = NL + "\t        \"(SELECT t.";
  protected final String TEXT_215 = " FROM \" + sourceTable_";
  protected final String TEXT_216 = " + " + NL + "\t        \" t WHERE ";
  protected final String TEXT_217 = ")\"";
  protected final String TEXT_218 = NL + "        \tdateValue_";
  protected final String TEXT_219 = " " + NL + "        ;  " + NL + "     \t" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_222 = ".executeUpdate(insertForType2_";
  protected final String TEXT_223 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_224 = ".close();";
  protected final String TEXT_225 = NL + "            System.out.println(\"[";
  protected final String TEXT_226 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_227 = " + \"\\ndone\");";
  protected final String TEXT_228 = NL + "    String insert_";
  protected final String TEXT_229 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_230 = " + \"(";
  protected final String TEXT_231 = ", ";
  protected final String TEXT_232 = ") SELECT ";
  protected final String TEXT_233 = "\" + ";
  protected final String TEXT_234 = " + \".NEXTVAL, ";
  protected final String TEXT_235 = "t.";
  protected final String TEXT_236 = "\"" + NL + "    ";
  protected final String TEXT_237 = " + \", \"" + NL + "    \t+\t " + NL + "    \t";
  protected final String TEXT_238 = NL + "    \t dateValue_";
  protected final String TEXT_239 = NL + "    \t";
  protected final String TEXT_240 = NL + "    \t\"t.";
  protected final String TEXT_241 = "\"" + NL + "    \t";
  protected final String TEXT_242 = NL + "    \t+" + NL + "    \t";
  protected final String TEXT_243 = NL + "    \t\t\", NULL\"\t" + NL + "    \t";
  protected final String TEXT_244 = NL + "    \t\t \", to_date('\"+";
  protected final String TEXT_245 = "+\"-01-01', 'yyyy-mm-dd')\"" + NL + "    \t";
  protected final String TEXT_246 = "     " + NL + "     ";
  protected final String TEXT_247 = NL + "    " + NL + "    + \"";
  protected final String TEXT_248 = ", 1";
  protected final String TEXT_249 = ", 1";
  protected final String TEXT_250 = " FROM \" +" + NL + "     " + NL + "    sourceTable_";
  protected final String TEXT_251 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_252 = " + \" d ON ";
  protected final String TEXT_253 = " WHERE (";
  protected final String TEXT_254 = ")\";" + NL + "    " + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_255 = " = conn_";
  protected final String TEXT_256 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_257 = ".executeUpdate(insert_";
  protected final String TEXT_258 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_259 = ".close();";
  protected final String TEXT_260 = NL + "        System.out.println(\"[";
  protected final String TEXT_261 = "] new rows sql\\n\" + insert_";
