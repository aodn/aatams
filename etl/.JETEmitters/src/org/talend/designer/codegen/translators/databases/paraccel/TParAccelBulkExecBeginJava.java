...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_10 = NL + "\tString xpxSQL_";
  protected final String TEXT_11 = "=\"\";" + NL + "\tString bulkSQL_";
  protected final String TEXT_12 = "=\"\";";
  protected final String TEXT_13 = NL + "\txpxSQL_";
  protected final String TEXT_14 = " += \"xpx 'localize \" + \"";
  protected final String TEXT_15 = " \" + ";
  protected final String TEXT_16 = " + \" ";
  protected final String TEXT_17 = "'\";" + NL + "\tbulkSQL_";
  protected final String TEXT_18 = " += \"COPY \" + \"";
  protected final String TEXT_19 = "\" + " + NL + "\t\t\" FROM 'local' WITH PARALLEL ";
  protected final String TEXT_20 = " \";";
  protected final String TEXT_21 = NL + "\tbulkSQL_";
  protected final String TEXT_22 = " += \"COPY \" + \"";
  protected final String TEXT_23 = "\" + \"";
  protected final String TEXT_24 = "FROM '\" +" + NL + "\t\t";
  protected final String TEXT_25 = " + \"' WITH ";
  protected final String TEXT_26 = " \";";
  protected final String TEXT_27 = NL + "\tbulkSQL_";
  protected final String TEXT_28 = " += \"DELIMITER '\" + ";
  protected final String TEXT_29 = " + \"' \";";
  protected final String TEXT_30 = NL + "\t\t\tbulkSQL_";
  protected final String TEXT_31 = " += \"FIXEDWIDTH '\" + ";
  protected final String TEXT_32 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_33 = NL + "\t\tbulkSQL_";
  protected final String TEXT_34 = " += \"FIXEDWIDTH '\";" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\t\t\t\tbulkSQL_";
  ...
  protected final String TEXT_43 = NL + "\t\tbulkSQL_";
  protected final String TEXT_44 = " += \"' \";";
  protected final String TEXT_45 = NL + "\tbulkSQL_";
  protected final String TEXT_46 = " += \"REMOVEQUOTES \";";
  protected final String TEXT_47 = NL + "\tbulkSQL_";
  protected final String TEXT_48 = " += \"EXPLICIT_IDS \";";
  protected final String TEXT_49 = NL + "\tbulkSQL_";
  protected final String TEXT_50 = " += \"MAXERROR \" + ";
  protected final String TEXT_51 = " + \" \";";
  protected final String TEXT_52 = NL + "\tbulkSQL_";
  protected final String TEXT_53 = " += \"DATEFORMAT '\" + ";
  protected final String TEXT_54 = " + \"' \";";
  protected final String TEXT_55 = NL + "\tbulkSQL_";
  protected final String TEXT_56 = " += \"TIMEFORMAT '\" + ";
  protected final String TEXT_57 = " + \"' \";";
  protected final String TEXT_58 = NL + "\tbulkSQL_";
  protected final String TEXT_59 = " += ";
  protected final String TEXT_60 = " + \" \";";
  protected final String TEXT_61 = " " + NL + "if (";
  protected final String TEXT_62 = " > 0) {" + NL + "\tjava.io.Writer output_";
  protected final String TEXT_63 = " = new java.io.FileWriter(";
  protected final String TEXT_64 = ", true);" + NL + "\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_65 = ",true));" + NL + "}\t" + NL + "com.paraccel.Driver.setLogLevel(";
  ...
  protected final String TEXT_69 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_70 = "\");" + NL + "\t ";
  protected final String TEXT_71 = NL + "\t\tjava.lang.Class.forName(\"com.paraccel.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_72 = " = java.sql.DriverManager.getConnection(\"jdbc:paraccel://\" + ";
  protected final String TEXT_73 = " + \":\" + ";
  protected final String TEXT_74 = " + \"/\" + ";
  protected final String TEXT_75 = "+\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_76 = "+\"&protocolVersion=3\", ";
  protected final String TEXT_77 = ", ";
  protected final String TEXT_78 = ");" + NL + "\t";
  protected final String TEXT_79 = NL;
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_82 = " = conn_";
  protected final String TEXT_83 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_84 = ".execute(\"";
  protected final String TEXT_85 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_86 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_87 = " = conn_";
  protected final String TEXT_88 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_106 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_107 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_108 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_109 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_119 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  ...
  protected final String TEXT_124 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_125 = ") || dbschema_";
  protected final String TEXT_126 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_131 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_132 = " = dbMetaData_";
  protected final String TEXT_133 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_134 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_135 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_136 = " = rsTable_";
  protected final String TEXT_137 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_138 = ".equalsIgnoreCase(";
  protected final String TEXT_139 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_140 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_158 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_162 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_165 = ".executeUpdate(\"";
  protected final String TEXT_166 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_167 = ".close();";
  protected final String TEXT_168 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_171 = " = stmtTruncCount_";
  protected final String TEXT_172 = ".executeQuery(\"";
  protected final String TEXT_173 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_176 = ".executeUpdate(\"";
  protected final String TEXT_177 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_178 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_179 = " += rsTruncCount_";
  protected final String TEXT_180 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_181 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_182 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_183 = ".close();            ";
  protected final String TEXT_184 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_185 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_186 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_187 = NL + "\t";
  protected final String TEXT_188 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_189 = " = conn_";
  protected final String TEXT_190 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_191 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_194 = ".execute(xpxSQL_";
  protected final String TEXT_195 = ");" + NL + "    stmtXPX_";
  protected final String TEXT_196 = ".close();    ";
  protected final String TEXT_197 = NL + "    stmtBulk_";
  protected final String TEXT_198 = ".execute(bulkSQL_";
  protected final String TEXT_199 = ");" + NL + "    stmtBulk_";
