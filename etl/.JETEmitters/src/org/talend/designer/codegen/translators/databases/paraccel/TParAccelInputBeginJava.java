...
public class TParAccelInputBeginJava
{
  ...
  protected final String TEXT_154 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_155 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_156 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_157 = ".setLength(rsmd_";
  protected final String TEXT_158 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_159 = ".setLength(rsmd_";
  protected final String TEXT_160 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_161 = NL + "\t\t\tdcm_";
  protected final String TEXT_162 = ".setLength(rsmd_";
  protected final String TEXT_163 = ".getPrecision(i));";
  protected final String TEXT_164 = NL + "                \tdcm_";
  protected final String TEXT_165 = ".setPrecision(rsmd_";
  protected final String TEXT_166 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_167 = ".setNullable(rsmd_";
  protected final String TEXT_168 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_169 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_170 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_171 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_172 = ".metadatas.add(dcm_";
  protected final String TEXT_173 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_174 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_175 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_176 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_177 = "++;" + NL + "\t\t        ";
  protected final String TEXT_178 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_189 = " = (List)rs_";
  protected final String TEXT_190 = ".getObject(";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "\t\t                         ";
  protected final String TEXT_193 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_194 = ".getObject(";
  protected final String TEXT_195 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_196 = NL + "                                    ";
  protected final String TEXT_197 = ".";
  protected final String TEXT_198 = " = new Geometry(wktValue);";
  protected final String TEXT_199 = NL + "                                        ";
  protected final String TEXT_200 = ".";
  protected final String TEXT_201 = ".setEPSG(";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_204 = NL + "                                  ";
  protected final String TEXT_205 = ".";
  protected final String TEXT_206 = "=dcg_";
  protected final String TEXT_207 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = ", rs_";
  protected final String TEXT_210 = ", fixedColumnCount_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_213 = ".getObject(";
  protected final String TEXT_214 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_215 = ".";
  protected final String TEXT_216 = " = new Geometry(sb.toString());";
