...
public class TParAccelOutputMainJava {
  ...
  protected final String TEXT_69 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_70 = " = pstmt_";
  protected final String TEXT_71 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_72 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_73 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_74 = " = rs_";
  protected final String TEXT_75 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_84 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_85 = " = updatedCount_";
  protected final String TEXT_86 = " + pstmtUpdate_";
  protected final String TEXT_87 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_88 = " = true;";
  protected final String TEXT_89 = NL + "                        throw(e);";
  ...
  protected final String TEXT_98 = NL + "                            rejectedCount_";
  protected final String TEXT_99 = " = rejectedCount_";
  ...
  protected final String TEXT_105 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_106 = NL + "                        ";
  protected final String TEXT_107 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_108 = " = insertedCount_";
  protected final String TEXT_109 = " + pstmtInsert_";
  protected final String TEXT_110 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_121 = NL + "                            rejectedCount_";
  protected final String TEXT_122 = " = rejectedCount_";
  protected final String TEXT_123 = " + 1;";
  ...
  protected final String TEXT_130 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_139 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_140 = "=pstmtUpdate_";
  protected final String TEXT_141 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_142 = " = updatedCount_";
  protected final String TEXT_143 = "+updateFlag_";
  protected final String TEXT_144 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_155 = NL + "                        rejectedCount_";
  protected final String TEXT_156 = " = rejectedCount_";
  protected final String TEXT_157 = " + 1;";
  protected final String TEXT_158 = NL + "                        ";
  protected final String TEXT_159 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_160 = ";";
  protected final String TEXT_161 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_162 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_163 = " == 0) {";
  protected final String TEXT_164 = NL + "                        ";
  protected final String TEXT_165 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_166 = " = insertedCount_";
  protected final String TEXT_167 = " + pstmtInsert_";
  protected final String TEXT_168 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_179 = NL + "                            rejectedCount_";
  protected final String TEXT_180 = " = rejectedCount_";
  ...
  protected final String TEXT_186 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_208 = NL + "                        rejectedCount_";
  protected final String TEXT_209 = " = rejectedCount_";
  protected final String TEXT_210 = " + 1;";
  ...
  protected final String TEXT_229 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_230 = "<=commitCounter_";
  protected final String TEXT_231 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_232 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_233 = "=0;" + NL + "        " + NL + "                }";
