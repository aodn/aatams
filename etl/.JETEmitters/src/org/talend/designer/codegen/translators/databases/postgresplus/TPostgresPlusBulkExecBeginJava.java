...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_17 = " + \"' WITH \";";
  protected final String TEXT_18 = NL + "    bulkSQL_";
  protected final String TEXT_19 = " += \"BINARY ";
  protected final String TEXT_20 = "\";";
  protected final String TEXT_21 = NL + "    bulkSQL_";
  protected final String TEXT_22 = " += \"";
  protected final String TEXT_23 = " \" + \"DELIMITER AS '\" + ";
  protected final String TEXT_24 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_25 = " += \"NULL AS '\" + ";
  protected final String TEXT_26 = " + \"' \";";
  protected final String TEXT_27 = NL + "        bulkSQL_";
  protected final String TEXT_28 = " += \"CSV ";
  protected final String TEXT_29 = " QUOTE AS '\" + ";
  protected final String TEXT_30 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";";
  protected final String TEXT_31 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_32 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_33 = " + \"' \";";
  protected final String TEXT_34 = NL + "        bulkSQL_";
  protected final String TEXT_35 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_36 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";        ";
  protected final String TEXT_37 = "            " + NL + "        bulkSQL_";
  ...
  protected final String TEXT_43 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_44 = "\");" + NL + "\t ";
  protected final String TEXT_45 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_46 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_54 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_63 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_64 = " = conn_";
  protected final String TEXT_65 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_75 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_76 = ", tableNameForSearch_";
  protected final String TEXT_77 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_78 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_79 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_80 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_90 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_91 = " = rsTable_";
  protected final String TEXT_92 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_93 = ".equalsIgnoreCase(";
  protected final String TEXT_94 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_95 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_96 = ") || dbschema_";
  protected final String TEXT_97 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_98 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_159 = NL + "        int keyCount_";
  protected final String TEXT_160 = " = ";
  protected final String TEXT_161 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_162 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        String tmpTableName_";
  protected final String TEXT_163 = " = tableName_";
  protected final String TEXT_164 = ";" + NL + "        tableName_";
  protected final String TEXT_165 = " = \"tmp_";
  protected final String TEXT_166 = "\" + \"_\" + pid;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_167 = " = conn_";
  protected final String TEXT_168 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_169 = ".execute(\"";
  protected final String TEXT_170 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_171 = ".close();";
  protected final String TEXT_172 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_173 = " =conn_";
  protected final String TEXT_174 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_175 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_176 = ".close();" + NL + "   \t\t";
  protected final String TEXT_177 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_180 = ".execute(bulkSQL_";
  protected final String TEXT_181 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_182 = ".close();" + NL + "        tableName_";
  protected final String TEXT_183 = " = tmpTableName_";
  protected final String TEXT_184 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_185 = " = \"tmp_";
  protected final String TEXT_186 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_189 = ".executeUpdate(\"";
  protected final String TEXT_190 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_191 = ".close();" + NL + "        tableName_";
  protected final String TEXT_192 = " = tmpTableName_";
  protected final String TEXT_193 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_196 = ".execute(\"";
  protected final String TEXT_197 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_198 = ".close();";
  protected final String TEXT_199 = NL + "\t    ";
  protected final String TEXT_200 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_201 = " =conn_";
  protected final String TEXT_202 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_203 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_204 = ".close();" + NL + "   \t\t";
  protected final String TEXT_205 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_208 = ".execute(bulkSQL_";
  protected final String TEXT_209 = ");" + NL + "    stmtBulk_";
