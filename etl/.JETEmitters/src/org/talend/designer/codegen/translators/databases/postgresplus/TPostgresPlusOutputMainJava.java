...
public class TPostgresPlusOutputMainJava {
  ...
  protected final String TEXT_179 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_180 = "=pstmtUpdate_";
  protected final String TEXT_181 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_182 = " = updatedCount_";
  protected final String TEXT_183 = "+updateFlag_";
  protected final String TEXT_184 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_195 = NL + "                        rejectedCount_";
  protected final String TEXT_196 = " = rejectedCount_";
  ...
  protected final String TEXT_202 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_203 = " == 0) {" + NL + "            \t";
  protected final String TEXT_204 = NL + "\t\t\t\tquery_";
  protected final String TEXT_205 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_206 = NL + "                        ";
  protected final String TEXT_207 = NL + "                            query_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ";";
  protected final String TEXT_210 = NL + "                    globalMap.put(\"";
  protected final String TEXT_211 = "_QUERY\", query_";
  protected final String TEXT_212 = ".toString().trim());";
  protected final String TEXT_213 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_214 = " = insertedCount_";
  protected final String TEXT_215 = " + pstmtInsert_";
  protected final String TEXT_216 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_217 = " = true;";
  protected final String TEXT_218 = NL + "                        throw(e);";
  ...
  protected final String TEXT_227 = NL + "                            rejectedCount_";
  protected final String TEXT_228 = " = rejectedCount_";
  protected final String TEXT_229 = " + 1;";
  protected final String TEXT_230 = NL + "                            ";
  protected final String TEXT_231 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_234 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_248 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_249 = " = deletedCount_";
  protected final String TEXT_250 = " + pstmt_";
  protected final String TEXT_251 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_262 = NL + "                        rejectedCount_";
  protected final String TEXT_263 = " = rejectedCount_";
  ...
  protected final String TEXT_269 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_270 = "++;";
  protected final String TEXT_271 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_282 = NL + "                commitCounter_";
  protected final String TEXT_283 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_284 = "<=commitCounter_";
  protected final String TEXT_285 = ") {" + NL + "                " + NL + "                    conn_";
  protected final String TEXT_286 = ".commit();" + NL + "                    " + NL + "                    commitCounter_";
  protected final String TEXT_287 = "=0;" + NL + "        " + NL + "                }";
