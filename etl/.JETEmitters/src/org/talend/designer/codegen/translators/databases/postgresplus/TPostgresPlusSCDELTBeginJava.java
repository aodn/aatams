...
public class TPostgresPlusSCDELTBeginJava {
  ...
  protected final String TEXT_92 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_93 = " = conn_";
  protected final String TEXT_94 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_95 = ".executeUpdate(\"";
  protected final String TEXT_96 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_97 = ".close();";
  protected final String TEXT_98 = NL + "        System.out.println(\"[";
  protected final String TEXT_99 = "] table action ";
  protected final String TEXT_100 = " done\\n\");";
  protected final String TEXT_101 = NL + "        String updateForType1_";
  protected final String TEXT_102 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_103 = " + \"\\\" d SET ";
  protected final String TEXT_104 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_105 = " + \"\\\" t WHERE ";
  protected final String TEXT_106 = " AND (";
  protected final String TEXT_107 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_110 = ".executeUpdate(updateForType1_";
  protected final String TEXT_111 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_112 = ".close();";
  protected final String TEXT_113 = NL + "            System.out.println(\"[";
  protected final String TEXT_114 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_115 = " + \"\\ndone\");";
  protected final String TEXT_116 = NL + "        String updateForType2_";
  protected final String TEXT_117 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_118 = " + \"\\\" d SET \\\"";
  protected final String TEXT_119 = "\\\" = '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_120 = "\"))) + \"'";
  protected final String TEXT_121 = ", \\\"";
  protected final String TEXT_122 = "\\\" = 0";
  protected final String TEXT_123 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_124 = " + \"\\\" t WHERE ";
  ...
  protected final String TEXT_141 = ") SELECT ";
  protected final String TEXT_142 = "NEXTVAL('\" + ";
  protected final String TEXT_143 = " + \"'), ";
  protected final String TEXT_144 = "t.";
  protected final String TEXT_145 = ", '\" + " + NL + "        (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_146 = "\"))) + \"', NULL";
  protected final String TEXT_147 = ", 1";
  protected final String TEXT_148 = ", d.\\\"";
  protected final String TEXT_149 = "\\\" + 1";
  protected final String TEXT_150 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_151 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_152 = " + \"\\\" d WHERE ";
  protected final String TEXT_153 = " AND (";
  protected final String TEXT_154 = ") AND d.\\\"";
  protected final String TEXT_155 = "\\\" = '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_156 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_159 = ".executeUpdate(insertForType2_";
  protected final String TEXT_160 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_161 = ".close();";
  protected final String TEXT_162 = NL + "            System.out.println(\"[";
  protected final String TEXT_163 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_164 = " + \"\\ndone\");";
  protected final String TEXT_165 = NL + "    String insert_";
  protected final String TEXT_166 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_167 = " + \"\\\"(";
  protected final String TEXT_168 = "\\\"";
  protected final String TEXT_169 = "\\\", ";
  protected final String TEXT_170 = ") SELECT ";
  protected final String TEXT_171 = "NEXTVAL('\" + ";
  protected final String TEXT_172 = " + \"'), ";
  protected final String TEXT_173 = "t.";
  protected final String TEXT_174 = "\"";
  protected final String TEXT_175 = " + \", '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_176 = "\"))) + \"', NULL\"";
  protected final String TEXT_177 = NL + "    + \"";
  protected final String TEXT_178 = ", 1";
  protected final String TEXT_179 = ", 1";
  protected final String TEXT_180 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_181 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_182 = " + \"\\\" d ON ";
  protected final String TEXT_183 = " WHERE (";
  protected final String TEXT_184 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_187 = ".executeUpdate(insert_";
  protected final String TEXT_188 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_189 = ".close();";
  protected final String TEXT_190 = NL + "        System.out.println(\"[";
  protected final String TEXT_191 = "] new rows sql\\n\" + insert_";
