...
public class TPostgresPlusSCDMainJava {
  ...
  protected final String TEXT_163 = NL + "    }" + NL + "    " + NL + "\t} catch (Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_176 = NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_177 = NL + "\t}//end catch" + NL + "    ";
  protected final String TEXT_178 = NL + "                lookUpValue_";
  ...
  protected final String TEXT_193 = NL + "        cache_";
  protected final String TEXT_194 = ".put(lookUpKey_";
  protected final String TEXT_195 = ", lookUpValue_";
