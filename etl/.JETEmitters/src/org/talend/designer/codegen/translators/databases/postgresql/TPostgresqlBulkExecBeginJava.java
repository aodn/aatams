...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_2 = " = null;" + NL + "int deletedCount_";
  protected final String TEXT_3 = "=0;";
  protected final String TEXT_4 = NL + "    tableName_";
  ...
  protected final String TEXT_11 = NL + "String bulkSQL_";
  protected final String TEXT_12 = " = \"COPY \" + \"";
  protected final String TEXT_13 = "\" ";
  protected final String TEXT_14 = "+ \"_\"+ pid + \"\\\"\"";
  protected final String TEXT_15 = NL + " +\"";
  protected final String TEXT_16 = "FROM '\" + ";
  protected final String TEXT_17 = " + \"' WITH \"; " + NL + " bulkSQL_";
  protected final String TEXT_18 = " = bulkSQL_";
  protected final String TEXT_19 = ".replace(\"\\\\\",\"/\");";
  protected final String TEXT_20 = NL + "    bulkSQL_";
  protected final String TEXT_21 = " += \"BINARY ";
  protected final String TEXT_22 = "\";";
  protected final String TEXT_23 = NL + "    bulkSQL_";
  protected final String TEXT_24 = " += \"";
  protected final String TEXT_25 = " \" + \"DELIMITER AS '\" + ";
  protected final String TEXT_26 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_27 = " += \"NULL AS '\" + ";
  protected final String TEXT_28 = " + \"' \";";
  protected final String TEXT_29 = NL + "        bulkSQL_";
  protected final String TEXT_30 = " += \"CSV ";
  protected final String TEXT_31 = " QUOTE AS '\" + ";
  protected final String TEXT_32 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";";
  protected final String TEXT_33 = NL + "        bulkSQL_";
  protected final String TEXT_34 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_35 = " + \"' \"; ";
  protected final String TEXT_36 = NL + "        bulkSQL_";
  protected final String TEXT_37 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_38 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";";
  protected final String TEXT_39 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_40 = " += \"";
  protected final String TEXT_41 = "\";";
  protected final String TEXT_42 = " " + NL + "java.sql.Connection conn_";
  protected final String TEXT_43 = " = null;" + NL + "\t";
  protected final String TEXT_44 = NL + "\t \tconn_";
  protected final String TEXT_45 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_46 = "\");" + NL + "\t ";
  protected final String TEXT_47 = NL + "\t\tjava.lang.Class.forName(\"org.postgresql.Driver\").newInstance();" + NL + "\t\tconn_";
  protected final String TEXT_48 = " = java.sql.DriverManager.getConnection(\"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_56 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_57 = " = conn_";
  protected final String TEXT_58 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_59 = ".execute(\"";
  protected final String TEXT_60 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_61 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_67 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_68 = " = conn_";
  protected final String TEXT_69 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_75 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_76 = " = conn_";
  protected final String TEXT_77 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_78 = " = dbMetaData_";
  protected final String TEXT_79 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_80 = ", tableNameForSearch_";
  protected final String TEXT_81 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_82 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_83 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_84 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_94 = ".getString(\"TABLE_NAME\");" + NL + "\t                String schema_";
  protected final String TEXT_95 = " = rsTable_";
  protected final String TEXT_96 = ".getString(\"TABLE_SCHEM\");" + NL + "\t                if(table_";
  protected final String TEXT_97 = ".equalsIgnoreCase(";
  protected final String TEXT_98 = ")" + NL + "\t                \t&& (schema_";
  protected final String TEXT_99 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_100 = ") || dbschema_";
  protected final String TEXT_101 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_102 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_106 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_107 = " = dbMetaData_";
  protected final String TEXT_108 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_109 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_110 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_111 = " = rsTable_";
  protected final String TEXT_112 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_113 = ".equalsIgnoreCase(";
  protected final String TEXT_114 = ")) {" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_143 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_146 = " = stmtTruncCount_";
  protected final String TEXT_147 = ".executeQuery(\"";
  protected final String TEXT_148 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_151 = ".executeUpdate(\"";
  protected final String TEXT_152 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_153 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_154 = " += rsTruncCount_";
  protected final String TEXT_155 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_156 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_157 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_158 = ".close();            ";
  protected final String TEXT_159 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_160 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_161 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_162 = NL + "\t";
  protected final String TEXT_163 = NL + "        int keyCount_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_166 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        String tmpTableName_";
  protected final String TEXT_167 = " = tableName_";
  protected final String TEXT_168 = ";" + NL + "        tableName_";
  protected final String TEXT_169 = " = \"tmp_";
  protected final String TEXT_170 = "\" + \"_\" + pid ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_173 = ".execute(\"";
  protected final String TEXT_174 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_175 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_176 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_177 = " =conn_";
  protected final String TEXT_178 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_179 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_180 = ".close();" + NL + "   \t\t";
  protected final String TEXT_181 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_184 = ".execute(bulkSQL_";
  protected final String TEXT_185 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_186 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_187 = " = tmpTableName_";
  protected final String TEXT_188 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_189 = " = \"tmp_";
  protected final String TEXT_190 = "\" + \"_\" + pid;" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  protected final String TEXT_193 = ".executeUpdate(\"";
  protected final String TEXT_194 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_195 = ".close();" + NL + "        tableName_";
  protected final String TEXT_196 = " = tmpTableName_";
  protected final String TEXT_197 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_200 = ".execute(\"";
  protected final String TEXT_201 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_202 = ".close();";
  protected final String TEXT_203 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_204 = " =conn_";
  protected final String TEXT_205 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_206 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_207 = ".close();";
  protected final String TEXT_208 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_211 = ".execute(bulkSQL_";
  protected final String TEXT_212 = ");" + NL + "    stmtBulk_";
