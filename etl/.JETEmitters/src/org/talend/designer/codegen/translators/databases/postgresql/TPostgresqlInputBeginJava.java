...
public class TPostgresqlInputBeginJava
{
  ...
  protected final String TEXT_86 = " = \"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_148 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_149 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_150 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_151 = ".setLength(rsmd_";
  protected final String TEXT_152 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_153 = ".setLength(rsmd_";
  protected final String TEXT_154 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_155 = NL + "\t\t\tdcm_";
  protected final String TEXT_156 = ".setLength(rsmd_";
  protected final String TEXT_157 = ".getPrecision(i));";
  protected final String TEXT_158 = NL + "                \tdcm_";
  protected final String TEXT_159 = ".setPrecision(rsmd_";
  protected final String TEXT_160 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_161 = ".setNullable(rsmd_";
  protected final String TEXT_162 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_163 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_164 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_165 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_166 = ".metadatas.add(dcm_";
  protected final String TEXT_167 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_168 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_169 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_170 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_171 = "++;" + NL + "\t\t        ";
  protected final String TEXT_172 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_183 = " = (List)rs_";
  protected final String TEXT_184 = ".getObject(";
  protected final String TEXT_185 = ");";
  protected final String TEXT_186 = NL + "\t\t                         ";
  protected final String TEXT_187 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_188 = ".getObject(";
  protected final String TEXT_189 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_190 = NL + "                                    ";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = new Geometry(wktValue);";
  protected final String TEXT_193 = NL + "                                        ";
  protected final String TEXT_194 = ".";
  protected final String TEXT_195 = ".setEPSG(";
  protected final String TEXT_196 = ");";
  protected final String TEXT_197 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_198 = NL + "                                  ";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = "=dcg_";
  protected final String TEXT_201 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_202 = ".";
  protected final String TEXT_203 = ", rs_";
  protected final String TEXT_204 = ", fixedColumnCount_";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_207 = ".getObject(";
  protected final String TEXT_208 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_209 = ".";
  protected final String TEXT_210 = " = new Geometry(sb.toString());";
