...
public class TPostgresqlOutputEndJava
{
  ...
  protected final String TEXT_47 = " = 0;" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_48 = " != null) {" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_49 = ": pstmt_";
  protected final String TEXT_50 = ".executeBatch()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_51 = " += (countEach_";
  protected final String TEXT_52 = " < 0 ? 0 : countEach_";
  protected final String TEXT_53 = ");" + NL + "\t\t\t\t\t}                \t" + NL + "\t\t\t\t}" + NL + "\t\t    \t";
  protected final String TEXT_54 = NL + "\t\t    \t\tinsertedCount_";
  protected final String TEXT_55 = " += countSum_";
  protected final String TEXT_56 = "; " + NL + "\t\t    \t";
  protected final String TEXT_57 = NL + "\t\t    \t\tupdatedCount_";
  protected final String TEXT_58 = " += countSum_";
  protected final String TEXT_59 = ";" + NL + "\t\t    \t";
  protected final String TEXT_60 = NL + "\t\t    \t    deletedCount_";
  protected final String TEXT_61 = " += countSum_";
  protected final String TEXT_62 = ";" + NL + "\t\t    \t";
  protected final String TEXT_63 = "            \t    " + NL + "\t    }catch (java.sql.BatchUpdateException e){" + NL + "\t    \t";
  protected final String TEXT_64 = NL + "\t    \t\tthrow(e);" + NL + "\t    \t";
  protected final String TEXT_65 = NL + "\t    \tint countSum_";
  protected final String TEXT_66 = " = 0;" + NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_67 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_68 = " += (countEach_";
  protected final String TEXT_69 = " < 0 ? 0 : countEach_";
  protected final String TEXT_70 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_71 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_72 = " += countSum_";
  protected final String TEXT_73 = "; " + NL + "\t    \t";
  protected final String TEXT_74 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_75 = " += countSum_";
  protected final String TEXT_76 = ";" + NL + "\t    \t";
  protected final String TEXT_77 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_78 = " += countSum_";
  protected final String TEXT_79 = ";" + NL + "\t    \t";
  protected final String TEXT_80 = NL + "\t    \tSystem.out.println(e.getMessage());" + NL + "\t    \t";
  protected final String TEXT_81 = "                \t" + NL + "\t\t}                                  " + NL + "\t    ";
  protected final String TEXT_82 = "   " + NL + "        if(pstmt_";
  ...
  protected final String TEXT_87 = ".commit();";
  protected final String TEXT_88 = "\t" + NL + "    \tconn_";
  protected final String TEXT_89 = " .close();" + NL + "    \t";
  protected final String TEXT_90 = NL + NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_94 = "=nb_line_update_";
  protected final String TEXT_95 = " + updatedCount_";
  protected final String TEXT_96 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_97 = "=nb_line_inserted_";
  protected final String TEXT_98 = " + insertedCount_";
  protected final String TEXT_99 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_100 = "=nb_line_rejected_";
  protected final String TEXT_101 = " + rejectedCount_";
  ...
  protected final String TEXT_105 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_106 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_107 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_108 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_109 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_110 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_111 = "_NB_LINE_REJECTED\",nb_line_rejected_";
