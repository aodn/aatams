...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_395 = NL + "                            geometryColumnName_";
  protected final String TEXT_396 = " = \"";
  protected final String TEXT_397 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_398 = ") {" + NL + "                                dimension_";
  protected final String TEXT_399 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_402 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_403 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_406 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_407 = " = refSys_";
  protected final String TEXT_408 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_409 = " = refSys_";
  protected final String TEXT_410 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_411 = " == null || ident_";
  protected final String TEXT_412 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_413 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_414 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_415 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_416 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_417 = " = Integer.parseInt(code_";
  protected final String TEXT_418 = ");" + NL + "                                            }" + NL + "                                        } catch (Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_419 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_420 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_421 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_422 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_423 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_424 = ".";
  protected final String TEXT_425 = ", pstmt_";
  protected final String TEXT_426 = ", ";
  protected final String TEXT_427 = ", \"";
  protected final String TEXT_428 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_429 = NL + "                globalMap.put(\"";
  protected final String TEXT_430 = "_QUERY\", query_";
  protected final String TEXT_431 = ".toString().trim());";
  protected final String TEXT_432 = NL + "\t\t\t";
  protected final String TEXT_433 = NL + "    \t\tpstmt_";
  protected final String TEXT_434 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_435 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_436 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_437 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_438 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_439 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_440 = " = insertedCount_";
  protected final String TEXT_441 = " + pstmt_";
  protected final String TEXT_442 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_443 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_444 = " = true;";
  protected final String TEXT_445 = NL + "                    throw(e);";
  protected final String TEXT_446 = NL + "                        ";
  protected final String TEXT_447 = " = new ";
  protected final String TEXT_448 = "Struct();";
  protected final String TEXT_449 = NL + "                            ";
  protected final String TEXT_450 = ".";
  protected final String TEXT_451 = " = ";
  protected final String TEXT_452 = ".";
  protected final String TEXT_453 = ";";
  protected final String TEXT_454 = NL + "                        rejectedCount_";
  protected final String TEXT_455 = " = rejectedCount_";
  protected final String TEXT_456 = " + 1;";
  protected final String TEXT_457 = NL + "                        ";
  protected final String TEXT_458 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_459 = ";";
  protected final String TEXT_460 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_466 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_467 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_481 = NL + "                        query_";
  protected final String TEXT_482 = " = ";
  protected final String TEXT_483 = ";";
  protected final String TEXT_484 = NL + "                globalMap.put(\"";
  protected final String TEXT_485 = "_QUERY\", query_";
  protected final String TEXT_486 = ".toString().trim());";
  protected final String TEXT_487 = NL + "    \t\tpstmt_";
  protected final String TEXT_488 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_489 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_490 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_491 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_492 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_493 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_494 = " = updatedCount_";
  protected final String TEXT_495 = " + pstmt_";
  protected final String TEXT_496 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_497 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_498 = " = true;";
  protected final String TEXT_499 = NL + "                    throw(e);";
  protected final String TEXT_500 = NL + "                        ";
  protected final String TEXT_501 = " = new ";
  protected final String TEXT_502 = "Struct();";
  protected final String TEXT_503 = NL + "                            ";
  protected final String TEXT_504 = ".";
  protected final String TEXT_505 = " = ";
  protected final String TEXT_506 = ".";
  protected final String TEXT_507 = ";";
  protected final String TEXT_508 = NL + "                        rejectedCount_";
  protected final String TEXT_509 = " = rejectedCount_";
  protected final String TEXT_510 = " + 1;";
  protected final String TEXT_511 = NL + "                        ";
  protected final String TEXT_512 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_513 = ";";
  protected final String TEXT_514 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_519 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_520 = " = pstmt_";
  protected final String TEXT_521 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_522 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_523 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_524 = " = rs_";
  protected final String TEXT_525 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_526 = " > 0) {";
  protected final String TEXT_527 = NL + "                        ";
  protected final String TEXT_528 = NL + "                            query_";
  protected final String TEXT_529 = " = ";
  protected final String TEXT_530 = ";";
  protected final String TEXT_531 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_532 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_533 = ".";
  protected final String TEXT_534 = ", pstmtUpdate_";
  protected final String TEXT_535 = ", ";
  protected final String TEXT_536 = ", \"";
  protected final String TEXT_537 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_538 = NL + "\t                    \t";
  protected final String TEXT_539 = NL + "\t                    ";
  protected final String TEXT_540 = NL + "\t                        query_";
  protected final String TEXT_541 = " = ";
  protected final String TEXT_542 = ";" + NL + "\t                        ";
  protected final String TEXT_543 = NL + "                        ";
  protected final String TEXT_544 = NL + "                            query_";
  ...
  protected final String TEXT_550 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_551 = " = updatedCount_";
  protected final String TEXT_552 = " + pstmtUpdate_";
  protected final String TEXT_553 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_554 = " = true;";
  protected final String TEXT_555 = NL + "                        throw(e);";
  protected final String TEXT_556 = NL + "                            ";
  protected final String TEXT_557 = " = new ";
  protected final String TEXT_558 = "Struct();";
  protected final String TEXT_559 = NL + "                                ";
  protected final String TEXT_560 = ".";
  protected final String TEXT_561 = " = ";
  protected final String TEXT_562 = ".";
  protected final String TEXT_563 = ";";
  protected final String TEXT_564 = NL + "                            rejectedCount_";
  protected final String TEXT_565 = " = rejectedCount_";
  protected final String TEXT_566 = " + 1;";
  protected final String TEXT_567 = NL + "                            ";
  protected final String TEXT_568 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_569 = ";";
  protected final String TEXT_570 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_571 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_572 = NL + "                        ";
  protected final String TEXT_573 = NL + "                            query_";
  protected final String TEXT_574 = " = ";
  protected final String TEXT_575 = ";";
  protected final String TEXT_576 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_577 = ".";
  protected final String TEXT_578 = ", pstmtInsert_";
  protected final String TEXT_579 = ", ";
  protected final String TEXT_580 = ", \"";
  protected final String TEXT_581 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_582 = NL + "                    globalMap.put(\"";
  protected final String TEXT_583 = "_QUERY\", query_";
  protected final String TEXT_584 = ".toString().trim());";
  protected final String TEXT_585 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_586 = " = insertedCount_";
  protected final String TEXT_587 = " + pstmtInsert_";
  protected final String TEXT_588 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_631 = NL + "                globalMap.put(\"";
  protected final String TEXT_632 = "_QUERY\", query_";
  protected final String TEXT_633 = ".toString().trim());";
  protected final String TEXT_634 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_635 = "=pstmtUpdate_";
  protected final String TEXT_636 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_637 = " = updatedCount_";
  protected final String TEXT_638 = "+updateFlag_";
  protected final String TEXT_639 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_640 = " = true;";
  protected final String TEXT_641 = NL + "                    throw(e);";
  protected final String TEXT_642 = NL + "                        ";
  protected final String TEXT_643 = " = new ";
  protected final String TEXT_644 = "Struct();";
  protected final String TEXT_645 = NL + "                            ";
  protected final String TEXT_646 = ".";
  protected final String TEXT_647 = " = ";
  protected final String TEXT_648 = ".";
  protected final String TEXT_649 = ";";
  protected final String TEXT_650 = NL + "                        rejectedCount_";
  protected final String TEXT_651 = " = rejectedCount_";
  protected final String TEXT_652 = " + 1;";
  protected final String TEXT_653 = NL + "                        ";
  protected final String TEXT_654 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_655 = ";";
  protected final String TEXT_656 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_657 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_658 = " == 0) {" + NL + "            \t";
  protected final String TEXT_659 = NL + "\t\t\t\tquery_";
  protected final String TEXT_660 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_661 = NL + "                        ";
  protected final String TEXT_662 = NL + "                            query_";
  protected final String TEXT_663 = " = ";
  protected final String TEXT_664 = ";";
  protected final String TEXT_665 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_666 = ".";
  protected final String TEXT_667 = ", pstmtInsert_";
  protected final String TEXT_668 = ", ";
  protected final String TEXT_669 = ", \"";
  protected final String TEXT_670 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_671 = NL + "                    globalMap.put(\"";
  protected final String TEXT_672 = "_QUERY\", query_";
  protected final String TEXT_673 = ".toString().trim());";
  protected final String TEXT_674 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_675 = " = insertedCount_";
  protected final String TEXT_676 = " + pstmtInsert_";
  protected final String TEXT_677 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_678 = " = true;";
  protected final String TEXT_679 = NL + "                        throw(e);";
  protected final String TEXT_680 = NL + "                            ";
  protected final String TEXT_681 = " = new ";
  protected final String TEXT_682 = "Struct();";
  protected final String TEXT_683 = NL + "                                ";
  protected final String TEXT_684 = ".";
  protected final String TEXT_685 = " = ";
  protected final String TEXT_686 = ".";
  protected final String TEXT_687 = ";";
  protected final String TEXT_688 = NL + "                            rejectedCount_";
  protected final String TEXT_689 = " = rejectedCount_";
  protected final String TEXT_690 = " + 1;";
  protected final String TEXT_691 = NL + "                            ";
  protected final String TEXT_692 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_693 = ";";
  protected final String TEXT_694 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_695 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_703 = NL + "                        query_";
  protected final String TEXT_704 = " = ";
  protected final String TEXT_705 = ";";
  protected final String TEXT_706 = NL + "                globalMap.put(\"";
  protected final String TEXT_707 = "_QUERY\", query_";
  protected final String TEXT_708 = ".toString().trim());";
  protected final String TEXT_709 = NL + "    \t\tpstmt_";
  protected final String TEXT_710 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_711 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_712 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_713 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_714 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_715 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_716 = " = deletedCount_";
  protected final String TEXT_717 = " + pstmt_";
  protected final String TEXT_718 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_719 = " = true;";
  protected final String TEXT_720 = NL + "                    throw(e);";
  protected final String TEXT_721 = NL + "                        ";
  protected final String TEXT_722 = " = new ";
  protected final String TEXT_723 = "Struct();";
  protected final String TEXT_724 = NL + "                            ";
  protected final String TEXT_725 = ".";
  protected final String TEXT_726 = " = ";
  protected final String TEXT_727 = ".";
  protected final String TEXT_728 = ";";
  protected final String TEXT_729 = NL + "                        rejectedCount_";
  protected final String TEXT_730 = " = rejectedCount_";
  protected final String TEXT_731 = " + 1;";
  protected final String TEXT_732 = NL + "                        ";
  protected final String TEXT_733 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_734 = ";";
  protected final String TEXT_735 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_736 = NL + "            }";
  protected final String TEXT_737 = NL + "            nb_line_";
  protected final String TEXT_738 = "++;";
  protected final String TEXT_739 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_750 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_751 = " <= batchSizeCounter_";
  protected final String TEXT_752 = ") {                ";
  protected final String TEXT_753 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_754 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_755 = ": pstmt_";
  protected final String TEXT_756 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_757 = " += (countEach_";
  protected final String TEXT_758 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_763 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_764 = " += countSum_";
  protected final String TEXT_765 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_766 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_767 = " += countSum_";
  protected final String TEXT_768 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_769 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_770 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_771 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_772 = NL + "                \tint countSum_";
  protected final String TEXT_773 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_774 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_775 = " += (countEach_";
  protected final String TEXT_776 = " < 0 ? 0 : countEach_";
  protected final String TEXT_777 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_778 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_779 = " += countSum_";
  protected final String TEXT_780 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_781 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_782 = " += countSum_";
  protected final String TEXT_783 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_784 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_785 = " += countSum_";
  protected final String TEXT_786 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_787 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_788 = NL + "                }";
  protected final String TEXT_789 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_790 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_791 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_792 = " <= commitCounter_";
  protected final String TEXT_793 = ") {" + NL + "                ";
  protected final String TEXT_794 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_795 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_796 = ": pstmt_";
  protected final String TEXT_797 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_798 = " += (countEach_";
  protected final String TEXT_799 = " < 0 ? 0 : countEach_";
  protected final String TEXT_800 = ");" + NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_801 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_802 = " += countSum_";
  protected final String TEXT_803 = ";" + NL + "            \t    \t";
  protected final String TEXT_804 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_805 = " += countSum_";
  protected final String TEXT_806 = ";" + NL + "            \t    \t";
  protected final String TEXT_807 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_808 = " += countSum_";
  protected final String TEXT_809 = ";" + NL + "            \t    \t";
  protected final String TEXT_810 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_811 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_812 = NL + "                \t\tint countSum_";
  protected final String TEXT_813 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_814 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_815 = " += (countEach_";
  protected final String TEXT_816 = " < 0 ? 0 : countEach_";
  protected final String TEXT_817 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_818 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_819 = " += countSum_";
  protected final String TEXT_820 = "; " + NL + "\t\t\t\t    \t";
  protected final String TEXT_821 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_822 = " += countSum_";
  protected final String TEXT_823 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_824 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_825 = " += countSum_";
  protected final String TEXT_826 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_827 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_828 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_829 = NL + "                \tconn_";
  protected final String TEXT_830 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_831 = "=0;" + NL + "                }\t";
