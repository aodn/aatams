...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_180 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_181 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_182 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_183 = ".setLength(rsmd_";
  protected final String TEXT_184 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_185 = ".setLength(rsmd_";
  protected final String TEXT_186 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_187 = NL + "\t\t\tdcm_";
  protected final String TEXT_188 = ".setLength(rsmd_";
  protected final String TEXT_189 = ".getPrecision(i));";
  protected final String TEXT_190 = NL + "                \tdcm_";
  protected final String TEXT_191 = ".setPrecision(rsmd_";
  protected final String TEXT_192 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_193 = ".setNullable(rsmd_";
  protected final String TEXT_194 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_195 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_196 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_197 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_198 = ".metadatas.add(dcm_";
  protected final String TEXT_199 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_200 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_201 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_202 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_203 = "++;" + NL + "\t\t        ";
  protected final String TEXT_204 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_215 = " = (List)rs_";
  protected final String TEXT_216 = ".getObject(";
  protected final String TEXT_217 = ");";
  protected final String TEXT_218 = NL + "\t\t                         ";
  protected final String TEXT_219 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_220 = ".getObject(";
  protected final String TEXT_221 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_222 = NL + "                                    ";
  protected final String TEXT_223 = ".";
  protected final String TEXT_224 = " = new Geometry(wktValue);";
  protected final String TEXT_225 = NL + "                                        ";
  protected final String TEXT_226 = ".";
  protected final String TEXT_227 = ".setEPSG(";
  protected final String TEXT_228 = ");";
  protected final String TEXT_229 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_230 = NL + "                                  ";
  protected final String TEXT_231 = ".";
  protected final String TEXT_232 = "=dcg_";
  protected final String TEXT_233 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_234 = ".";
  protected final String TEXT_235 = ", rs_";
  protected final String TEXT_236 = ", fixedColumnCount_";
  protected final String TEXT_237 = ");";
  protected final String TEXT_238 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_239 = ".getObject(";
  protected final String TEXT_240 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_241 = ".";
  protected final String TEXT_242 = " = new Geometry(sb.toString());";
