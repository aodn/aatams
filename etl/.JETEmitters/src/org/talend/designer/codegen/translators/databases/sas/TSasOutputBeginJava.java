...
public class TSasOutputBeginJava {
  ...
  protected final String TEXT_14 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_15 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_16 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_17 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_18 = " = false;" + NL;
  protected final String TEXT_19 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_20 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_26 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_27 = ", ";
  protected final String TEXT_28 = ", ";
  protected final String TEXT_29 = ");";
  protected final String TEXT_30 = NL + "//        connection_";
  protected final String TEXT_31 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_32 = " = ";
  protected final String TEXT_33 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_34 = " = 0;         ";
  protected final String TEXT_35 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_36 = " = connection_";
  protected final String TEXT_37 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_38 = " = deletedCount_";
  protected final String TEXT_39 = " + statementClear_";
  protected final String TEXT_40 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_41 = ");" + NL + "\t";
  protected final String TEXT_42 = NL + "\t\tString insert_";
  protected final String TEXT_43 = " = \"INSERT INTO \" + ";
  protected final String TEXT_44 = " + \" (";
  protected final String TEXT_45 = ") VALUES (";
  protected final String TEXT_46 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_47 = " = connection_";
  protected final String TEXT_48 = ".prepareStatement(insert_";
  protected final String TEXT_49 = ");" + NL + "\t\t";
  protected final String TEXT_50 = NL + "\t\tString update_";
  protected final String TEXT_51 = " = \"UPDATE \" + ";
  protected final String TEXT_52 = " + \" SET ";
  protected final String TEXT_53 = " WHERE ";
  protected final String TEXT_54 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_55 = " = connection_";
  protected final String TEXT_56 = ".prepareStatement(update_";
  protected final String TEXT_57 = ");" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_59 = " = connection_";
  protected final String TEXT_60 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_61 = " + \" WHERE ";
  protected final String TEXT_62 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_63 = " = \"INSERT INTO \" + ";
  protected final String TEXT_64 = " + \" (";
  protected final String TEXT_65 = ") VALUES (";
  protected final String TEXT_66 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_67 = " = connection_";
  protected final String TEXT_68 = ".prepareStatement(insert_";
  protected final String TEXT_69 = ");" + NL + "\t\tString update_";
  protected final String TEXT_70 = " = \"UPDATE \" + ";
  protected final String TEXT_71 = " + \" SET ";
  protected final String TEXT_72 = " WHERE ";
  protected final String TEXT_73 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_74 = " = connection_";
  protected final String TEXT_75 = ".prepareStatement(update_";
  protected final String TEXT_76 = ");" + NL + "\t\t";
  protected final String TEXT_77 = NL + "\t\tString update_";
  protected final String TEXT_78 = " = \"UPDATE \" + ";
  protected final String TEXT_79 = " + \" SET ";
  protected final String TEXT_80 = " WHERE ";
  protected final String TEXT_81 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_82 = " = connection_";
  protected final String TEXT_83 = ".prepareStatement(update_";
  protected final String TEXT_84 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_85 = " = \"INSERT INTO \" + ";
  protected final String TEXT_86 = " + \" (";
  protected final String TEXT_87 = ") VALUES (";
  protected final String TEXT_88 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_89 = " = connection_";
  protected final String TEXT_90 = ".prepareStatement(insert_";
  protected final String TEXT_91 = ");" + NL + "\t\t";
  protected final String TEXT_92 = NL + "\t\tString delete_";
  protected final String TEXT_93 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_94 = " + \" WHERE ";
  protected final String TEXT_95 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_96 = " = connection_";
  protected final String TEXT_97 = ".prepareStatement(delete_";
  protected final String TEXT_98 = ");" + NL + "\t\t";
  protected final String TEXT_99 = NL + "        StringBuffer query_";
  protected final String TEXT_100 = " = null;" + NL + "       \t";
  protected final String TEXT_101 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_102 = " = insert_";
  protected final String TEXT_103 = ".split(\"\\\\?\");";
  protected final String TEXT_104 = NL + "\t\t\tupdate_";
  protected final String TEXT_105 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_106 = " = update_";
  protected final String TEXT_107 = ".split(\"\\\\?\");";
  protected final String TEXT_108 = NL + "\t\t\tupdate_";
  protected final String TEXT_109 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_110 = " = update_";
  protected final String TEXT_111 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_112 = " = insert_";
  protected final String TEXT_113 = ".split(\"\\\\?\");";
  protected final String TEXT_114 = NL + "\t\t\tdelete_";
  protected final String TEXT_115 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_116 = " = delete_";
  protected final String TEXT_117 = ".split(\"\\\\?\");";
  protected final String TEXT_118 = NL + "\t\t\treplace_";
  protected final String TEXT_119 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_120 = " = replace_";
  protected final String TEXT_121 = ".split(\"\\\\?\");";
  protected final String TEXT_122 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_123 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_124 = " = insertIgnore_";
  protected final String TEXT_125 = ".split(\"\\\\?\");";
  protected final String TEXT_126 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_127 = " = insert_";
