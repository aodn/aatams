...
public class TSasOutputMainJava {
  ...
  protected final String TEXT_14 = "_QUERY\", query_";
  protected final String TEXT_15 = ".toString().trim());";
  protected final String TEXT_16 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_17 = " = insertedCount_";
  protected final String TEXT_18 = " + pstmt_";
  protected final String TEXT_19 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_20 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_32 = ".errorMessage = e.getMessage();";
  protected final String TEXT_33 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_34 = NL + "            }";
  protected final String TEXT_35 = NL + "                    ";
  protected final String TEXT_36 = NL + "                        query_";
  ...
  protected final String TEXT_44 = "_QUERY\", query_";
  protected final String TEXT_45 = ".toString().trim());";
  protected final String TEXT_46 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_47 = " = updatedCount_";
  protected final String TEXT_48 = " + pstmt_";
  protected final String TEXT_49 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_50 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_51 = " = true;";
  protected final String TEXT_52 = NL + "                    throw(e);";
  ...
  protected final String TEXT_62 = ".errorMessage = e.getMessage();";
  protected final String TEXT_63 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_64 = NL + "            }";
  protected final String TEXT_65 = NL + "                    ";
  protected final String TEXT_66 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_67 = " = pstmt_";
  protected final String TEXT_68 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_69 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_70 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_71 = " = rs_";
  protected final String TEXT_72 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_73 = " > 0) {";
  protected final String TEXT_74 = NL + "                        ";
  protected final String TEXT_75 = NL + "                            query_";
  protected final String TEXT_76 = " = ";
  protected final String TEXT_77 = ";";
  protected final String TEXT_78 = NL + "                        ";
  protected final String TEXT_79 = NL + "                            query_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";";
  protected final String TEXT_82 = NL + "                    globalMap.put(\"";
  protected final String TEXT_83 = "_QUERY\", query_";
  protected final String TEXT_84 = ".toString().trim());";
  ...
  protected final String TEXT_102 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_110 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_111 = " = insertedCount_";
  protected final String TEXT_112 = " + pstmtInsert_";
  ...
  protected final String TEXT_125 = ".errorMessage = e.getMessage();";
  protected final String TEXT_126 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_127 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_128 = "++;";
  protected final String TEXT_129 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_140 = "_QUERY\", query_";
  protected final String TEXT_141 = ".toString().trim());";
  protected final String TEXT_142 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_143 = " = pstmtUpdate_";
  protected final String TEXT_144 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_145 = " = updatedCount_";
  protected final String TEXT_146 = " + updateFlag_";
  protected final String TEXT_147 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_159 = ".errorMessage = e.getMessage();";
  protected final String TEXT_160 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_161 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_162 = " == 0) {" + NL + "            \t";
  protected final String TEXT_163 = NL + "\t\t\t\tquery_";
  protected final String TEXT_164 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_165 = NL + "                        ";
  protected final String TEXT_166 = NL + "                            query_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";";
  protected final String TEXT_169 = NL + "                    globalMap.put(\"";
  protected final String TEXT_170 = "_QUERY\", query_";
  protected final String TEXT_171 = ".toString().trim());";
  protected final String TEXT_172 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_173 = " = insertedCount_";
  protected final String TEXT_174 = " + pstmtInsert_";
  protected final String TEXT_175 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_187 = ".errorMessage = e.getMessage();";
  protected final String TEXT_188 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_189 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_196 = "_QUERY\", query_";
  protected final String TEXT_197 = ".toString().trim());";
  protected final String TEXT_198 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_199 = " = deletedCount_";
  protected final String TEXT_200 = " + pstmt_";
  protected final String TEXT_201 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_228 = NL + "                commitCounter_";
  protected final String TEXT_229 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_230 = " <= commitCounter_";
  protected final String TEXT_231 = ") {" + NL + "                    connection_";
  protected final String TEXT_232 = ".commit();" + NL + "                    commitCounter_";
