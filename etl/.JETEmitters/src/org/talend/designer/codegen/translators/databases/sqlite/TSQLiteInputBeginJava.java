...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_86 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_87 = ";";
  protected final String TEXT_88 = NL + "\t\t\t    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_95 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_101 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_102 = " = ";
  protected final String TEXT_103 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_104 = "_QUERY\",dbquery_";
  protected final String TEXT_105 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_106 = " = stmt_";
  protected final String TEXT_107 = ".executeQuery(dbquery_";
  protected final String TEXT_108 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_109 = " = rs_";
  protected final String TEXT_110 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_111 = " = rsmd_";
  protected final String TEXT_112 = ".getColumnCount();" + NL;
  protected final String TEXT_113 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_114 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_115 = ".setDbmsId(\"";
  protected final String TEXT_116 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_117 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_118 = "=1; i_";
  protected final String TEXT_119 = "<";
  protected final String TEXT_120 = "; i_";
  protected final String TEXT_121 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_122 = ".add(rsmd_";
  protected final String TEXT_123 = ".getColumnName(i_";
  protected final String TEXT_124 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_125 = " = ";
  protected final String TEXT_126 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_127 = "; i <= rsmd_";
  protected final String TEXT_128 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_129 = ".contains(rsmd_";
  protected final String TEXT_130 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_131 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_132 = ".setName(rsmd_";
  protected final String TEXT_133 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_134 = ".setDbName(rsmd_";
  protected final String TEXT_135 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_136 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_137 = "\", rsmd_";
  protected final String TEXT_138 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_139 = ".getPrecision(i), rsmd_";
  protected final String TEXT_140 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_141 = ".setDbType(rsmd_";
  protected final String TEXT_142 = ".getColumnTypeName(i));";
  protected final String TEXT_143 = NL + "                \tdcm_";
  protected final String TEXT_144 = ".setFormat(";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_147 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_148 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_149 = ".setLength(rsmd_";
  protected final String TEXT_150 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_151 = ".setLength(rsmd_";
  protected final String TEXT_152 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_153 = NL + "\t\t\tdcm_";
  protected final String TEXT_154 = ".setLength(rsmd_";
  protected final String TEXT_155 = ".getPrecision(i));";
  protected final String TEXT_156 = NL + "                \tdcm_";
