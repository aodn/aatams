...
public class TSQLiteOutputBeginJava {
  ...
  protected final String TEXT_27 = NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_45 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_72 = NL + "                if(whetherExist_";
  protected final String TEXT_73 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_74 = " = conn_";
  protected final String TEXT_75 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_76 = ".execute(\"";
  protected final String TEXT_77 = "\");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_82 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_83 = " = conn_";
  protected final String TEXT_84 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_85 = " = deletedCount_";
  protected final String TEXT_86 = " + stmtClear_";
  protected final String TEXT_87 = ".executeUpdate(\"";
  protected final String TEXT_88 = "\");";
  protected final String TEXT_89 = NL + "\t    String insert_";
  protected final String TEXT_90 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_91 = " + \"\\\" (";
  protected final String TEXT_92 = ") VALUES (";
  protected final String TEXT_93 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_94 = " = conn_";
  protected final String TEXT_95 = ".prepareStatement(insert_";
  protected final String TEXT_96 = ");" + NL + "\t    ";
  protected final String TEXT_97 = NL + "\t    String update_";
  protected final String TEXT_98 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_99 = " + \"\\\" SET ";
  protected final String TEXT_100 = " WHERE ";
  protected final String TEXT_101 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".prepareStatement(update_";
  protected final String TEXT_104 = ");" + NL + "\t    ";
  protected final String TEXT_105 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_106 = " = conn_";
  protected final String TEXT_107 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_108 = " + \"\\\" WHERE ";
  ...
  protected final String TEXT_113 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".prepareStatement(insert_";
  protected final String TEXT_116 = ");" + NL + "\t    String update_";
  protected final String TEXT_117 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_118 = " + \"\\\" SET ";
  protected final String TEXT_119 = " WHERE ";
  protected final String TEXT_120 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_121 = " = conn_";
  protected final String TEXT_122 = ".prepareStatement(update_";
  ...
  protected final String TEXT_128 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".prepareStatement(update_";
  protected final String TEXT_131 = ");" + NL + "\t    String insert_";
  protected final String TEXT_132 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_133 = " + \"\\\" (";
  protected final String TEXT_134 = ") VALUES (";
  protected final String TEXT_135 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".prepareStatement(insert_";
  protected final String TEXT_138 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_139 = NL + "\t    String delete_";
  protected final String TEXT_140 = " = \"DELETE FROM \\\"\" + ";
  protected final String TEXT_141 = " + \"\\\" WHERE ";
  protected final String TEXT_142 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".prepareStatement(delete_";
  protected final String TEXT_145 = ");" + NL + "\t    ";
  protected final String TEXT_146 = NL + "        StringBuffer query_";
  protected final String TEXT_147 = " = null;" + NL + "       \t";
  protected final String TEXT_148 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_149 = " = insert_";
  protected final String TEXT_150 = ".split(\"\\\\?\");";
  protected final String TEXT_151 = NL + "\t\t\tupdate_";
  protected final String TEXT_152 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_153 = " = update_";
  protected final String TEXT_154 = ".split(\"\\\\?\");";
  protected final String TEXT_155 = NL + "\t\t\tupdate_";
  protected final String TEXT_156 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_157 = " = update_";
  protected final String TEXT_158 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_159 = " = insert_";
  protected final String TEXT_160 = ".split(\"\\\\?\");";
  protected final String TEXT_161 = NL + "\t\t\tdelete_";
  protected final String TEXT_162 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_163 = " = delete_";
  protected final String TEXT_164 = ".split(\"\\\\?\");";
  protected final String TEXT_165 = NL + "\t\t\treplace_";
  protected final String TEXT_166 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_167 = " = replace_";
  protected final String TEXT_168 = ".split(\"\\\\?\");";
  protected final String TEXT_169 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_170 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_171 = " = insertIgnore_";
  protected final String TEXT_172 = ".split(\"\\\\?\");";
