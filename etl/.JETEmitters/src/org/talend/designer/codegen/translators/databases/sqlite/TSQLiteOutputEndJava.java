...
public class TSQLiteOutputEndJava {
  ...
  protected final String TEXT_3 = " != null) {    " + NL + "                pstmtUpdate_";
  protected final String TEXT_4 = ".close();                " + NL + "            } " + NL + "            if(pstmtInsert_";
  protected final String TEXT_5 = " != null) {    " + NL + "                pstmtInsert_";
  protected final String TEXT_6 = ".close();                " + NL + "            }" + NL + "            if(pstmt_";
  protected final String TEXT_7 = " != null) {    " + NL + "                pstmt_";
  protected final String TEXT_8 = ".close();                " + NL + "            }        ";
  protected final String TEXT_9 = NL + "            if(pstmtUpdate_";
  protected final String TEXT_10 = " != null) {    " + NL + "                pstmtUpdate_";
  protected final String TEXT_11 = ".close();                " + NL + "            } " + NL + "            if(pstmtInsert_";
  protected final String TEXT_12 = " != null) {    " + NL + "                pstmtInsert_";
  protected final String TEXT_13 = ".close();                " + NL + "            }        ";
  protected final String TEXT_14 = NL + "            if(pstmt_";
  protected final String TEXT_15 = " != null) {    " + NL + "                pstmt_";
