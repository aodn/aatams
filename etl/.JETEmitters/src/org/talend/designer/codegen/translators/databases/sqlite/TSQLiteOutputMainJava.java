...
public class TSQLiteOutputMainJava {
  ...
  protected final String TEXT_55 = ".toString().trim());";
  ...
  protected final String TEXT_172 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_190 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_198 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_199 = " = insertedCount_";
  protected final String TEXT_200 = " + pstmtInsert_";
  ...
  protected final String TEXT_220 = NL + "\t                        query_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";" + NL + "\t                        ";
  protected final String TEXT_223 = NL + "                    ";
  protected final String TEXT_224 = NL + "                        query_";
  protected final String TEXT_225 = " = ";
  protected final String TEXT_226 = ";";
  protected final String TEXT_227 = NL + "                globalMap.put(\"";
  protected final String TEXT_228 = "_QUERY\", query_";
  protected final String TEXT_229 = ".toString().trim());";
  protected final String TEXT_230 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_231 = " = deletedCount_";
  protected final String TEXT_232 = " + pstmt_";
  protected final String TEXT_233 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_248 = NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_261 = NL + "                commitCounter_";
  protected final String TEXT_262 = "++;    " + NL + "                if(commitEvery_";
  protected final String TEXT_263 = " <= commitCounter_";
  protected final String TEXT_264 = ") {            " + NL + "                    conn_";
  protected final String TEXT_265 = ".commit();                " + NL + "                    commitCounter_";
  protected final String TEXT_266 = "=0;                       " + NL + "                }               ";
