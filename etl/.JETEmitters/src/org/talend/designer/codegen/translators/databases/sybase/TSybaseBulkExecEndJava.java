...
public class TSybaseBulkExecEndJava {
  ...
  protected final String TEXT_2 = NL + "        tableName_";
  protected final String TEXT_3 = " = tmpTableName_";
  protected final String TEXT_4 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_5 = " = \"tmp_";
  protected final String TEXT_6 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_7 = " = con_";
  protected final String TEXT_8 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_9 = ".executeUpdate(\"";
  protected final String TEXT_10 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_11 = ".close();" + NL + "        tableName_";
  protected final String TEXT_12 = " = tmpTableName_";
  protected final String TEXT_13 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_14 = " = con_";
  protected final String TEXT_15 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_16 = ".execute(\"";
  protected final String TEXT_17 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_18 = ".close();         ";
  protected final String TEXT_19 = NL;
  protected final String TEXT_20 = NL + "\t    if(conn_";
  protected final String TEXT_21 = " != null && !conn_";
  protected final String TEXT_22 = ".isClosed()) {" + NL + "\t        conn_";
