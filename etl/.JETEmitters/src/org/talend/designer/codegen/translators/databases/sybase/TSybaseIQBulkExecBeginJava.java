...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_1 = "\tjava.sql.Connection con_";
  protected final String TEXT_2 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_3 = "\");";
  protected final String TEXT_4 = NL;
  protected final String TEXT_5 = NL + "\t\t\tString url_";
  protected final String TEXT_6 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_7 = " + \":\" + ";
  protected final String TEXT_8 = " + \"/\" + ";
  protected final String TEXT_9 = ";";
  protected final String TEXT_10 = NL + "\t\t\tString url_";
  protected final String TEXT_11 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_12 = " + \":\" + ";
  protected final String TEXT_13 = " + \"/\" + ";
  protected final String TEXT_14 = " + \"?\" + ";
  protected final String TEXT_15 = ";";
  protected final String TEXT_16 = NL + "\t\t String dirverName = \"com.sybase.jdbc3.jdbc.SybDriver\";";
  protected final String TEXT_17 = NL + "\t\t\tString url_";
  protected final String TEXT_18 = " = \"jdbc:odbc:dsn=\"+";
  protected final String TEXT_19 = ";";
  protected final String TEXT_20 = NL + "\t\t\tString url_";
  protected final String TEXT_21 = " = \"jdbc:odbc:FileDSN=\"+";
  protected final String TEXT_22 = ";";
  protected final String TEXT_23 = NL + "\t\t\turl_";
  protected final String TEXT_24 = " +=\";DatabaseName=\"+";
  protected final String TEXT_25 = ";";
  protected final String TEXT_26 = NL + "\t\tString dirverName = \"ianywhere.ml.jdbcodbc.IDriver\";";
  protected final String TEXT_27 = NL + "   " + NL + "    java.lang.Class.forName(dirverName);" + NL + "    java.sql.Connection con_";
  ...
  protected final String TEXT_35 = NL + "        java.sql.Statement stmtDrop_";
  protected final String TEXT_36 = " = con_";
  protected final String TEXT_37 = ".createStatement();" + NL + "        stmtDrop_";
  protected final String TEXT_38 = ".execute(\"";
  protected final String TEXT_39 = "\");" + NL + "        stmtDrop_";
  protected final String TEXT_40 = ".close();" + NL + "        java.sql.Statement stmtCreate_";
  protected final String TEXT_41 = " = con_";
  ...
  protected final String TEXT_47 = " = con_";
  protected final String TEXT_48 = ".createStatement();" + NL + "        stmtCreate_";
  protected final String TEXT_49 = ".execute(\"";
  protected final String TEXT_50 = ")\");" + NL + "        stmtCreate_";
  protected final String TEXT_51 = ".close();";
  protected final String TEXT_52 = NL + "        java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_53 = " = con_";
  protected final String TEXT_54 = ".getMetaData();" + NL + "        java.sql.ResultSet rsTable_";
  protected final String TEXT_55 = " = dbMetaData_";
  protected final String TEXT_56 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "        boolean whetherExist_";
  protected final String TEXT_57 = " = false;" + NL + "        while(rsTable_";
  protected final String TEXT_58 = ".next()) {" + NL + "            String table_";
  protected final String TEXT_59 = " = rsTable_";
  protected final String TEXT_60 = ".getString(\"TABLE_NAME\");" + NL + "            if(table_";
  protected final String TEXT_61 = ".equalsIgnoreCase(";
  protected final String TEXT_62 = ")) {" + NL + "                whetherExist_";
  protected final String TEXT_63 = " = true;" + NL + "                break;" + NL + "            }" + NL + "        }" + NL + "        rsTable_";
  protected final String TEXT_64 = ".close();" + NL + "        if(!whetherExist_";
  protected final String TEXT_65 = ") {" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_66 = " = con_";
  ...
  protected final String TEXT_71 = NL + "        java.sql.Statement stmtClear_";
  protected final String TEXT_72 = " = con_";
  protected final String TEXT_73 = ".createStatement();" + NL + "        stmtClear_";
  protected final String TEXT_74 = ".executeUpdate(\"";
  protected final String TEXT_75 = "\");" + NL + "        stmtClear_";
  protected final String TEXT_76 = ".close();";
  protected final String TEXT_77 = NL + "        java.sql.Statement stmtTrunc_";
  protected final String TEXT_78 = " = con_";
  protected final String TEXT_79 = ".createStatement();" + NL + "        stmtTrunc_";
  protected final String TEXT_80 = ".executeUpdate(\"";
  protected final String TEXT_81 = "\");" + NL + "        stmtTrunc_";
  protected final String TEXT_82 = ".close();";
  protected final String TEXT_83 = NL + NL + "\t\tStringBuilder loadingCols = new StringBuilder();";
  protected final String TEXT_84 = NL + "    \tloadingCols.append(\"(\");";
  protected final String TEXT_85 = NL + "        loadingCols.append(\"";
  protected final String TEXT_86 = "\" + \" \");";
  protected final String TEXT_87 = NL + "\t\tloadingCols.append(\"ASCII(\" + ";
  protected final String TEXT_88 = " + \"),\");";
  protected final String TEXT_89 = NL + "        loadingCols.append(\"'\" + ";
  protected final String TEXT_90 = " + \"'\" + \",\");";
  protected final String TEXT_91 = NL + "\t\tloadingCols.append(\"ASCII(\" + ";
  protected final String TEXT_92 = " + \")\");";
  protected final String TEXT_93 = NL + "        \tloadingCols.append(\"'\" + ";
  protected final String TEXT_94 = " + \"'\");";
  protected final String TEXT_95 = NL + "    loadingCols.append(\")\");";
  protected final String TEXT_96 = " " + NL + "" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_97 = "=con_";
  protected final String TEXT_98 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_99 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "    " + NL + "    //stmt_";
  protected final String TEXT_100 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "        " + NL + "    String strSQL = \"LOAD TABLE \" + ";
  protected final String TEXT_101 = " + \".\" + tableName_";
  protected final String TEXT_102 = " + loadingCols.toString() ;";
  protected final String TEXT_103 = NL + "\t\tstrSQL +=\" from '\" + ";
  protected final String TEXT_104 = " + \"' \";";
  protected final String TEXT_105 = NL + "\t\tstrSQL +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_106 = " + \"' \";";
  protected final String TEXT_107 = NL + "    ";
  protected final String TEXT_108 = NL + "     strSQL = strSQL + \" row delimited by '\" + ";
  protected final String TEXT_109 = " + \"'\";    " + NL + "\t strSQL=strSQL + \" quotes off\";";
  protected final String TEXT_110 = NL + "\tstrSQL=strSQL + \" quotes on \";";
  protected final String TEXT_111 = NL + "\tstrSQL=strSQL + \" quotes off \";";
  protected final String TEXT_112 = NL + "    strSQL =strSQL + \" escapes off \";" + NL + "    ";
  protected final String TEXT_113 = NL + "\tstrSQL =strSQL + \" skip 1 \";";
  protected final String TEXT_114 = NL + "    " + NL + "    stmt_";
  protected final String TEXT_115 = ".execute(strSQL);" + NL;
  protected final String TEXT_116 = NL + "    if(con_";
  protected final String TEXT_117 = " != null && !con_";
  protected final String TEXT_118 = ".isClosed()) {" + NL + "        con_";
