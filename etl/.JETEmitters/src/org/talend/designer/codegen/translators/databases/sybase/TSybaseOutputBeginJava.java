...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_14 = " = false;" + NL + "String dbschema_";
  protected final String TEXT_15 = "= ";
  protected final String TEXT_16 = "; " + NL + NL;
  protected final String TEXT_17 = NL;
  protected final String TEXT_18 = NL + "        int updateKeyCount_";
  protected final String TEXT_19 = " = ";
  protected final String TEXT_20 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_21 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_22 = NL + "        int deleteKeyCount_";
  protected final String TEXT_23 = " = ";
  protected final String TEXT_24 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_25 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_28 = "\");" + NL + "\tdbschema_";
  ...
  protected final String TEXT_35 = ";" + NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_36 = NL + "\t\tString url_";
  protected final String TEXT_37 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_38 = " + \":\" + ";
  protected final String TEXT_39 = " + \"/\" + ";
  protected final String TEXT_40 = "; ";
  protected final String TEXT_41 = NL + "\t\tString url_";
  protected final String TEXT_42 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_43 = " + \":\" + ";
  protected final String TEXT_44 = " + \"/\" + ";
  protected final String TEXT_45 = " + \"?\" + ";
  protected final String TEXT_46 = ";";
  protected final String TEXT_47 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_48 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_49 = ",dbUser_";
  protected final String TEXT_50 = ",dbPwd_";
  protected final String TEXT_51 = ");";
  protected final String TEXT_52 = NL + "        conn_";
  protected final String TEXT_53 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_62 = " " + NL + "" + NL + "if(dbschema_";
  protected final String TEXT_63 = " != null && dbschema_";
  protected final String TEXT_64 = ".trim().length() != 0) {" + NL + "\ttableName_";
  protected final String TEXT_65 = " = dbschema_";
  protected final String TEXT_66 = " + \".\" + ";
  protected final String TEXT_67 = ";" + NL + "} ";
  protected final String TEXT_68 = NL + "int count_";
  ...
  protected final String TEXT_80 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_87 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_97 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_98 = " = conn_";
  protected final String TEXT_99 = ".createStatement();";
  ...
  protected final String TEXT_109 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_120 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_121 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_128 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_131 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_132 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_133 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_134 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_135 = ")== null){";
  protected final String TEXT_136 = "              ";
  protected final String TEXT_137 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_138 = " = conn_";
  protected final String TEXT_139 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_140 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_141 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_142 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_143 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_144 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_169 = ".equalsIgnoreCase(";
  protected final String TEXT_170 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_171 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_185 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_195 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_202 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_212 = NL + "                if(whetherExist_";
  protected final String TEXT_213 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_216 = ".execute(\"";
  protected final String TEXT_217 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_218 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".createStatement();";
  ...
  protected final String TEXT_240 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_241 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_242 = "            ";
  protected final String TEXT_243 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_246 = ".executeUpdate(\"";
  protected final String TEXT_247 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_248 = ".close();";
  protected final String TEXT_249 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_252 = " = stmtTruncCount_";
  protected final String TEXT_253 = ".executeQuery(\"";
  protected final String TEXT_254 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_255 = " = conn_";
  protected final String TEXT_256 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_257 = ".executeUpdate(\"";
  protected final String TEXT_258 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_259 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_260 = " += rsTruncCount_";
  protected final String TEXT_261 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_262 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_263 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_264 = ".close();            ";
  protected final String TEXT_265 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_266 = " = conn_";
  protected final String TEXT_267 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_268 = " = stmtTruncCount_";
  protected final String TEXT_269 = ".executeQuery(\"";
  protected final String TEXT_270 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_271 = " = conn_";
  protected final String TEXT_272 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_273 = ".executeUpdate(\"";
  protected final String TEXT_274 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_275 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_276 = " += rsTruncCount_";
  protected final String TEXT_277 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_278 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_279 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_280 = ".close();";
  protected final String TEXT_281 = NL + "\t    String insert_";
  protected final String TEXT_282 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_283 = " + \" (";
  protected final String TEXT_284 = ") VALUES (";
  protected final String TEXT_285 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_293 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_294 = " = conn_";
  protected final String TEXT_295 = ".prepareStatement(update_";
  protected final String TEXT_296 = ");" + NL + "\t    ";
  protected final String TEXT_297 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_298 = " = conn_";
  protected final String TEXT_299 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_300 = " + \" WHERE ";
  protected final String TEXT_301 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_302 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_303 = " + \" (";
  protected final String TEXT_304 = ") VALUES (";
  protected final String TEXT_305 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_306 = " = conn_";
  protected final String TEXT_307 = ".prepareStatement(insert_";
  protected final String TEXT_308 = ");" + NL + "\t    String update_";
  protected final String TEXT_309 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_310 = " + \" SET ";
  protected final String TEXT_311 = " WHERE ";
  protected final String TEXT_312 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_313 = " = conn_";
  protected final String TEXT_314 = ".prepareStatement(update_";
  protected final String TEXT_315 = ");\t" + NL + "\t    ";
  protected final String TEXT_316 = NL + "\t    String update_";
  protected final String TEXT_317 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_318 = " + \" SET ";
  protected final String TEXT_319 = " WHERE ";
  protected final String TEXT_320 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_321 = " = conn_";
  protected final String TEXT_322 = ".prepareStatement(update_";
  protected final String TEXT_323 = ");" + NL + "\t    String insert_";
  protected final String TEXT_324 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_325 = " + \" (";
  protected final String TEXT_326 = ") VALUES (";
  protected final String TEXT_327 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_328 = " = conn_";
  protected final String TEXT_329 = ".prepareStatement(insert_";
  protected final String TEXT_330 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_331 = NL + "\t    String delete_";
  protected final String TEXT_332 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_333 = " + \" WHERE ";
  protected final String TEXT_334 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_335 = " = conn_";
  protected final String TEXT_336 = ".prepareStatement(delete_";
  protected final String TEXT_337 = ");" + NL + "\t    ";
  protected final String TEXT_338 = NL + "        StringBuffer query_";
  protected final String TEXT_339 = " = null;" + NL + "       \t";
  protected final String TEXT_340 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_341 = " = insert_";
  protected final String TEXT_342 = ".split(\"\\\\?\");";
  protected final String TEXT_343 = NL + "\t\t\tupdate_";
  protected final String TEXT_344 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_345 = " = update_";
  ...
  protected final String TEXT_350 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_351 = " = insert_";
  protected final String TEXT_352 = ".split(\"\\\\?\");";
  protected final String TEXT_353 = NL + "\t\t\tdelete_";
  protected final String TEXT_354 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_355 = " = delete_";
  protected final String TEXT_356 = ".split(\"\\\\?\");";
  protected final String TEXT_357 = NL + "\t\t\treplace_";
  protected final String TEXT_358 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_359 = " = replace_";
  protected final String TEXT_360 = ".split(\"\\\\?\");";
  protected final String TEXT_361 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_362 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_363 = " = insertIgnore_";
  protected final String TEXT_364 = ".split(\"\\\\?\");";
  protected final String TEXT_365 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_366 = " = insert_";
  protected final String TEXT_367 = ".split(\"\\\\?\");";
  protected final String TEXT_368 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_369 = " = conn_";
  protected final String TEXT_370 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_371 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_372 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_373 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_374 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_375 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
