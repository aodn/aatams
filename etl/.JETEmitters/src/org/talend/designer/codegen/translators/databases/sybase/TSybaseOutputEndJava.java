...
public class TSybaseOutputEndJava
{
  ...
  protected final String TEXT_22 = " = 0;" + NL + "\t\t\tif (pstmt_";
  protected final String TEXT_23 = " != null) {" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_24 = ": pstmt_";
  protected final String TEXT_25 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_26 = " += (countEach_";
  protected final String TEXT_27 = " < 0 ? 0 : countEach_";
  protected final String TEXT_28 = ");" + NL + "\t\t\t\t}                \t" + NL + "\t\t\t}" + NL + "\t    \t";
  protected final String TEXT_29 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_30 = " += countSum_";
  protected final String TEXT_31 = "; " + NL + "\t    \t";
  protected final String TEXT_32 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_33 = " += countSum_";
  protected final String TEXT_34 = ";" + NL + "\t    \t";
  protected final String TEXT_35 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_36 = " += countSum_";
  protected final String TEXT_37 = ";" + NL + "\t    \t";
  protected final String TEXT_38 = "  " + NL + "\t    }          \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_39 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_40 = NL + "    \tint countSum_";
  protected final String TEXT_41 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_42 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_43 = " += (countEach_";
  protected final String TEXT_44 = " < 0 ? 0 : countEach_";
  protected final String TEXT_45 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_46 = NL + "    \t\tinsertedCount_";
  protected final String TEXT_47 = " += countSum_";
  protected final String TEXT_48 = "; " + NL + "    \t";
  protected final String TEXT_49 = NL + "    \t\tupdatedCount_";
  protected final String TEXT_50 = " += countSum_";
  protected final String TEXT_51 = ";" + NL + "    \t";
  protected final String TEXT_52 = NL + "    \t    deletedCount_";
  protected final String TEXT_53 = " += countSum_";
  protected final String TEXT_54 = ";" + NL + "    \t";
  protected final String TEXT_55 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_56 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_57 = "   " + NL + "        if(pstmt_";
  protected final String TEXT_58 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_59 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_60 = NL + "        stmt_";
  protected final String TEXT_61 = ".execute(\"SET IDENTITY_INSERT \"+ ";
  protected final String TEXT_62 = " +\" OFF\");" + NL + "        stmt_";
  protected final String TEXT_63 = ".close();";
  protected final String TEXT_64 = NL + "\t\t    conn_";
  protected final String TEXT_65 = ".commit();" + NL + "\t\t    ";
  ...
  protected final String TEXT_89 = "_NB_LINE_REJECTED\",nb_line_rejected_";
