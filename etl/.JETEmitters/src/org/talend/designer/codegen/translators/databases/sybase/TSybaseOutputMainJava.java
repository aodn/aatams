...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_382 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_383 = " = conn_";
  protected final String TEXT_384 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_385 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_386 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_387 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_388 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_389 = " = buffersSize_";
  protected final String TEXT_390 = ";";
  protected final String TEXT_391 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_392 = " = buffersSize_";
  protected final String TEXT_393 = ";";
  protected final String TEXT_394 = NL + "        whetherReject_";
  protected final String TEXT_395 = " = false;";
  protected final String TEXT_396 = NL + "                    ";
  protected final String TEXT_397 = NL + "                        query_";
  protected final String TEXT_398 = " = ";
  protected final String TEXT_399 = ";";
  protected final String TEXT_400 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_407 = "_QUERY\", query_";
  protected final String TEXT_408 = ".toString().trim());";
  protected final String TEXT_409 = NL + "    \t\tpstmt_";
  protected final String TEXT_410 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_411 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_412 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_413 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_414 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_415 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_416 = " = insertedCount_";
  protected final String TEXT_417 = " + pstmt_";
  protected final String TEXT_418 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_419 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_434 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_435 = ";";
  protected final String TEXT_436 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_442 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_443 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_444 = ".";
  protected final String TEXT_445 = ", pstmt_";
  protected final String TEXT_446 = ", ";
  protected final String TEXT_447 = ", \"";
  protected final String TEXT_448 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_449 = NL + "                    " + NL + "\t\t\t\t\t";
  protected final String TEXT_450 = NL + "                    \t";
  protected final String TEXT_451 = NL + "                        query_";
  protected final String TEXT_452 = " = ";
  protected final String TEXT_453 = ";";
  protected final String TEXT_454 = "  ";
  protected final String TEXT_455 = NL + "                    ";
  protected final String TEXT_456 = NL + "                        query_";
  protected final String TEXT_457 = " = ";
  protected final String TEXT_458 = ";";
  protected final String TEXT_459 = NL + "                globalMap.put(\"";
  protected final String TEXT_460 = "_QUERY\", query_";
  protected final String TEXT_461 = ".toString().trim());";
  ...
  protected final String TEXT_468 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_469 = " = updatedCount_";
  protected final String TEXT_470 = " + pstmt_";
  protected final String TEXT_471 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_472 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_483 = NL + "                        rejectedCount_";
  protected final String TEXT_484 = " = rejectedCount_";
  protected final String TEXT_485 = " + 1;";
  protected final String TEXT_486 = NL + "                        ";
  protected final String TEXT_487 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_488 = ";";
  protected final String TEXT_489 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_494 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_495 = " = pstmt_";
  protected final String TEXT_496 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_497 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_498 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_499 = " = rs_";
  protected final String TEXT_500 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_501 = " > 0) {";
  protected final String TEXT_502 = NL + "                        ";
  protected final String TEXT_503 = NL + "                            query_";
  protected final String TEXT_504 = " = ";
  protected final String TEXT_505 = ";";
  protected final String TEXT_506 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_507 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_508 = ".";
  protected final String TEXT_509 = ", pstmtUpdate_";
  protected final String TEXT_510 = ", ";
  protected final String TEXT_511 = ", \"";
  protected final String TEXT_512 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_513 = NL + "\t                    \t";
  protected final String TEXT_514 = NL + "\t                    ";
  protected final String TEXT_515 = NL + "\t                        query_";
  ...
  protected final String TEXT_522 = NL + "                    globalMap.put(\"";
  protected final String TEXT_523 = "_QUERY\", query_";
  protected final String TEXT_524 = ".toString().trim());";
  protected final String TEXT_525 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_526 = " = updatedCount_";
  protected final String TEXT_527 = " + pstmtUpdate_";
  protected final String TEXT_528 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_529 = " = true;";
  protected final String TEXT_530 = NL + "                        throw(e);";
  protected final String TEXT_531 = NL + "                            ";
  protected final String TEXT_532 = " = new ";
  protected final String TEXT_533 = "Struct();";
  protected final String TEXT_534 = NL + "                                ";
  protected final String TEXT_535 = ".";
  protected final String TEXT_536 = " = ";
  protected final String TEXT_537 = ".";
  protected final String TEXT_538 = ";";
  protected final String TEXT_539 = NL + "                            rejectedCount_";
  protected final String TEXT_540 = " = rejectedCount_";
  protected final String TEXT_541 = " + 1;";
  protected final String TEXT_542 = NL + "                            ";
  protected final String TEXT_543 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_544 = ";";
  protected final String TEXT_545 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_546 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_547 = NL + "                        ";
  protected final String TEXT_548 = NL + "                            query_";
  protected final String TEXT_549 = " = ";
  protected final String TEXT_550 = ";";
  protected final String TEXT_551 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_552 = ".";
  protected final String TEXT_553 = ", pstmtInsert_";
  protected final String TEXT_554 = ", ";
  protected final String TEXT_555 = ", \"";
  protected final String TEXT_556 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_557 = NL + "                    globalMap.put(\"";
  protected final String TEXT_558 = "_QUERY\", query_";
  protected final String TEXT_559 = ".toString().trim());";
  protected final String TEXT_560 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_561 = " = insertedCount_";
  protected final String TEXT_562 = " + pstmtInsert_";
  protected final String TEXT_563 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_564 = " = true;";
  protected final String TEXT_565 = NL + "                        throw(e);";
  protected final String TEXT_566 = NL + "                            ";
  protected final String TEXT_567 = " = new ";
  protected final String TEXT_568 = "Struct();";
  protected final String TEXT_569 = NL + "                                ";
  protected final String TEXT_570 = ".";
  protected final String TEXT_571 = " = ";
  protected final String TEXT_572 = ".";
  protected final String TEXT_573 = ";";
  protected final String TEXT_574 = NL + "                            rejectedCount_";
  protected final String TEXT_575 = " = rejectedCount_";
  protected final String TEXT_576 = " + 1;";
  protected final String TEXT_577 = NL + "                            ";
  protected final String TEXT_578 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_579 = ";";
  protected final String TEXT_580 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_581 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_582 = "++;";
  protected final String TEXT_583 = NL + "            int updateFlag_";
  protected final String TEXT_584 = " = 0;";
  protected final String TEXT_585 = NL + "                    ";
  protected final String TEXT_586 = NL + "                        query_";
  protected final String TEXT_587 = " = ";
  protected final String TEXT_588 = ";";
  protected final String TEXT_589 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_590 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_591 = ".";
  protected final String TEXT_592 = ", pstmtUpdate_";
  ...
  protected final String TEXT_680 = NL + "                globalMap.put(\"";
  protected final String TEXT_681 = "_QUERY\", query_";
  protected final String TEXT_682 = ".toString().trim());";
  ...
  protected final String TEXT_768 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_769 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_770 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_771 = NL + "                \t\tint countSum_";
  protected final String TEXT_772 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_773 = ": pstmt_";
  protected final String TEXT_774 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_789 = " = 0;  " + NL + "\t                \t";
  protected final String TEXT_790 = NL + "            \t   ";
  protected final String TEXT_791 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_792 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_793 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_794 = NL + "\t                \tint countSum_";
  protected final String TEXT_795 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_796 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_797 = " += (countEach_";
  protected final String TEXT_798 = " < 0 ? 0 : countEach_";
  protected final String TEXT_799 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_800 = NL + "            \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_804 = " += countSum_";
  protected final String TEXT_805 = ";" + NL + "            \t    \t";
  protected final String TEXT_806 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_807 = " += countSum_";
  protected final String TEXT_808 = ";" + NL + "            \t    \t";
  protected final String TEXT_809 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_810 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_811 = NL + "                \tconn_";
  protected final String TEXT_812 = ".commit();                " + NL + "                \tcommitCounter_";
