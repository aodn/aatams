...
public class TSybaseSCDBeginJava {
  ...
  protected final String TEXT_13 = "\");" + NL + "        dbschema_";
  protected final String TEXT_14 = "= (String)globalMap.get(\"";
  protected final String TEXT_15 = "\");";
  protected final String TEXT_16 = NL + "        java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_17 = NL + "\t\tString connectionString_";
  protected final String TEXT_18 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = " + \"/\" + ";
  protected final String TEXT_21 = ";";
  protected final String TEXT_22 = NL + "\t\tString connectionString_";
  protected final String TEXT_23 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_24 = " + \":\" + ";
  protected final String TEXT_25 = " + \"/\" + ";
  protected final String TEXT_26 = " + \"?\" + ";
  protected final String TEXT_27 = ";";
  protected final String TEXT_28 = NL + "        java.sql.Connection connection_";
  protected final String TEXT_29 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_38 = ";" + NL + "\t} " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_39 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_40 = " = null;    ";
  protected final String TEXT_41 = NL + "        String searching_";
  protected final String TEXT_42 = " = \"";
  protected final String TEXT_43 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_44 = " = connection_";
  protected final String TEXT_45 = ".prepareStatement(searching_";
  protected final String TEXT_46 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_47 = " = null;";
  protected final String TEXT_48 = NL + "        String search_";
  protected final String TEXT_49 = " = \"";
  protected final String TEXT_50 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_51 = " = connection_";
  protected final String TEXT_52 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_53 = " = statement_";
  protected final String TEXT_54 = ".executeQuery(search_";
  protected final String TEXT_55 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_56 = ", SCDStruct_";
  protected final String TEXT_57 = "> cache_";
  protected final String TEXT_58 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_59 = ", SCDStruct_";
  protected final String TEXT_60 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_61 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_62 = " sk_";
  protected final String TEXT_63 = " = new SCDSK_";
  protected final String TEXT_64 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_65 = " row_";
  protected final String TEXT_66 = " = new SCDStruct_";
  protected final String TEXT_67 = "();";
  protected final String TEXT_68 = NL + "                    tmpValue_";
  protected final String TEXT_69 = " = resultSet_";
  ...
  protected final String TEXT_73 = ".length() > 0) {";
  protected final String TEXT_74 = NL + "                        ";
  protected final String TEXT_75 = ".";
  protected final String TEXT_76 = " = tmpValue_";
  protected final String TEXT_77 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_78 = NL + "                            if(tmpValue_";
  protected final String TEXT_79 = " == null) {";
  protected final String TEXT_80 = NL + "                                ";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = " = null;" + NL + "                            } else {";
  protected final String TEXT_83 = NL + "                                ";
  protected final String TEXT_84 = ".";
  protected final String TEXT_85 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_86 = NL + "                            if((\"\").equals(tmpValue_";
  ...
  protected final String TEXT_94 = NL + "                    timestamp_";
  protected final String TEXT_95 = " = resultSet_";
  protected final String TEXT_96 = ".getTimestamp(";
  protected final String TEXT_97 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_98 = " != null) {";
  protected final String TEXT_99 = NL + "                        ";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = " = new java.util.Date(timestamp_";
  protected final String TEXT_102 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_103 = NL + "                        ";
  protected final String TEXT_104 = ".";
  protected final String TEXT_105 = " = null;" + NL + "                    }";
  protected final String TEXT_106 = NL + "                    if(resultSet_";
  protected final String TEXT_107 = ".getObject(";
  protected final String TEXT_108 = ") != null) {";
  protected final String TEXT_109 = NL + "                        ";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = " = resultSet_";
  protected final String TEXT_112 = ".get";
  protected final String TEXT_113 = "(";
  protected final String TEXT_114 = ");" + NL + "                    }";
  protected final String TEXT_115 = NL + "            cache_";
  protected final String TEXT_116 = ".put(sk_";
  protected final String TEXT_117 = ", row_";
  protected final String TEXT_118 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_119 = ".close();" + NL + "        statement_";
  protected final String TEXT_120 = ".close();";
  protected final String TEXT_121 = NL + "            System.out.println(\"[";
  protected final String TEXT_122 = "] comparison cache loaded\");";
  protected final String TEXT_123 = NL + "        ";
  protected final String TEXT_124 = " nextSurrogateKey_";
  protected final String TEXT_125 = " = 1;";
  protected final String TEXT_126 = NL + "            if(cache_";
  protected final String TEXT_127 = ".size() > 0) {";
  protected final String TEXT_128 = NL + "        String tmpQuery_";
  protected final String TEXT_129 = " = \"SELECT MAX(";
  protected final String TEXT_130 = ") FROM \" + tableName_";
  protected final String TEXT_131 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_132 = " = connection_";
  protected final String TEXT_133 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_134 = " = tmpStmt_";
  protected final String TEXT_135 = ".executeQuery(tmpQuery_";
  protected final String TEXT_136 = ");";
  protected final String TEXT_137 = NL + "        if(tmpRS_";
  protected final String TEXT_138 = ".next() && tmpRS_";
  protected final String TEXT_139 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_140 = " = tmpRS_";
  protected final String TEXT_141 = ".get";
  protected final String TEXT_142 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_143 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_144 = ".close();";
  protected final String TEXT_145 = NL + "            }            ";
  protected final String TEXT_146 = NL + "    String insertionSQL_";
  protected final String TEXT_147 = " = \"";
  protected final String TEXT_148 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_149 = " = connection_";
  protected final String TEXT_150 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_151 = ");";
  protected final String TEXT_152 = NL + "            insertionStatement_";
  protected final String TEXT_153 = ".setTimestamp(";
  protected final String TEXT_154 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_155 = "\")));";
  protected final String TEXT_156 = NL + "            insertionStatement_";
  protected final String TEXT_157 = ".setNull(";
  protected final String TEXT_158 = ", java.sql.Types.DATE);";
  protected final String TEXT_159 = NL + "            insertionStatement_";
  protected final String TEXT_160 = ".setTimestamp(";
  protected final String TEXT_161 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_162 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_163 = NL + "        String updateSQLForType1_";
  protected final String TEXT_164 = " = \"";
  protected final String TEXT_165 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_166 = " = connection_";
  protected final String TEXT_167 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_168 = ");        ";
  protected final String TEXT_169 = NL + "        String updateSQLForType2_";
  protected final String TEXT_170 = " = \"";
  protected final String TEXT_171 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_172 = " = connection_";
  protected final String TEXT_173 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_174 = ");";
  protected final String TEXT_175 = NL + "            updateForType2_";
  protected final String TEXT_176 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_177 = "\")));";
  protected final String TEXT_178 = NL + "        String updateSQLForType3_";
  protected final String TEXT_179 = " = \"";
  protected final String TEXT_180 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_181 = " = connection_";
  protected final String TEXT_182 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "    ";
  protected final String TEXT_185 = NL + "        SCDSK_";
  protected final String TEXT_186 = " lookUpKey_";
  protected final String TEXT_187 = " = null;        ";
  protected final String TEXT_188 = NL + "    SCDStruct_";
  protected final String TEXT_189 = " lookUpValue_";
