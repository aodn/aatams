...
public class TSybaseSCDELTBeginJava {
  ...
  protected final String TEXT_28 = ";" + NL + "    String sourceTable_";
  protected final String TEXT_29 = " = ";
  protected final String TEXT_30 = ";";
  protected final String TEXT_31 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_32 = " = conn_";
  protected final String TEXT_33 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_52 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_53 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_54 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_55 = " = rsTable_";
  protected final String TEXT_56 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_57 = ".equalsIgnoreCase(";
  protected final String TEXT_58 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_59 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_60 = ".close();";
  protected final String TEXT_61 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_74 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_80 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_81 = " = conn_";
  protected final String TEXT_82 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_83 = ".executeUpdate(\"";
  protected final String TEXT_84 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_85 = ".close();";
  protected final String TEXT_86 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_87 = " = conn_";
  protected final String TEXT_88 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_89 = ".executeUpdate(\"";
  protected final String TEXT_90 = "\");" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_97 = " + \" SET ";
  protected final String TEXT_98 = " FROM \" + sourceTable_";
  protected final String TEXT_99 = " + \" t WHERE ";
  protected final String TEXT_100 = " AND (";
  protected final String TEXT_101 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_104 = ".executeUpdate(updateForType1_";
  protected final String TEXT_105 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_106 = ".close();";
  protected final String TEXT_107 = NL + "            System.out.println(\"[";
  protected final String TEXT_108 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_109 = " + \"\\ndone\");";
  protected final String TEXT_110 = NL + "        String updateForType2_";
  protected final String TEXT_111 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_112 = " + \" SET ";
  protected final String TEXT_113 = " = '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_114 = "\"))) + \"'";
  protected final String TEXT_115 = ", ";
  protected final String TEXT_116 = " = 0";
  protected final String TEXT_117 = " FROM \" + sourceTable_";
  protected final String TEXT_118 = " + \" t WHERE ";
  protected final String TEXT_119 = " AND (";
  protected final String TEXT_120 = ") AND \" + tableName_";
  protected final String TEXT_121 = " + \".";
  protected final String TEXT_122 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_125 = ".executeUpdate(updateForType2_";
  protected final String TEXT_126 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_127 = ".close();";
  protected final String TEXT_128 = NL + "            System.out.println(\"[";
  protected final String TEXT_129 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_130 = " + \"\\ndone\");";
  protected final String TEXT_131 = NL + "        String insertForType2_";
  protected final String TEXT_132 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_133 = " + \"(";
  protected final String TEXT_134 = ", ";
  protected final String TEXT_135 = ") SELECT ";
  protected final String TEXT_136 = "\" + ";
  protected final String TEXT_137 = " + \".NEXTVAL, ";
  protected final String TEXT_138 = "t.";
  protected final String TEXT_139 = ", '\" + " + NL + "        (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_140 = "\"))) + \"', NULL";
  protected final String TEXT_141 = ", 1";
  protected final String TEXT_142 = ", d.";
  protected final String TEXT_143 = " + 1";
  protected final String TEXT_144 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_145 = " + \" t, \" + tableName_";
  protected final String TEXT_146 = " + \" d WHERE ";
  protected final String TEXT_147 = " AND (";
  protected final String TEXT_148 = ") AND d.";
  protected final String TEXT_149 = " = '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_150 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_153 = ".executeUpdate(insertForType2_";
  protected final String TEXT_154 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_155 = ".close();";
  protected final String TEXT_156 = NL + "            System.out.println(\"[";
  protected final String TEXT_157 = "] type2 new active row slq\\n\" + insertForType2_";
  ...
  protected final String TEXT_165 = " + \".NEXTVAL, ";
  protected final String TEXT_166 = "t.";
  protected final String TEXT_167 = "\"";
  protected final String TEXT_168 = " + \", '\" + (new java.sql.Date((Long)start_Hash.get(\"";
  protected final String TEXT_169 = "\"))) + \"', NULL\"";
  protected final String TEXT_170 = NL + "    + \"";
  protected final String TEXT_171 = ", 1";
  protected final String TEXT_172 = ", 1";
  protected final String TEXT_173 = " FROM \" + " + NL + "    sourceTable_";
  protected final String TEXT_174 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_175 = " + \" d ON ";
  protected final String TEXT_176 = " WHERE (";
  protected final String TEXT_177 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_180 = ".executeUpdate(insert_";
  protected final String TEXT_181 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_182 = ".close();";
  protected final String TEXT_183 = NL + "        System.out.println(\"[";
  protected final String TEXT_184 = "] new rows sql\\n\" + insert_";
