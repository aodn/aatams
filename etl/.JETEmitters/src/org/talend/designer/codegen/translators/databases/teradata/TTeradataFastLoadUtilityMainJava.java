...
public class TTeradataFastLoadUtilityMainJava
{
  ...
  protected final String TEXT_65 = "= new String(\"fastload -c \"+";
  protected final String TEXT_66 = "+\" < \\\"\"+";
  protected final String TEXT_67 = "+";
  protected final String TEXT_68 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_69 = "+\"\\\" 2>&1\");";
  protected final String TEXT_70 = "\t" + NL + "String sb_";
  protected final String TEXT_71 = "= new String(\"fastload < \\\"\"+";
  protected final String TEXT_72 = "+";
  protected final String TEXT_73 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_74 = "+\"\\\" 2>&1\");";
  protected final String TEXT_75 = NL + "final Process process_";
  protected final String TEXT_76 = " = Runtime.getRuntime().exec(new String[]{\"cmd\",\"/c\",sb_";
  protected final String TEXT_77 = "}); ";
  protected final String TEXT_78 = NL + "final Process process_";
  protected final String TEXT_79 = " = Runtime.getRuntime().exec(new String[]{\"sh\",\"-c\",sb_";
  protected final String TEXT_80 = "});";
  protected final String TEXT_81 = NL + "Thread normal_";
  protected final String TEXT_82 = " = new Thread() {" + NL + "    public void run() {" + NL + "    \ttry {" + NL + "    \t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_83 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {" + NL + "    \t\tioe.printStackTrace();" + NL + "    \t}" + NL + "    }" + NL + "};" + NL + "normal_";
  protected final String TEXT_84 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_85 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_86 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_87 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_88 = ".waitFor();" + NL + "" + NL + "normal_";
  protected final String TEXT_89 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_90 = ".interrupt();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_91 = "_EXIT_VALUE\", process_";
  protected final String TEXT_92 = ".exitValue());" + NL;
  protected final String TEXT_93 = NL + "\tif(process_";
  protected final String TEXT_94 = ".exitValue()>=";
  protected final String TEXT_95 = ") {" + NL + "\t\tthrow new RuntimeException(\"Fastload returned exit code \"+process_";
  protected final String TEXT_96 = ".exitValue());" + NL + "\t}";
