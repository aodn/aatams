...
public class TTeradataMultiLoadMainJava
{
  ...
  protected final String TEXT_70 = "= new String(\"mload -c \"+";
  protected final String TEXT_71 = "+\" < \\\"\"+";
  protected final String TEXT_72 = "+";
  protected final String TEXT_73 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_74 = "+\"\\\" 2>&1\");";
  protected final String TEXT_75 = "\t" + NL + "String sb_";
  protected final String TEXT_76 = "= new String(\"mload < \\\"\"+";
  protected final String TEXT_77 = "+";
  protected final String TEXT_78 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_79 = "+\"\\\" 2>&1\");";
  protected final String TEXT_80 = NL + "final Process process_";
  protected final String TEXT_81 = " = Runtime.getRuntime().exec(new String[]{\"cmd\",\"/c\",sb_";
  protected final String TEXT_82 = "}); ";
  protected final String TEXT_83 = NL + "final Process process_";
  protected final String TEXT_84 = " = Runtime.getRuntime().exec(new String[]{\"sh\",\"-c\",sb_";
  protected final String TEXT_85 = "});";
  protected final String TEXT_86 = NL + "Thread normal_";
  ...
  protected final String TEXT_88 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {" + NL + "    \t\tioe.printStackTrace();" + NL + "    \t}" + NL + "    }" + NL + "};" + NL + "normal_";
  protected final String TEXT_89 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_90 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_91 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_92 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_93 = ".waitFor();" + NL + "" + NL + "normal_";
  protected final String TEXT_94 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_95 = ".interrupt();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_96 = "_EXIT_VALUE\", process_";
  protected final String TEXT_97 = ".exitValue());" + NL;
  protected final String TEXT_98 = NL + "\tif(process_";
  protected final String TEXT_99 = ".exitValue()>=";
  protected final String TEXT_100 = ") {" + NL + "\t\tthrow new RuntimeException(\"Multiload returned exit code \"+process_";
  protected final String TEXT_101 = ".exitValue());" + NL + "\t}";
