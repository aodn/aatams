...
public class TTeradataOutputEndJava
{
  ...
  protected final String TEXT_36 = NL + "                \t\t//throw(e);" + NL + "                \tboolean isFailure = false;" + NL + "                \tint errorCode = 0;" + NL + "\t\t\t\t\tString sqlState = \"\";" + NL + "\t\t\t\t\tString message = \"\";" + NL + "            \t    while(e != null){" + NL + "            \t    \tif(e.getErrorCode() == -2801){" + NL + "\t\t\t\t            System.out.println(\"[Message]: \" + e.getMessage());" + NL + "            \t    \t\te.printStackTrace();" + NL + "            \t    \t\tSystem.out.println();" + NL + "            \t    \t}" + NL + "            \t    \telse if(e.getErrorCode() == 1339){" + NL + "            \t    \t\tisFailure = true;" + NL + "            \t    \t}" + NL + "            \t    \telse{" + NL + "            \t    \t\t" + NL + " \t\t\t\t            System.out.println(\"[Message]: \" + e.getMessage());" + NL + "            \t    \t\te.printStackTrace();" + NL + "            \t    \t}" + NL + "            \t    \te = e.getNextException();" + NL + "            \t    }" + NL + "            \t    if(isFailure){" + NL + "\t\t\t\t         System.out.println(\"[Message]: \" + e.getMessage());" + NL + "            \t    \t e.printStackTrace();" + NL + "            \t    }" + NL + "                \t";
  protected final String TEXT_37 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_38 = "                \t" + NL + "            \t}                                  ";
  protected final String TEXT_39 = NL + "        " + NL + "        if(pstmt_";
  protected final String TEXT_40 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_41 = ".close();" + NL + "            pstmt_";
  protected final String TEXT_42 = " = null;" + NL + "        }        ";
  protected final String TEXT_43 = NL + "\t\t\tif (commitCounter_";
  protected final String TEXT_44 = " > 0)" + NL + "\t            conn_";
  protected final String TEXT_45 = ".commit();" + NL + "\t        ";
  protected final String TEXT_46 = NL + "\t    conn_";
  protected final String TEXT_47 = " .close();" + NL + "\t    ";
  protected final String TEXT_48 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_49 = "=nb_line_deleted_";
  protected final String TEXT_50 = "+ deletedCount_";
  protected final String TEXT_51 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_52 = "=nb_line_update_";
  protected final String TEXT_53 = " + updatedCount_";
  protected final String TEXT_54 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_55 = "=nb_line_inserted_";
  protected final String TEXT_56 = " + insertedCount_";
  protected final String TEXT_57 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_58 = "=nb_line_rejected_";
  protected final String TEXT_59 = " + rejectedCount_";
  ...
  protected final String TEXT_63 = "_NB_LINE_UPDATED\",nb_line_update_";
  ...
  protected final String TEXT_67 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_68 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_69 = "_NB_LINE_REJECTED\",nb_line_rejected_";
