...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_411 = NL + "    \t\t////////////////////////////" + NL + "            try {" + NL + "                insertedCount_";
  ...
  protected final String TEXT_415 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_416 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_417 = " = true;";
  protected final String TEXT_418 = NL + "                    throw(e_";
  ...
  protected final String TEXT_432 = ".errorMessage = e_";
  protected final String TEXT_433 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_434 = ";";
  protected final String TEXT_435 = NL + "                        System.err.print(e_";
  protected final String TEXT_436 = ".getMessage());";
  ...
  protected final String TEXT_443 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_444 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_445 = ".";
  protected final String TEXT_446 = ", pstmt_";
  ...
  protected final String TEXT_465 = ".addBatch();" + NL + "\t    \t\tnb_line_";
  protected final String TEXT_466 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_468 = "++;" + NL + "\t    \t\t";
  protected final String TEXT_469 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_470 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_471 = " = updatedCount_";
  protected final String TEXT_472 = " + pstmt_";
  protected final String TEXT_473 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_474 = "++;" + NL + "            } catch(Exception e_";
  protected final String TEXT_475 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_476 = " = true;";
  protected final String TEXT_477 = NL + "                    throw(e_";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL + "                        ";
  protected final String TEXT_480 = " = new ";
  protected final String TEXT_481 = "Struct();";
  protected final String TEXT_482 = NL + "                            ";
  protected final String TEXT_483 = ".";
  protected final String TEXT_484 = " = ";
  protected final String TEXT_485 = ".";
  protected final String TEXT_486 = ";";
  protected final String TEXT_487 = NL + "                        rejectedCount_";
  protected final String TEXT_488 = " = rejectedCount_";
  protected final String TEXT_489 = " + 1;";
  protected final String TEXT_490 = NL + "                        ";
  protected final String TEXT_491 = ".errorMessage = e_";
  protected final String TEXT_492 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_493 = ";";
  protected final String TEXT_494 = NL + "                        System.err.print(e_";
  protected final String TEXT_495 = ".getMessage());";
  ...
  protected final String TEXT_501 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_502 = " = pstmt_";
  protected final String TEXT_503 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_504 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_505 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_506 = " = rs_";
  protected final String TEXT_507 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_513 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_514 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_515 = ".";
  protected final String TEXT_516 = ", pstmtUpdate_";
  protected final String TEXT_517 = ", ";
  protected final String TEXT_518 = ", \"";
  protected final String TEXT_519 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_520 = NL + "\t                    \t";
  protected final String TEXT_521 = NL + "\t                    ";
  protected final String TEXT_522 = NL + "\t                        query_";
  ...
  protected final String TEXT_532 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_533 = " = updatedCount_";
  protected final String TEXT_534 = " + pstmtUpdate_";
  protected final String TEXT_535 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e_";
  protected final String TEXT_536 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_537 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_538 = NL + "    \t                throw(e_";
  protected final String TEXT_539 = ");" + NL + "    \t                ";
  protected final String TEXT_540 = NL + "                            ";
  protected final String TEXT_541 = " = new ";
  protected final String TEXT_542 = "Struct();";
  protected final String TEXT_543 = NL + "    \t                        ";
  protected final String TEXT_544 = ".";
  protected final String TEXT_545 = " = ";
  protected final String TEXT_546 = ".";
  protected final String TEXT_547 = ";" + NL + "    \t                        ";
  protected final String TEXT_548 = NL + "    \t                    rejectedCount_";
  protected final String TEXT_549 = " = rejectedCount_";
  protected final String TEXT_550 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_551 = ".errorMessage = e_";
  protected final String TEXT_552 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_553 = ";" + NL + "    \t                    ";
  protected final String TEXT_554 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_555 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_556 = NL + "    \t\t\t}" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_557 = NL + "                        ";
  protected final String TEXT_558 = NL + "                            query_";
  protected final String TEXT_559 = " = ";
  protected final String TEXT_560 = ";";
  protected final String TEXT_561 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_562 = ".";
  protected final String TEXT_563 = ", pstmtInsert_";
  protected final String TEXT_564 = ", ";
  protected final String TEXT_565 = ", \"";
  protected final String TEXT_566 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_567 = NL + "                    globalMap.put(\"";
  protected final String TEXT_568 = "_QUERY\", query_";
  protected final String TEXT_569 = ".toString().trim());";
  protected final String TEXT_570 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_571 = " = insertedCount_";
  protected final String TEXT_572 = " + pstmtInsert_";
  protected final String TEXT_573 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e_";
  protected final String TEXT_574 = ") {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_575 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_576 = NL + "    \t                throw(e_";
  ...
  protected final String TEXT_588 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_589 = ".errorMessage = e_";
  protected final String TEXT_590 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_591 = ";" + NL + "    \t                    ";
  protected final String TEXT_592 = NL + "    \t                    System.err.print(e_";
  protected final String TEXT_593 = ".getMessage());" + NL + "    \t                    ";
  protected final String TEXT_594 = NL + "    \t\t\t}" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_595 = "++;" + NL + "    \t\t";
  protected final String TEXT_596 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_602 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_603 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_604 = ".";
  protected final String TEXT_605 = ", pstmtUpdate_";
  ...
  protected final String TEXT_618 = NL + "                globalMap.put(\"";
  protected final String TEXT_619 = "_QUERY\", query_";
  protected final String TEXT_620 = ".toString().trim());";
  protected final String TEXT_621 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_622 = "=pstmtUpdate_";
  protected final String TEXT_623 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_624 = " = updatedCount_";
  protected final String TEXT_625 = " + updateFlag_";
  protected final String TEXT_626 = ";" + NL + "        \t} catch(Exception e_";
  protected final String TEXT_627 = ") {" + NL + "        \t    whetherReject_";
  protected final String TEXT_628 = " = true;" + NL + "        \t    ";
  protected final String TEXT_629 = NL + "                    throw(e_";
  protected final String TEXT_630 = ");";
  protected final String TEXT_631 = NL + "                       ";
  protected final String TEXT_632 = " = new ";
  protected final String TEXT_633 = "Struct();";
  protected final String TEXT_634 = NL + "                            ";
  protected final String TEXT_635 = ".";
  protected final String TEXT_636 = " = ";
  protected final String TEXT_637 = ".";
  protected final String TEXT_638 = ";";
  protected final String TEXT_639 = NL + "                        rejectedCount_";
  protected final String TEXT_640 = " = rejectedCount_";
  protected final String TEXT_641 = " + 1;";
  protected final String TEXT_642 = NL + "                        ";
  protected final String TEXT_643 = ".errorMessage = e_";
  protected final String TEXT_644 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_645 = ";";
  protected final String TEXT_646 = NL + "                        System.err.print(e_";
  protected final String TEXT_647 = ".getMessage());";
  protected final String TEXT_648 = NL + "        \t}" + NL + "        \tif(updateFlag_";
  protected final String TEXT_649 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_650 = NL + "\t\t\t\tquery_";
  protected final String TEXT_651 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_652 = NL + "                        ";
  protected final String TEXT_653 = NL + "                            query_";
  protected final String TEXT_654 = " = ";
  protected final String TEXT_655 = ";";
  protected final String TEXT_656 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_657 = ".";
  protected final String TEXT_658 = ", pstmtInsert_";
  protected final String TEXT_659 = ", ";
  protected final String TEXT_660 = ", \"";
  protected final String TEXT_661 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_662 = NL + "                    globalMap.put(\"";
  protected final String TEXT_663 = "_QUERY\", query_";
  protected final String TEXT_664 = ".toString().trim());";
  protected final String TEXT_665 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_666 = " = insertedCount_";
  protected final String TEXT_667 = " + pstmtInsert_";
  protected final String TEXT_668 = ".executeUpdate();" + NL + "        \t\t} catch(Exception e_";
  protected final String TEXT_669 = ") {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_670 = " = true;" + NL + "        \t\t    ";
  protected final String TEXT_671 = NL + "                        throw(e_";
  ...
  protected final String TEXT_685 = ".errorMessage = e_";
  protected final String TEXT_686 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_687 = ";";
  protected final String TEXT_688 = NL + "                            System.err.print(e_";
  protected final String TEXT_689 = ".getMessage());";
  protected final String TEXT_690 = NL + "        \t\t}" + NL + "        \t} " + NL + "        \tnb_line_";
  ...
  protected final String TEXT_701 = NL + "                globalMap.put(\"";
  protected final String TEXT_702 = "_QUERY\", query_";
  protected final String TEXT_703 = ".toString().trim());";
  protected final String TEXT_704 = NL + "    \t\t";
  protected final String TEXT_705 = NL + "    \t\t  pstmt_";
  protected final String TEXT_706 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_707 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_708 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_709 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_710 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_711 = " = deletedCount_";
  protected final String TEXT_712 = " + pstmt_";
  protected final String TEXT_713 = ".executeUpdate();" + NL + "    \t\t} catch(Exception e_";
  protected final String TEXT_714 = ") {" + NL + "    \t\t    whetherReject_";
  protected final String TEXT_715 = " = true;" + NL + "    \t\t    ";
  protected final String TEXT_716 = NL + "                    throw(e_";
  protected final String TEXT_717 = ");";
  protected final String TEXT_718 = NL + "                        ";
  protected final String TEXT_719 = " = new ";
  protected final String TEXT_720 = "Struct();";
  ...
  protected final String TEXT_730 = ".errorMessage = e_";
  protected final String TEXT_731 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_732 = ";";
  protected final String TEXT_733 = NL + "                        System.err.print(e_";
  protected final String TEXT_734 = ".getMessage());";
  protected final String TEXT_735 = NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_736 = "++;" + NL + "    \t\t//////////////////////////////////////    \t\t" + NL + "    \t\t";
  protected final String TEXT_737 = NL + NL + "    \t";
  protected final String TEXT_738 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_749 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_750 = " <= batchSizeCounter_";
  protected final String TEXT_751 = ") {                ";
  protected final String TEXT_752 = "                                                " + NL + "                try {" + NL + "                \t\tbatchSizeCounter_";
  protected final String TEXT_753 = " = 0; " + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_754 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_755 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_756 = " += pstmt_";
  protected final String TEXT_757 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_758 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_759 = " += pstmt_";
  protected final String TEXT_760 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_761 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_762 = " += pstmt_";
  protected final String TEXT_763 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_764 = "                         \t    \t" + NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_765 = "){" + NL + "                \t";
  protected final String TEXT_766 = NL + "\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_767 = " = e_";
  protected final String TEXT_768 = ";" + NL + "\t\t\t\t\twhile (e2_";
  protected final String TEXT_769 = " != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_770 = ".getMessage());" + NL + "\t\t\t\t\t\te2_";
  protected final String TEXT_771 = " = e2_";
  protected final String TEXT_772 = ".getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_773 = NL + "                \t";
  protected final String TEXT_774 = NL + "                \tboolean isFailure = false;" + NL + "            \t    while(e_";
  protected final String TEXT_775 = " != null){" + NL + "            \t    \tif(e_";
  protected final String TEXT_776 = ".getErrorCode() == -2801){" + NL + " \t\t\t\t            System.out.println(\" Message: \" + e_";
  protected final String TEXT_777 = ".getMessage());" + NL + "            \t    \t\te_";
  protected final String TEXT_778 = ".printStackTrace();" + NL + "            \t    \t\tSystem.out.println();" + NL + "            \t    \t}" + NL + "            \t    \telse if(e_";
  protected final String TEXT_779 = ".getErrorCode() == 1339){" + NL + "            \t    \t\tisFailure = true;" + NL + "            \t    \t}" + NL + "            \t    \telse{" + NL + " \t\t\t\t            System.out.println(\" Message: \" + e_";
  protected final String TEXT_780 = ".getMessage());" + NL + "            \t    \t\te_";
  protected final String TEXT_781 = ".printStackTrace();" + NL + "            \t    \t}" + NL + "            \t    \te_";
  protected final String TEXT_782 = " = e_";
  protected final String TEXT_783 = ".getNextException();" + NL + "            \t    }" + NL + "            \t    if(isFailure){" + NL + "\t\t\t\t            System.out.println(\" Message: \" + e_";
  protected final String TEXT_784 = ".getMessage());" + NL + "\t\t\t\t            e_";
  protected final String TEXT_785 = ".printStackTrace();" + NL + "            \t    }" + NL + "            \t    throw (e_";
  protected final String TEXT_786 = ");" + NL + "            \t\t";
  protected final String TEXT_787 = NL + "                \tSystem.err.println(e_";
  protected final String TEXT_788 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_789 = "  " + NL + "                }";
  protected final String TEXT_790 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_791 = NL + "                commitCounter_";
  protected final String TEXT_792 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_793 = " <= commitCounter_";
  protected final String TEXT_794 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_795 = NL + "\t\t                try {" + NL + "\t\t                \tcommitCounter_";
  protected final String TEXT_796 = " = 0;" + NL + "\t\t                \t";
  protected final String TEXT_797 = NL + "\t\t                \tbatchSizeCounter_";
  protected final String TEXT_798 = " = 0;  " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_799 = NL + "    \t\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_800 = " > 0 ) {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_801 = NL + "\t\t                \t\t    pstmt_";
  protected final String TEXT_802 = ".executeBatch();" + NL + "\t\t            \t    \t";
  protected final String TEXT_803 = NL + "\t\t            \t    \t\tinsertedCount_";
  protected final String TEXT_804 = " += pstmt_";
  protected final String TEXT_805 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_806 = "            \t    \t\t" + NL + "\t\t            \t    \t\tupdatedCount_";
  protected final String TEXT_807 = " += pstmt_";
  protected final String TEXT_808 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_809 = NL + "\t\t            \t    \t    deletedCount_";
  protected final String TEXT_810 = " += pstmt_";
  protected final String TEXT_811 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_812 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_813 = NL + "    \t\t\t\t\t\t\t}" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_814 = "\t" + NL + "\t\t\t\t\t\t\t\t                " + NL + "\t\t                \tconn_";
  protected final String TEXT_815 = ".commit();\t\t                \t" + NL + "\t\t                }catch(java.sql.SQLException e_";
  protected final String TEXT_816 = "){" + NL + "\t\t                \t";
  protected final String TEXT_817 = NL + "\t\t\t\t\t\t\tjava.sql.SQLException e2_";
  protected final String TEXT_818 = " = e_";
  protected final String TEXT_819 = ";" + NL + "\t\t\t\t\t\t\twhile (e2_";
  protected final String TEXT_820 = " != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e_";
  protected final String TEXT_821 = ".getMessage());" + NL + "\t\t\t\t\t\t\t\te2_";
  protected final String TEXT_822 = " = e2_";
  protected final String TEXT_823 = ".getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_824 = NL + "\t\t                \t";
  protected final String TEXT_825 = NL + "\t\t                \t boolean isFailure = false;" + NL + "\t\t                \t    while(e_";
  protected final String TEXT_826 = " != null){" + NL + "\t\t                \t    \tif(e_";
  protected final String TEXT_827 = ".getErrorCode() == -2801){" + NL + "\t\t     \t\t\t\t            System.out.println(\" Message: \" + e_";
  protected final String TEXT_828 = ".getMessage());" + NL + "\t\t                \t    \t\te_";
  protected final String TEXT_829 = ".printStackTrace();" + NL + "\t\t                \t    \t\tSystem.out.println();" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \telse if(e_";
  protected final String TEXT_830 = ".getErrorCode() == 1339){" + NL + "\t\t                \t    \t\tisFailure = true;" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \telse{" + NL + "\t\t     \t\t\t\t            System.out.println(\" Message: \" + e_";
  protected final String TEXT_831 = ".getMessage());" + NL + "\t\t                \t    \t\te_";
  protected final String TEXT_832 = ".printStackTrace();" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \te_";
  protected final String TEXT_833 = " = e_";
  protected final String TEXT_834 = ".getNextException();" + NL + "\t\t                \t    }" + NL + "\t\t                \t    if(isFailure){" + NL + "\t\t \t\t\t\t            System.out.println(\" Message: \" + e_";
  protected final String TEXT_835 = ".getMessage());" + NL + "\t\t                \t    \te_";
  protected final String TEXT_836 = ".printStackTrace();" + NL + "\t\t                \t    }" + NL + "            \t    \t\t\tthrow (e_";
  protected final String TEXT_837 = ");" + NL + "\t\t                \t    " + NL + "\t\t                \t";
  protected final String TEXT_838 = NL + "\t\t                        System.out.println(e_";
  protected final String TEXT_839 = ".getMessage());" + NL + "\t\t                \t";
