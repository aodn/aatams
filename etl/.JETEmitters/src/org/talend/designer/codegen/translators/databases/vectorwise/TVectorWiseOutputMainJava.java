...
public class TVectorWiseOutputMainJava {
  ...
  protected final String TEXT_34 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_35 = ";";
  protected final String TEXT_36 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_37 = NL + "            }";
  protected final String TEXT_38 = NL + "                    ";
  protected final String TEXT_39 = NL + "                        query_";
  ...
  protected final String TEXT_54 = ".toString().trim());";
  protected final String TEXT_55 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_56 = " = updatedCount_";
  protected final String TEXT_57 = " + pstmt_";
  protected final String TEXT_58 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_59 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_60 = " = true;";
  protected final String TEXT_61 = NL + "                    throw(e);";
  ...
  protected final String TEXT_71 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_72 = ";";
  protected final String TEXT_73 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_74 = NL + "            }";
  protected final String TEXT_75 = NL + "\t\t\t\t\t";
  protected final String TEXT_76 = NL + "                    \t";
  protected final String TEXT_77 = NL + "                    ";
  protected final String TEXT_78 = NL + "                    ";
  protected final String TEXT_79 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_80 = " = pstmt_";
  protected final String TEXT_81 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_82 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_83 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_84 = " = rs_";
  protected final String TEXT_85 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_103 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_104 = " = updatedCount_";
  protected final String TEXT_105 = " + pstmtUpdate_";
  protected final String TEXT_106 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_121 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_122 = NL + "                        ";
  protected final String TEXT_123 = NL + "                            query_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ";";
  protected final String TEXT_126 = NL + "                    globalMap.put(\"";
  protected final String TEXT_127 = "_QUERY\", query_";
  protected final String TEXT_128 = ".toString().trim());";
  protected final String TEXT_129 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_130 = " = insertedCount_";
  protected final String TEXT_131 = " + pstmtInsert_";
  protected final String TEXT_132 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_133 = " = true;";
  protected final String TEXT_134 = NL + "                        throw(e);";
  ...
  protected final String TEXT_144 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_145 = ";";
  protected final String TEXT_146 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_147 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_168 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_169 = "=pstmtUpdate_";
  protected final String TEXT_170 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_171 = " = updatedCount_";
  protected final String TEXT_172 = " + updateFlag_";
  protected final String TEXT_173 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_174 = " = true;";
  protected final String TEXT_175 = NL + "                    throw(e);";
  ...
  protected final String TEXT_188 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_189 = " == 0) {" + NL + "            \t";
  protected final String TEXT_190 = NL + "\t\t\t\tquery_";
  protected final String TEXT_191 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_202 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_203 = " = true;";
  protected final String TEXT_204 = NL + "                        throw(e);";
  ...
  protected final String TEXT_217 = NL + "                }" + NL + "            }" + NL + "           " + NL + "            nb_line_";
  ...
  protected final String TEXT_229 = "_QUERY\", query_";
  protected final String TEXT_230 = ".toString().trim());";
  protected final String TEXT_231 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_232 = " = deletedCount_";
  protected final String TEXT_233 = " + pstmt_";
  protected final String TEXT_234 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_235 = " = true;";
  protected final String TEXT_236 = NL + "                    throw(e);";
  protected final String TEXT_237 = NL + "                        ";
  protected final String TEXT_238 = " = new ";
  protected final String TEXT_239 = "Struct();";
  ...
  protected final String TEXT_249 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_250 = "++;";
  protected final String TEXT_251 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_262 = NL + "\t            commitCounter_";
  protected final String TEXT_263 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_264 = " <= commitCounter_";
  protected final String TEXT_265 = ") {" + NL + "\t            " + NL + "\t                conn_";
  protected final String TEXT_266 = ".commit();" + NL + "\t                " + NL + "\t                commitCounter_";
  protected final String TEXT_267 = "=0;" + NL + "\t            " + NL + "\t            }" + NL + "\t        " + NL + "\t        ";
