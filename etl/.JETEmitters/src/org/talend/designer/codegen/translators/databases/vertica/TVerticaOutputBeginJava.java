...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_12 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_13 = " = null;" + NL + "boolean whetherReject_";
  protected final String TEXT_14 = " = false;";
  protected final String TEXT_15 = NL;
  protected final String TEXT_16 = NL + "        int updateKeyCount_";
  protected final String TEXT_17 = " = ";
  protected final String TEXT_18 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_19 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_20 = NL + "        int deleteKeyCount_";
  protected final String TEXT_21 = " = ";
  protected final String TEXT_22 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_23 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_24 = " " + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_25 = " = null;" + NL + "\t\t   ";
  protected final String TEXT_26 = NL + "\t\t\t\tdbschema_";
  protected final String TEXT_27 = " = (String)globalMap.get(\"";
  protected final String TEXT_28 = "\");" + NL + "\t\t        conn_";
  protected final String TEXT_29 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_30 = "\");" + NL + "\t\t   ";
  protected final String TEXT_31 = NL + "\t\t   \t\t dbschema_";
  protected final String TEXT_32 = " = ";
  protected final String TEXT_33 = ";\t" + NL + "\t\t\t\tjava.lang.Class.forName(\"com.vertica.Driver\");" + NL + "\t\t\t\tString url_";
  protected final String TEXT_34 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_55 = ".setAutoCommit(false);" + NL + "        " + NL + "int commitEvery_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "        " + NL + "int commitCounter_";
  protected final String TEXT_58 = " = 0;        ";
  protected final String TEXT_59 = NL + "   int batchSize_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_69 = ");" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_70 = " = conn_";
  protected final String TEXT_71 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_72 = ".execute(\"";
  protected final String TEXT_73 = ")\");";
  protected final String TEXT_74 = NL + "            stmtCreate_";
  protected final String TEXT_75 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_76 = " + \"_proj (";
  protected final String TEXT_77 = ") AS SELECT ";
  protected final String TEXT_78 = " FROM \" + tableName_";
  ...
  protected final String TEXT_86 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_87 = " + \"_proj (";
  protected final String TEXT_88 = ") AS SELECT ";
  protected final String TEXT_89 = " FROM \" + tableName_";
  ...
  protected final String TEXT_99 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_100 = ".equalsIgnoreCase(";
  protected final String TEXT_101 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_102 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_103 = NL + "                if(!whetherExist_";
  protected final String TEXT_104 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_110 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_111 = " + \"_proj (";
  protected final String TEXT_112 = ") AS SELECT ";
  protected final String TEXT_113 = " FROM \" + tableName_";
  ...
  protected final String TEXT_122 = ");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_125 = ".execute(\"";
  protected final String TEXT_126 = ")\");";
  protected final String TEXT_127 = NL + "            \tstmtCreate_";
  protected final String TEXT_128 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_129 = " + \"_proj (";
  protected final String TEXT_130 = ") AS SELECT ";
  protected final String TEXT_131 = " FROM \" + tableName_";
  protected final String TEXT_132 = ");//";
  protected final String TEXT_133 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_134 = " = conn_";
  protected final String TEXT_135 = ".createStatement();" + NL + "            deletedCount_";
  protected final String TEXT_136 = " = stmtClear_";
  protected final String TEXT_137 = ".executeUpdate(\"";
  protected final String TEXT_138 = "\");";
  protected final String TEXT_139 = NL + "        String insert_";
  ...
  protected final String TEXT_145 = ".prepareStatement(insert_";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "        int batchCount_";
  protected final String TEXT_148 = " = 0;";
  protected final String TEXT_149 = NL + "        String update_";
  protected final String TEXT_150 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_151 = " + \" SET ";
  protected final String TEXT_152 = " WHERE ";
  protected final String TEXT_153 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".prepareStatement(update_";
  protected final String TEXT_156 = ");";
  protected final String TEXT_157 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_160 = " + \" WHERE ";
  protected final String TEXT_161 = "\");" + NL + "        String insert_";
  protected final String TEXT_162 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_163 = " + \" (";
  protected final String TEXT_164 = ") VALUES (";
  protected final String TEXT_165 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".prepareStatement(insert_";
  protected final String TEXT_168 = ");" + NL + "        String update_";
  protected final String TEXT_169 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_170 = " + \" SET ";
  protected final String TEXT_171 = " WHERE ";
  protected final String TEXT_172 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".prepareStatement(update_";
  protected final String TEXT_175 = ");    ";
  protected final String TEXT_176 = NL + "        String update_";
  protected final String TEXT_177 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_178 = " + \" SET ";
  protected final String TEXT_179 = " WHERE ";
  protected final String TEXT_180 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_181 = " = conn_";
  protected final String TEXT_182 = ".prepareStatement(update_";
  protected final String TEXT_183 = ");" + NL + "        String insert_";
  protected final String TEXT_184 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_191 = NL + "        String delete_";
  protected final String TEXT_192 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_193 = " + \" WHERE ";
  protected final String TEXT_194 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".prepareStatement(delete_";
  protected final String TEXT_197 = ");";
  protected final String TEXT_198 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_199 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".createStatement();\t" + NL + "        String template_";
  protected final String TEXT_202 = " = \"COPY \" + tableName_";
  protected final String TEXT_203 = " +\" (";
  protected final String TEXT_204 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_205 = "DIRECT";
  protected final String TEXT_206 = "\";" + NL + "\t\t";
  protected final String TEXT_207 = NL + "        StringBuffer query_";
  protected final String TEXT_208 = " = null;" + NL + "       \t";
  protected final String TEXT_209 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_210 = " = insert_";
  protected final String TEXT_211 = ".split(\"\\\\?\");";
  protected final String TEXT_212 = NL + "\t\t\tupdate_";
  protected final String TEXT_213 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_214 = " = update_";
  protected final String TEXT_215 = ".split(\"\\\\?\");";
  protected final String TEXT_216 = NL + "\t\t\tupdate_";
  protected final String TEXT_217 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_218 = " = update_";
  protected final String TEXT_219 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_220 = " = insert_";
  protected final String TEXT_221 = ".split(\"\\\\?\");";
  protected final String TEXT_222 = NL + "\t\t\tdelete_";
  protected final String TEXT_223 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_224 = " = delete_";
  protected final String TEXT_225 = ".split(\"\\\\?\");";
  protected final String TEXT_226 = NL + "\t\t\treplace_";
  protected final String TEXT_227 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_228 = " = replace_";
  protected final String TEXT_229 = ".split(\"\\\\?\");";
  protected final String TEXT_230 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_231 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_232 = " = insertIgnore_";
  protected final String TEXT_233 = ".split(\"\\\\?\");";
  ...
  protected final String TEXT_237 = NL + NL + NL;
