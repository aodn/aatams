...
public class TVerticaSCDBeginJava {
  ...
  protected final String TEXT_15 = NL + "        java.lang.Class.forName(\"com.vertica.Driver\");" + NL + "        dbschema_";
  protected final String TEXT_16 = " = ";
  protected final String TEXT_17 = ";\t" + NL + "\t\tjava.lang.Class.forName(\"com.vertica.Driver\");" + NL + "\t\tString url_";
  protected final String TEXT_18 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_19 = " + \":\" + ";
  protected final String TEXT_20 = " + \"/\" + ";
  protected final String TEXT_21 = ";" + NL + "\t\tString dbUser_";
  protected final String TEXT_22 = " = ";
  protected final String TEXT_23 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_24 = " = ";
  protected final String TEXT_25 = ";" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_30 = NL + "    if(dbschema_";
  protected final String TEXT_31 = "!=null&&!\"\".equals(dbschema_";
  protected final String TEXT_32 = ")){" + NL + "    \ttableName_";
  protected final String TEXT_33 = " =dbschema_";
  protected final String TEXT_34 = "+\".\"+tableName_";
  protected final String TEXT_35 = ";" + NL + "    }";
  protected final String TEXT_36 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_37 = " = connection_";
  protected final String TEXT_38 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_39 = ".execute(\"";
  protected final String TEXT_40 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_41 = ".close();";
  protected final String TEXT_42 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_43 = " = connection_";
  protected final String TEXT_44 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_45 = " = dbMetaData_";
  protected final String TEXT_46 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_47 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_48 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_49 = " = rsTable_";
  protected final String TEXT_50 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_51 = ".equalsIgnoreCase(";
  protected final String TEXT_52 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_53 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            if(!whetherExist_";
  protected final String TEXT_54 = ") {" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_60 = NL + "        " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_61 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_62 = " = null;    ";
  protected final String TEXT_63 = NL + "        String searching_";
  protected final String TEXT_64 = " = \"";
  protected final String TEXT_65 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_66 = " = connection_";
  protected final String TEXT_67 = ".prepareStatement(searching_";
  protected final String TEXT_68 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_69 = " = null;";
  protected final String TEXT_70 = NL + "        String search_";
  protected final String TEXT_71 = " = \"";
  protected final String TEXT_72 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_73 = " = connection_";
  protected final String TEXT_74 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_75 = " = statement_";
  protected final String TEXT_76 = ".executeQuery(search_";
  protected final String TEXT_77 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_78 = ", SCDStruct_";
  protected final String TEXT_79 = "> cache_";
  protected final String TEXT_80 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_81 = ", SCDStruct_";
  protected final String TEXT_82 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_83 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_84 = " sk_";
  protected final String TEXT_85 = " = new SCDSK_";
  protected final String TEXT_86 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_87 = " row_";
  protected final String TEXT_88 = " = new SCDStruct_";
  protected final String TEXT_89 = "();";
  protected final String TEXT_90 = NL + "                    tmpValue_";
  ...
  protected final String TEXT_94 = " != null && tmpValue_";
  protected final String TEXT_95 = ".length() > 0) {";
  protected final String TEXT_96 = NL + "                        ";
  protected final String TEXT_97 = ".";
  protected final String TEXT_98 = " = tmpValue_";
  protected final String TEXT_99 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_100 = NL + "                            if(tmpValue_";
  protected final String TEXT_101 = " == null) {";
  protected final String TEXT_102 = NL + "                                ";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = " = null;" + NL + "                            } else {";
  protected final String TEXT_105 = NL + "                                ";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_108 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_109 = ")) {";
  protected final String TEXT_110 = NL + "                                ";
  protected final String TEXT_111 = ".";
  protected final String TEXT_112 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_116 = NL + "                    timestamp_";
  protected final String TEXT_117 = " = resultSet_";
  protected final String TEXT_118 = ".getTimestamp(";
  protected final String TEXT_119 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_120 = " != null) {";
  protected final String TEXT_121 = NL + "                        ";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = " = new java.util.Date(timestamp_";
  protected final String TEXT_124 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_125 = NL + "                        ";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = " = null;" + NL + "                    }";
  protected final String TEXT_128 = NL + "                    if(resultSet_";
  protected final String TEXT_129 = ".getObject(";
  protected final String TEXT_130 = ") != null) {";
  protected final String TEXT_131 = NL + "                        ";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = " = resultSet_";
  protected final String TEXT_134 = ".get";
  protected final String TEXT_135 = "(";
  protected final String TEXT_136 = ");" + NL + "                    }";
  protected final String TEXT_137 = NL + "            cache_";
  protected final String TEXT_138 = ".put(sk_";
  protected final String TEXT_139 = ", row_";
  protected final String TEXT_140 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_141 = ".close();" + NL + "        statement_";
  protected final String TEXT_142 = ".close();";
  protected final String TEXT_143 = NL + "            System.out.println(\"[";
  protected final String TEXT_144 = "] comparison cache loaded\");";
  protected final String TEXT_145 = NL + "        ";
  protected final String TEXT_146 = " nextSurrogateKey_";
  protected final String TEXT_147 = " = 1;";
  protected final String TEXT_148 = NL + "            if(cache_";
  protected final String TEXT_149 = ".size() > 0) {";
  protected final String TEXT_150 = NL + "        String tmpQuery_";
  protected final String TEXT_151 = " = \"SELECT MAX(";
  protected final String TEXT_152 = ") FROM \" + tableName_";
  protected final String TEXT_153 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_154 = " = connection_";
  protected final String TEXT_155 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_156 = " = tmpStmt_";
  protected final String TEXT_157 = ".executeQuery(tmpQuery_";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "        if(tmpRS_";
  protected final String TEXT_160 = ".next() && tmpRS_";
  protected final String TEXT_161 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_162 = " = tmpRS_";
  protected final String TEXT_163 = ".get";
  protected final String TEXT_164 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_165 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_166 = ".close();";
  protected final String TEXT_167 = NL + "            }            ";
  protected final String TEXT_168 = NL + "    String insertionSQL_";
  protected final String TEXT_169 = " = \"";
  protected final String TEXT_170 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_171 = " = connection_";
  protected final String TEXT_172 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_173 = ");";
  protected final String TEXT_174 = NL + "            insertionStatement_";
  protected final String TEXT_175 = ".setTimestamp(";
  protected final String TEXT_176 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_177 = "\")));";
  protected final String TEXT_178 = NL + "            insertionStatement_";
  protected final String TEXT_179 = ".setNull(";
  protected final String TEXT_180 = ", java.sql.Types.DATE);";
  protected final String TEXT_181 = NL + "            insertionStatement_";
  protected final String TEXT_182 = ".setTimestamp(";
  protected final String TEXT_183 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_184 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_185 = NL + "        String updateSQLForType1_";
  protected final String TEXT_186 = " = \"";
  protected final String TEXT_187 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_188 = " = connection_";
  protected final String TEXT_189 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_190 = ");        ";
  protected final String TEXT_191 = NL + "        String updateSQLForType2_";
  protected final String TEXT_192 = " = \"";
  protected final String TEXT_193 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_194 = " = connection_";
  protected final String TEXT_195 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_196 = ");";
  protected final String TEXT_197 = NL + "            updateForType2_";
  protected final String TEXT_198 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_199 = "\")));";
  protected final String TEXT_200 = NL + "        String updateSQLForType3_";
  protected final String TEXT_201 = " = \"";
  protected final String TEXT_202 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_203 = " = connection_";
  protected final String TEXT_204 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "    ";
  protected final String TEXT_207 = NL + "        SCDSK_";
  protected final String TEXT_208 = " lookUpKey_";
  protected final String TEXT_209 = " = null;        ";
  protected final String TEXT_210 = NL + "    SCDStruct_";
