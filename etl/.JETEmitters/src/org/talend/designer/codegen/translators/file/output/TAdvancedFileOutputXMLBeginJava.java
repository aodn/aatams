...
public class TAdvancedFileOutputXMLBeginJava
{
  ...
  protected final String TEXT_68 = ".removeWhiteSpaceTextNode(doc_";
  protected final String TEXT_69 = ".getRootElement());" + NL + "\t\t\t\t\t} catch (Exception ex) {" + NL + "\t\t\t\t\t\tex.printStackTrace();" + NL + "\t\t\t\t\t\tthrow new Exception(\"can not find the file:\" + fileName_";
  protected final String TEXT_70 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdoc_";
  protected final String TEXT_71 = "=org.dom4j.DocumentHelper.createDocument();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\torg.dom4j.Element firstGroupPathElement_";
  protected final String TEXT_73 = " = null;" + NL + "\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\tdoc_";
  protected final String TEXT_76 = "=org.dom4j.DocumentHelper.createDocument();" + NL + "\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\t\t\tdoc_";
  protected final String TEXT_78 = ".addDocType(";
  protected final String TEXT_79 = ", null, ";
  protected final String TEXT_80 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\t\t\tjava.util.Map<String, String> inMap_";
  protected final String TEXT_82 = " = new java.util.HashMap<String, String>();" + NL + "\t\t\t\t\t\tinMap_";
  protected final String TEXT_83 = ".put(\"type\",";
  protected final String TEXT_84 = ");" + NL + "\t\t\t\t\t\tinMap_";
  protected final String TEXT_85 = ".put(\"href\",";
  protected final String TEXT_86 = ");" + NL + "\t\t\t\t\t\tdoc_";
  protected final String TEXT_87 = ".addProcessingInstruction(\"xml-stylesheet\", inMap_";
  protected final String TEXT_88 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\torg.dom4j.io.OutputFormat format_";
  protected final String TEXT_90 = " = org.dom4j.io.OutputFormat.createCompactFormat();" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\torg.dom4j.io.OutputFormat format_";
  protected final String TEXT_92 = " = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\tformat_";
  protected final String TEXT_94 = ".setTrimText(";
  protected final String TEXT_95 = ");" + NL + "\t\t\tformat_";
  protected final String TEXT_96 = ".setEncoding(";
  protected final String TEXT_97 = ");" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\tint[] orders_";
  protected final String TEXT_99 = " = new int[";
  protected final String TEXT_100 = "];" + NL + "\t\t";
  protected final String TEXT_101 = NL + "\t\t\tjava.util.List<String> endTabStrs_";
  protected final String TEXT_102 = " = new java.util.ArrayList<String>();" + NL + "\t\t\tjava.util.List<String> startTabStrs_";
  protected final String TEXT_103 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\t\t\tendTabStrs_";
  protected final String TEXT_105 = ".add(\"";
  protected final String TEXT_106 = "</";
  protected final String TEXT_107 = ">\");" + NL + "\t\t\t\t\tstartTabStrs_";
  protected final String TEXT_108 = ".add(\"";
  protected final String TEXT_109 = "<";
  protected final String TEXT_110 = ">\");" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_111 = NL + "\t\t\tint preUnNullMaxIndex_";
  protected final String TEXT_112 = " = -1;" + NL + "\t\t\tint preNewTabIndex_";
  protected final String TEXT_113 = " = -1;" + NL + "\t\t\tString[] startTabs_";
  protected final String TEXT_114 = " = new String[endTabStrs_";
  protected final String TEXT_115 = ".size()];" + NL + "\t\t\tString[] endTabs_";
  protected final String TEXT_116 = " = new String[endTabStrs_";
  protected final String TEXT_117 = ".size()];" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t//String[] mainEndTabs_";
  protected final String TEXT_119 = " = new String[";
  protected final String TEXT_120 = "];" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\tjava.io.BufferedWriter out_";
  protected final String TEXT_122 = " = new java.io.BufferedWriter(" + NL + "\t\t\t\tnew java.io.OutputStreamWriter(new java.io.FileOutputStream(fileName_";
  protected final String TEXT_123 = "), ";
  protected final String TEXT_124 = "));" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_126 = " = new java.io.OutputStreamWriter(";
  protected final String TEXT_127 = ", ";
  protected final String TEXT_128 = ");" + NL + "\t\t\t\tjava.io.BufferedWriter out_";
  protected final String TEXT_129 = " = new java.io.BufferedWriter(outWriter_";
  protected final String TEXT_130 = ");" + NL + "\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\tout_";
  protected final String TEXT_132 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_133 = "+\"\\\"?>\");" + NL + "\t\t\tout_";
  protected final String TEXT_134 = ".newLine();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t\tout_";
  protected final String TEXT_136 = ".write(\"<!DOCTYPE \"+";
  protected final String TEXT_137 = "+\" SYSTEM \\\"\" + ";
  protected final String TEXT_138 = " + \"\\\">\");" + NL + "\t\t\t\t\tout_";
  protected final String TEXT_139 = ".newLine();" + NL + "\t\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\t\tout_";
  protected final String TEXT_141 = ".write(\"<?xml-stylesheet type=\\\"\"+";
  protected final String TEXT_142 = "+\"\\\" href=\\\"\"+";
  protected final String TEXT_143 = "+\"\\\">\");" + NL + "\t\t\t\t\tout_";
  protected final String TEXT_144 = ".newLine();" + NL + "\t\t\t\t";
