...
public class TAdvancedFileOutputXMLMainJava {
  ...
  protected final String TEXT_370 = NL + "\t\tif(firstGroupPathElement_";
  protected final String TEXT_371 = " == null){" + NL + "\t\t\tfirstGroupPathElement_";
  protected final String TEXT_372 = " = (org.dom4j.Element)doc_";
  protected final String TEXT_373 = ".selectSingleNode(\"";
  protected final String TEXT_374 = "\");" + NL + "\t\t\tif(firstGroupPathElement_";
  protected final String TEXT_375 = " == null){" + NL + "\t\t\t\tfirstGroupPathElement_";
  protected final String TEXT_376 = " = (org.dom4j.Element)doc_";
  protected final String TEXT_377 = ".selectSingleNode(\"";
  protected final String TEXT_378 = "\");" + NL + "\t\t\t\tif(firstGroupPathElement_";
  protected final String TEXT_379 = " == null) {" + NL + "\t\t\t\t\tSystem.err.println(\"WARN : the root tag is not same when appending\");" + NL + "\t\t\t\t} else { " + NL + "\t\t\t\t\tString subRootPath = firstGroupPathElement_";
  protected final String TEXT_380 = ".getPath().replace(\"*[name()='\",\"\").replace(\"']\", \"\");" + NL + "\t\t\t\t\tif(!\"";
  protected final String TEXT_381 = "\".equals(subRootPath)) {" + NL + "\t\t\t\t\t\tSystem.err.println(\"WARN : the root tag is not same on namespace prefix when appending\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tfirstGroupPathElement_";
  protected final String TEXT_382 = " = firstGroupPathElement_";
  protected final String TEXT_383 = ".getParent();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tsubTreeRootParent_";
  protected final String TEXT_384 = " = firstGroupPathElement_";
  protected final String TEXT_385 = ";" + NL + "\t\t" + NL + "\t\tboolean bl_";
  protected final String TEXT_386 = "= false;//true:find the insert node;false:not";
  protected final String TEXT_387 = NL + "\t\tif(bl_";
  protected final String TEXT_388 = "==false){" + NL + "\t\t\tjava.util.List<org.dom4j.Element> listNodes= subTreeRootParent_";
  protected final String TEXT_389 = ".elements();" + NL + "\t\t\tif(listNodes!=null && listNodes.size()>0){" + NL + "\t\t\t\tint j=0;" + NL + "\t\t\t\tfor(j=0;j<listNodes.size();j++){" + NL + "\t\t\t\t\torg.dom4j.Element tempElem =listNodes.get(j);" + NL + "\t\t\t\t\tif((\"";
  protected final String TEXT_390 = "\").equals(tempElem.getPath()!=null ? tempElem.getPath().replace(\"*[name()='\",\"\").replace(\"']\", \"\") : \"\")){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_391 = "){" + NL + "\t\t\t\t\t\t\tsubTreeRootParent_";
  protected final String TEXT_392 = " =  tempElem;" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(j>=listNodes.size()){" + NL + "\t\t\t\t\tbl_";
  protected final String TEXT_393 = "=true;" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbl_";
  protected final String TEXT_394 = "=true;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif(bl_";
  protected final String TEXT_395 = "==true){";
  protected final String TEXT_396 = NL + "\t\t}";
  protected final String TEXT_397 = NL + "\tboolean isNewElememt_";
  protected final String TEXT_398 = " = false;";
  protected final String TEXT_399 = NL + "\tif(isNewElememt_";
  protected final String TEXT_400 = " || groupbyList_";
  protected final String TEXT_401 = ".size()<=";
  protected final String TEXT_402 = " || groupbyList_";
  protected final String TEXT_403 = ".get(";
  protected final String TEXT_404 = ")==null";
  protected final String TEXT_405 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_406 = ".get(";
  protected final String TEXT_407 = ").get(";
  protected final String TEXT_408 = ")!=null " + NL + "\t\t? !groupbyList_";
  protected final String TEXT_409 = ".get(";
  protected final String TEXT_410 = ").get(";
  protected final String TEXT_411 = ").equals(";
  protected final String TEXT_412 = ") " + NL + "\t\t: ";
  protected final String TEXT_413 = "!=null )";
  protected final String TEXT_414 = NL + "\t){";
  protected final String TEXT_415 = NL + "\t\tif(groupbyList_";
  protected final String TEXT_416 = ".size()<=";
  protected final String TEXT_417 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_418 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_419 = ".get(";
  protected final String TEXT_420 = ").clear();" + NL + "        }";
  protected final String TEXT_421 = NL + "\t\tgroupbyList_";
  protected final String TEXT_422 = ".get(";
  protected final String TEXT_423 = ").add(";
  protected final String TEXT_424 = ");";
  protected final String TEXT_425 = NL + "        isNewElememt_";
  protected final String TEXT_426 = "=true;" + NL + "        if(groupElementList_";
  protected final String TEXT_427 = ".size()<=";
  protected final String TEXT_428 = "){" + NL + "\t\t\tgroupElementList_";
  protected final String TEXT_429 = ".add(group";
  protected final String TEXT_430 = "__";
  protected final String TEXT_431 = ");" + NL + "        }else{" + NL + "        \tgroupElementList_";
  protected final String TEXT_432 = ".set(";
  protected final String TEXT_433 = ",group";
  protected final String TEXT_434 = "__";
  protected final String TEXT_435 = ");" + NL + "        }" + NL + "        " + NL + "\t}else{" + NL + "\t\tsubTreeRootParent_";
  protected final String TEXT_436 = "=groupElementList_";
  protected final String TEXT_437 = ".get(";
  protected final String TEXT_438 = ");" + NL + "\t}" + NL;
  protected final String TEXT_439 = NL + "\t// build loop xml tree";
  protected final String TEXT_440 = NL + "    currentRowCount_";
  protected final String TEXT_441 = "++;" + NL + "    if(currentRowCount_";
  protected final String TEXT_442 = " == ";
  protected final String TEXT_443 = "){" + NL + "    \tneedRoot_";
  protected final String TEXT_444 = "  = true;" + NL + "    \tfileName_";
  protected final String TEXT_445 = " = file_";
  protected final String TEXT_446 = " + currentFileCount_";
  protected final String TEXT_447 = " + suffix_";
  protected final String TEXT_448 = ";" + NL + "        currentRowCount_";
  protected final String TEXT_449 = " = 0;" + NL + "        currentFileCount_";
  protected final String TEXT_450 = "++;" + NL + "    \tgroupbyList_";
  protected final String TEXT_451 = ".clear();" + NL + "" + NL + "    \tjava.io.FileOutputStream stream_";
  protected final String TEXT_452 = " = new java.io.FileOutputStream(fileName_";
  protected final String TEXT_453 = ");" + NL + "        org.dom4j.io.XMLWriter output_";
  protected final String TEXT_454 = " = new org.dom4j.io.XMLWriter(stream_";
  protected final String TEXT_455 = ", format_";
  protected final String TEXT_456 = ");";
  protected final String TEXT_457 = NL + "\t\tdoc_";
  protected final String TEXT_458 = ".getRootElement().addAttribute(\"xsi:noNamespaceSchemaLocation\", file_";
  protected final String TEXT_459 = ".substring(file_";
  protected final String TEXT_460 = ".lastIndexOf(\"/\")+1)+\".xsd\");" + NL + "        doc_";
  protected final String TEXT_461 = ".getRootElement().addNamespace(\"xsi\", \"http://www.w3.org/2001/XMLSchema-instance\");";
  protected final String TEXT_462 = "        " + NL + "        nestXMLTool_";
  protected final String TEXT_463 = ".replaceDefaultNameSpace(doc_";
  protected final String TEXT_464 = ".getRootElement());";
  protected final String TEXT_465 = NL + "\t\tnestXMLTool_";
  protected final String TEXT_466 = ".removeEmptyElement(doc_";
  protected final String TEXT_467 = ".getRootElement());";
  protected final String TEXT_468 = NL + "        output_";
  protected final String TEXT_469 = ".write(doc_";
  protected final String TEXT_470 = ");" + NL + "        output_";
  protected final String TEXT_471 = ".close();" + NL + "        doc_";
  protected final String TEXT_472 = "  = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tgroupElementList_";
  protected final String TEXT_473 = ".clear();" + NL + "    }";
  protected final String TEXT_474 = NL + "\tStringBuffer buf_";
  protected final String TEXT_475 = " = new StringBuffer();" + NL + "\t//init value is 0 not -1, because it will output the root tab when all the row value is null." + NL + "\tint unNullMaxIndex_";
  protected final String TEXT_476 = " = 0;" + NL + "" + NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_477 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_478 = "=false;";
  protected final String TEXT_479 = NL + "\t\tif( false";
  protected final String TEXT_480 = " || valueMap_";
  protected final String TEXT_481 = ".get(\"";
  protected final String TEXT_482 = "\") != null";
  protected final String TEXT_483 = NL + "\t\t){" + NL + "\t\t\tunNullMaxIndex_";
  protected final String TEXT_484 = " = ";
  protected final String TEXT_485 = ";" + NL + "\t\t}";
  protected final String TEXT_486 = NL + "\t\tendTabs_";
  protected final String TEXT_487 = "[";
  protected final String TEXT_488 = "] = buf_";
  protected final String TEXT_489 = ".toString();" + NL + "\t\tbuf_";
  protected final String TEXT_490 = " = new StringBuffer();";
  protected final String TEXT_491 = NL + "\t}" + NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_492 = NL + "\tboolean isNewElememt_";
  protected final String TEXT_493 = " = false;" + NL + "\t//The index of group element which is the first new group in groups." + NL + "\tint newTabIndex_";
  protected final String TEXT_494 = " = -1;" + NL + "\t//Buffer all group tab XML, then set to startTabBuffer." + NL + "    String[] groupBuffer_";
  protected final String TEXT_495 = " = new String[";
  protected final String TEXT_496 = "];" + NL + "    String[] groupEndBuffer_";
  protected final String TEXT_497 = " = new String[";
  protected final String TEXT_498 = "];";
  protected final String TEXT_499 = NL + NL + "\t// need a new group element ";
  protected final String TEXT_500 = " or not" + NL + "\tif(isNewElememt_";
  protected final String TEXT_501 = " || groupbyList_";
  protected final String TEXT_502 = ".size()<=";
  protected final String TEXT_503 = " || groupbyList_";
  protected final String TEXT_504 = ".get(";
  protected final String TEXT_505 = ")==null";
  protected final String TEXT_506 = NL + "\t|| ( groupbyList_";
  protected final String TEXT_507 = ".get(";
  protected final String TEXT_508 = ").get(";
  protected final String TEXT_509 = ")!=null " + NL + "\t\t? !groupbyList_";
  protected final String TEXT_510 = ".get(";
  protected final String TEXT_511 = ").get(";
  protected final String TEXT_512 = ").equals(";
  protected final String TEXT_513 = ") " + NL + "\t\t: ";
  protected final String TEXT_514 = "!=null )";
  protected final String TEXT_515 = NL + "\t){" + NL + "\t\t// Is the first new element in groups." + NL + "\t\tif(isNewElememt_";
  protected final String TEXT_516 = " == false && groupbyList_";
  protected final String TEXT_517 = ".size()>";
  protected final String TEXT_518 = "){" + NL + "\t\t\tnewTabIndex_";
  protected final String TEXT_519 = " = ";
  protected final String TEXT_520 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\t// count the groupby element" + NL + "\t\tif(groupbyList_";
  protected final String TEXT_521 = ".size()<=";
  protected final String TEXT_522 = "){" + NL + "        \tgroupbyList_";
  protected final String TEXT_523 = ".add(new java.util.ArrayList<String>());" + NL + "        }else{" + NL + "        \tgroupbyList_";
  protected final String TEXT_524 = ".get(";
  protected final String TEXT_525 = ").clear();" + NL + "        }";
  protected final String TEXT_526 = NL + "\t\tgroupbyList_";
  protected final String TEXT_527 = ".get(";
  protected final String TEXT_528 = ").add(";
  protected final String TEXT_529 = ");";
  protected final String TEXT_530 = NL + "        isNewElememt_";
  protected final String TEXT_531 = "=true;" + NL + "\t}" + NL + "\t" + NL + "\t// subtree XML string generate";
  protected final String TEXT_532 = NL + "\tif( false";
  protected final String TEXT_533 = " || valueMap_";
  protected final String TEXT_534 = ".get(\"";
  protected final String TEXT_535 = "\") != null";
  protected final String TEXT_536 = NL + "\t){" + NL + "\t\tunNullMaxIndex_";
  protected final String TEXT_537 = " = ";
  protected final String TEXT_538 = ";" + NL + "\t}";
  protected final String TEXT_539 = NL + "\t// buffer the end tabs to groupEnd buffer" + NL + "\tgroupEndBuffer_";
  protected final String TEXT_540 = "[";
  protected final String TEXT_541 = "] = buf_";
  protected final String TEXT_542 = ".toString();" + NL + "    buf_";
  protected final String TEXT_543 = " = new StringBuffer();";
  protected final String TEXT_544 = NL + "\t//output the previous groups as there's a new group" + NL + "    if (newTabIndex_";
  protected final String TEXT_545 = " >= 0) {" + NL + "        //out_";
  protected final String TEXT_546 = ".newLine();//Track code";
  protected final String TEXT_547 = NL + "\t\t// output unNull tabs in start tabs buffer" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_548 = " >= 0) {" + NL + "            for (int i_";
  protected final String TEXT_549 = " = 0; i_";
  protected final String TEXT_550 = " < startTabs_";
  protected final String TEXT_551 = ".length; i_";
  protected final String TEXT_552 = "++) {" + NL + "                if (i_";
  protected final String TEXT_553 = " <= preUnNullMaxIndex_";
  protected final String TEXT_554 = ") {" + NL + "                    if (startTabs_";
  protected final String TEXT_555 = "[i_";
  protected final String TEXT_556 = "] != null) {" + NL + "                        out_";
  protected final String TEXT_557 = ".write(startTabs_";
  protected final String TEXT_558 = "[i_";
  protected final String TEXT_559 = "]);" + NL + "                    }" + NL + "                    startTabs_";
  protected final String TEXT_560 = "[i_";
  protected final String TEXT_561 = "] = null;" + NL + "                }" + NL + "            }" + NL + "        }";
  protected final String TEXT_562 = NL + "\t\t//output all start tabs buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_563 = " = 0; i_";
  protected final String TEXT_564 = " < startTabs_";
  protected final String TEXT_565 = ".length; i_";
  protected final String TEXT_566 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_567 = "[i_";
  protected final String TEXT_568 = "] != null) {" + NL + "                out_";
  protected final String TEXT_569 = ".write(startTabs_";
  protected final String TEXT_570 = "[i_";
  protected final String TEXT_571 = "]);" + NL + "            }" + NL + "            startTabs_";
  protected final String TEXT_572 = "[i_";
  protected final String TEXT_573 = "] = null;" + NL + "        }";
  protected final String TEXT_574 = NL + "        // output endtabs" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_575 = " >= preNewTabIndex_";
  protected final String TEXT_576 = NL + "            && preUnNullMaxIndex_";
  protected final String TEXT_577 = " >= ";
  protected final String TEXT_578 = " + newTabIndex_";
  protected final String TEXT_579 = ") {" + NL + "            for (int i_";
  protected final String TEXT_580 = " = preUnNullMaxIndex_";
  ...
  protected final String TEXT_593 = "out_";
  protected final String TEXT_594 = ".newLine(); ";
  protected final String TEXT_595 = NL + "                out_";
  protected final String TEXT_596 = ".write(endTabStrs_";
  protected final String TEXT_597 = NL + "                        .get(i_";
  protected final String TEXT_598 = "));" + NL + "            }" + NL + "        } else {";
  protected final String TEXT_599 = NL + "            for (int i_";
  protected final String TEXT_600 = " = preNewTabIndex_";
  protected final String TEXT_601 = " - 1; i_";
  protected final String TEXT_602 = " >= ";
  protected final String TEXT_603 = " + newTabIndex_";
  protected final String TEXT_604 = "; i_";
  protected final String TEXT_605 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_606 = "[i_";
  protected final String TEXT_607 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_608 = ".write(endTabs_";
  protected final String TEXT_609 = "[i_";
  protected final String TEXT_610 = "]);" + NL + "            \t}" + NL + "            \tendTabs_";
  protected final String TEXT_611 = "[i_";
  protected final String TEXT_612 = "] = null;" + NL + "            \t";
  protected final String TEXT_613 = "out_";
  protected final String TEXT_614 = ".newLine(); ";
  protected final String TEXT_615 = NL + "                out_";
  protected final String TEXT_616 = ".write(endTabStrs_";
  protected final String TEXT_617 = NL + "                        .get(i_";
  protected final String TEXT_618 = "));" + NL + "            }";
  protected final String TEXT_619 = NL + "        }";
  protected final String TEXT_620 = NL + "        preNewTabIndex_";
  protected final String TEXT_621 = " = newTabIndex_";
  protected final String TEXT_622 = " + ";
  protected final String TEXT_623 = ";" + NL + "    }" + NL + "" + NL + "    // set new element groupbuffer to startbuffer" + NL + "    for (int i_";
  protected final String TEXT_624 = " = 0; i_";
  protected final String TEXT_625 = " < groupBuffer_";
  protected final String TEXT_626 = ".length; i_";
  protected final String TEXT_627 = "++) {" + NL + "        // when newTabIndex is null, must use the perNewTabIndex" + NL + "        if (i_";
  protected final String TEXT_628 = " >= preNewTabIndex_";
  protected final String TEXT_629 = " - ";
  protected final String TEXT_630 = ") {" + NL + "            startTabs_";
  protected final String TEXT_631 = "[i_";
  protected final String TEXT_632 = " + ";
  protected final String TEXT_633 = "] = groupBuffer_";
  protected final String TEXT_634 = "[i_";
  protected final String TEXT_635 = "];" + NL + "            endTabs_";
  protected final String TEXT_636 = "[i_";
  protected final String TEXT_637 = " + ";
  protected final String TEXT_638 = "] = groupEndBuffer_";
  protected final String TEXT_639 = "[i_";
  protected final String TEXT_640 = "];" + NL + "        }" + NL + "    }";
  protected final String TEXT_641 = NL + "\t//reset the preUnNullMaxIndex" + NL + "\tif(unNullMaxIndex_";
  protected final String TEXT_642 = ">=0){" + NL + "    \tpreUnNullMaxIndex_";
  protected final String TEXT_643 = "=unNullMaxIndex_";
  protected final String TEXT_644 = ";" + NL + "\t}else{" + NL + "\t\tif(preUnNullMaxIndex_";
  protected final String TEXT_645 = ">";
  protected final String TEXT_646 = "){" + NL + "\t\t\tpreUnNullMaxIndex_";
  protected final String TEXT_647 = "=";
  protected final String TEXT_648 = ";" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_649 = NL + "\t// build loop xml tree";
  protected final String TEXT_650 = NL + "\t\tif( false";
  protected final String TEXT_651 = " || valueMap_";
  protected final String TEXT_652 = ".get(\"";
  protected final String TEXT_653 = "\") != null";
  protected final String TEXT_654 = " || true " + NL + "    \t";
  protected final String TEXT_655 = NL + "\t\t){";
  protected final String TEXT_656 = NL + "\t\t// output all buffer" + NL + "\t\tfor (int i_";
  protected final String TEXT_657 = " = 0; i_";
  protected final String TEXT_658 = " < startTabs_";
  protected final String TEXT_659 = ".length; i_";
  protected final String TEXT_660 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_661 = "[i_";
  protected final String TEXT_662 = "] != null && startTabs_";
  protected final String TEXT_663 = "[i_";
  protected final String TEXT_664 = "].length() > 0) {" + NL + "                out_";
  protected final String TEXT_665 = ".write(startTabs_";
  protected final String TEXT_666 = "[i_";
  protected final String TEXT_667 = "]);" + NL + "                startTabs_";
  protected final String TEXT_668 = "[i_";
  protected final String TEXT_669 = "] = null;" + NL + "            }" + NL + "        }" + NL + "\t\tout_";
  protected final String TEXT_670 = ".write(buf_";
  protected final String TEXT_671 = ".toString());" + NL + "\t\tpreNewTabIndex_";
  protected final String TEXT_672 = " = ";
  protected final String TEXT_673 = ";";
  protected final String TEXT_674 = NL + "            preUnNullMaxIndex_";
  protected final String TEXT_675 = " = ";
  protected final String TEXT_676 = ";" + NL + "\t\t}";
  protected final String TEXT_677 = NL + "    currentRowCount_";
  protected final String TEXT_678 = "++;" + NL + "    if(currentRowCount_";
  protected final String TEXT_679 = " == ";
  protected final String TEXT_680 = "){" + NL + "    \tneedRoot_";
  protected final String TEXT_681 = "  = true;" + NL + "    \tfileName_";
  protected final String TEXT_682 = " = file_";
  protected final String TEXT_683 = " + currentFileCount_";
  protected final String TEXT_684 = " + suffix_";
  protected final String TEXT_685 = ";" + NL + "        currentRowCount_";
  protected final String TEXT_686 = " = 0;" + NL + "        currentFileCount_";
  protected final String TEXT_687 = "++;" + NL + "    \tgroupbyList_";
  protected final String TEXT_688 = ".clear();" + NL + " ";
  protected final String TEXT_689 = "   \t" + NL + "\tif (preUnNullMaxIndex_";
  protected final String TEXT_690 = " >= 0) {" + NL + "        // output all buffer" + NL + "        for (int j_";
  protected final String TEXT_691 = " = 0; j_";
  protected final String TEXT_692 = " <= preUnNullMaxIndex_";
  protected final String TEXT_693 = "; j_";
  protected final String TEXT_694 = "++) {" + NL + "            if (startTabs_";
  protected final String TEXT_695 = "[j_";
  protected final String TEXT_696 = "] != null)" + NL + "                out_";
  protected final String TEXT_697 = ".write(startTabs_";
  protected final String TEXT_698 = "[j_";
  protected final String TEXT_699 = "]);" + NL + "        }" + NL + "" + NL + "        if (preUnNullMaxIndex_";
  protected final String TEXT_700 = " < preNewTabIndex_";
  protected final String TEXT_701 = " ) {" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_702 = " = preNewTabIndex_";
  protected final String TEXT_703 = " - 1; i_";
  protected final String TEXT_704 = " >= 0; i_";
  protected final String TEXT_705 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_706 = "[i_";
  protected final String TEXT_707 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_708 = ".write(endTabs_";
  protected final String TEXT_709 = "[i_";
  protected final String TEXT_710 = "]);" + NL + "            \t}";
  protected final String TEXT_711 = "out_";
  protected final String TEXT_712 = ".newLine(); ";
  protected final String TEXT_713 = NL + "                out_";
  protected final String TEXT_714 = ".write(endTabStrs_";
  protected final String TEXT_715 = ".get(i_";
  protected final String TEXT_716 = "));" + NL + "            }" + NL + "        } else {" + NL + "            for (int i_";
  protected final String TEXT_717 = " = preUnNullMaxIndex_";
  protected final String TEXT_718 = "; i_";
  protected final String TEXT_719 = " >= 0; i_";
  protected final String TEXT_720 = "--) {" + NL + "            \tif(endTabs_";
  protected final String TEXT_721 = "[i_";
  protected final String TEXT_722 = "]!=null){" + NL + "            \t\tout_";
  protected final String TEXT_723 = ".write(endTabs_";
  protected final String TEXT_724 = "[i_";
  protected final String TEXT_725 = "]);" + NL + "            \t}";
  protected final String TEXT_726 = "out_";
  protected final String TEXT_727 = ".newLine(); ";
  protected final String TEXT_728 = NL + "                out_";
  protected final String TEXT_729 = ".write(endTabStrs_";
  protected final String TEXT_730 = ".get(i_";
  protected final String TEXT_731 = "));" + NL + "            }" + NL + "        }" + NL + "    }";
  protected final String TEXT_732 = NL + "\tfor (int i_";
  protected final String TEXT_733 = " = endTabStrs_";
  protected final String TEXT_734 = ".size() - 1; i_";
  protected final String TEXT_735 = " >= 0; i_";
  protected final String TEXT_736 = "--) {" + NL + "    \tif(endTabs_";
  protected final String TEXT_737 = "[i_";
  protected final String TEXT_738 = "]!=null){" + NL + "    \t\tout_";
  protected final String TEXT_739 = ".write(endTabs_";
  protected final String TEXT_740 = "[i_";
  protected final String TEXT_741 = "]);" + NL + "    \t}";
  protected final String TEXT_742 = "out_";
  protected final String TEXT_743 = ".newLine(); ";
  protected final String TEXT_744 = NL + "        out_";
  protected final String TEXT_745 = ".write(endTabStrs_";
  protected final String TEXT_746 = ".get(i_";
  protected final String TEXT_747 = "));" + NL + "    }";
  protected final String TEXT_748 = NL + "\t    preUnNullMaxIndex_";
  protected final String TEXT_749 = " = -1;" + NL + "        preNewTabIndex_";
  protected final String TEXT_750 = " = -1;" + NL + "    \tstartTabs_";
  protected final String TEXT_751 = " = new String[endTabStrs_";
  protected final String TEXT_752 = ".size()];" + NL + "    \tendTabs_";
  protected final String TEXT_753 = " = new String[endTabStrs_";
  protected final String TEXT_754 = ".size()];" + NL + "    \t" + NL + "\t\tout_";
  protected final String TEXT_755 = ".close();" + NL + "\t\tout_";
  protected final String TEXT_756 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(file_";
  protected final String TEXT_757 = " + currentFileCount_";
  protected final String TEXT_758 = " + suffix_";
  protected final String TEXT_759 = "), ";
  protected final String TEXT_760 = "));" + NL + "        out_";
  protected final String TEXT_761 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_762 = "+\"\\\"?>\");" + NL + "        out_";
  protected final String TEXT_763 = ".newLine();" + NL + "\t}";
