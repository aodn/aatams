...
public class TFileOutputDelimitedBeginJava
{
  ...
  protected final String TEXT_284 = ".isUseCRLFRecordDelimiter()) {" + NL + "    \t    \t\tCsvWriter";
  protected final String TEXT_285 = ".useCRLFRecordDelimiter(true);" + NL + "    \t    \t} else {" + NL + "    \t    \t\tCsvWriter";
  protected final String TEXT_286 = ".setRecordDelimiter(csvSettings_";
  protected final String TEXT_287 = ".getRowDelim());" + NL + "    \t    \t}" + NL + "\t    \t\t";
  protected final String TEXT_288 = NL + "\t    \t\tif(!csvSettings_";
  protected final String TEXT_289 = ".isUseCRLFRecordDelimiter() && csvSettings_";
  protected final String TEXT_290 = ".getRowDelim()!='\\r' && csvSettings_";
  protected final String TEXT_291 = ".getRowDelim()!='\\n') {" + NL + "\t    \t\t\tCsvWriter";
  protected final String TEXT_292 = ".setRecordDelimiter(csvSettings_";
  protected final String TEXT_293 = ".getRowDelim());" + NL + "\t    \t\t}" + NL + "\t    \t\t";
  protected final String TEXT_294 = "\t\t   " + NL + "\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\tsynchronized (multiThreadLockWrite) {" + NL + "\t\t\t";
  protected final String TEXT_296 = NL + "\t\t\tsynchronized (lockWrite) {" + NL + "\t        ";
  protected final String TEXT_297 = NL + "\t\t\tObject[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "\t\t\tsynchronized (pLockWrite) {" + NL + "\t\t\t";
  protected final String TEXT_298 = NL + "\t        \tif(file_";
  protected final String TEXT_299 = ".length()==0)" + NL + "\t        \t{" + NL + "\t        ";
  protected final String TEXT_300 = NL + "    \t        if(file";
  protected final String TEXT_301 = ".length()==0)  " + NL + "    \t        {" + NL + "    \t            ";
  protected final String TEXT_302 = "\t      \t" + NL + "        \t\t\t\theadColu";
  protected final String TEXT_303 = "[";
  protected final String TEXT_304 = "]=\"";
  protected final String TEXT_305 = "\";" + NL + "        \t\t\t\t";
  protected final String TEXT_306 = "\t " + NL + "    \t            CsvWriter";
  protected final String TEXT_307 = ".writeRecord(headColu";
  protected final String TEXT_308 = ");" + NL + "    \t            CsvWriter";
  protected final String TEXT_309 = ".flush();" + NL + "    \t            \t";
  protected final String TEXT_310 = NL + "    \t            out";
  protected final String TEXT_311 = ".write(strWriter";
  protected final String TEXT_312 = ".getBuffer().toString());" + NL + "    \t            out";
  protected final String TEXT_313 = ".flush();" + NL + "                \tstrWriter";
  protected final String TEXT_314 = ".getBuffer().delete(0, strWriter";
  protected final String TEXT_315 = ".getBuffer().length()); \t" + NL + "                \t\t";
  ...
  protected final String TEXT_320 = NL + "    \t\t    java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_321 = " = null;" + NL + "\t\t\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_322 = " = null;" + NL + "                java.io.Writer out";
  protected final String TEXT_323 = " = null;\t\t\t\t" + NL + "                com.csvreader.CsvWriter CsvWriter";
  protected final String TEXT_324 = " = null;" + NL + "                try {" + NL + "                \tzipOut_";
  protected final String TEXT_325 = "=new java.util.zip.ZipOutputStream(" + NL + "    \t\t    \t\t\tnew java.io.BufferedOutputStream(";
  protected final String TEXT_326 = "));" + NL + "    \t\t    \tzipOut_";
  protected final String TEXT_327 = ".putNextEntry(new java.util.zip.ZipEntry(\"TalendOutputDelimited\"));" + NL + "    \t\t    \toutWriter_";
  protected final String TEXT_328 = " = new java.io.OutputStreamWriter(zipOut_";
  protected final String TEXT_329 = ", ";
  protected final String TEXT_330 = ");" + NL + "    \t\t    \tout";
  protected final String TEXT_331 = " = new routines.system.BufferedOutput(outWriter_";
  protected final String TEXT_332 = ");" + NL + "    \t\t    \tjava.io.StringWriter strWriter";
  protected final String TEXT_333 = " = new java.io.StringWriter();" + NL + "    \t\t    \tCsvWriter";
  protected final String TEXT_334 = " = new com.csvreader.CsvWriter(strWriter";
  protected final String TEXT_335 = ", csvSettings_";
  protected final String TEXT_336 = ".getFieldDelim());";
  protected final String TEXT_337 = NL + "\t\t\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_338 = " = null;" + NL + "                java.io.Writer out";
  protected final String TEXT_339 = " = null;\t\t\t\t" + NL + "                com.csvreader.CsvWriter CsvWriter";
  protected final String TEXT_340 = " = null;  " + NL + "                try {" + NL + "                \toutWriter_";
  protected final String TEXT_341 = " = new java.io.OutputStreamWriter(";
  protected final String TEXT_342 = ", ";
  protected final String TEXT_343 = ");" + NL + "                \tout";
  protected final String TEXT_344 = " = new routines.system.BufferedOutput(outWriter_";
  protected final String TEXT_345 = ");" + NL + "                \tjava.io.StringWriter strWriter";
  protected final String TEXT_346 = " = new java.io.StringWriter();" + NL + "                \tCsvWriter";
  protected final String TEXT_347 = " = new com.csvreader.CsvWriter(strWriter";
  protected final String TEXT_348 = ", csvSettings_";
  protected final String TEXT_349 = ".getFieldDelim());";
  protected final String TEXT_350 = NL + "    \t\t    java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_351 = " = null;" + NL + "\t\t\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_352 = " = null;" + NL + "\t\t\t\tjava.io.BufferedWriter bufferWriter_";
  protected final String TEXT_353 = " = null;" + NL + "\t\t\t\tcom.csvreader.CsvWriter CsvWriter";
  protected final String TEXT_354 = " = null;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tzipOut_";
  protected final String TEXT_355 = "=new java.util.zip.ZipOutputStream(" + NL + "    \t\t    \t\t\tnew java.io.BufferedOutputStream(";
  protected final String TEXT_356 = "));" + NL + "    \t\t   \t\tzipOut_";
  protected final String TEXT_357 = ".putNextEntry(new java.util.zip.ZipEntry(\"TalendOutputDelimited\"));" + NL + "    \t\t   \t\toutWriter_";
  protected final String TEXT_358 = " = new java.io.OutputStreamWriter(zipOut_";
  protected final String TEXT_359 = ", ";
  protected final String TEXT_360 = ");" + NL + "    \t\t   \t\tbufferWriter_";
  protected final String TEXT_361 = " = new java.io.BufferedWriter(outWriter_";
  protected final String TEXT_362 = ");" + NL + "    \t\t   \t\tCsvWriter";
  protected final String TEXT_363 = " = new com.csvreader.CsvWriter(bufferWriter_";
  protected final String TEXT_364 = ", csvSettings_";
  protected final String TEXT_365 = ".getFieldDelim());";
  protected final String TEXT_366 = NL + "\t\t\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_367 = " = null;" + NL + "\t\t\t\tjava.io.BufferedWriter bufferWriter_";
  protected final String TEXT_368 = " = null;" + NL + "\t\t\t\tcom.csvreader.CsvWriter CsvWriter";
  protected final String TEXT_369 = " = null;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\toutWriter_";
  protected final String TEXT_370 = " = new java.io.OutputStreamWriter(";
  protected final String TEXT_371 = ", ";
  protected final String TEXT_372 = ");" + NL + "\t\t\t\t\tbufferWriter_";
  protected final String TEXT_373 = " = new java.io.BufferedWriter(outWriter_";
  protected final String TEXT_374 = ");" + NL + "\t\t\t\t\tCsvWriter";
  protected final String TEXT_375 = " = new com.csvreader.CsvWriter(bufferWriter_";
  protected final String TEXT_376 = ", csvSettings_";
  protected final String TEXT_377 = ".getFieldDelim());";
  protected final String TEXT_378 = NL + "       \t    \tif(csvSettings_";
  protected final String TEXT_379 = ".isUseCRLFRecordDelimiter()) {" + NL + "    \t    \t\tCsvWriter";
  protected final String TEXT_380 = ".useCRLFRecordDelimiter(true);" + NL + "    \t    \t} else {" + NL + "    \t    \t\tCsvWriter";
  protected final String TEXT_381 = ".setRecordDelimiter(csvSettings_";
  protected final String TEXT_382 = ".getRowDelim());   \t    \t" + NL + "    \t    \t}" + NL + "    \t    \t";
  protected final String TEXT_383 = NL + "    \t    \tif(!csvSettings_";
  protected final String TEXT_384 = ".isUseCRLFRecordDelimiter() && csvSettings_";
  protected final String TEXT_385 = ".getRowDelim()!='\\r' && csvSettings_";
  protected final String TEXT_386 = ".getRowDelim()!='\\n') {" + NL + "\t    \t\t\tCsvWriter";
  protected final String TEXT_387 = ".setRecordDelimiter(csvSettings_";
  protected final String TEXT_388 = ".getRowDelim());" + NL + "\t    \t\t}" + NL + "    \t    \t";
  protected final String TEXT_389 = NL + "       \t\t\t\theadColu";
  protected final String TEXT_390 = "[";
  protected final String TEXT_391 = "]=\"";
  protected final String TEXT_392 = "\";" + NL + "       \t\t\t\t";
  protected final String TEXT_393 = NL + "        \t\tCsvWriter";
  protected final String TEXT_394 = ".writeRecord(headColu";
  ...
  protected final String TEXT_401 = NL + "\t\t\t\tCsvWriter";
  protected final String TEXT_402 = ".setEscapeMode(csvSettings_";
  protected final String TEXT_403 = ".getEscapeChar());" + NL + "\t\t\t\tCsvWriter";
  protected final String TEXT_404 = ".setTextQualifier(csvSettings_";
  protected final String TEXT_405 = ".getTextEnclosure());" + NL + "\t\t\t\tCsvWriter";
  protected final String TEXT_406 = ".setForceQualifier(true);";
