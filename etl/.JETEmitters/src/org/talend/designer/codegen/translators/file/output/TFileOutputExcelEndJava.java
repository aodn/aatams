...
public class TFileOutputExcelEndJava
{
  ...
  protected final String TEXT_38 = NL + "\t\t\t\t\tif(bufferCount_";
  protected final String TEXT_39 = "!=0){" + NL + "    \t\t\t\t\txlsxTool_";
  protected final String TEXT_40 = ".flushRowInMemory();" + NL + "    \t\t\t\t\t//flush all rocords in memory on disk." + NL + "    \t\t\t\t}" + NL + "\t";
  protected final String TEXT_41 = NL + "\t";
  protected final String TEXT_42 = NL + "\t\t\txlsxTool_";
  protected final String TEXT_43 = ".writeExcel(";
  protected final String TEXT_44 = ");" + NL + "\t";
  protected final String TEXT_45 = NL + "\t\t\txlsxTool_";
  protected final String TEXT_46 = ".writeExcel(";
  ...
  protected final String TEXT_52 = NL + "\t\tif(nb_line_";
  protected final String TEXT_53 = " ==1 && needDel_";
  protected final String TEXT_54 = "){" + NL + "\t";
  protected final String TEXT_55 = NL + "\t\tif(nb_line_";
  protected final String TEXT_56 = " == 0){" + NL + "\t";
  protected final String TEXT_57 = NL + "\t\t\tnew java.io.File(";
  protected final String TEXT_58 = ").delete();" + NL + "\t\t}\t\t" + NL + "\t";
