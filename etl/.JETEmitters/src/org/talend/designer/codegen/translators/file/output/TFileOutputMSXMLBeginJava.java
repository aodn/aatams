...
public class TFileOutputMSXMLBeginJava
{
  ...
  protected final String TEXT_27 = ");" + NL + "format_";
  protected final String TEXT_28 = ".setTrimText(";
  protected final String TEXT_29 = ");" + NL;
  protected final String TEXT_30 = NL + "org.dom4j.Element root_";
  protected final String TEXT_31 = "_";
  protected final String TEXT_32 = " = null;" + NL + "//used to judge branch root tags" + NL + "boolean needRoot_";
  protected final String TEXT_33 = "_";
  protected final String TEXT_34 = "  = true;" + NL + "//namespace support" + NL + "java.util.Map<String,String> uriToPrefixForDefaultNamespace_";
  protected final String TEXT_35 = "_";
  protected final String TEXT_36 = " = new java.util.HashMap<String,String>();" + NL + "java.util.Map<String,String> prefixToUriForNamespace_";
