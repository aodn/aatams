...
public class TFileOutputMSXMLEndJava
{
  ...
  protected final String TEXT_20 = ".setEscapeText(";
  protected final String TEXT_21 = ");" + NL + "    output_";
  protected final String TEXT_22 = ".write(doc_";
  protected final String TEXT_23 = ");" + NL + "    output_";
  protected final String TEXT_24 = ".close();" + NL + "    " + NL + "    globalMap.put(\"";
  protected final String TEXT_25 = "_NB_LINE\",nb_line_";
  protected final String TEXT_26 = ");" + NL;
  protected final String TEXT_27 = NL + "\tif(nb_line_";
  protected final String TEXT_28 = " == 0){" + NL + "\t\tnew java.io.File(";
  protected final String TEXT_29 = ").delete();" + NL + "\t}";
