...
public class TFileOutputPositionalMainJava
{
  ...
  protected final String TEXT_12 = ",byteArray_";
  ...
  protected final String TEXT_18 = NL + "\t\t\tsynchronized (multiThreadLockWrite) {" + NL + "\t\t\t";
  protected final String TEXT_19 = NL + "\t\t\tsynchronized (lockWrite) {" + NL + "\t\t\t";
  protected final String TEXT_20 = NL + "\t\t\tObject[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "\t\t\tsynchronized (pLockWrite) {" + NL + "\t\t\t";
  ...
  protected final String TEXT_26 = " == 0) {" + NL + "        \t\tout";
  protected final String TEXT_27 = ".flush();" + NL + "        \t\t}" + NL + "    \t\t";
