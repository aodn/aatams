...
public class TPivotToColumnsDelimitedBeginJava {
  ...
  protected final String TEXT_5 = ")).getAbsolutePath().replace(\"\\\\\",\"/\");" + NL + "String fullName_";
  protected final String TEXT_6 = " = null;" + NL + "String extension_";
  protected final String TEXT_7 = " = null;" + NL + "String directory_";
  protected final String TEXT_8 = " = null;" + NL + "if((fileName_";
  protected final String TEXT_9 = ".indexOf(\"/\") != -1)) {" + NL + "    if(fileName_";
  protected final String TEXT_10 = ".lastIndexOf(\".\") < fileName_";
  protected final String TEXT_11 = ".lastIndexOf(\"/\")) {" + NL + "        fullName_";
  protected final String TEXT_12 = " = fileName_";
  protected final String TEXT_13 = ";" + NL + "        extension_";
  protected final String TEXT_14 = " = \"\";" + NL + "    } else {" + NL + "        fullName_";
  protected final String TEXT_15 = " = fileName_";
  protected final String TEXT_16 = ".substring(0, fileName_";
  protected final String TEXT_17 = ".lastIndexOf(\".\"));" + NL + "        extension_";
  protected final String TEXT_18 = " = fileName_";
  protected final String TEXT_19 = ".substring(fileName_";
  protected final String TEXT_20 = ".lastIndexOf(\".\"));" + NL + "    }           " + NL + "    directory_";
  protected final String TEXT_21 = " = fileName_";
  protected final String TEXT_22 = ".substring(0, fileName_";
  protected final String TEXT_23 = ".lastIndexOf(\"/\"));            " + NL + "} else {" + NL + "    if(fileName_";
  protected final String TEXT_24 = ".lastIndexOf(\".\") != -1) {" + NL + "        fullName_";
  protected final String TEXT_25 = " = fileName_";
  protected final String TEXT_26 = ".substring(0, fileName_";
  protected final String TEXT_27 = ".lastIndexOf(\".\"));" + NL + "        extension_";
  protected final String TEXT_28 = " = fileName_";
  protected final String TEXT_29 = ".substring(fileName_";
  protected final String TEXT_30 = ".lastIndexOf(\".\"));" + NL + "    } else {" + NL + "        fullName_";
  protected final String TEXT_31 = " = fileName_";
  protected final String TEXT_32 = ";" + NL + "        extension_";
  protected final String TEXT_33 = " = \"\";" + NL + "    }" + NL + "    directory_";
  protected final String TEXT_34 = " = \"\";" + NL + "}";
  protected final String TEXT_35 = NL + "\t //create directory only if not exists" + NL + "\tif(directory_";
  protected final String TEXT_36 = " != null && directory_";
  protected final String TEXT_37 = ".trim().length() != 0) {" + NL + "\t    java.io.File dir_";
  protected final String TEXT_38 = " = new java.io.File(directory_";
  protected final String TEXT_39 = ");" + NL + "\t    if(!dir_";
  protected final String TEXT_40 = ".exists()) {" + NL + "\t\tdir_";
  protected final String TEXT_41 = ".mkdirs();" + NL + "\t    }" + NL + "\t}";
  protected final String TEXT_42 = NL + "    " + NL + "    java.io.BufferedWriter out";
  protected final String TEXT_43 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "            new java.io.FileOutputStream(fileName_";
  protected final String TEXT_44 = ", false),";
  protected final String TEXT_45 = "));" + NL;
  protected final String TEXT_46 = NL + "    " + NL + "    com.csvreader.CsvWriter CsvWriter";
  protected final String TEXT_47 = " = new com.csvreader.CsvWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "            new java.io.FileOutputStream(fileName_";
  protected final String TEXT_48 = ", false), ";
  protected final String TEXT_49 = ")), '";
  protected final String TEXT_50 = "');  " + NL + "    ";
  protected final String TEXT_51 = NL + "    CsvWriter";
  protected final String TEXT_52 = ".setRecordDelimiter('";
  protected final String TEXT_53 = "');";
  protected final String TEXT_54 = NL + "    CsvWriter";
  protected final String TEXT_55 = ".setTextQualifier('";
  protected final String TEXT_56 = "');                " + NL;
  protected final String TEXT_57 = NL + "    CsvWriter";
  protected final String TEXT_58 = ".setEscapeMode(com.csvreader.CsvWriter.ESCAPE_MODE_BACKSLASH);";
  protected final String TEXT_59 = NL + "    CsvWriter";
  protected final String TEXT_60 = ".setEscapeMode(com.csvreader.CsvWriter.ESCAPE_MODE_DOUBLED);";
  protected final String TEXT_61 = "    " + NL + "\tCsvWriter";
  protected final String TEXT_62 = ".setForceQualifier(true);   " + NL + NL;
  protected final String TEXT_63 = NL + NL + NL + "java.io.File file";
  protected final String TEXT_64 = " = new java.io.File(fileName_";
  protected final String TEXT_65 = ");" + NL + "" + NL + "boolean pivot_Exists";
  protected final String TEXT_66 = " = false;" + NL + "" + NL + "StringBuilder pivot_Key";
  protected final String TEXT_67 = " = new StringBuilder();" + NL + "" + NL + "String pivot_Keys";
  protected final String TEXT_68 = " = new String(\"\");" + NL + "" + NL + "String[] pivot_Keys_Split";
  protected final String TEXT_69 = " = null;" + NL + "" + NL + "boolean group_Exists";
  protected final String TEXT_70 = " = false;" + NL + "" + NL + "StringBuilder group_Key";
  protected final String TEXT_71 = " = new StringBuilder();" + NL + "" + NL + "String gKvalue";
  protected final String TEXT_72 = " = new String(\"\");" + NL + "" + NL + "String group_Keys";
  protected final String TEXT_73 = " = new String(\"\");" + NL + "" + NL + "String[] group_Keys_Split";
  protected final String TEXT_74 = " = null;" + NL + "" + NL + "StringBuilder aggValues";
  protected final String TEXT_75 = " = new StringBuilder();" + NL + "" + NL + "java.util.Map<String,String> aggregation";
