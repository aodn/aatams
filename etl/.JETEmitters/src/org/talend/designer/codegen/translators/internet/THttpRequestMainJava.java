...
public class THttpRequestMainJava
{
  ...
  protected final String TEXT_46 = NL + "\t\twhile ((bos_buffer_";
  protected final String TEXT_47 = " = bis_";
  protected final String TEXT_48 = ".read(buffer_";
  protected final String TEXT_49 = ")) != -1) {";
  protected final String TEXT_50 = "bosContent_";
  protected final String TEXT_51 = ".write(buffer_";
  protected final String TEXT_52 = ",0,bos_buffer_";
  protected final String TEXT_53 = "); ";
  protected final String TEXT_54 = "sb_";
  protected final String TEXT_55 = ".append(new String(buffer_";
  protected final String TEXT_56 = ",0,bos_buffer_";
  protected final String TEXT_57 = ")); ";
  protected final String TEXT_58 = NL + "\t\t}";
  protected final String TEXT_59 = "\t\t" + NL + "\t\tbosContent_";
  protected final String TEXT_60 = ".flush();" + NL + "\t\tbosContent_";
  protected final String TEXT_61 = ".close();";
  protected final String TEXT_62 = NL + "\t\tbis_";
  protected final String TEXT_63 = ".close();" + NL + "} else {" + NL + "  System.err.println(urlConn_";
  protected final String TEXT_64 = ".getResponseCode() + \" \" + urlConn_";
  protected final String TEXT_65 = ".getResponseMessage());" + NL + "}" + NL;
  protected final String TEXT_66 = NL + "        ";
  protected final String TEXT_67 = ".ResponseContent = sb_";
  ...
  protected final String TEXT_74 = NL + "urlConn_";
  protected final String TEXT_75 = ".disconnect();";
