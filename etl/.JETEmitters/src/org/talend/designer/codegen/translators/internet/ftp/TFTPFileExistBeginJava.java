...
public class TFTPFileExistBeginJava
{
  ...
  protected final String TEXT_54 = NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_55 = " = null;" + NL;
  protected final String TEXT_56 = NL + "    ftp_";
  protected final String TEXT_57 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_58 = "\");";
  protected final String TEXT_59 = "    " + NL + "    ftp_";
  protected final String TEXT_60 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_61 = ".setRemoteHost(";
  protected final String TEXT_62 = ");" + NL + "    ftp_";
  protected final String TEXT_63 = ".setRemotePort(";
  protected final String TEXT_64 = ");" + NL;
  protected final String TEXT_65 = NL + "      ftp_";
  protected final String TEXT_66 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_67 = NL + "      ftp_";
  protected final String TEXT_68 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_69 = NL + "    ftp_";
  protected final String TEXT_70 = ".setControlEncoding(";
  protected final String TEXT_71 = ");" + NL + "    ftp_";
  protected final String TEXT_72 = ".connect();  " + NL + "    ftp_";
  protected final String TEXT_73 = ".login(";
