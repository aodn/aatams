...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_65 = NL + NL + "  for (java.util.Map<String, String> map";
  protected final String TEXT_66 = " : list";
  protected final String TEXT_67 = ") {" + NL;
  protected final String TEXT_68 = NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_69 = " =null;" + NL;
  protected final String TEXT_70 = NL + "    ftp_";
  protected final String TEXT_71 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_72 = "\");";
  protected final String TEXT_73 = "    " + NL + "    ftp_";
  protected final String TEXT_74 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_75 = ".setRemoteHost(";
  protected final String TEXT_76 = ");" + NL + "    ftp_";
  protected final String TEXT_77 = ".setRemotePort(";
  protected final String TEXT_78 = ");" + NL;
  protected final String TEXT_79 = NL + "      ftp_";
  protected final String TEXT_80 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_81 = NL + "      ftp_";
  protected final String TEXT_82 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_83 = NL + "    ftp_";
  protected final String TEXT_84 = ".setControlEncoding(";
  protected final String TEXT_85 = ");" + NL + "    ftp_";
  protected final String TEXT_86 = ".connect();  " + NL + "    ftp_";
  protected final String TEXT_87 = ".login(";
  protected final String TEXT_88 = ", ";
  protected final String TEXT_89 = "); ";
  protected final String TEXT_90 = NL + "  java.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_91 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL;
  protected final String TEXT_92 = "    " + NL + "    java.util.Map<String,String> map";
  protected final String TEXT_93 = " = new java.util.HashMap<String,String>();  " + NL + "    map";
  protected final String TEXT_94 = ".put(";
  protected final String TEXT_95 = ",";
  protected final String TEXT_96 = ");" + NL + "    list";
  protected final String TEXT_97 = ".add(map";
  protected final String TEXT_98 = ");       ";
  protected final String TEXT_99 = "  " + NL + "  String remotedir";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";" + NL + "  ftp_";
  protected final String TEXT_102 = ".chdir(remotedir";
  protected final String TEXT_103 = ");" + NL + "" + NL + "  for (java.util.Map<String, String> map";
