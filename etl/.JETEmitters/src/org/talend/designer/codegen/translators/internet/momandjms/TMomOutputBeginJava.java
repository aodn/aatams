...
public class TMomOutputBeginJava
{
  ...
  protected final String TEXT_64 = ".put(\"transport\", \"MQSeries\");" + NL + "\t    " + NL + "\t    ";
  protected final String TEXT_65 = NL + "\t\t\tcom.ibm.mq.MQEnvironment.sslCipherSuite = \"";
  protected final String TEXT_66 = "\";" + NL + "\t\t";
  protected final String TEXT_67 = NL + "\t\t\tprops_";
  protected final String TEXT_68 = ".put(\"userID\",";
  protected final String TEXT_69 = ");" + NL + "\t\t\tprops_";
  protected final String TEXT_70 = ".put(\"password\",";
  protected final String TEXT_71 = ");" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t" + NL + "\t\tcom.ibm.mq.MQQueueManager qMgr_";
  protected final String TEXT_73 = " = new com.ibm.mq.MQQueueManager(";
  protected final String TEXT_74 = ", props_";
  protected final String TEXT_75 = ");" + NL + "\t    com.ibm.mq.MQQueue remoteQ_";
  protected final String TEXT_76 = " = qMgr_";
  protected final String TEXT_77 = ".accessQueue(";
  protected final String TEXT_78 = ", 16);" + NL + "\t    com.ibm.mq.MQPutMessageOptions opM_";
  protected final String TEXT_79 = " = new com.ibm.mq.MQPutMessageOptions();";
  protected final String TEXT_80 = "\t" + NL + "\t\topM_";
  protected final String TEXT_81 = ".options=opM_";
  protected final String TEXT_82 = ".options+com.ibm.mq.MQC.MQGMO_SYNCPOINT;";
