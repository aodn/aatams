...
public class TAggregateOutMainJava
{
  ...
  protected final String TEXT_158 = ".checkedIADD( operation_result_";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = "_";
  protected final String TEXT_161 = ", (double)";
  protected final String TEXT_162 = ".";
  protected final String TEXT_163 = ", ";
  protected final String TEXT_164 = ".doubleValue(), ";
  protected final String TEXT_165 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_166 = "utilClass_";
  protected final String TEXT_167 = ".checkedIADD( (";
  protected final String TEXT_168 = ") operation_result_";
  ...
  protected final String TEXT_175 = ".doubleValue(), ";
  protected final String TEXT_176 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_177 = NL + "\t\t\t\t\toperation_result_";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = "_";
  protected final String TEXT_180 = " += ";
  protected final String TEXT_181 = ".";
  protected final String TEXT_182 = ".doubleValue();" + NL + "\t\t\t\t\t";
  protected final String TEXT_183 = "utilClass_";
  protected final String TEXT_184 = ".checkedIADD( operation_result_";
  ...
  protected final String TEXT_192 = "utilClass_";
  protected final String TEXT_193 = ".checkedIADD( (";
  protected final String TEXT_194 = ") operation_result_";
  ...
  protected final String TEXT_203 = "operation_result_";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = "_";
  protected final String TEXT_206 = " = (";
  protected final String TEXT_207 = ")(operation_result_";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = "_";
  protected final String TEXT_210 = ".";
  protected final String TEXT_211 = "Value() + ";
  protected final String TEXT_212 = ".";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = "Value());" + NL + "\t\t\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\t\tif( ";
  protected final String TEXT_216 = ".";
  protected final String TEXT_217 = " != null)" + NL + "\t\t\t\t\t\toperation_result_";
  ...
  protected final String TEXT_229 = NL + "\t\t\t\tif(isFirstAdd_";
  protected final String TEXT_230 = " ";
  protected final String TEXT_231 = " || operation_result_";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = "_";
  protected final String TEXT_234 = " == null";
  protected final String TEXT_235 = ") {" + NL + "\t\t\t\t\toperation_result_";
  protected final String TEXT_236 = ".";
  protected final String TEXT_237 = "_";
  protected final String TEXT_238 = " = ";
  protected final String TEXT_239 = ".";
  protected final String TEXT_240 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t\t\toperation_result_";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = "_";
  protected final String TEXT_244 = " = ";
  protected final String TEXT_245 = ".";
  protected final String TEXT_246 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\tif(operation_result_";
  protected final String TEXT_248 = ".";
  protected final String TEXT_249 = "_";
  protected final String TEXT_250 = ".length() > 0) {" + NL + "\t\t\t\t\toperation_result_";
  protected final String TEXT_251 = ".";
  protected final String TEXT_252 = "_";
  protected final String TEXT_253 = ".append(";
  protected final String TEXT_254 = ");" + NL + "\t\t\t\t} " + NL + "\t\t\t\t";
  protected final String TEXT_255 = NL + "\t\t\t\t\tif(operation_result_";
  protected final String TEXT_256 = ".";
  protected final String TEXT_257 = "_";
  protected final String TEXT_258 = " != null) {" + NL + "\t\t\t\t\t\toperation_result_";
  protected final String TEXT_259 = ".";
  protected final String TEXT_260 = "_";
  protected final String TEXT_261 = " = operation_result_";
  protected final String TEXT_262 = ".";
  protected final String TEXT_263 = "_";
  protected final String TEXT_264 = ".append(java.util.Arrays.toString(";
  protected final String TEXT_265 = ".";
  protected final String TEXT_266 = "));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_267 = "else if(operation_result_";
  protected final String TEXT_268 = ".";
  protected final String TEXT_269 = "_";
  protected final String TEXT_270 = "_firstEmpty){" + NL + "\t\t\t\t\toperation_result_";
  protected final String TEXT_271 = ".";
  protected final String TEXT_272 = "_";
  protected final String TEXT_273 = ".append(";
  protected final String TEXT_274 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t\tif(operation_result_";
  protected final String TEXT_275 = ".";
  protected final String TEXT_276 = "_";
  protected final String TEXT_277 = " != null) {" + NL + "\t\t\t\t\t\tif(operation_result_";
  protected final String TEXT_278 = ".";
  protected final String TEXT_279 = "_";
  protected final String TEXT_280 = "_firstEmpty==false && (\"\").equals(String.valueOf(";
  protected final String TEXT_281 = ".";
  protected final String TEXT_282 = "))){" + NL + "\t\t\t\t\t\t\toperation_result_";
  protected final String TEXT_283 = ".";
  protected final String TEXT_284 = "_";
  protected final String TEXT_285 = "_firstEmpty = true;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\toperation_result_";
  protected final String TEXT_286 = ".";
  protected final String TEXT_287 = "_";
  protected final String TEXT_288 = " = operation_result_";
  protected final String TEXT_289 = ".";
  protected final String TEXT_290 = "_";
  protected final String TEXT_291 = ".append(String.valueOf(";
  protected final String TEXT_292 = ".";
  protected final String TEXT_293 = "));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_294 = "// Load first one or union" + NL + "\t\t\t\tif (operation_result_";
  protected final String TEXT_295 = ".";
  protected final String TEXT_296 = "_";
  protected final String TEXT_297 = " == null) {" + NL + "\t\t\t\t\toperation_result_";
  protected final String TEXT_298 = ".";
  protected final String TEXT_299 = "_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = ".";
  protected final String TEXT_302 = ";" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\toperation_result_";
  ...
  protected final String TEXT_308 = ".union(";
  protected final String TEXT_309 = ".";
  protected final String TEXT_310 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\toperation_result_";
  protected final String TEXT_312 = ".";
  protected final String TEXT_313 = "_";
  protected final String TEXT_314 = ".add(";
  protected final String TEXT_315 = ".";
  protected final String TEXT_316 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_317 = "operation_result_";
  protected final String TEXT_318 = ".";
  protected final String TEXT_319 = "_";
  protected final String TEXT_320 = ".add(";
  protected final String TEXT_321 = ".";
  protected final String TEXT_322 = ".doubleValue());" + NL + "\t\t\t\t\t";
  protected final String TEXT_323 = "operation_result_";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = "_";
  protected final String TEXT_326 = ".add((double)";
  protected final String TEXT_327 = ".";
  protected final String TEXT_328 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\t} // G_OutMain_AggR_546" + NL + "\t\t\t\t";
