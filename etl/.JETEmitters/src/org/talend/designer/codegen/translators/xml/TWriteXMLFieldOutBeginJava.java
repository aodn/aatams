...
public class TWriteXMLFieldOutBeginJava
{
  ...
  protected final String TEXT_11 = " extends Thread {" + NL + "\tjava.util.Queue<String> queue;" + NL + "\tjava.util.List<java.util.Map<String,String>> flows;" + NL + "\t" + NL + "\tThreadXMLField_";
  protected final String TEXT_12 = "(java.util.Queue q) {" + NL + "\t\tthis.queue = q;" + NL + "\t\tglobalMap.put(\"queue_";
  protected final String TEXT_13 = "\", queue);" + NL + "\t}" + NL + "\t" + NL + "\tThreadXMLField_";
  protected final String TEXT_14 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "\t\tthis.queue = q;" + NL + "\t\tthis.flows = l;" + NL + "\t\tglobalMap.put(\"queue_";
  protected final String TEXT_15 = "\", queue);" + NL + "\t\tglobalMap.put(\"flows_";
  protected final String TEXT_16 = "\", flows);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\t";
  protected final String TEXT_17 = "Process(globalMap);" + NL + "\t\t} catch (TalendException e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "}";
  protected final String TEXT_18 = NL + "\tThreadXMLField_";
  protected final String TEXT_19 = " txf_";
  protected final String TEXT_20 = " = new ThreadXMLField_";
  protected final String TEXT_21 = "(listGroupby_";
  protected final String TEXT_22 = ");";
  protected final String TEXT_23 = NL + "\tThreadXMLField_";
  protected final String TEXT_24 = " txf_";
  protected final String TEXT_25 = " = new ThreadXMLField_";
  protected final String TEXT_26 = "(listGroupby_";
  protected final String TEXT_27 = ", flows_";
  protected final String TEXT_28 = ");";
  protected final String TEXT_29 = NL + "txf_";
  protected final String TEXT_30 = ".start();" + NL + "" + NL + "java.util.List<java.util.List<String>> groupbyList_";
  protected final String TEXT_31 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "java.util.Map<String,String> valueMap_";
  protected final String TEXT_32 = " = new java.util.HashMap<String,String>();" + NL;
  protected final String TEXT_33 = NL + NL + "class NestXMLTool_";
  ...
  protected final String TEXT_35 = " nestXMLTool_";
  protected final String TEXT_36 = " = new NestXMLTool_";
  protected final String TEXT_37 = "();" + NL + "" + NL + "// sort group root element for judgement of group" + NL + "java.util.List<org.dom4j.Element> groupElementList_";
  protected final String TEXT_38 = " = new java.util.ArrayList<org.dom4j.Element>();" + NL + "org.dom4j.Element root4Group_";
  protected final String TEXT_39 = " = null;" + NL + "org.dom4j.Document doc_";
  protected final String TEXT_40 = "  = org.dom4j.DocumentHelper.createDocument();";
  protected final String TEXT_41 = NL + "org.dom4j.io.OutputFormat format_";
  protected final String TEXT_42 = " = org.dom4j.io.OutputFormat.createCompactFormat();" + NL + "format_";
  protected final String TEXT_43 = ".setNewLineAfterDeclaration(false);";
  protected final String TEXT_44 = NL + "org.dom4j.io.OutputFormat format_";
  protected final String TEXT_45 = " = org.dom4j.io.OutputFormat.createPrettyPrint();";
  protected final String TEXT_46 = NL + "format_";
  protected final String TEXT_47 = ".setTrimText(false);" + NL + "format_";
  protected final String TEXT_48 = ".setEncoding(";
  protected final String TEXT_49 = ");";
  protected final String TEXT_50 = "format_";
  protected final String TEXT_51 = ".setExpandEmptyElements(true);";
  protected final String TEXT_52 = NL + "int[] orders_";
  protected final String TEXT_53 = " = new int[";
  protected final String TEXT_54 = "];";
  protected final String TEXT_55 = NL + "java.util.List<String> endTabStrs_";
  protected final String TEXT_56 = " = new java.util.ArrayList<String>();" + NL + "java.util.List<String> startTabStrs_";
  protected final String TEXT_57 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_58 = NL + "endTabStrs_";
  protected final String TEXT_59 = ".add(\"";
  protected final String TEXT_60 = "</";
  protected final String TEXT_61 = ">\");" + NL + "startTabStrs_";
  protected final String TEXT_62 = ".add(\"";
  protected final String TEXT_63 = "<";
  protected final String TEXT_64 = ">\");";
  protected final String TEXT_65 = NL + "int preUnNullMaxIndex_";
  protected final String TEXT_66 = " = -1;" + NL + "int preNewTabIndex_";
  protected final String TEXT_67 = " = -1;" + NL + "String[] startTabs_";
  protected final String TEXT_68 = " = new String[endTabStrs_";
  protected final String TEXT_69 = ".size()];" + NL + "String[] endTabs_";
  protected final String TEXT_70 = " = new String[endTabStrs_";
  protected final String TEXT_71 = ".size()];" + NL + "java.io.StringWriter strWriter_";
  protected final String TEXT_72 = " = new java.io.StringWriter();" + NL + "java.io.BufferedWriter out_";
  protected final String TEXT_73 = " = new java.io.BufferedWriter(strWriter_";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = NL + "out_";
  protected final String TEXT_76 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_77 = "+\"\\\"?>\");" + NL + "out_";
