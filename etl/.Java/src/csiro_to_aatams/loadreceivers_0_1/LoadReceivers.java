...
public class LoadReceivers implements TalendJob {
	...
	public static class row7Struct implements
		...
		public java.util.Date import_finish_date;

		public java.util.Date getImport_finish_date() {
			return this.import_finish_date;
		}

		public java.util.Date import_start_date;

		public java.util.Date getImport_start_date() {
			return this.import_start_date;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					this.import_finish_date = readDate(dis);

					this.import_start_date = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeDate(this.import_finish_date, dos);

				// java.util.Date

				writeDate(this.import_start_date, dos);
		...
		public String toString() {
			...
			sb.append(",import_finish_date="
					+ String.valueOf(import_finish_date));
			sb.append(",import_start_date=" + String.valueOf(import_start_date));
	...
	public void tJavaFlex_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tPostgresqlOutput_3", System
						.currentTimeMillis());
				...
				String dbUser_tPostgresqlOutput_3 = "postgres";
				String dbPwd_tPostgresqlOutput_3 = "postgres";
				...
				String insert_tPostgresqlOutput_3 = "INSERT INTO \""
						...
						+ "\" (\"id\",\"version\",\"import_finish_date\",\"import_start_date\",\"organisation_id\",\"status\") VALUES (?,?,?,?,?,?)";
				java.sql.PreparedStatement pstmt_tPostgresqlOutput_3 = conn_tPostgresqlOutput_3
						.prepareStatement(insert_tPostgresqlOutput_3);

				StringBuffer query_tPostgresqlOutput_3 = null;

				String[] insertSQLSplits_tPostgresqlOutput_3 = insert_tPostgresqlOutput_3
						.split("\\?");
				...
				row7.id = pk;
				row7.version = 0;
				row7.import_start_date = new Date();
				row7.import_finish_date = null;
				row7.organisation_id = 629985l;
				row7.status = "IN_PROGRESS";
				...
				query_tPostgresqlOutput_3 = new StringBuffer("");
				whetherReject_tPostgresqlOutput_3 = false;
				pstmt_tPostgresqlOutput_3.setLong(1, row7.id);

				query_tPostgresqlOutput_3 = query_tPostgresqlOutput_3.append(
						insertSQLSplits_tPostgresqlOutput_3[0]).append(
						String.valueOf(row7.id)).append(
						insertSQLSplits_tPostgresqlOutput_3[1]);
				pstmt_tPostgresqlOutput_3.setLong(2, row7.version);

				query_tPostgresqlOutput_3 = query_tPostgresqlOutput_3.append(
						String.valueOf(row7.version)).append(
						insertSQLSplits_tPostgresqlOutput_3[2]);
				if (row7.import_finish_date != null) {
					pstmt_tPostgresqlOutput_3.setTimestamp(3,
							new java.sql.Timestamp(row7.import_finish_date
									.getTime()));
				} else {
				...
				query_tPostgresqlOutput_3 = query_tPostgresqlOutput_3.append(
						row7.import_finish_date == null ? "null" : "'"
								+ new java.text.SimpleDateFormat("dd-MM-yyyy")
										.format(row7.import_finish_date) + "'")
						.append(insertSQLSplits_tPostgresqlOutput_3[3]);
				if (row7.import_start_date != null) {
					pstmt_tPostgresqlOutput_3.setTimestamp(4,
							new java.sql.Timestamp(row7.import_start_date
									.getTime()));
				} else {
				...
				query_tPostgresqlOutput_3 = query_tPostgresqlOutput_3.append(
						row7.import_start_date == null ? "null" : "'"
								+ new java.text.SimpleDateFormat("dd-MM-yyyy")
										.format(row7.import_start_date) + "'")
						.append(insertSQLSplits_tPostgresqlOutput_3[4]);
				pstmt_tPostgresqlOutput_3.setLong(5, row7.organisation_id);

				query_tPostgresqlOutput_3 = query_tPostgresqlOutput_3.append(
						String.valueOf(row7.organisation_id)).append(
						insertSQLSplits_tPostgresqlOutput_3[5]);
				if (row7.status == null) {
					pstmt_tPostgresqlOutput_3
							.setNull(6, java.sql.Types.VARCHAR);
				} else {
					pstmt_tPostgresqlOutput_3.setString(6, row7.status);
				}

				query_tPostgresqlOutput_3 = query_tPostgresqlOutput_3.append(
						row7.status == null ? "null" : "'" + row7.status + "'")
						.append(insertSQLSplits_tPostgresqlOutput_3[6]);
				globalMap.put("tPostgresqlOutput_3_QUERY",
						query_tPostgresqlOutput_3.toString().trim());
				...
				globalMap.put("bulkImportPk", Long.valueOf(pk));
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				start_Hash.put("tPostgresqlOutput_4", System
						.currentTimeMillis());
				...
				String url_tPostgresqlOutput_4 = "jdbc:postgresql://"
						+ "localhost" + ":" + "5432" + "/" + "aatams";
				String dbUser_tPostgresqlOutput_4 = "postgres";
				String dbPwd_tPostgresqlOutput_4 = "postgres";
				...
				String update_tPostgresqlOutput_4 = "UPDATE \""
						...
						+ "\" SET \"import_finish_date\" = ?,\"status\" = ? WHERE \"id\" = ?";
				java.sql.PreparedStatement pstmt_tPostgresqlOutput_4 = conn_tPostgresqlOutput_4
						.prepareStatement(update_tPostgresqlOutput_4);

				StringBuffer query_tPostgresqlOutput_4 = null;

				update_tPostgresqlOutput_4 += " ";
				String[] updateSQLSplits_tPostgresqlOutput_4 = update_tPostgresqlOutput_4
						.split("\\?");
				...
				// start part of your Java code
				System.out.println("Running bulk import update, PK: "
						+ globalMap.get("bulkImportPk"));
				...
				row8.id = ((Long) globalMap.get("bulkImportPk")).longValue();
				row8.import_finish_date = new Date();
				row8.status = "SUCCESS";
				...
				query_tPostgresqlOutput_4 = new StringBuffer("");
				whetherReject_tPostgresqlOutput_4 = false;
				if (row8.import_finish_date != null) {
					pstmt_tPostgresqlOutput_4.setTimestamp(1,
							new java.sql.Timestamp(row8.import_finish_date
									.getTime()));
				} else {
					pstmt_tPostgresqlOutput_4.setNull(1,
							java.sql.Types.TIMESTAMP);
				}

				query_tPostgresqlOutput_4 = query_tPostgresqlOutput_4.append(
						updateSQLSplits_tPostgresqlOutput_4[0]).append(
						row8.import_finish_date == null ? "null" : "'"
								+ new java.text.SimpleDateFormat("dd-MM-yyyy")
										.format(row8.import_finish_date) + "'")
						.append(updateSQLSplits_tPostgresqlOutput_4[1]);
				if (row8.status == null) {
					pstmt_tPostgresqlOutput_4
							.setNull(2, java.sql.Types.VARCHAR);
				} else {
					pstmt_tPostgresqlOutput_4.setString(2, row8.status);
				}

				query_tPostgresqlOutput_4 = query_tPostgresqlOutput_4.append(
						row8.status == null ? "null" : "'" + row8.status + "'")
						.append(updateSQLSplits_tPostgresqlOutput_4[2]);

				pstmt_tPostgresqlOutput_4.setLong(
						3 + count_tPostgresqlOutput_4, row8.id);

				query_tPostgresqlOutput_4 = query_tPostgresqlOutput_4.append(
						String.valueOf(row8.id)).append(
						updateSQLSplits_tPostgresqlOutput_4[3]);
				globalMap.put("tPostgresqlOutput_4_QUERY",
						query_tPostgresqlOutput_4.toString().trim());
				try {
					updatedCount_tPostgresqlOutput_4 = updatedCount_tPostgresqlOutput_4
							+ pstmt_tPostgresqlOutput_4.executeUpdate();
...
/************************************************************************************************
 * 163108 characters generated by Talend Open Studio for Data Integration on the
 * May 30, 2012 5:02:27 PM EST
 ************************************************************************************************/
