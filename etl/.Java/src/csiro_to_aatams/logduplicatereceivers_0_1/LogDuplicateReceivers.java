...
//
// ============================================================================
package csiro_to_aatams.logduplicatereceivers_0_1;
...
/**
 * Job: LogDuplicateReceivers Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.1.0.r82787
 * @status 
 */
public class LogDuplicateReceivers implements TalendJob {
	...
	private final String jobName = "LogDuplicateReceivers";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LogDuplicateReceivers.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LogDuplicateReceivers.this, new Object[] {
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				util_tLogRow_1.addRow(new String[] { "RCV_ID", "RCV_SERIAL_NO",
						"RCV_MODEL_CODE", "RCV_OWNER", "RCV_COMMENTS",
						"ENTRY_DATETIME", "ENTRY_BY", "MODIFIED_DATETIME",
						"MODIFIED_BY", });
				...
				try {
					...
					while (limittFileInputDelimited_1 != 0
						...
						if (row1 != null) {
							...
							row2 = new row2Struct();
							row2.RCV_ID = row1.RCV_ID;
							row2.RCV_SERIAL_NO = row1.RCV_SERIAL_NO;
							row2.RCV_MODEL_CODE = row1.RCV_MODEL_CODE;
							row2.RCV_OWNER = row1.RCV_OWNER;
							row2.RCV_COMMENTS = row1.RCV_COMMENTS;
							row2.ENTRY_DATETIME = row1.ENTRY_DATETIME;
							row2.ENTRY_BY = row1.ENTRY_BY;
							row2.MODIFIED_DATETIME = row1.MODIFIED_DATETIME;
							row2.MODIFIED_BY = row1.MODIFIED_BY;
							...
							if (row4 != null) {
								...
								row_tLogRow_2[0] = String.valueOf(row4.RCV_ID);

								if (row4.RCV_SERIAL_NO != null) { //
									row_tLogRow_2[1] = String
											.valueOf(row4.RCV_SERIAL_NO);

								} //

								if (row4.RCV_MODEL_CODE != null) { //
									row_tLogRow_2[2] = String
											.valueOf(row4.RCV_MODEL_CODE);

								} //

								if (row4.RCV_OWNER != null) { //
									row_tLogRow_2[3] = String
											.valueOf(row4.RCV_OWNER);

								} //

								if (row4.RCV_COMMENTS != null) { //
									row_tLogRow_2[4] = String
											.valueOf(row4.RCV_COMMENTS);

								} //

								if (row4.ENTRY_DATETIME != null) { //
									row_tLogRow_2[5] = FormatterUtils
											.format_Date(row4.ENTRY_DATETIME,
													"dd/MM/yyyy' 'HH:mm:ss");

								} //

								if (row4.ENTRY_BY != null) { //
									row_tLogRow_2[6] = String
											.valueOf(row4.ENTRY_BY);

								} //

								if (row4.MODIFIED_DATETIME != null) { //
									row_tLogRow_2[7] = FormatterUtils
											.format_Date(
													row4.MODIFIED_DATETIME,
													"dd/MM/yyyy' 'HH:mm:ss");

								} //

								if (row4.MODIFIED_BY != null) { //
									row_tLogRow_2[8] = String
											.valueOf(row4.MODIFIED_BY);
							...
							if (row2 != null) {
								...
								row_tLogRow_1[0] = String.valueOf(row2.RCV_ID);

								if (row2.RCV_SERIAL_NO != null) { //
									row_tLogRow_1[1] = String
											.valueOf(row2.RCV_SERIAL_NO);

								} //

								if (row2.RCV_MODEL_CODE != null) { //
									row_tLogRow_1[2] = String
											.valueOf(row2.RCV_MODEL_CODE);

								} //

								if (row2.RCV_OWNER != null) { //
									row_tLogRow_1[3] = String
											.valueOf(row2.RCV_OWNER);

								} //

								if (row2.RCV_COMMENTS != null) { //
									row_tLogRow_1[4] = String
											.valueOf(row2.RCV_COMMENTS);

								} //

								if (row2.ENTRY_DATETIME != null) { //
									row_tLogRow_1[5] = FormatterUtils
											.format_Date(row2.ENTRY_DATETIME,
													"dd/MM/yyyy' 'HH:mm:ss");

								} //

								if (row2.ENTRY_BY != null) { //
									row_tLogRow_1[6] = String
											.valueOf(row2.ENTRY_BY);

								} //

								if (row2.MODIFIED_DATETIME != null) { //
									row_tLogRow_1[7] = FormatterUtils
											.format_Date(
													row2.MODIFIED_DATETIME,
													"dd/MM/yyyy' 'HH:mm:ss");

								} //

								if (row2.MODIFIED_BY != null) { //
									row_tLogRow_1[8] = String
											.valueOf(row2.MODIFIED_BY);
				...
				while (rs_tPostgresqlInput_1.next()) {
					...
					if (colQtyInRs_tPostgresqlInput_1 < 1) {
						...
						if (rs_tPostgresqlInput_1.getObject(1) != null) {
							row3.id = rs_tPostgresqlInput_1.getLong(1);
						} else {
					...
					if (colQtyInRs_tPostgresqlInput_1 < 2) {
						...
						if (rs_tPostgresqlInput_1.getObject(2) != null) {
							row3.version = rs_tPostgresqlInput_1.getLong(2);
						} else {
							throw new RuntimeException(
									"Null value in non-Nullable column");
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 3) {
						...
						if (tmpContent_tPostgresqlInput_1 != null) {
							row3.comment = tmpContent_tPostgresqlInput_1.trim();
						} else {
							row3.comment = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 4) {
						...
						if (rs_tPostgresqlInput_1.getObject(4) != null) {
							row3.model_id = rs_tPostgresqlInput_1.getLong(4);
						} else {
							throw new RuntimeException(
									"Null value in non-Nullable column");
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 5) {
						...
						tmpContent_tPostgresqlInput_1 = rs_tPostgresqlInput_1
								.getString(5);
						if (tmpContent_tPostgresqlInput_1 != null) {
							row3.serial_number = tmpContent_tPostgresqlInput_1
									.trim();
						} else {
							row3.serial_number = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 6) {
						...
						if (rs_tPostgresqlInput_1.getObject(6) != null) {
							row3.status_id = rs_tPostgresqlInput_1.getLong(6);
						} else {
							row3.status_id = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 7) {
						...
						tmpContent_tPostgresqlInput_1 = rs_tPostgresqlInput_1
								.getString(7);
						if (tmpContent_tPostgresqlInput_1 != null) {
							row3._class = tmpContent_tPostgresqlInput_1.trim();
						} else {
							row3._class = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 8) {
						...
						if (rs_tPostgresqlInput_1.getObject(8) != null) {
							row3.organisation_id = rs_tPostgresqlInput_1
									.getLong(8);
						} else {
							row3.organisation_id = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 9) {
						...
						if (rs_tPostgresqlInput_1.getObject(9) != null) {
							row3.expected_life_time_days = rs_tPostgresqlInput_1
									.getInt(9);
						} else {
							row3.expected_life_time_days = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 10) {
						...
						if (rs_tPostgresqlInput_1.getObject(10) != null) {
							row3.project_id = rs_tPostgresqlInput_1.getLong(10);
						} else {
							row3.project_id = null;
						}
					...
					if (colQtyInRs_tPostgresqlInput_1 < 11) {
						...
						if (rs_tPostgresqlInput_1.getObject(11) != null) {
							row3.code_map_id = rs_tPostgresqlInput_1
									.getLong(11);
						} else {
							row3.code_map_id = null;
						}
	...
	public static void main(String[] args) {
		final LogDuplicateReceivers LogDuplicateReceiversClass = new LogDuplicateReceivers();

		int exitCode = LogDuplicateReceiversClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LogDuplicateReceivers.class
					.getClassLoader().getResourceAsStream(
							"csiro_to_aatams/logduplicatereceivers_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : LogDuplicateReceivers");
		}
...
/************************************************************************************************
 * 96340 characters generated by Talend Open Studio for Data Integration on the
 * May 30, 2012 1:25:03 PM EST
 ************************************************************************************************/
