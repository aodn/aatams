            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.suburbTown.label" default="Suburb Town" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: addressInstance, field: "suburbTown")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="address.postcode.label" default="Postcode" /></td>
