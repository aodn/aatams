            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="detectionSurgery.surgery.label" default="Surgery" /></td>
                            
                            <td valign="top" class="value"><g:link controller="surgery" action="show" id="${detectionSurgeryInstance?.surgery?.id}">${detectionSurgeryInstance?.surgery?.encodeAsHTML()}</g:link></td>
