            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="device.codeName.label" default="Code Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: deviceInstance, field: "codeName")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="device.status.label" default="Status" /></td>
                            
                            <td valign="top" class="value"><g:link controller="deviceStatus" action="show" id="${deviceInstance?.status?.id}">${deviceInstance?.status?.encodeAsHTML()}</g:link></td>
