...
--%>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: personInstance, field: 'defaultTimeZone', 'errors')}">
                                    <joda:dateTimeZoneSelect name="defaultTimeZone" value="${personInstance?.defaultTimeZone}" />
