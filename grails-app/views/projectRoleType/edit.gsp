...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:hasErrors bean="${projectRoleTypeInstance}">
            <div class="errors">
                <g:renderErrors bean="${projectRoleTypeInstance}" as="list" />
            </div>
            </g:hasErrors>
            <g:form method="post" >
                <g:hiddenField name="id" value="${projectRoleTypeInstance?.id}" />
                <g:hiddenField name="version" value="${projectRoleTypeInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
