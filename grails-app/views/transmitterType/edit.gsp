...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:hasErrors bean="${transmitterTypeInstance}">
            <div class="errors">
                <g:renderErrors bean="${transmitterTypeInstance}" as="list" />
            </div>
            </g:hasErrors>
            <g:form method="post" >
                <g:hiddenField name="id" value="${transmitterTypeInstance?.id}" />
                <g:hiddenField name="version" value="${transmitterTypeInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
