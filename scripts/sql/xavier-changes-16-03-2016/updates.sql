...
--------------------
---- Delete all aatams_acoustic obsolete tables/views that were historically used for reporting, 0 row in all three tables, deletes 5 underlying views.
---- JA should be Liquibase
---- DROP TABLE aatams_acoustictag_all_deployments_mv CASCADE;
---- DROP TABLE aatams_acoustictag_all_detections_view_mv CASCADE;
---- DROP TABLE aatams_acoustictag_totals_species_view_mv CASCADE;
