...
class DetectionExtractServiceTests extends AbstractGrailsUnitTestCase 
{
    ...
    {
        assertEquals('''select * from detection_extract_view_mv limit 10000 offset 0''', detectionExtractService.constructQuery([:], 10000, 0))
    }

    void testConstructQueryOneProject()
    {
        assertEquals('''select * from detection_extract_view_mv where project in ('Whales') limit 10000 offset 0''',
    ...
    {
        assertEquals('''select * from detection_extract_view_mv where project in ('Whales', 'Sharks') limit 10000 offset 0''',
    ...
    {
        assertEquals('''select * from detection_extract_view_mv where project in ('Whales') and installation in ('Bondi') limit 10000 offset 0''',
    ...
    {
        assertEquals('''select * from detection_extract_view_mv where project in ('Whales', 'Sharks') and installation in ('Bondi') limit 10000 offset 0''',
    ...
    {
        assertEquals('''select * from detection_extract_view_mv where installation in ('Bondi') limit 10000 offset 0''',
    ...
    {
        assertEquals('''select * from detection_extract_view_mv where station in ('CTBAR East') limit 10000 offset 0''', 
    ...
    {
        assertEquals('''select * from detection_extract_view_mv where transmitter_id in ('A69-1303-12345') limit 10000 offset 0''', 
                     detectionExtractService.constructQuery([filter: [in:["transmitterId", "A69-1303-12345, "]]], 10000, 0))
    }
    
    void testConstructQueryOneSpecies() 
    {
        assertEquals('''select * from detection_extract_view_mv where spcode in ('12345') limit 10000 offset 0''', 
                     detectionExtractService.constructQuery([filter: [detectionSurgeries:[surgery:[release:[animal:[species:[in:["spcode", "12345, "]]]]]]]], 10000, 0))
    }
    ...
    void testConstructQueryTimestampRange() 
    {
        ...
        assertEquals('''select * from detection_extract_view_mv where timestamp between '2010-01-01 12:34:56.0' and '2010-01-01 17:00:01.0' limit 10000 offset 0''', 
    ...
    void testConstructQueryTimestampRangeOneProject() 
    {
        ...
        assertEquals('''select * from detection_extract_view_mv where project in ('Whales') and timestamp between '2010-01-01 12:34:56.0' and '2010-01-01 17:00:01.0' limit 10000 offset 0''', 
