...
'''
	...
	private void batchUpdateFirst(String[] statementList) {
		if (count == 0) {
			...
			assertEquals("INSERT INTO RAW_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_DEPLOYMENT_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, CLASS, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'2009-12-08 17:44:24.0',1,null,'AAA','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','au.org.emii.aatams.detection.InvalidDetection','Unknown receiver code name AAA','UNKNOWN_RECEIVER')", statementList[4])
			assertEquals("INSERT INTO RAW_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_DEPLOYMENT_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, CLASS, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'2009-12-08 17:44:24.0',1,null,'BBB','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','au.org.emii.aatams.detection.InvalidDetection','Unknown receiver code name BBB','UNKNOWN_RECEIVER')", statementList[5])
		}
		else if (count == 1) {
			assertEquals("INSERT INTO RAW_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_DEPLOYMENT_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, CLASS, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'2009-12-08 17:47:24.0',1,null,'BBB','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','au.org.emii.aatams.detection.InvalidDetection','Unknown receiver code name BBB','UNKNOWN_RECEIVER')", statementList[0])
