...
'''
    ...
    private void batchUpdateFirst(String[] statementList) {
        if (count == 0) {
            assertEach(
            [
                "INSERT INTO VALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, RECEIVER_DEPLOYMENT_ID)  VALUES(nextval('hibernate_sequence'),0,'20091208T174424.000+1100',1,'VR3UWM-354','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234',1)",
                "INSERT INTO VALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, RECEIVER_DEPLOYMENT_ID)  VALUES(nextval('hibernate_sequence'),0,'20091208T174424.000+1100',1,'VR3UWM-354','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234',1)",
                "INSERT INTO INVALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'20091208T174424.000+1100',1,'AAA-111','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','Unknown receiver code name AAA-111','UNKNOWN_RECEIVER')",
                "INSERT INTO INVALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'20091208T174424.000+1100',1,'BBB-111','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','Unknown receiver code name BBB-111','UNKNOWN_RECEIVER')",
            ], statementList)
        }
        else if (count == 1) {
            assertEach([
                "INSERT INTO INVALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'20091208T174724.000+1100',1,'BBB-111','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','Unknown receiver code name BBB-111','UNKNOWN_RECEIVER')",
                "INSERT INTO INVALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'20071208T174424.000+1100',1,'VR3UWM-354','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','No deployment at time 2007-12-08 06:44:24 for receiver VR3UWM-354','NO_DEPLOYMENT_AT_DATE_TIME')",
                "INSERT INTO INVALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, MESSAGE, REASON)  VALUES(nextval('hibernate_sequence'),0,'20101208T174424.000+1100',1,'VR3UWM-354','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234','No recovery at time 2010-12-08 06:44:24 for receiver VR3UWM-354','NO_RECOVERY_AT_DATE_TIME')",
                "INSERT INTO VALID_DETECTION (ID, VERSION, TIMESTAMP, RECEIVER_DOWNLOAD_ID, RECEIVER_NAME, SENSOR_UNIT, SENSOR_VALUE, STATION_NAME, TRANSMITTER_ID, TRANSMITTER_NAME, TRANSMITTER_SERIAL_NUMBER, RECEIVER_DEPLOYMENT_ID)  VALUES(nextval('hibernate_sequence'),0,'20091208T175024.000+1100',1,'VR3UWM-354','',null,'Neptune SW 1','A69-1303-62347','shark tag','1234',1)",
            ], statementList)
        }
