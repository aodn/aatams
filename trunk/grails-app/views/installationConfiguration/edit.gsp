...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:hasErrors bean="${installationConfigurationInstance}">
            <div class="errors">
                <g:renderErrors bean="${installationConfigurationInstance}" as="list" />
            </div>
            </g:hasErrors>
            <g:form method="post" >
                <g:hiddenField name="id" value="${installationConfigurationInstance?.id}" />
                <g:hiddenField name="version" value="${installationConfigurationInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
